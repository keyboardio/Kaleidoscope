...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ч', LSHIFT(Key_Backtick)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   ...
   OP(L'ч', Key_Backtick) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Cyrillic_che, Key_Backtick) \
