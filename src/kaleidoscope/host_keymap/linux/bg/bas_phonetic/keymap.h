...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'§', LSHIFT(Key_7)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'Ч', LSHIFT(Key_Q)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   ...
   OP(L'Ъ', LSHIFT(Key_Y)) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ю', LSHIFT(Key_Backtick)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_LeftBracket)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   ...
   OP(L'ч', Key_Q) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   ...
   OP(L'ъ', Key_Y) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   ...
   OP(L'я', Key_LeftBracket) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ѝ', Key_NonUsBackslashAndPipe) \
   OP(L'–', LSHIFT(Key_Minus)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'“', LSHIFT(Key_Period)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'„', LSHIFT(Key_Comma)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'€', LSHIFT(Key_6)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Cyrillic_HARDSIGN, LSHIFT(Key_Y)) \
   ...
   OP(XKB_KEY_Cyrillic_YA, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_hardsign, Key_Y) \
   ...
   OP(XKB_KEY_Cyrillic_ya, Key_LeftBracket) \
   ...
   OP(XKB_KEY_EuroSign, LSHIFT(Key_6)) \
   ...
   OP(XKB_KEY_doublelowquotemark, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_endash, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_equal, Key_Equals) \
   OP(XKB_KEY_exclam, LSHIFT(Key_1)) \
   OP(XKB_KEY_leftdoublequotemark, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_section, LSHIFT(Key_7)) \
