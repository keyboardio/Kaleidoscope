...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ș', LSHIFT(Key_Semicolon)) \
   OP(L'ș', Key_Semicolon) \
   OP(L'Ț', LSHIFT(Key_Quote)) \
   OP(L'ț', Key_Quote) \
   OP(L'–', RALT(LSHIFT(Key_Minus))) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'”', LSHIFT(Key_Backtick)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', Key_Backtick) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_doublelowquotemark, Key_Backtick) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightdoublequotemark, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_s, Key_S) \
