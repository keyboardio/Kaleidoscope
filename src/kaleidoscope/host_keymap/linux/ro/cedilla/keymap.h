...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Â', RALT(LSHIFT(Key_Q))) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   OP(L'Î', RALT(LSHIFT(Key_I))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ß', RALT(Key_W)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   ...
   OP(L'Đ', RALT(LSHIFT(Key_D))) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', RALT(Key_D)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   ...
   OP(L'”', RALT(Key_RightBracket)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Acircumflex, RALT(LSHIFT(Key_Q))) \
   ...
   OP(XKB_KEY_Dstroke, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_RightBracket)) \
   OP(XKB_KEY_s, Key_S) \
