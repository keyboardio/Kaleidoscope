...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', Key_Backtick) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', LSHIFT(Key_2)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(',', Key_NonUsPound) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(';', LSHIFT(Key_NonUsPound)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('<', Key_NonUsBackslashAndPipe) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_1)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('\\', LSHIFT(Key_Backtick)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP('i', Key_Quote) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', Key_Backtick) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', LSHIFT(Key_2)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L',', Key_NonUsPound) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(L';', LSHIFT(Key_NonUsPound)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'<', Key_NonUsBackslashAndPipe) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_1)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'\\', LSHIFT(Key_Backtick)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'i', Key_Quote) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   ...
   OP(L'£', RALT(Key_2)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   ...
   OP(L'§', RALT(Key_P)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'Â', RALT(LSHIFT(Key_A))) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   OP(L'Ç', LSHIFT(Key_Period)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Í', RALT(LSHIFT(Key_F))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Î', RALT(LSHIFT(Key_I))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ñ', LSHIFT(Key_X)) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   OP(L'Ô', RALT(LSHIFT(Key_O))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ö', LSHIFT(Key_Comma)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'Ü', LSHIFT(Key_RightBracket)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'â', RALT(Key_A)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'ç', Key_Period) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'í', RALT(Key_F)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'î', RALT(Key_I)) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ñ', Key_X) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   OP(L'ô', RALT(Key_O)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'ö', Key_Comma) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'ü', Key_RightBracket) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Ă', RALT(LSHIFT(Key_W))) /* U+0102, XKB_KEY_Abreve, LATIN CAPITAL LETTER A WITH BREVE */ \
   OP(L'ă', RALT(Key_W)) /* U+0103, XKB_KEY_abreve, LATIN SMALL LETTER A WITH BREVE */ \
   OP(L'Ğ', LSHIFT(Key_LeftBracket)) /* U+011e, XKB_KEY_Gbreve, LATIN CAPITAL LETTER G WITH BREVE */ \
   OP(L'ğ', Key_LeftBracket) /* U+011f, XKB_KEY_gbreve, LATIN SMALL LETTER G WITH BREVE */ \
   OP(L'Ĭ', LSHIFT(Key_J)) /* U+012c, XKB_KEY_Ibreve, LATIN CAPITAL LETTER I WITH BREVE */ \
   OP(L'ĭ', Key_J) /* U+012d, XKB_KEY_ibreve, LATIN SMALL LETTER I WITH BREVE */ \
   OP(L'İ', LSHIFT(Key_Quote)) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
   OP(L'ı', Key_I) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'Ș', RALT(LSHIFT(Key_S))) \
   OP(L'ș', RALT(Key_S)) \
   OP(L'Ț', RALT(LSHIFT(Key_T))) \
   OP(L'ț', RALT(Key_T)) \
   ...
   OP(L'™', RALT(Key_M)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Abreve, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_Acircumflex, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_Gbreve, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Iabovedot, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_Ibreve, LSHIFT(Key_J)) \
   ...
   OP(XKB_KEY_Ntilde, LSHIFT(Key_X)) \
   OP(XKB_KEY_Num_Lock, Key_KeypadNumLock) /* XKB_KEY_Num_Lock */ \
   OP(XKB_KEY_O, LSHIFT(Key_O)) \
   OP(XKB_KEY_Ocircumflex, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, Key_Period) \
   OP(XKB_KEY_cent, RALT(Key_C)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_comma, Key_NonUsPound) \
   OP(XKB_KEY_copyright, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_Slash)) /* XKB_KEY_dead_abovedot */ \
