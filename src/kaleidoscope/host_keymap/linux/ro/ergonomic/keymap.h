...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Î', LSHIFT(Key_K)) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'â', RALT(Key_A)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'î', Key_K) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ă', LSHIFT(Key_Q)) /* U+0102, XKB_KEY_Abreve, LATIN CAPITAL LETTER A WITH BREVE */ \
   OP(L'ă', Key_Q) /* U+0103, XKB_KEY_abreve, LATIN SMALL LETTER A WITH BREVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Abreve, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Icircumflex, LSHIFT(Key_K)) \
