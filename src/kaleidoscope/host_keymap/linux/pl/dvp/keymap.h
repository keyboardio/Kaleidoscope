...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¡', RALT(Key_Minus)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   OP(L'¢', RALT(Key_3)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', RALT(Key_6)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¤', RALT(Key_2)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¥', RALT(Key_4)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'¦', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', RALT(LSHIFT(Key_R))) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'«', RALT(Key_W)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'­', RALT(Key_Quote)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_O)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'¶', RALT(Key_R)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'»', RALT(Key_E)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'½', RALT(Key_8)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¿', RALT(Key_LeftBracket)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'É', RALT(LSHIFT(Key_F))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Ð', RALT(LSHIFT(Key_H))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ó', RALT(LSHIFT(Key_S))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ü', RALT(LSHIFT(Key_T))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Þ', RALT(LSHIFT(Key_K))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   OP(L'é', RALT(Key_F)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ó', RALT(Key_S)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ü', RALT(Key_T)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'Ć', RALT(LSHIFT(Key_I))) /* U+0106, XKB_KEY_Cacute, LATIN CAPITAL LETTER C WITH ACUTE */ \
   OP(L'ć', RALT(Key_I)) /* U+0107, XKB_KEY_cacute, LATIN SMALL LETTER C WITH ACUTE */ \
   OP(L'Ę', RALT(LSHIFT(Key_D))) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', RALT(Key_D)) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   OP(L'Ł', RALT(LSHIFT(Key_P))) /* U+0141, XKB_KEY_Lstroke, LATIN CAPITAL LETTER L WITH STROKE */ \
   OP(L'ł', RALT(Key_P)) /* U+0142, XKB_KEY_lstroke, LATIN SMALL LETTER L WITH STROKE */ \
   OP(L'Ń', RALT(LSHIFT(Key_L))) /* U+0143, XKB_KEY_Nacute, LATIN CAPITAL LETTER N WITH ACUTE */ \
   OP(L'ń', RALT(Key_L)) /* U+0144, XKB_KEY_nacute, LATIN SMALL LETTER N WITH ACUTE */ \
   OP(L'Ś', RALT(LSHIFT(Key_Semicolon))) /* U+015a, XKB_KEY_Sacute, LATIN CAPITAL LETTER S WITH ACUTE */ \
   OP(L'ś', RALT(Key_Semicolon)) /* U+015b, XKB_KEY_sacute, LATIN SMALL LETTER S WITH ACUTE */ \
   OP(L'Ź', RALT(LSHIFT(Key_B))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_B)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
   OP(L'Ż', RALT(LSHIFT(Key_Slash))) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', RALT(Key_Slash)) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   OP(L'–', RALT(LSHIFT(Key_Quote))) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_V))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(LSHIFT(Key_N))) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'“', RALT(Key_V)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_N)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_1)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'‽', RALT(LSHIFT(Key_LeftBracket))) \
   OP(L'€', RALT(Key_5)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(LSHIFT(Key_O))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cacute, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Eogonek, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Lstroke, RALT(LSHIFT(Key_P))) \
   ...
   OP(XKB_KEY_Nacute, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_Zabovedot, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_cacute, RALT(Key_I)) \
   OP(XKB_KEY_cent, RALT(Key_3)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Q)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_currency, RALT(Key_2)) \
   OP(XKB_KEY_d, Key_H) \
   OP(XKB_KEY_dead_acute, RALT(Key_J)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_RightBracket))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_RightBracket)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_Q)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Z))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_9)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_Backtick)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_dollar, Key_Backtick) \
   OP(XKB_KEY_doublelowquotemark, RALT(Key_1)) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_eacute, RALT(Key_F)) \
   OP(XKB_KEY_endash, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_eogonek, RALT(Key_D)) \
   OP(XKB_KEY_equal, Key_6) \
   OP(XKB_KEY_eth, RALT(Key_H)) \
   OP(XKB_KEY_exclam, Key_Minus) \
   OP(XKB_KEY_exclamdown, RALT(Key_Minus)) \
   OP(XKB_KEY_f, Key_Y) \
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, LSHIFT(Key_Equals)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_E)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_W)) \
   OP(XKB_KEY_guillemotright, RALT(Key_E)) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_hyphen, RALT(Key_Quote)) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   ...
   OP(XKB_KEY_lstroke, RALT(Key_P)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_Quote) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_nacute, RALT(Key_L)) \
   OP(XKB_KEY_numbersign, Key_Equals) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_oacute, RALT(Key_S)) \
   OP(XKB_KEY_onehalf, RALT(Key_8)) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_questiondown, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_Z)) \
   OP(XKB_KEY_r, Key_O) \
   OP(XKB_KEY_registered, RALT(Key_O)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_N)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_s, Key_Semicolon) \
   OP(XKB_KEY_sacute, RALT(Key_Semicolon)) \
   OP(XKB_KEY_section, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_trademark, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_u, Key_F) \
   OP(XKB_KEY_udiaeresis, RALT(Key_T)) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_v, Key_Period) \
   OP(XKB_KEY_w, Key_Comma) \
   OP(XKB_KEY_x, Key_B) \
   OP(XKB_KEY_y, Key_T) \
   OP(XKB_KEY_yen, RALT(Key_4)) \
   OP(XKB_KEY_z, Key_Slash) \
   OP(XKB_KEY_zabovedot, RALT(Key_Slash)) \
   OP(XKB_KEY_zacute, RALT(Key_B)) \
