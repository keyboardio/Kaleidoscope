...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', RALT(LSHIFT(Key_V))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', RALT(LSHIFT(Key_V))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'ó', Key_NonUsPound) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   ...
   OP(L'ą', Key_Quote) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'ć', LSHIFT(Key_RightBracket)) /* U+0107, XKB_KEY_cacute, LATIN SMALL LETTER C WITH ACUTE */ \
   ...
   OP(L'ę', LSHIFT(Key_Quote)) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   ...
   OP(L'Ł', LSHIFT(Key_Semicolon)) /* U+0141, XKB_KEY_Lstroke, LATIN CAPITAL LETTER L WITH STROKE */ \
   OP(L'ł', Key_Semicolon) /* U+0142, XKB_KEY_lstroke, LATIN SMALL LETTER L WITH STROKE */ \
   OP(L'ń', LSHIFT(Key_LeftBracket)) /* U+0144, XKB_KEY_nacute, LATIN SMALL LETTER N WITH ACUTE */ \
   OP(L'Ŋ', RALT(LSHIFT(Key_G))) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ś', Key_RightBracket) /* U+015b, XKB_KEY_sacute, LATIN SMALL LETTER S WITH ACUTE */ \
   ...
   OP(L'ź', LSHIFT(Key_NonUsPound)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
   OP(L'ż', Key_LeftBracket) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   OP(L'˙', Key_Backtick) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Lstroke, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abovedot, Key_Backtick) \
   OP(XKB_KEY_ae, RALT(Key_A)) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_6)) \
   OP(XKB_KEY_aogonek, Key_Quote) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cacute, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eogonek, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(LSHIFT(Key_V))) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_sacute, Key_RightBracket) \
   ...
   OP(XKB_KEY_z, Key_Y) \
   OP(XKB_KEY_zabovedot, Key_LeftBracket) \
   OP(XKB_KEY_zacute, LSHIFT(Key_NonUsPound)) \
