...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', LSHIFT(Key_KeypadDot)) /* XKB_KEY_KP_Separator, Separator, often comma  */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', LSHIFT(Key_KeypadDot)) /* XKB_KEY_KP_Separator, Separator, often comma  */ \
   ...
   OP(L'Ⱉ', LSHIFT(Key_W)) \
   OP(L'Ⱊ', LSHIFT(Key_P)) \
   OP(L'Ⱋ', Key_RightBracket) \
   OP(L'Ⱌ', Key_C) \
   OP(L'Ⱍ', LSHIFT(Key_C)) \
   OP(L'Ⱎ', Key_LeftBracket) \
   OP(L'Ⱏ', LSHIFT(Key_X)) \
   OP(L'Ⱐ', Key_X) \
   OP(L'Ⱑ', Key_Q) \
   OP(L'Ⱓ', LSHIFT(Key_Q)) \
   OP(L'Ⱔ', RALT(Key_E)) \
   OP(L'Ⱕ', RALT(LSHIFT(Key_E))) \
   OP(L'Ⱖ', LSHIFT(Key_LeftBracket)) \
   OP(L'Ⱗ', LSHIFT(Key_E)) \
   OP(L'Ⱘ', Key_Semicolon) \
   OP(L'Ⱙ', LSHIFT(Key_RightBracket)) \
   OP(L'Ⱚ', LSHIFT(Key_F)) \
   OP(L'Ⱛ', LSHIFT(Key_V)) \
   OP(L'ⱁ', RALT(Key_O)) \
