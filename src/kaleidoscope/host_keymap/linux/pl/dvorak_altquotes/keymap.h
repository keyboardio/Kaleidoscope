...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'”', RALT(LSHIFT(Key_1))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_r, Key_O) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_1))) \
