...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¢', RALT(Key_6)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'©', RALT(Key_2)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'«', RALT(LSHIFT(Key_LeftBracket))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'°', RALT(Key_0)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'¶', RALT(LSHIFT(Key_NonUsPound))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_Period))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'»', RALT(LSHIFT(Key_RightBracket))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'×', RALT(Key_8)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   ...
   OP(L'‘', RALT(Key_Semicolon)) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_Quote)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(Key_Comma)) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_Semicolon))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_Quote))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_belowdot, RALT(LSHIFT(Key_9))) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_7))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_5))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_4))) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(LSHIFT(Key_6))) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_2))) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_3))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Backtick)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_macron, RALT(LSHIFT(Key_Minus))) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_leftsinglequotemark, RALT(Key_Semicolon)) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_lstroke, RALT(Key_L)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_multiply, RALT(Key_8)) \
   OP(XKB_KEY_n, Key_N) \
   ...
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_NonUsPound))) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_Quote)) \
   OP(XKB_KEY_s, Key_S) \
