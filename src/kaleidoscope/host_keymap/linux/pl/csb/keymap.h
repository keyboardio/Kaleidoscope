...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ã', RALT(LSHIFT(Key_S))) /* U+00c3, XKB_KEY_Atilde, LATIN CAPITAL LETTER A WITH TILDE */ \
   ...
   OP(L'Ò', RALT(LSHIFT(Key_I))) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   ...
   OP(L'ã', RALT(Key_S)) /* U+00e3, XKB_KEY_atilde, LATIN SMALL LETTER A WITH TILDE */ \
   ...
   OP(L'ò', RALT(Key_I)) /* U+00f2, XKB_KEY_ograve, LATIN SMALL LETTER O WITH GRAVE */ \
   ...
   OP(L'€', RALT(Key_Y)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Atilde, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_EuroSign, RALT(Key_Y)) \
   ...
   OP(XKB_KEY_Ograve, RALT(LSHIFT(Key_I))) \
