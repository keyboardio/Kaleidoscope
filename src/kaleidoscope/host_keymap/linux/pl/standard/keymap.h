...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', RALT(Key_9)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'·', RALT(Key_8)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'»', RALT(Key_0)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¼', RALT(LSHIFT(Key_4))) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(Key_6)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(LSHIFT(Key_8))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   OP(L'¿', RALT(LSHIFT(Key_2))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   ...
   OP(L'ß', RALT(Key_T)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   ...
   OP(L'Ę', RALT(LSHIFT(Key_E))) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', RALT(Key_E)) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   ...
   OP(L'Ń', RALT(LSHIFT(Key_N))) /* U+0143, XKB_KEY_Nacute, LATIN CAPITAL LETTER N WITH ACUTE */ \
   OP(L'ń', RALT(Key_N)) /* U+0144, XKB_KEY_nacute, LATIN SMALL LETTER N WITH ACUTE */ \
   ...
   OP(L'Œ', RALT(LSHIFT(Key_W))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_W)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Ś', RALT(LSHIFT(Key_S))) /* U+015a, XKB_KEY_Sacute, LATIN CAPITAL LETTER S WITH ACUTE */ \
   OP(L'ś', RALT(Key_S)) /* U+015b, XKB_KEY_sacute, LATIN SMALL LETTER S WITH ACUTE */ \
   ...
   OP(L'Ə', RALT(LSHIFT(Key_J))) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'ə', RALT(Key_J)) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   ...
   OP(L'’', RALT(Key_H)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_B))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   ...
   OP(L'…', RALT(Key_K)) /* U+2026, XKB_KEY_ellipsis, HORIZONTAL ELLIPSIS */ \
   OP(L'‰', RALT(LSHIFT(Key_5))) \
   OP(L'€', RALT(Key_5)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(LSHIFT(Key_T))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   ...
   OP(L'∞', RALT(LSHIFT(Key_M))) /* U+221e, XKB_KEY_infinity, INFINITY */ \
   OP(L'∧', RALT(LSHIFT(Key_6))) /* U+2227, XKB_KEY_logicaland, LOGICAL AND */ \
   OP(L'∨', RALT(LSHIFT(Key_Backtick))) /* U+2228, XKB_KEY_logicalor, LOGICAL OR */ \
   OP(L'≈', RALT(LSHIFT(Key_7))) /* U+2248, XKB_KEY_approxeq, ALMOST EQUAL TO */ \
   OP(L'≠', RALT(Key_1)) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Eogonek, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Nacute, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_SCHWA, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Sacute, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_approxeq, RALT(LSHIFT(Key_7))) \
   ...
   OP(XKB_KEY_dead_stroke, RALT(LSHIFT(Key_K))) /* XKB_KEY_dead_stroke */ \
   ...
   OP(XKB_KEY_guillemotleft, RALT(Key_9)) \
   OP(XKB_KEY_guillemotright, RALT(Key_0)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_infinity, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftarrow, RALT(Key_Y)) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_B))) \
   ...
   OP(XKB_KEY_logicaland, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_logicalor, RALT(LSHIFT(Key_Backtick))) \
   ...
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_H)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_sacute, RALT(Key_S)) \
   OP(XKB_KEY_schwa, RALT(Key_J)) \
   OP(XKB_KEY_section, RALT(Key_7)) \
   OP(XKB_KEY_semicolon, Key_Semicolon) \
   OP(XKB_KEY_slash, Key_Slash) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_ssharp, RALT(Key_T)) \
   ...
   OP(XKB_KEY_trademark, RALT(LSHIFT(Key_T))) \
