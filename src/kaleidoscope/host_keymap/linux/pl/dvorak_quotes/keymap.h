...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ź', RALT(LSHIFT(Key_Period))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_Period)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
   ...
   OP(L'”', RALT(LSHIFT(Key_Q))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_Q)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_1))) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(Key_Q)) \
   OP(XKB_KEY_e, Key_D) \
   ...
   OP(XKB_KEY_r, Key_O) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_Q))) \
   ...
   OP(XKB_KEY_zacute, RALT(Key_Period)) \
