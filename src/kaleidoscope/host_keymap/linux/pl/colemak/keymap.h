...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('D', LSHIFT(Key_G)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', LSHIFT(Key_K)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', LSHIFT(Key_E)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_T)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   ...
   OP('R', LSHIFT(Key_S)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   ...
   OP('Y', LSHIFT(Key_O)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP('d', Key_G) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', Key_K) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', Key_E) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', Key_T) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   ...
   OP('r', Key_S) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   ...
   OP('y', Key_O) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'D', LSHIFT(Key_G)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', LSHIFT(Key_K)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', LSHIFT(Key_E)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_T)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   ...
   OP(L'R', LSHIFT(Key_S)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   ...
   OP(L'Y', LSHIFT(Key_O)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP(L'd', Key_G) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', Key_K) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', Key_E) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', Key_T) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   ...
   OP(L'r', Key_S) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   ...
   OP(L'y', Key_O) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP(L'¥', RALT(LSHIFT(Key_5))) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'ª', RALT(Key_3)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'Ã', RALT(LSHIFT(Key_E))) /* U+00c3, XKB_KEY_Atilde, LATIN CAPITAL LETTER A WITH TILDE */ \
   ...
   OP(L'Í', RALT(LSHIFT(Key_L))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ð', RALT(LSHIFT(Key_7))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ó', RALT(LSHIFT(Key_Semicolon))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Õ', RALT(LSHIFT(Key_Quote))) /* U+00d5, XKB_KEY_Otilde, LATIN CAPITAL LETTER O WITH TILDE */ \
   OP(L'Ö', RALT(LSHIFT(Key_P))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'×', RALT(Key_Equals)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Ø', RALT(LSHIFT(Key_R))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ú', RALT(LSHIFT(Key_I))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ü', RALT(LSHIFT(Key_O))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Þ', RALT(LSHIFT(Key_8))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   OP(L'ã', RALT(Key_E)) /* U+00e3, XKB_KEY_atilde, LATIN SMALL LETTER A WITH TILDE */ \
   ...
   OP(L'í', RALT(Key_L)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ð', RALT(Key_7)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ó', RALT(Key_Semicolon)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'õ', RALT(Key_Quote)) /* U+00f5, XKB_KEY_otilde, LATIN SMALL LETTER O WITH TILDE */ \
   OP(L'ö', RALT(Key_P)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(LSHIFT(Key_Equals))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', RALT(Key_R)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ú', RALT(Key_I)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ü', RALT(Key_O)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'þ', RALT(Key_8)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'Ą', RALT(LSHIFT(Key_A))) /* U+0104, XKB_KEY_Aogonek, LATIN CAPITAL LETTER A WITH OGONEK */ \
   OP(L'ą', RALT(Key_A)) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'Ć', RALT(LSHIFT(Key_C))) /* U+0106, XKB_KEY_Cacute, LATIN CAPITAL LETTER C WITH ACUTE */ \
   OP(L'ć', RALT(Key_C)) /* U+0107, XKB_KEY_cacute, LATIN SMALL LETTER C WITH ACUTE */ \
   OP(L'Đ', RALT(LSHIFT(Key_Y))) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', RALT(Key_Y)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ę', RALT(LSHIFT(Key_K))) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', RALT(Key_K)) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   OP(L'Ħ', RALT(LSHIFT(Key_6))) /* U+0126, XKB_KEY_Hstroke, LATIN CAPITAL LETTER H WITH STROKE */ \
   OP(L'ħ', RALT(Key_6)) /* U+0127, XKB_KEY_hstroke, LATIN SMALL LETTER H WITH STROKE */ \
   ...
   OP(L'Ń', RALT(LSHIFT(Key_J))) /* U+0143, XKB_KEY_Nacute, LATIN CAPITAL LETTER N WITH ACUTE */ \
   OP(L'ń', RALT(Key_J)) /* U+0144, XKB_KEY_nacute, LATIN SMALL LETTER N WITH ACUTE */ \
   OP(L'Œ', RALT(LSHIFT(Key_V))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_V)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Ś', RALT(LSHIFT(Key_D))) /* U+015a, XKB_KEY_Sacute, LATIN CAPITAL LETTER S WITH ACUTE */ \
   OP(L'ś', RALT(Key_D)) /* U+015b, XKB_KEY_sacute, LATIN SMALL LETTER S WITH ACUTE */ \
   OP(L'Ź', RALT(LSHIFT(Key_X))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_X)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
   OP(L'Ż', RALT(LSHIFT(Key_Z))) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', RALT(Key_Z)) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   ...
   OP(L'“', RALT(LSHIFT(Key_9))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_0))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aogonek, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_Aring, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_Atilde, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Cacute, RALT(LSHIFT(Key_C))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Nacute, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Otilde, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_Sacute, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_THORN, RALT(LSHIFT(Key_8))) /* XKB_KEY_Thorn, deprecated  */ \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, LSHIFT(Key_I)) \
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_Y, LSHIFT(Key_O)) \
   OP(XKB_KEY_Z, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Zabovedot, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_adiaeresis, RALT(Key_Q)) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_7)) \
   OP(XKB_KEY_aogonek, RALT(Key_A)) \
   ...
   OP(XKB_KEY_dead_abovering, RALT(Key_N)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_F)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_breve, RALT(Key_B)) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(Key_H)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_Comma)) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_G)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_F))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_S)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_macron, RALT(Key_M)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_T)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_Backtick)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_dstroke, RALT(Key_Y)) \
   OP(XKB_KEY_e, Key_K) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_endash, RALT(Key_Minus)) \
   OP(XKB_KEY_eogonek, RALT(Key_K)) \
   OP(XKB_KEY_equal, Key_Equals) \
   OP(XKB_KEY_eth, RALT(Key_7)) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hstroke, RALT(Key_6)) \
   OP(XKB_KEY_i, Key_L) \
   OP(XKB_KEY_iacute, RALT(Key_L)) \
   OP(XKB_KEY_j, Key_Y) \
   OP(XKB_KEY_k, Key_N) \
   OP(XKB_KEY_l, Key_U) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_9))) \
   ...
   OP(XKB_KEY_n, Key_J) \
   OP(XKB_KEY_nacute, RALT(Key_J)) \
   OP(XKB_KEY_nobreakspace, RALT(LSHIFT(Key_Spacebar))) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_Semicolon) \
   OP(XKB_KEY_oacute, RALT(Key_Semicolon)) \
   OP(XKB_KEY_odiaeresis, RALT(Key_P)) \
   OP(XKB_KEY_oe, RALT(Key_V)) \
   OP(XKB_KEY_onesuperior, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_ordfeminine, RALT(Key_3)) \
   OP(XKB_KEY_oslash, RALT(Key_R)) \
   OP(XKB_KEY_otilde, RALT(Key_Quote)) \
   OP(XKB_KEY_p, Key_R) \
