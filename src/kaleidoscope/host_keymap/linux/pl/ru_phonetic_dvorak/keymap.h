...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', LSHIFT(Key_Q)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', Key_Q) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(':', LSHIFT(Key_Z)) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', LSHIFT(Key_Q)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', Key_Q) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L':', LSHIFT(Key_Z)) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP(L'Ё', RALT(LSHIFT(Key_S))) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   OP(L'А', LSHIFT(Key_A)) /* U+0410, XKB_KEY_Cyrillic_A, CYRILLIC CAPITAL LETTER A */ \
   OP(L'Б', LSHIFT(Key_N)) /* U+0411, XKB_KEY_Cyrillic_BE, CYRILLIC CAPITAL LETTER BE */ \
   OP(L'В', LSHIFT(Key_Comma)) /* U+0412, XKB_KEY_Cyrillic_VE, CYRILLIC CAPITAL LETTER VE */ \
   OP(L'Г', LSHIFT(Key_U)) /* U+0413, XKB_KEY_Cyrillic_GHE, CYRILLIC CAPITAL LETTER GHE */ \
   OP(L'Д', LSHIFT(Key_H)) /* U+0414, XKB_KEY_Cyrillic_DE, CYRILLIC CAPITAL LETTER DE */ \
   OP(L'Е', LSHIFT(Key_D)) /* U+0415, XKB_KEY_Cyrillic_IE, CYRILLIC CAPITAL LETTER IE */ \
   OP(L'Ж', RALT(LSHIFT(Key_Slash))) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', LSHIFT(Key_Slash)) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   OP(L'И', LSHIFT(Key_G)) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   OP(L'Й', LSHIFT(Key_C)) /* U+0419, XKB_KEY_Cyrillic_SHORTI, CYRILLIC CAPITAL LETTER SHORT I */ \
   OP(L'К', LSHIFT(Key_V)) /* U+041a, XKB_KEY_Cyrillic_KA, CYRILLIC CAPITAL LETTER KA */ \
   OP(L'Л', LSHIFT(Key_P)) /* U+041b, XKB_KEY_Cyrillic_EL, CYRILLIC CAPITAL LETTER EL */ \
   OP(L'М', LSHIFT(Key_M)) /* U+041c, XKB_KEY_Cyrillic_EM, CYRILLIC CAPITAL LETTER EM */ \
   OP(L'Н', LSHIFT(Key_L)) /* U+041d, XKB_KEY_Cyrillic_EN, CYRILLIC CAPITAL LETTER EN */ \
   OP(L'О', LSHIFT(Key_S)) /* U+041e, XKB_KEY_Cyrillic_O, CYRILLIC CAPITAL LETTER O */ \
   OP(L'П', LSHIFT(Key_R)) /* U+041f, XKB_KEY_Cyrillic_PE, CYRILLIC CAPITAL LETTER PE */ \
   OP(L'Р', LSHIFT(Key_O)) /* U+0420, XKB_KEY_Cyrillic_ER, CYRILLIC CAPITAL LETTER ER */ \
   OP(L'С', LSHIFT(Key_Semicolon)) /* U+0421, XKB_KEY_Cyrillic_ES, CYRILLIC CAPITAL LETTER ES */ \
   OP(L'Т', LSHIFT(Key_K)) /* U+0422, XKB_KEY_Cyrillic_TE, CYRILLIC CAPITAL LETTER TE */ \
   OP(L'У', LSHIFT(Key_F)) /* U+0423, XKB_KEY_Cyrillic_U, CYRILLIC CAPITAL LETTER U */ \
   OP(L'Ф', LSHIFT(Key_Y)) /* U+0424, XKB_KEY_Cyrillic_EF, CYRILLIC CAPITAL LETTER EF */ \
   OP(L'Х', LSHIFT(Key_J)) /* U+0425, XKB_KEY_Cyrillic_HA, CYRILLIC CAPITAL LETTER HA */ \
   OP(L'Ц', LSHIFT(Key_I)) /* U+0426, XKB_KEY_Cyrillic_TSE, CYRILLIC CAPITAL LETTER TSE */ \
   OP(L'Ч', RALT(LSHIFT(Key_I))) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', RALT(LSHIFT(Key_Semicolon))) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_B)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   OP(L'Ъ', RALT(LSHIFT(Key_N))) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ы', LSHIFT(Key_T)) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', RALT(LSHIFT(Key_R))) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', RALT(LSHIFT(Key_D))) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', RALT(LSHIFT(Key_F))) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_X)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   OP(L'а', Key_A) /* U+0430, XKB_KEY_Cyrillic_a, CYRILLIC SMALL LETTER A */ \
   OP(L'б', Key_N) /* U+0431, XKB_KEY_Cyrillic_be, CYRILLIC SMALL LETTER BE */ \
   OP(L'в', Key_Comma) /* U+0432, XKB_KEY_Cyrillic_ve, CYRILLIC SMALL LETTER VE */ \
   OP(L'г', Key_U) /* U+0433, XKB_KEY_Cyrillic_ghe, CYRILLIC SMALL LETTER GHE */ \
   OP(L'д', Key_H) /* U+0434, XKB_KEY_Cyrillic_de, CYRILLIC SMALL LETTER DE */ \
   OP(L'е', Key_D) /* U+0435, XKB_KEY_Cyrillic_ie, CYRILLIC SMALL LETTER IE */ \
   OP(L'ж', RALT(Key_Slash)) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', Key_Slash) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   OP(L'и', Key_G) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   OP(L'й', Key_C) /* U+0439, XKB_KEY_Cyrillic_shorti, CYRILLIC SMALL LETTER SHORT I */ \
   OP(L'к', Key_V) /* U+043a, XKB_KEY_Cyrillic_ka, CYRILLIC SMALL LETTER KA */ \
   OP(L'л', Key_P) /* U+043b, XKB_KEY_Cyrillic_el, CYRILLIC SMALL LETTER EL */ \
   OP(L'м', Key_M) /* U+043c, XKB_KEY_Cyrillic_em, CYRILLIC SMALL LETTER EM */ \
   OP(L'н', Key_L) /* U+043d, XKB_KEY_Cyrillic_en, CYRILLIC SMALL LETTER EN */ \
   OP(L'о', Key_S) /* U+043e, XKB_KEY_Cyrillic_o, CYRILLIC SMALL LETTER O */ \
   OP(L'п', Key_R) /* U+043f, XKB_KEY_Cyrillic_pe, CYRILLIC SMALL LETTER PE */ \
   OP(L'р', Key_O) /* U+0440, XKB_KEY_Cyrillic_er, CYRILLIC SMALL LETTER ER */ \
   OP(L'с', Key_Semicolon) /* U+0441, XKB_KEY_Cyrillic_es, CYRILLIC SMALL LETTER ES */ \
   OP(L'т', Key_K) /* U+0442, XKB_KEY_Cyrillic_te, CYRILLIC SMALL LETTER TE */ \
   OP(L'у', Key_F) /* U+0443, XKB_KEY_Cyrillic_u, CYRILLIC SMALL LETTER U */ \
   OP(L'ф', Key_Y) /* U+0444, XKB_KEY_Cyrillic_ef, CYRILLIC SMALL LETTER EF */ \
   OP(L'х', Key_J) /* U+0445, XKB_KEY_Cyrillic_ha, CYRILLIC SMALL LETTER HA */ \
   OP(L'ц', Key_I) /* U+0446, XKB_KEY_Cyrillic_tse, CYRILLIC SMALL LETTER TSE */ \
   OP(L'ч', RALT(Key_I)) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', RALT(Key_Semicolon)) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_B) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   OP(L'ъ', RALT(Key_N)) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', Key_T) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', RALT(Key_R)) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', RALT(Key_D)) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', RALT(Key_F)) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', Key_X) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ё', RALT(Key_S)) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_BE, LSHIFT(Key_N)) \
   OP(XKB_KEY_Cyrillic_CHE, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Cyrillic_DE, LSHIFT(Key_H)) \
   OP(XKB_KEY_Cyrillic_E, RALT(LSHIFT(Key_D))) \
   OP(XKB_KEY_Cyrillic_EF, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_EL, LSHIFT(Key_P)) \
   OP(XKB_KEY_Cyrillic_EM, LSHIFT(Key_M)) \
   OP(XKB_KEY_Cyrillic_EN, LSHIFT(Key_L)) \
   OP(XKB_KEY_Cyrillic_ER, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_ES, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_GHE, LSHIFT(Key_U)) \
   OP(XKB_KEY_Cyrillic_HA, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_HARDSIGN, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_IE, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_IO, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_V)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_S)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_R)) \
   OP(XKB_KEY_Cyrillic_SHA, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_B)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_C)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Cyrillic_TE, LSHIFT(Key_K)) \
   OP(XKB_KEY_Cyrillic_TSE, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_U, LSHIFT(Key_F)) \
   OP(XKB_KEY_Cyrillic_VE, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_Cyrillic_YA, LSHIFT(Key_X)) \
   OP(XKB_KEY_Cyrillic_YERU, LSHIFT(Key_T)) \
   OP(XKB_KEY_Cyrillic_YU, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Cyrillic_ZHE, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_Cyrillic_a, Key_A) \
   OP(XKB_KEY_Cyrillic_be, Key_N) \
   OP(XKB_KEY_Cyrillic_che, RALT(Key_I)) \
   OP(XKB_KEY_Cyrillic_de, Key_H) \
   OP(XKB_KEY_Cyrillic_e, RALT(Key_D)) \
   OP(XKB_KEY_Cyrillic_ef, Key_Y) \
   OP(XKB_KEY_Cyrillic_el, Key_P) \
   OP(XKB_KEY_Cyrillic_em, Key_M) \
   OP(XKB_KEY_Cyrillic_en, Key_L) \
   OP(XKB_KEY_Cyrillic_er, Key_O) \
   OP(XKB_KEY_Cyrillic_es, Key_Semicolon) \
   OP(XKB_KEY_Cyrillic_ghe, Key_U) \
   OP(XKB_KEY_Cyrillic_ha, Key_J) \
   OP(XKB_KEY_Cyrillic_hardsign, RALT(Key_N)) \
   OP(XKB_KEY_Cyrillic_i, Key_G) \
   OP(XKB_KEY_Cyrillic_ie, Key_D) \
   OP(XKB_KEY_Cyrillic_io, RALT(Key_S)) \
   OP(XKB_KEY_Cyrillic_ka, Key_V) \
   OP(XKB_KEY_Cyrillic_o, Key_S) \
   OP(XKB_KEY_Cyrillic_pe, Key_R) \
   OP(XKB_KEY_Cyrillic_sha, RALT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_shcha, Key_B) \
   OP(XKB_KEY_Cyrillic_shorti, Key_C) \
   OP(XKB_KEY_Cyrillic_softsign, RALT(Key_R)) \
   OP(XKB_KEY_Cyrillic_te, Key_K) \
   OP(XKB_KEY_Cyrillic_tse, Key_I) \
   OP(XKB_KEY_Cyrillic_u, Key_F) \
   OP(XKB_KEY_Cyrillic_ve, Key_Comma) \
   OP(XKB_KEY_Cyrillic_ya, Key_X) \
   OP(XKB_KEY_Cyrillic_yeru, Key_T) \
   OP(XKB_KEY_Cyrillic_yu, RALT(Key_F)) \
   OP(XKB_KEY_Cyrillic_ze, Key_Slash) \
   OP(XKB_KEY_Cyrillic_zhe, RALT(Key_Slash)) \
   ...
   OP(XKB_KEY_apostrophe, Key_Q) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_colon, LSHIFT(Key_Z)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_E)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_acute, RALT(Key_Q)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_W))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_W)) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_6)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_Q))) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_dead_ogonek, RALT(Key_Z)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_Equals)) /* XKB_KEY_dead_tilde */ \
   ...
   OP(XKB_KEY_quotedbl, LSHIFT(Key_Q)) \
