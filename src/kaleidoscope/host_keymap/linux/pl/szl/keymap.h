...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Õ', RALT(LSHIFT(Key_P))) /* U+00d5, XKB_KEY_Otilde, LATIN CAPITAL LETTER O WITH TILDE */ \
   ...
   OP(L'õ', RALT(Key_P)) /* U+00f5, XKB_KEY_otilde, LATIN SMALL LETTER O WITH TILDE */ \
   ...
   OP(L'Ō', RALT(LSHIFT(Key_U))) /* U+014c, XKB_KEY_Omacron, LATIN CAPITAL LETTER O WITH MACRON */ \
   OP(L'ō', RALT(Key_U)) /* U+014d, XKB_KEY_omacron, LATIN SMALL LETTER O WITH MACRON */ \
   OP(L'Ŏ', RALT(LSHIFT(Key_A))) \
   OP(L'ŏ', RALT(Key_A)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Omacron, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_Otilde, RALT(LSHIFT(Key_P))) \
