...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', Key_Quote) /* U+002c, XKB_KEY_comma, COMMA */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', Key_Quote) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(L'ָ', RALT(Key_E)) \
   OP(L'ֹ', RALT(Key_U)) \
   OP(L'ֻ', RALT(Key_NonUsPound)) \
   OP(L'ּ', RALT(Key_S)) \
   OP(L'ֽ', RALT(Key_7)) \
   OP(L'־', RALT(Key_Minus)) \
   OP(L'ֿ', RALT(Key_RightBracket)) \
   OP(L'ׁ', RALT(Key_W)) \
   OP(L'ׂ', RALT(Key_Q)) \
   ...
   OP(L'‚', RALT(Key_Period)) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'”', RALT(Key_L)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_Semicolon)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'₪', RALT(Key_4)) /* U+20aa, XKB_KEY_NewSheqelSign, NEW SHEQEL SIGN */ \
   OP(L'€', RALT(Key_3)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EuroSign, RALT(Key_3)) \
   ...
   OP(XKB_KEY_NewSheqelSign, RALT(Key_4)) \
   ...
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_L)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_Comma)) \
   OP(XKB_KEY_semicolon, Key_Backtick) \
   OP(XKB_KEY_singlelowquotemark, RALT(Key_Period)) \
