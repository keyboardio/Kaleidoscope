...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Hangul, Key_RightAlt) /* XKB_KEY_Hangul, Hangul start/stop(toggle)  */ \
   OP(XKB_KEY_Hangul_Hanja, Key_PcApplication) /* XKB_KEY_Hangul_Hanja, Start Hangul->Hanja Conversion  */ \
