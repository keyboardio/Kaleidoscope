...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Õ', RALT(LSHIFT(Key_RightBracket))) /* U+00d5, XKB_KEY_Otilde, LATIN CAPITAL LETTER O WITH TILDE */ \
   ...
   OP(L'õ', RALT(Key_RightBracket)) /* U+00f5, XKB_KEY_otilde, LATIN SMALL LETTER O WITH TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Otilde, RALT(LSHIFT(Key_RightBracket))) \
   ...
   OP(XKB_KEY_otilde, RALT(Key_RightBracket)) \
   OP(XKB_KEY_p, Key_P) \
