...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', RALT(Key_Equals)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', RALT(Key_Equals)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'Õ', LSHIFT(Key_RightBracket)) /* U+00d5, XKB_KEY_Otilde, LATIN CAPITAL LETTER O WITH TILDE */ \
   ...
   OP(L'õ', Key_RightBracket) /* U+00f5, XKB_KEY_otilde, LATIN SMALL LETTER O WITH TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Otilde, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_dead_caron, Key_Backtick) /* XKB_KEY_dead_caron */ \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(Key_Equals)) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_otilde, Key_RightBracket) \
   OP(XKB_KEY_p, Key_P) \
