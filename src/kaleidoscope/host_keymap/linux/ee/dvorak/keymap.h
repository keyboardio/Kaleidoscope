...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Õ', RALT(LSHIFT(Key_S))) /* U+00d5, XKB_KEY_Otilde, LATIN CAPITAL LETTER O WITH TILDE */ \
   OP(L'Ö', RALT(LSHIFT(Key_D))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'õ', RALT(Key_S)) /* U+00f5, XKB_KEY_otilde, LATIN SMALL LETTER O WITH TILDE */ \
   OP(L'ö', RALT(Key_D)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_D))) \
   OP(XKB_KEY_Otilde, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_odiaeresis, RALT(Key_D)) \
   OP(XKB_KEY_onehalf, RALT(Key_8)) \
   OP(XKB_KEY_otilde, RALT(Key_S)) \
   OP(XKB_KEY_p, Key_R) \
