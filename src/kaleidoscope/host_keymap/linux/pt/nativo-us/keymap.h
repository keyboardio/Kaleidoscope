...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', Key_X) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'»', LSHIFT(Key_X)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_guillemotleft, Key_X) \
   OP(XKB_KEY_guillemotright, LSHIFT(Key_X)) \
   OP(XKB_KEY_h, Key_R) \
   OP(XKB_KEY_i, Key_A) \
