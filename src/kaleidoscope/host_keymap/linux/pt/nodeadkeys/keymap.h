...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('+', Key_LeftBracket) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP('^', RALT(Key_Quote)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Slash)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', LSHIFT(Key_RightBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'+', Key_LeftBracket) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP(L'^', RALT(Key_Quote)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Slash)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', LSHIFT(Key_RightBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'ª', LSHIFT(Key_Quote)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', Key_Equals) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'´', Key_RightBracket) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   ...
   OP(L'º', Key_Quote) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'»', LSHIFT(Key_Equals)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, LSHIFT(Key_RightBracket)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_guillemotleft, Key_Equals) \
   OP(XKB_KEY_guillemotright, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_h, Key_H) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, Key_Quote) \
   ...
   OP(XKB_KEY_ordfeminine, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_plus, Key_LeftBracket) \
