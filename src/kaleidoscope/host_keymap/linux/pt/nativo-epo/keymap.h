...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('Q', RALT(LSHIFT(Key_N))) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP('X', RALT(LSHIFT(Key_T))) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', RALT(LSHIFT(Key_Z))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP('q', RALT(Key_N)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP('x', RALT(Key_T)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', RALT(Key_Z)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Q', RALT(LSHIFT(Key_N))) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP(L'X', RALT(LSHIFT(Key_T))) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', RALT(LSHIFT(Key_Z))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP(L'q', RALT(Key_N)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP(L'x', RALT(Key_T)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', RALT(Key_Z)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP(L'¤', RALT(Key_B)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¦', RALT(LSHIFT(Key_B))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', RALT(Key_4)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'¨', RALT(LSHIFT(Key_6))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   OP(L'©', RALT(Key_O)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', LSHIFT(Key_Minus)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'º', Key_Minus) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   ...
   OP(L'Ç', RALT(LSHIFT(Key_X))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   ...
   OP(L'ç', RALT(Key_X)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   ...
   OP(L'Ĉ', LSHIFT(Key_T)) /* U+0108, XKB_KEY_Ccircumflex, LATIN CAPITAL LETTER C WITH CIRCUMFLEX */ \
   OP(L'ĉ', Key_T) /* U+0109, XKB_KEY_ccircumflex, LATIN SMALL LETTER C WITH CIRCUMFLEX */ \
   OP(L'Ĝ', LSHIFT(Key_N)) /* U+011c, XKB_KEY_Gcircumflex, LATIN CAPITAL LETTER G WITH CIRCUMFLEX */ \
   OP(L'ĝ', Key_N) /* U+011d, XKB_KEY_gcircumflex, LATIN SMALL LETTER G WITH CIRCUMFLEX */ \
   OP(L'Ĥ', RALT(LSHIFT(Key_R))) /* U+0124, XKB_KEY_Hcircumflex, LATIN CAPITAL LETTER H WITH CIRCUMFLEX */ \
   OP(L'ĥ', RALT(Key_R)) /* U+0125, XKB_KEY_hcircumflex, LATIN SMALL LETTER H WITH CIRCUMFLEX */ \
   ...
   OP(L'Ĵ', LSHIFT(Key_Z)) /* U+0134, XKB_KEY_Jcircumflex, LATIN CAPITAL LETTER J WITH CIRCUMFLEX */ \
   OP(L'ĵ', Key_Z) /* U+0135, XKB_KEY_jcircumflex, LATIN SMALL LETTER J WITH CIRCUMFLEX */ \
   ...
   OP(L'Ŝ', LSHIFT(Key_X)) /* U+015c, XKB_KEY_Scircumflex, LATIN CAPITAL LETTER S WITH CIRCUMFLEX */ \
   OP(L'ŝ', Key_X) /* U+015d, XKB_KEY_scircumflex, LATIN SMALL LETTER S WITH CIRCUMFLEX */ \
   OP(L'Ŭ', LSHIFT(Key_Y)) /* U+016c, XKB_KEY_Ubreve, LATIN CAPITAL LETTER U WITH BREVE */ \
   OP(L'ŭ', Key_Y) /* U+016d, XKB_KEY_ubreve, LATIN SMALL LETTER U WITH BREVE */ \
   ...
   OP(L'̕', RALT(LSHIFT(Key_W))) \
   OP(L'̦', RALT(LSHIFT(Key_Minus))) \
   OP(L'̩', RALT(Key_W)) \
   OP(L'̭', RALT(LSHIFT(Key_7))) \
   OP(L'̱', RALT(LSHIFT(Key_8))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccedilla, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Ccircumflex, LSHIFT(Key_T)) \
   ...
   OP(XKB_KEY_Gcircumflex, LSHIFT(Key_N)) \
   OP(XKB_KEY_H, LSHIFT(Key_R)) \
   OP(XKB_KEY_Hcircumflex, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Jcircumflex, LSHIFT(Key_Z)) \
   ...
   OP(XKB_KEY_Q, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_Scircumflex, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Y, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_brokenbar, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_c, Key_O) \
   OP(XKB_KEY_ccedilla, RALT(Key_X)) \
   OP(XKB_KEY_ccircumflex, Key_T) \
   OP(XKB_KEY_cent, RALT(Key_5)) \
   OP(XKB_KEY_colon, LSHIFT(Key_E)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_copyright, RALT(Key_O)) \
   OP(XKB_KEY_currency, RALT(Key_B)) \
   OP(XKB_KEY_d, Key_J) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_NonUsPound))) /* XKB_KEY_dead_abovedot */ \
   ...
   OP(XKB_KEY_dead_belowdot, RALT(Key_NonUsPound)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(Key_LeftBracket)) /* XKB_KEY_dead_caron */ \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(Key_Backtick)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_LeftBracket))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, LSHIFT(Key_Quote)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(LSHIFT(Key_0))) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(LSHIFT(Key_9))) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(Key_Quote)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_Minus)) /* XKB_KEY_dead_ogonek */ \
   ...
   OP(XKB_KEY_h, Key_R) \
   OP(XKB_KEY_hcircumflex, RALT(Key_R)) \
   OP(XKB_KEY_i, Key_A) \
   OP(XKB_KEY_idotless, RALT(Key_A)) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_jcircumflex, Key_Z) \
   OP(XKB_KEY_k, Key_B) \
   OP(XKB_KEY_l, Key_U) \
   ...
   OP(XKB_KEY_m, Key_H) \
   OP(XKB_KEY_masculine, Key_Minus) \
   ...
   OP(XKB_KEY_ordfeminine, LSHIFT(Key_Minus)) \
   ...
   OP(XKB_KEY_s, Key_K) \
   OP(XKB_KEY_scircumflex, Key_X) \
   OP(XKB_KEY_section, RALT(Key_4)) \
   ...
   OP(XKB_KEY_u, Key_G) \
   OP(XKB_KEY_ubreve, Key_Y) \
   OP(XKB_KEY_underscore, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_v, Key_M) \
   OP(XKB_KEY_w, RALT(Key_Y)) \
   OP(XKB_KEY_x, RALT(Key_T)) \
   OP(XKB_KEY_y, RALT(Key_Z)) \
