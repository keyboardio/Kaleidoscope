...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ª', LSHIFT(Key_LeftBracket)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'º', Key_LeftBracket) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, Key_LeftBracket) \
   ...
   OP(XKB_KEY_ordfeminine, LSHIFT(Key_LeftBracket)) \
