...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('~', RALT(Key_5)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'~', RALT(Key_5)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciitilde, RALT(Key_5)) \
   ...
   OP(XKB_KEY_dead_circumflex, LSHIFT(Key_NonUsPound)) /* XKB_KEY_dead_circumflex */ \
