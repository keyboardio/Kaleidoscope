...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ṣ', LSHIFT(Key_V)) \
   OP(L'ṣ', Key_V) \
   OP(L'Ẹ', LSHIFT(Key_Q)) /* U+1eb8, XKB_KEY_Ebelowdot, LATIN CAPITAL LETTER E WITH DOT BELOW */ \
   OP(L'ẹ', Key_Q) /* U+1eb9, XKB_KEY_ebelowdot, LATIN SMALL LETTER E WITH DOT BELOW */ \
   OP(L'Ọ', LSHIFT(Key_X)) /* U+1ecc, XKB_KEY_Obelowdot, LATIN CAPITAL LETTER O WITH DOT BELOW */ \
   OP(L'ọ', Key_X) /* U+1ecd, XKB_KEY_obelowdot, LATIN SMALL LETTER O WITH DOT BELOW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ebelowdot, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Obelowdot, LSHIFT(Key_X)) \
