...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ṅ', LSHIFT(Key_X)) \
   OP(L'ṅ', Key_X) \
   OP(L'Ị', LSHIFT(Key_Q)) /* U+1eca, XKB_KEY_Ibelowdot, LATIN CAPITAL LETTER I WITH DOT BELOW */ \
   OP(L'ị', Key_Q) /* U+1ecb, XKB_KEY_ibelowdot, LATIN SMALL LETTER I WITH DOT BELOW */ \
   OP(L'Ọ', LSHIFT(Key_LeftBracket)) /* U+1ecc, XKB_KEY_Obelowdot, LATIN CAPITAL LETTER O WITH DOT BELOW */ \
   OP(L'ọ', Key_LeftBracket) /* U+1ecd, XKB_KEY_obelowdot, LATIN SMALL LETTER O WITH DOT BELOW */ \
   OP(L'Ụ', LSHIFT(Key_Semicolon)) /* U+1ee4, XKB_KEY_Ubelowdot, LATIN CAPITAL LETTER U WITH DOT BELOW */ \
   OP(L'ụ', Key_Semicolon) /* U+1ee5, XKB_KEY_ubelowdot, LATIN SMALL LETTER U WITH DOT BELOW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ibelowdot, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Obelowdot, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Ubelowdot, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_obelowdot, Key_LeftBracket) \
   OP(XKB_KEY_p, Key_P) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_ubelowdot, Key_Semicolon) \
