...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ñ', LSHIFT(Key_M)) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   ...
   OP(L'ñ', Key_M) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   OP(L'ü', Key_W) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'İ', LSHIFT(Key_Semicolon)) \
   OP(L'ı', Key_Semicolon) \
   OP(L'Ş', LSHIFT(Key_Slash)) /* U+015e, XKB_KEY_Scedilla, LATIN CAPITAL LETTER S WITH CEDILLA */ \
   OP(L'ş', Key_Slash) /* U+015f, XKB_KEY_scedilla, LATIN SMALL LETTER S WITH CEDILLA */ \
   OP(L'Ɗ', LSHIFT(Key_D)) \
   OP(L'Ǝ', LSHIFT(Key_Quote)) \
   OP(L'Ɲ', LSHIFT(Key_Z)) \
   OP(L'Ƴ', LSHIFT(Key_LeftBracket)) \
   OP(L'ƴ', Key_LeftBracket) \
   OP(L'ǝ', Key_Quote) \
   OP(L'Ǧ', LSHIFT(Key_RightBracket)) /* U+01e6, XKB_KEY_Gcaron, LATIN CAPITAL LETTER G WITH CARON */ \
   OP(L'ǧ', Key_RightBracket) /* U+01e7, XKB_KEY_gcaron, LATIN SMALL LETTER G WITH CARON */ \
   OP(L'ɗ', Key_D) \
   OP(L'ɲ', Key_Z) \
   OP(L'₦', LSHIFT(Key_4)) /* U+20a6, XKB_KEY_NairaSign, NAIRA SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Gcaron, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_NairaSign, LSHIFT(Key_4)) \
   OP(XKB_KEY_Next, Key_PageDown) /* XKB_KEY_Next, Next  */ \
   OP(XKB_KEY_Ntilde, LSHIFT(Key_M)) \
   ...
   OP(XKB_KEY_Scedilla, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcaron, Key_RightBracket) \
