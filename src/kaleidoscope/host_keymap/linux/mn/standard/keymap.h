...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', Key_NonUsPound) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', LSHIFT(Key_3)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('$', RALT(Key_D)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP('%', LSHIFT(Key_9)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('&', RALT(Key_7)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP('\'', RALT(Key_Q)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', Key_NonUsBackslashAndPipe) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP('*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP('+', Key_KeypadAdd) /* XKB_KEY_KP_Add */ \
   OP(',', LSHIFT(Key_8)) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_KeypadSubtract) /* XKB_KEY_KP_Subtract */ \
   OP('.', LSHIFT(Key_6)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(':', LSHIFT(Key_5)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP('<', RALT(Key_N)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Backtick) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_M)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', LSHIFT(Key_0)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP('L', RALT(Key_Equals)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('X', RALT(Key_Minus)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('[', RALT(Key_9)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(Key_Slash)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_0)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('_', LSHIFT(Key_7)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', RALT(Key_W)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   OP('{', RALT(Key_LeftBracket)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_RightBracket)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', Key_NonUsPound) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', LSHIFT(Key_3)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'$', RALT(Key_D)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP(L'%', LSHIFT(Key_9)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'&', RALT(Key_7)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP(L'\'', RALT(Key_Q)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', Key_NonUsBackslashAndPipe) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP(L'*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP(L'+', Key_KeypadAdd) /* XKB_KEY_KP_Add */ \
   OP(L',', LSHIFT(Key_8)) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_KeypadSubtract) /* XKB_KEY_KP_Subtract */ \
   OP(L'.', LSHIFT(Key_6)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(L':', LSHIFT(Key_5)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L'<', RALT(Key_N)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Backtick) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_M)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', LSHIFT(Key_0)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP(L'L', RALT(Key_Equals)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'X', RALT(Key_Minus)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'[', RALT(Key_9)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(Key_Slash)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_0)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'_', LSHIFT(Key_7)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', RALT(Key_W)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   OP(L'{', RALT(Key_LeftBracket)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_RightBracket)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L' ', RALT(Key_Spacebar)) /* U+00a0, XKB_KEY_nobreakspace, NO-BREAK SPACE */ \
   OP(L'£', RALT(Key_S)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   ...
   OP(L'§', RALT(Key_Semicolon)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'«', RALT(Key_Comma)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_4)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', RALT(Key_Backtick)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(Key_3)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'µ', RALT(Key_A)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'»', RALT(Key_Period)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'×', RALT(Key_1)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'÷', RALT(Key_2)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'Ё', LSHIFT(Key_C)) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   OP(L'А', LSHIFT(Key_G)) /* U+0410, XKB_KEY_Cyrillic_A, CYRILLIC CAPITAL LETTER A */ \
   OP(L'Б', LSHIFT(Key_D)) /* U+0411, XKB_KEY_Cyrillic_BE, CYRILLIC CAPITAL LETTER BE */ \
   OP(L'В', LSHIFT(Key_Period)) /* U+0412, XKB_KEY_Cyrillic_VE, CYRILLIC CAPITAL LETTER VE */ \
   OP(L'Г', LSHIFT(Key_U)) /* U+0413, XKB_KEY_Cyrillic_GHE, CYRILLIC CAPITAL LETTER GHE */ \
   OP(L'Д', LSHIFT(Key_Semicolon)) /* U+0414, XKB_KEY_Cyrillic_DE, CYRILLIC CAPITAL LETTER DE */ \
   OP(L'Е', LSHIFT(Key_Minus)) /* U+0415, XKB_KEY_Cyrillic_IE, CYRILLIC CAPITAL LETTER IE */ \
   OP(L'Ж', LSHIFT(Key_R)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', LSHIFT(Key_P)) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   OP(L'И', LSHIFT(Key_N)) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   OP(L'Й', LSHIFT(Key_A)) /* U+0419, XKB_KEY_Cyrillic_SHORTI, CYRILLIC CAPITAL LETTER SHORT I */ \
   OP(L'К', LSHIFT(Key_LeftBracket)) /* U+041a, XKB_KEY_Cyrillic_KA, CYRILLIC CAPITAL LETTER KA */ \
   OP(L'Л', LSHIFT(Key_L)) /* U+041b, XKB_KEY_Cyrillic_EL, CYRILLIC CAPITAL LETTER EL */ \
   OP(L'М', LSHIFT(Key_B)) /* U+041c, XKB_KEY_Cyrillic_EM, CYRILLIC CAPITAL LETTER EM */ \
   OP(L'Н', LSHIFT(Key_Y)) /* U+041d, XKB_KEY_Cyrillic_EN, CYRILLIC CAPITAL LETTER EN */ \
   OP(L'О', LSHIFT(Key_K)) /* U+041e, XKB_KEY_Cyrillic_O, CYRILLIC CAPITAL LETTER O */ \
   OP(L'П', LSHIFT(Key_Quote)) /* U+041f, XKB_KEY_Cyrillic_PE, CYRILLIC CAPITAL LETTER PE */ \
   OP(L'Р', LSHIFT(Key_J)) /* U+0420, XKB_KEY_Cyrillic_ER, CYRILLIC CAPITAL LETTER ER */ \
   OP(L'С', LSHIFT(Key_V)) /* U+0421, XKB_KEY_Cyrillic_ES, CYRILLIC CAPITAL LETTER ES */ \
   OP(L'Т', LSHIFT(Key_M)) /* U+0422, XKB_KEY_Cyrillic_TE, CYRILLIC CAPITAL LETTER TE */ \
   OP(L'У', LSHIFT(Key_E)) /* U+0423, XKB_KEY_Cyrillic_U, CYRILLIC CAPITAL LETTER U */ \
   OP(L'Ф', LSHIFT(Key_Q)) /* U+0424, XKB_KEY_Cyrillic_EF, CYRILLIC CAPITAL LETTER EF */ \
   ...
   OP(L'Щ', LSHIFT(Key_Equals)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   ...
   OP(L'Ь', LSHIFT(Key_Comma)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', LSHIFT(Key_T)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', LSHIFT(Key_Slash)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_Z)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   OP(L'а', Key_G) /* U+0430, XKB_KEY_Cyrillic_a, CYRILLIC SMALL LETTER A */ \
   OP(L'б', Key_D) /* U+0431, XKB_KEY_Cyrillic_be, CYRILLIC SMALL LETTER BE */ \
   OP(L'в', Key_Period) /* U+0432, XKB_KEY_Cyrillic_ve, CYRILLIC SMALL LETTER VE */ \
   OP(L'г', Key_U) /* U+0433, XKB_KEY_Cyrillic_ghe, CYRILLIC SMALL LETTER GHE */ \
   OP(L'д', Key_Semicolon) /* U+0434, XKB_KEY_Cyrillic_de, CYRILLIC SMALL LETTER DE */ \
   OP(L'е', Key_Minus) /* U+0435, XKB_KEY_Cyrillic_ie, CYRILLIC SMALL LETTER IE */ \
   OP(L'ж', Key_R) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', Key_P) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   OP(L'и', Key_N) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   OP(L'й', Key_A) /* U+0439, XKB_KEY_Cyrillic_shorti, CYRILLIC SMALL LETTER SHORT I */ \
   OP(L'к', Key_LeftBracket) /* U+043a, XKB_KEY_Cyrillic_ka, CYRILLIC SMALL LETTER KA */ \
   OP(L'л', Key_L) /* U+043b, XKB_KEY_Cyrillic_el, CYRILLIC SMALL LETTER EL */ \
   OP(L'м', Key_B) /* U+043c, XKB_KEY_Cyrillic_em, CYRILLIC SMALL LETTER EM */ \
   OP(L'н', Key_Y) /* U+043d, XKB_KEY_Cyrillic_en, CYRILLIC SMALL LETTER EN */ \
   OP(L'о', Key_K) /* U+043e, XKB_KEY_Cyrillic_o, CYRILLIC SMALL LETTER O */ \
   OP(L'п', Key_Quote) /* U+043f, XKB_KEY_Cyrillic_pe, CYRILLIC SMALL LETTER PE */ \
   OP(L'р', Key_J) /* U+0440, XKB_KEY_Cyrillic_er, CYRILLIC SMALL LETTER ER */ \
   OP(L'с', Key_V) /* U+0441, XKB_KEY_Cyrillic_es, CYRILLIC SMALL LETTER ES */ \
   OP(L'т', Key_M) /* U+0442, XKB_KEY_Cyrillic_te, CYRILLIC SMALL LETTER TE */ \
   OP(L'у', Key_E) /* U+0443, XKB_KEY_Cyrillic_u, CYRILLIC SMALL LETTER U */ \
   OP(L'ф', Key_Q) /* U+0444, XKB_KEY_Cyrillic_ef, CYRILLIC SMALL LETTER EF */ \
   ...
   OP(L'щ', Key_Equals) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   ...
   OP(L'ь', Key_Comma) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', Key_T) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', Key_Slash) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', Key_Z) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ё', Key_C) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'Ү', LSHIFT(Key_O)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_O) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   OP(L'Ө', LSHIFT(Key_F)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_F) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
   OP(L'–', RALT(Key_X)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_Z)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'“', RALT(Key_I)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_O)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_U)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'…', RALT(Key_Quote)) /* U+2026, XKB_KEY_ellipsis, HORIZONTAL ELLIPSIS */ \
   OP(L'€', RALT(Key_E)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'₮', LSHIFT(Key_4)) \
   OP(L'№', LSHIFT(Key_1)) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
   OP(L'™', RALT(Key_T)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'≠', RALT(Key_6)) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_A, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_BE, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_X)) \
   OP(XKB_KEY_Cyrillic_DE, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_E, LSHIFT(Key_T)) \
   OP(XKB_KEY_Cyrillic_EF, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Cyrillic_EL, LSHIFT(Key_L)) \
   OP(XKB_KEY_Cyrillic_EM, LSHIFT(Key_B)) \
   OP(XKB_KEY_Cyrillic_EN, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_ER, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_ES, LSHIFT(Key_V)) \
   ...
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_N)) \
   OP(XKB_KEY_Cyrillic_IE, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_Cyrillic_IO, LSHIFT(Key_C)) \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_K)) \
   OP(XKB_KEY_Cyrillic_O_bar, LSHIFT(Key_F)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_A)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_Cyrillic_TE, LSHIFT(Key_M)) \
   OP(XKB_KEY_Cyrillic_TSE, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_U, LSHIFT(Key_E)) \
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_VE, LSHIFT(Key_Period)) \
   OP(XKB_KEY_Cyrillic_YA, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_YERU, LSHIFT(Key_S)) \
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_P)) \
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_R)) \
   OP(XKB_KEY_Cyrillic_a, Key_G) \
   OP(XKB_KEY_Cyrillic_be, Key_D) \
   OP(XKB_KEY_Cyrillic_che, Key_X) \
   OP(XKB_KEY_Cyrillic_de, Key_Semicolon) \
   OP(XKB_KEY_Cyrillic_e, Key_T) \
   OP(XKB_KEY_Cyrillic_ef, Key_Q) \
   OP(XKB_KEY_Cyrillic_el, Key_L) \
   OP(XKB_KEY_Cyrillic_em, Key_B) \
   OP(XKB_KEY_Cyrillic_en, Key_Y) \
   OP(XKB_KEY_Cyrillic_er, Key_J) \
   OP(XKB_KEY_Cyrillic_es, Key_V) \
   OP(XKB_KEY_Cyrillic_ghe, Key_U) \
   OP(XKB_KEY_Cyrillic_ha, Key_H) \
   OP(XKB_KEY_Cyrillic_hardsign, Key_RightBracket) \
   OP(XKB_KEY_Cyrillic_i, Key_N) \
   OP(XKB_KEY_Cyrillic_ie, Key_Minus) \
   OP(XKB_KEY_Cyrillic_io, Key_C) \
   OP(XKB_KEY_Cyrillic_ka, Key_LeftBracket) \
   OP(XKB_KEY_Cyrillic_o, Key_K) \
   OP(XKB_KEY_Cyrillic_o_bar, Key_F) \
   OP(XKB_KEY_Cyrillic_pe, Key_Quote) \
   OP(XKB_KEY_Cyrillic_sha, Key_I) \
   OP(XKB_KEY_Cyrillic_shcha, Key_Equals) \
   OP(XKB_KEY_Cyrillic_shorti, Key_A) \
   OP(XKB_KEY_Cyrillic_softsign, Key_Comma) \
   OP(XKB_KEY_Cyrillic_te, Key_M) \
   OP(XKB_KEY_Cyrillic_tse, Key_W) \
   OP(XKB_KEY_Cyrillic_u, Key_E) \
   OP(XKB_KEY_Cyrillic_u_straight, Key_O) \
   OP(XKB_KEY_Cyrillic_ve, Key_Period) \
   OP(XKB_KEY_Cyrillic_ya, Key_Z) \
   OP(XKB_KEY_Cyrillic_yeru, Key_S) \
   OP(XKB_KEY_Cyrillic_yu, Key_Slash) \
   OP(XKB_KEY_Cyrillic_ze, Key_P) \
   OP(XKB_KEY_Cyrillic_zhe, Key_R) \
   ...
   OP(XKB_KEY_apostrophe, RALT(Key_Q)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asterisk, RALT(Key_8)) \
   OP(XKB_KEY_backslash, RALT(Key_Slash)) \
   OP(XKB_KEY_bar, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_braceleft, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_braceright, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_colon, LSHIFT(Key_5)) \
   OP(XKB_KEY_comma, LSHIFT(Key_8)) \
   OP(XKB_KEY_copyright, RALT(Key_C)) \
   OP(XKB_KEY_degree, RALT(Key_Backtick)) \
   OP(XKB_KEY_division, RALT(Key_2)) \
   OP(XKB_KEY_dollar, RALT(Key_D)) \
   OP(XKB_KEY_doublelowquotemark, RALT(Key_U)) \
   OP(XKB_KEY_ellipsis, RALT(Key_Quote)) \
   OP(XKB_KEY_emdash, RALT(Key_Z)) \
   OP(XKB_KEY_endash, RALT(Key_X)) \
   OP(XKB_KEY_equal, Key_Backtick) \
   OP(XKB_KEY_exclam, Key_NonUsPound) \
   OP(XKB_KEY_grave, RALT(Key_W)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_M)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_Comma)) \
   OP(XKB_KEY_guillemotright, RALT(Key_Period)) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_I)) \
   OP(XKB_KEY_less, RALT(Key_N)) \
   OP(XKB_KEY_minus, LSHIFT(Key_2)) \
   OP(XKB_KEY_mu, RALT(Key_A)) \
   OP(XKB_KEY_multiply, RALT(Key_1)) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_notequal, RALT(Key_6)) \
   OP(XKB_KEY_notsign, RALT(Key_4)) \
   OP(XKB_KEY_numerosign, LSHIFT(Key_1)) \
   OP(XKB_KEY_parenleft, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_parenright, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_percent, LSHIFT(Key_9)) \
   OP(XKB_KEY_period, LSHIFT(Key_6)) \
   OP(XKB_KEY_plus, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_plusminus, RALT(Key_3)) \
   OP(XKB_KEY_question, LSHIFT(Key_0)) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_3)) \
   OP(XKB_KEY_registered, RALT(Key_R)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_O)) \
   OP(XKB_KEY_section, RALT(Key_Semicolon)) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_sterling, RALT(Key_S)) \
   OP(XKB_KEY_trademark, RALT(Key_T)) \
   OP(XKB_KEY_underscore, LSHIFT(Key_7)) \
