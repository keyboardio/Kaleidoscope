...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ւ', LSHIFT(Key_W)) /* U+0552, XKB_KEY_Armenian_VYUN, ARMENIAN CAPITAL LETTER YIWN */ \
   OP(L'Փ', LSHIFT(Key_Quote)) /* U+0553, XKB_KEY_Armenian_PYUR, ARMENIAN CAPITAL LETTER PIWR */ \
   OP(L'Ք', LSHIFT(Key_C)) /* U+0554, XKB_KEY_Armenian_KE, ARMENIAN CAPITAL LETTER KEH */ \
   ...
   OP(L'ւ', Key_W) /* U+0582, XKB_KEY_Armenian_vyun, ARMENIAN SMALL LETTER YIWN */ \
   OP(L'փ', Key_Quote) /* U+0583, XKB_KEY_Armenian_pyur, ARMENIAN SMALL LETTER PIWR */ \
   OP(L'ք', Key_C) /* U+0584, XKB_KEY_Armenian_ke, ARMENIAN SMALL LETTER KEH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Armenian_KE, LSHIFT(Key_C)) \
   ...
   OP(XKB_KEY_Armenian_VYUN, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_Armenian_vyun, Key_W) \
