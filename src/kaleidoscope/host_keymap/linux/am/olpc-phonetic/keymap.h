...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Բ', LSHIFT(Key_B)) /* U+0532, XKB_KEY_Armenian_BEN, ARMENIAN CAPITAL LETTER BEN */ \
   OP(L'Գ', LSHIFT(Key_G)) /* U+0533, XKB_KEY_Armenian_GIM, ARMENIAN CAPITAL LETTER GIM */ \
   OP(L'Դ', LSHIFT(Key_D)) /* U+0534, XKB_KEY_Armenian_DA, ARMENIAN CAPITAL LETTER DA */ \
   OP(L'Ե', LSHIFT(Key_E)) /* U+0535, XKB_KEY_Armenian_YECH, ARMENIAN CAPITAL LETTER ECH */ \
   OP(L'Զ', LSHIFT(Key_Z)) /* U+0536, XKB_KEY_Armenian_ZA, ARMENIAN CAPITAL LETTER ZA */ \
   OP(L'Է', LSHIFT(Key_1)) /* U+0537, XKB_KEY_Armenian_E, ARMENIAN CAPITAL LETTER EH */ \
   OP(L'Ը', LSHIFT(Key_Y)) /* U+0538, XKB_KEY_Armenian_AT, ARMENIAN CAPITAL LETTER ET */ \
   OP(L'Թ', LSHIFT(Key_2)) /* U+0539, XKB_KEY_Armenian_TO, ARMENIAN CAPITAL LETTER TO */ \
   ...
   OP(L'Խ', LSHIFT(Key_LeftBracket)) /* U+053d, XKB_KEY_Armenian_KHE, ARMENIAN CAPITAL LETTER XEH */ \
   OP(L'Ծ', LSHIFT(Key_RightBracket)) /* U+053e, XKB_KEY_Armenian_TSA, ARMENIAN CAPITAL LETTER CA */ \
   OP(L'Կ', LSHIFT(Key_K)) /* U+053f, XKB_KEY_Armenian_KEN, ARMENIAN CAPITAL LETTER KEN */ \
   OP(L'Հ', LSHIFT(Key_H)) /* U+0540, XKB_KEY_Armenian_HO, ARMENIAN CAPITAL LETTER HO */ \
   OP(L'Ձ', LSHIFT(Key_4)) /* U+0541, XKB_KEY_Armenian_DZA, ARMENIAN CAPITAL LETTER JA */ \
   OP(L'Ղ', LSHIFT(Key_X)) /* U+0542, XKB_KEY_Armenian_GHAT, ARMENIAN CAPITAL LETTER GHAD */ \
   OP(L'Ճ', LSHIFT(Key_0)) /* U+0543, XKB_KEY_Armenian_TCHE, ARMENIAN CAPITAL LETTER CHEH */ \
   OP(L'Մ', LSHIFT(Key_M)) /* U+0544, XKB_KEY_Armenian_MEN, ARMENIAN CAPITAL LETTER MEN */ \
   OP(L'Յ', LSHIFT(Key_J)) /* U+0545, XKB_KEY_Armenian_HI, ARMENIAN CAPITAL LETTER YI */ \
   OP(L'Ն', LSHIFT(Key_N)) /* U+0546, XKB_KEY_Armenian_NU, ARMENIAN CAPITAL LETTER NOW */ \
   OP(L'Շ', LSHIFT(Key_NonUsPound)) /* U+0547, XKB_KEY_Armenian_SHA, ARMENIAN CAPITAL LETTER SHA */ \
   OP(L'Ո', LSHIFT(Key_W)) /* U+0548, XKB_KEY_Armenian_VO, ARMENIAN CAPITAL LETTER VO */ \
   OP(L'Չ', LSHIFT(Key_9)) /* U+0549, XKB_KEY_Armenian_CHA, ARMENIAN CAPITAL LETTER CHA */ \
   OP(L'Պ', LSHIFT(Key_P)) /* U+054a, XKB_KEY_Armenian_PE, ARMENIAN CAPITAL LETTER PEH */ \
   OP(L'Ջ', LSHIFT(Key_5)) /* U+054b, XKB_KEY_Armenian_JE, ARMENIAN CAPITAL LETTER JHEH */ \
   OP(L'Ռ', LSHIFT(Key_R)) /* U+054c, XKB_KEY_Armenian_RA, ARMENIAN CAPITAL LETTER RA */ \
   OP(L'Ս', LSHIFT(Key_S)) /* U+054d, XKB_KEY_Armenian_SE, ARMENIAN CAPITAL LETTER SEH */ \
   OP(L'Վ', LSHIFT(Key_V)) /* U+054e, XKB_KEY_Armenian_VEV, ARMENIAN CAPITAL LETTER VEW */ \
   OP(L'Տ', LSHIFT(Key_T)) /* U+054f, XKB_KEY_Armenian_TYUN, ARMENIAN CAPITAL LETTER TIWN */ \
   OP(L'Ր', LSHIFT(Key_8)) /* U+0550, XKB_KEY_Armenian_RE, ARMENIAN CAPITAL LETTER REH */ \
   OP(L'Ց', LSHIFT(Key_C)) /* U+0551, XKB_KEY_Armenian_TSO, ARMENIAN CAPITAL LETTER CO */ \
   OP(L'Ւ', LSHIFT(Key_6)) /* U+0552, XKB_KEY_Armenian_VYUN, ARMENIAN CAPITAL LETTER YIWN */ \
   OP(L'Փ', LSHIFT(Key_3)) /* U+0553, XKB_KEY_Armenian_PYUR, ARMENIAN CAPITAL LETTER PIWR */ \
   OP(L'Ք', LSHIFT(Key_Q)) /* U+0554, XKB_KEY_Armenian_KE, ARMENIAN CAPITAL LETTER KEH */ \
   OP(L'Օ', LSHIFT(Key_O)) /* U+0555, XKB_KEY_Armenian_O, ARMENIAN CAPITAL LETTER OH */ \
   OP(L'Ֆ', LSHIFT(Key_F)) /* U+0556, XKB_KEY_Armenian_FE, ARMENIAN CAPITAL LETTER FEH */ \
   OP(L'՛', Key_Quote) /* U+055b, XKB_KEY_Armenian_accent, ARMENIAN EMPHASIS MARK */ \
   ...
   OP(L'՞', LSHIFT(Key_Slash)) /* U+055e, XKB_KEY_Armenian_question, ARMENIAN QUESTION MARK */ \
   OP(L'ա', Key_A) /* U+0561, XKB_KEY_Armenian_ayb, ARMENIAN SMALL LETTER AYB */ \
   OP(L'բ', Key_B) /* U+0562, XKB_KEY_Armenian_ben, ARMENIAN SMALL LETTER BEN */ \
   OP(L'գ', Key_G) /* U+0563, XKB_KEY_Armenian_gim, ARMENIAN SMALL LETTER GIM */ \
   OP(L'դ', Key_D) /* U+0564, XKB_KEY_Armenian_da, ARMENIAN SMALL LETTER DA */ \
   OP(L'ե', Key_E) /* U+0565, XKB_KEY_Armenian_yech, ARMENIAN SMALL LETTER ECH */ \
   OP(L'զ', Key_Z) /* U+0566, XKB_KEY_Armenian_za, ARMENIAN SMALL LETTER ZA */ \
   OP(L'է', Key_1) /* U+0567, XKB_KEY_Armenian_e, ARMENIAN SMALL LETTER EH */ \
   OP(L'ը', Key_Y) /* U+0568, XKB_KEY_Armenian_at, ARMENIAN SMALL LETTER ET */ \
   OP(L'թ', Key_2) /* U+0569, XKB_KEY_Armenian_to, ARMENIAN SMALL LETTER TO */ \
   ...
   OP(L'խ', Key_LeftBracket) /* U+056d, XKB_KEY_Armenian_khe, ARMENIAN SMALL LETTER XEH */ \
   OP(L'ծ', Key_RightBracket) /* U+056e, XKB_KEY_Armenian_tsa, ARMENIAN SMALL LETTER CA */ \
   OP(L'կ', Key_K) /* U+056f, XKB_KEY_Armenian_ken, ARMENIAN SMALL LETTER KEN */ \
   OP(L'հ', Key_H) /* U+0570, XKB_KEY_Armenian_ho, ARMENIAN SMALL LETTER HO */ \
   OP(L'ձ', Key_4) /* U+0571, XKB_KEY_Armenian_dza, ARMENIAN SMALL LETTER JA */ \
   OP(L'ղ', Key_X) /* U+0572, XKB_KEY_Armenian_ghat, ARMENIAN SMALL LETTER GHAD */ \
   OP(L'ճ', Key_0) /* U+0573, XKB_KEY_Armenian_tche, ARMENIAN SMALL LETTER CHEH */ \
   OP(L'մ', Key_M) /* U+0574, XKB_KEY_Armenian_men, ARMENIAN SMALL LETTER MEN */ \
   OP(L'յ', Key_J) /* U+0575, XKB_KEY_Armenian_hi, ARMENIAN SMALL LETTER YI */ \
   OP(L'ն', Key_N) /* U+0576, XKB_KEY_Armenian_nu, ARMENIAN SMALL LETTER NOW */ \
   OP(L'շ', Key_NonUsPound) /* U+0577, XKB_KEY_Armenian_sha, ARMENIAN SMALL LETTER SHA */ \
   OP(L'ո', Key_W) /* U+0578, XKB_KEY_Armenian_vo, ARMENIAN SMALL LETTER VO */ \
   OP(L'չ', Key_9) /* U+0579, XKB_KEY_Armenian_cha, ARMENIAN SMALL LETTER CHA */ \
   OP(L'պ', Key_P) /* U+057a, XKB_KEY_Armenian_pe, ARMENIAN SMALL LETTER PEH */ \
   OP(L'ջ', Key_5) /* U+057b, XKB_KEY_Armenian_je, ARMENIAN SMALL LETTER JHEH */ \
   OP(L'ռ', Key_R) /* U+057c, XKB_KEY_Armenian_ra, ARMENIAN SMALL LETTER RA */ \
   OP(L'ս', Key_S) /* U+057d, XKB_KEY_Armenian_se, ARMENIAN SMALL LETTER SEH */ \
   OP(L'վ', Key_V) /* U+057e, XKB_KEY_Armenian_vev, ARMENIAN SMALL LETTER VEW */ \
   OP(L'տ', Key_T) /* U+057f, XKB_KEY_Armenian_tyun, ARMENIAN SMALL LETTER TIWN */ \
   OP(L'ր', Key_8) /* U+0580, XKB_KEY_Armenian_re, ARMENIAN SMALL LETTER REH */ \
   OP(L'ց', Key_C) /* U+0581, XKB_KEY_Armenian_tso, ARMENIAN SMALL LETTER CO */ \
   OP(L'ւ', Key_6) /* U+0582, XKB_KEY_Armenian_vyun, ARMENIAN SMALL LETTER YIWN */ \
   OP(L'փ', Key_3) /* U+0583, XKB_KEY_Armenian_pyur, ARMENIAN SMALL LETTER PIWR */ \
   OP(L'ք', Key_Q) /* U+0584, XKB_KEY_Armenian_ke, ARMENIAN SMALL LETTER KEH */ \
   OP(L'օ', Key_O) /* U+0585, XKB_KEY_Armenian_o, ARMENIAN SMALL LETTER OH */ \
   OP(L'ֆ', Key_F) /* U+0586, XKB_KEY_Armenian_fe, ARMENIAN SMALL LETTER FEH */ \
   OP(L'և', Key_7) /* U+0587, XKB_KEY_Armenian_ligature_ew, ARMENIAN SMALL LIGATURE ECH YIWN */ \
   OP(L'։', LSHIFT(Key_Semicolon)) /* U+0589, XKB_KEY_Armenian_full_stop, ARMENIAN FULL STOP */ \
   OP(L'֊', Key_Minus) /* U+058a, XKB_KEY_Armenian_hyphen, ARMENIAN HYPHEN */ \
   OP(L'֏', LSHIFT(Key_7)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Armenian_AT, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Armenian_AYB, LSHIFT(Key_A)) \
   OP(XKB_KEY_Armenian_BEN, LSHIFT(Key_B)) \
   OP(XKB_KEY_Armenian_CHA, LSHIFT(Key_9)) \
   OP(XKB_KEY_Armenian_DA, LSHIFT(Key_D)) \
   OP(XKB_KEY_Armenian_DZA, LSHIFT(Key_4)) \
   OP(XKB_KEY_Armenian_E, LSHIFT(Key_1)) \
   OP(XKB_KEY_Armenian_FE, LSHIFT(Key_F)) \
   OP(XKB_KEY_Armenian_GHAT, LSHIFT(Key_X)) \
   OP(XKB_KEY_Armenian_GIM, LSHIFT(Key_G)) \
   OP(XKB_KEY_Armenian_HI, LSHIFT(Key_J)) \
   OP(XKB_KEY_Armenian_HO, LSHIFT(Key_H)) \
   OP(XKB_KEY_Armenian_INI, LSHIFT(Key_I)) \
   OP(XKB_KEY_Armenian_JE, LSHIFT(Key_5)) \
   OP(XKB_KEY_Armenian_KE, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Armenian_KEN, LSHIFT(Key_K)) \
   OP(XKB_KEY_Armenian_KHE, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Armenian_LYUN, LSHIFT(Key_L)) \
   OP(XKB_KEY_Armenian_MEN, LSHIFT(Key_M)) \
   OP(XKB_KEY_Armenian_NU, LSHIFT(Key_N)) \
   OP(XKB_KEY_Armenian_O, LSHIFT(Key_O)) \
   OP(XKB_KEY_Armenian_PE, LSHIFT(Key_P)) \
   OP(XKB_KEY_Armenian_PYUR, LSHIFT(Key_3)) \
   OP(XKB_KEY_Armenian_RA, LSHIFT(Key_R)) \
   OP(XKB_KEY_Armenian_RE, LSHIFT(Key_8)) \
   OP(XKB_KEY_Armenian_SE, LSHIFT(Key_S)) \
   OP(XKB_KEY_Armenian_SHA, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_Armenian_TCHE, LSHIFT(Key_0)) \
   OP(XKB_KEY_Armenian_TO, LSHIFT(Key_2)) \
   OP(XKB_KEY_Armenian_TSA, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Armenian_TSO, LSHIFT(Key_C)) \
   OP(XKB_KEY_Armenian_TYUN, LSHIFT(Key_T)) \
   OP(XKB_KEY_Armenian_VEV, LSHIFT(Key_V)) \
   OP(XKB_KEY_Armenian_VO, LSHIFT(Key_W)) \
   OP(XKB_KEY_Armenian_VYUN, LSHIFT(Key_6)) \
   OP(XKB_KEY_Armenian_YECH, LSHIFT(Key_E)) \
   OP(XKB_KEY_Armenian_ZA, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Armenian_ZHE, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_Armenian_accent, Key_Quote) \
   OP(XKB_KEY_Armenian_at, Key_Y) \
   OP(XKB_KEY_Armenian_ayb, Key_A) \
   OP(XKB_KEY_Armenian_ben, Key_B) \
   OP(XKB_KEY_Armenian_cha, Key_9) \
   OP(XKB_KEY_Armenian_da, Key_D) \
   OP(XKB_KEY_Armenian_dza, Key_4) \
   OP(XKB_KEY_Armenian_e, Key_1) \
   OP(XKB_KEY_Armenian_exclam, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_Armenian_fe, Key_F) \
   OP(XKB_KEY_Armenian_full_stop, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Armenian_ghat, Key_X) \
   OP(XKB_KEY_Armenian_gim, Key_G) \
   OP(XKB_KEY_Armenian_hi, Key_J) \
   OP(XKB_KEY_Armenian_ho, Key_H) \
   OP(XKB_KEY_Armenian_hyphen, Key_Minus) \
   OP(XKB_KEY_Armenian_ini, Key_I) \
   OP(XKB_KEY_Armenian_je, Key_5) \
   OP(XKB_KEY_Armenian_ke, Key_Q) \
   OP(XKB_KEY_Armenian_ken, Key_K) \
   OP(XKB_KEY_Armenian_khe, Key_LeftBracket) \
   OP(XKB_KEY_Armenian_ligature_ew, Key_7) \
   OP(XKB_KEY_Armenian_lyun, Key_L) \
   OP(XKB_KEY_Armenian_men, Key_M) \
   OP(XKB_KEY_Armenian_nu, Key_N) \
   OP(XKB_KEY_Armenian_o, Key_O) \
   OP(XKB_KEY_Armenian_pe, Key_P) \
   OP(XKB_KEY_Armenian_pyur, Key_3) \
   OP(XKB_KEY_Armenian_question, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Armenian_ra, Key_R) \
   OP(XKB_KEY_Armenian_re, Key_8) \
   OP(XKB_KEY_Armenian_se, Key_S) \
   OP(XKB_KEY_Armenian_separation_mark, Key_Backtick) \
   OP(XKB_KEY_Armenian_sha, Key_NonUsPound) \
   OP(XKB_KEY_Armenian_tche, Key_0) \
   OP(XKB_KEY_Armenian_to, Key_2) \
   OP(XKB_KEY_Armenian_tsa, Key_RightBracket) \
   OP(XKB_KEY_Armenian_tso, Key_C) \
   OP(XKB_KEY_Armenian_tyun, Key_T) \
   OP(XKB_KEY_Armenian_vev, Key_V) \
   OP(XKB_KEY_Armenian_vo, Key_W) \
   OP(XKB_KEY_Armenian_vyun, Key_6) \
   OP(XKB_KEY_Armenian_yech, Key_E) \
