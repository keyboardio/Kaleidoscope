...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ք', LSHIFT(Key_G)) /* U+0554, XKB_KEY_Armenian_KE, ARMENIAN CAPITAL LETTER KEH */ \
   ...
   OP(L'ք', Key_G) /* U+0584, XKB_KEY_Armenian_ke, ARMENIAN SMALL LETTER KEH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Armenian_KE, LSHIFT(Key_G)) \
