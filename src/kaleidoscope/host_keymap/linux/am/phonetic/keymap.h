...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ռ', LSHIFT(Key_8)) /* U+054c, XKB_KEY_Armenian_RA, ARMENIAN CAPITAL LETTER RA */ \
   ...
   OP(L'ռ', Key_8) /* U+057c, XKB_KEY_Armenian_ra, ARMENIAN SMALL LETTER RA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Armenian_RA, LSHIFT(Key_8)) \
