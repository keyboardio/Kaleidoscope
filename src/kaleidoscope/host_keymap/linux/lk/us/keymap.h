...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('D', LSHIFT(Key_Q)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   ...
   OP('d', Key_Q) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   ...
   OP('q', LALT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'D', LSHIFT(Key_Q)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   ...
   OP(L'd', Key_Q) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   ...
   OP(L'q', LALT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP(L'¤', LALT(Key_4)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¦', LALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'«', LALT(Key_Comma)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'°', LALT(Key_5)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'´', LSHIFT(Key_W)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'»', LALT(Key_Period)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¼', LALT(Key_6)) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', LALT(Key_7)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', LALT(Key_8)) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   OP(L'Ð', LSHIFT(Key_D)) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'á', LSHIFT(Key_A)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'ä', LALT(Key_A)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'æ', Key_W) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', LSHIFT(Key_J)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'é', LSHIFT(Key_E)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ë', LALT(Key_E)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'í', LSHIFT(Key_I)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ï', LALT(Key_I)) /* U+00ef, XKB_KEY_idiaeresis, LATIN SMALL LETTER I WITH DIAERESIS */ \
   OP(L'ð', Key_D) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ñ', LALT(Key_N)) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   OP(L'ó', LSHIFT(Key_O)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ô', LALT(Key_L)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'ö', LALT(Key_O)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ú', LSHIFT(Key_U)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'û', LSHIFT(Key_R)) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
   OP(L'ü', LALT(Key_U)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'þ', Key_F) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'‌', LALT(Key_Slash)) \
   OP(L'—', LALT(Key_Minus)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Shift, Key_LeftAlt) /* XKB_KEY_ISO_Level3_Shift */ \
   ...
   OP(XKB_KEY_acute, LSHIFT(Key_W)) \
   OP(XKB_KEY_adiaeresis, LALT(Key_A)) \
   OP(XKB_KEY_ae, Key_W) \
   ...
   OP(XKB_KEY_brokenbar, LALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, LSHIFT(Key_J)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_currency, LALT(Key_4)) \
   OP(XKB_KEY_d, Key_Q) \
   OP(XKB_KEY_dead_abovedot, LALT(Key_3)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_belowdot, LALT(Key_2)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_macron, LALT(Key_1)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_degree, LALT(Key_5)) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, LSHIFT(Key_E)) \
   OP(XKB_KEY_ediaeresis, LALT(Key_E)) \
   ...
   OP(XKB_KEY_guillemotleft, LALT(Key_Comma)) \
   OP(XKB_KEY_guillemotright, LALT(Key_Period)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, LSHIFT(Key_I)) \
   OP(XKB_KEY_idiaeresis, LALT(Key_I)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_ntilde, LALT(Key_N)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oacute, LSHIFT(Key_O)) \
   OP(XKB_KEY_ocircumflex, LALT(Key_L)) \
   OP(XKB_KEY_odiaeresis, LALT(Key_O)) \
   OP(XKB_KEY_onehalf, LALT(Key_7)) \
   OP(XKB_KEY_onequarter, LALT(Key_6)) \
   OP(XKB_KEY_p, Key_P) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_thorn, Key_F) \
   OP(XKB_KEY_threequarters, LALT(Key_8)) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, LSHIFT(Key_U)) \
   OP(XKB_KEY_ucircumflex, LSHIFT(Key_R)) \
   OP(XKB_KEY_udiaeresis, LALT(Key_U)) \
