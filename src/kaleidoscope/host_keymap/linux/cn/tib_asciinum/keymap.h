...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'བ', Key_F) \
   OP(L'མ', Key_H) \
   OP(L'ཙ', Key_LeftBracket) \
   OP(L'ཚ', Key_RightBracket) \
   OP(L'ཛ', Key_NonUsPound) \
   OP(L'ཝ', Key_Equals) \
   OP(L'ཞ', Key_Semicolon) \
   OP(L'ཟ', Key_Z) \
   OP(L'འ', Key_A) \
   OP(L'ཡ', Key_Y) \
   OP(L'ར', Key_R) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Latch, Key_M) /* XKB_KEY_ISO_Level3_Latch */ \
