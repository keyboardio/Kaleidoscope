...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', LSHIFT(Key_RightBracket)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'»', LSHIFT(Key_LeftBracket)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'چ', Key_Q) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ژ', LSHIFT(Key_D)) /* U+0698, XKB_KEY_Arabic_jeh, ARABIC LETTER JEH */ \
   OP(L'ڭ', Key_I) \
   OP(L'گ', LSHIFT(Key_G)) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
   OP(L'ھ', Key_A) /* U+06be, XKB_KEY_Arabic_heh_doachashmee, ARABIC LETTER HEH DOACHASHMEE */ \
   OP(L'ۆ', LSHIFT(Key_K)) \
   OP(L'ۇ', Key_U) \
   OP(L'ۈ', Key_V) \
   OP(L'ۋ', Key_W) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_gaf, LSHIFT(Key_G)) \
   OP(XKB_KEY_Arabic_heh_doachashmee, Key_A) \
   OP(XKB_KEY_Arabic_jeh, LSHIFT(Key_D)) \
   OP(XKB_KEY_Arabic_peh, Key_P) \
   OP(XKB_KEY_Arabic_question_mark, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Arabic_semicolon, Key_Semicolon) \
   OP(XKB_KEY_Arabic_tcheh, Key_Q) \
   ...
   OP(XKB_KEY_guillemotleft, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_guillemotright, LSHIFT(Key_LeftBracket)) \
