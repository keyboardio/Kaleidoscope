...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'أ', LSHIFT(Key_Period)) /* U+0623, XKB_KEY_Arabic_hamzaonalef, ARABIC LETTER ALEF WITH HAMZA ABOVE */ \
   OP(L'ؤ', LSHIFT(Key_W)) /* U+0624, XKB_KEY_Arabic_hamzaonwaw, ARABIC LETTER WAW WITH HAMZA ABOVE */ \
   OP(L'إ', LSHIFT(Key_Comma)) /* U+0625, XKB_KEY_Arabic_hamzaunderalef, ARABIC LETTER ALEF WITH HAMZA BELOW */ \
   OP(L'ئ', LSHIFT(Key_I)) /* U+0626, XKB_KEY_Arabic_hamzaonyeh, ARABIC LETTER YEH WITH HAMZA ABOVE */ \
   ...
   OP(L'ذ', LSHIFT(Key_B)) /* U+0630, XKB_KEY_Arabic_thal, ARABIC LETTER THAL */ \
   ...
   OP(L'ش', LSHIFT(Key_C)) /* U+0634, XKB_KEY_Arabic_sheen, ARABIC LETTER SHEEN */ \
   ...
   OP(L'ٌ', LSHIFT(Key_U)) /* U+064c, XKB_KEY_Arabic_dammatan, ARABIC DAMMATAN */ \
   ...
   OP(L'ّ', LSHIFT(Key_L)) /* U+0651, XKB_KEY_Arabic_shadda, ARABIC SHADDA */ \
   ...
   OP(L'ٹ', LSHIFT(Key_R)) /* U+0679, XKB_KEY_Arabic_tteh, ARABIC LETTER TTEH */ \
   OP(L'پ', Key_P) /* U+067e, XKB_KEY_Arabic_peh, ARABIC LETTER PEH */ \
   OP(L'چ', Key_C) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڠ', Key_G) \
   OP(L'ڨ', Key_V) \
   OP(L'گ', LSHIFT(Key_Q)) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_dammatan, LSHIFT(Key_U)) \
   ...
   OP(XKB_KEY_Arabic_gaf, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Arabic_hamzaonalef, LSHIFT(Key_Period)) \
   OP(XKB_KEY_Arabic_hamzaonwaw, LSHIFT(Key_W)) \
   OP(XKB_KEY_Arabic_hamzaonyeh, LSHIFT(Key_I)) \
   OP(XKB_KEY_Arabic_hamzaunderalef, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Arabic_shadda, LSHIFT(Key_L)) \
   OP(XKB_KEY_Arabic_sheen, LSHIFT(Key_C)) \
   ...
   OP(XKB_KEY_Arabic_thal, LSHIFT(Key_B)) \
   OP(XKB_KEY_Arabic_theh, LSHIFT(Key_V)) \
   OP(XKB_KEY_Arabic_tteh, LSHIFT(Key_R)) \
