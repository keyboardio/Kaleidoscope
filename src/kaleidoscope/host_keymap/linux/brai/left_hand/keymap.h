...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_braille_dot_1, Key_D) /* XKB_KEY_braille_dot_1 */ \
   OP(XKB_KEY_braille_dot_2, Key_S) /* XKB_KEY_braille_dot_2 */ \
   OP(XKB_KEY_braille_dot_3, Key_A) /* XKB_KEY_braille_dot_3 */ \
   OP(XKB_KEY_braille_dot_4, Key_F) /* XKB_KEY_braille_dot_4 */ \
   OP(XKB_KEY_braille_dot_5, Key_B) /* XKB_KEY_braille_dot_5 */ \
   OP(XKB_KEY_braille_dot_6, Key_V) /* XKB_KEY_braille_dot_6 */ \
