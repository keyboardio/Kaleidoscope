...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_braille_dot_1, Key_F) /* XKB_KEY_braille_dot_1 */ \
   OP(XKB_KEY_braille_dot_10, Key_N) /* XKB_KEY_braille_dot_10 */ \
   OP(XKB_KEY_braille_dot_2, Key_D) /* XKB_KEY_braille_dot_2 */ \
   OP(XKB_KEY_braille_dot_3, Key_S) /* XKB_KEY_braille_dot_3 */ \
   OP(XKB_KEY_braille_dot_4, Key_J) /* XKB_KEY_braille_dot_4 */ \
   OP(XKB_KEY_braille_dot_5, Key_K) /* XKB_KEY_braille_dot_5 */ \
   OP(XKB_KEY_braille_dot_6, Key_L) /* XKB_KEY_braille_dot_6 */ \
   OP(XKB_KEY_braille_dot_7, Key_A) /* XKB_KEY_braille_dot_7 */ \
   OP(XKB_KEY_braille_dot_8, Key_Semicolon) /* XKB_KEY_braille_dot_8 */ \
