...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_braille_dot_1, Key_J) /* XKB_KEY_braille_dot_1 */ \
   OP(XKB_KEY_braille_dot_2, Key_B) /* XKB_KEY_braille_dot_2 */ \
   OP(XKB_KEY_braille_dot_3, Key_N) /* XKB_KEY_braille_dot_3 */ \
   OP(XKB_KEY_braille_dot_4, Key_K) /* XKB_KEY_braille_dot_4 */ \
   OP(XKB_KEY_braille_dot_5, Key_L) /* XKB_KEY_braille_dot_5 */ \
   OP(XKB_KEY_braille_dot_6, Key_Semicolon) /* XKB_KEY_braille_dot_6 */ \
