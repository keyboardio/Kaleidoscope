...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('>', RALT(Key_S)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('^', RALT(Key_W)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'>', RALT(Key_S)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'^', RALT(Key_W)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'Ĝ', LSHIFT(Key_Y)) /* U+011c, XKB_KEY_Gcircumflex, LATIN CAPITAL LETTER G WITH CIRCUMFLEX */ \
   OP(L'ĝ', Key_Y) /* U+011d, XKB_KEY_gcircumflex, LATIN SMALL LETTER G WITH CIRCUMFLEX */ \
   OP(L'Ĥ', LSHIFT(Key_Quote)) /* U+0124, XKB_KEY_Hcircumflex, LATIN CAPITAL LETTER H WITH CIRCUMFLEX */ \
   OP(L'ĥ', Key_Quote) /* U+0125, XKB_KEY_hcircumflex, LATIN SMALL LETTER H WITH CIRCUMFLEX */ \
   OP(L'Ĵ', LSHIFT(Key_W)) /* U+0134, XKB_KEY_Jcircumflex, LATIN CAPITAL LETTER J WITH CIRCUMFLEX */ \
   OP(L'ĵ', Key_W) /* U+0135, XKB_KEY_jcircumflex, LATIN SMALL LETTER J WITH CIRCUMFLEX */ \
   ...
   OP(L'Ŭ', LSHIFT(Key_Semicolon)) /* U+016c, XKB_KEY_Ubreve, LATIN CAPITAL LETTER U WITH BREVE */ \
   OP(L'ŭ', Key_Semicolon) /* U+016d, XKB_KEY_ubreve, LATIN SMALL LETTER U WITH BREVE */ \
   OP(L'–', RALT(Key_T)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_R)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Gcircumflex, LSHIFT(Key_Y)) \
   OP(XKB_KEY_H, LSHIFT(Key_H)) \
   OP(XKB_KEY_Hcircumflex, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Jcircumflex, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_W)) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_emdash, RALT(Key_R)) \
   OP(XKB_KEY_endash, RALT(Key_T)) \
   OP(XKB_KEY_equal, Key_Equals) \
   OP(XKB_KEY_exclam, LSHIFT(Key_1)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcircumflex, Key_Y) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_S)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hcircumflex, Key_Quote) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_jcircumflex, Key_W) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_ubreve, Key_Semicolon) \
