...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('{', RALT(Key_O)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_P)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'{', RALT(Key_O)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_P)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   ...
   OP(L'Ĉ', LSHIFT(Key_X)) /* U+0108, XKB_KEY_Ccircumflex, LATIN CAPITAL LETTER C WITH CIRCUMFLEX */ \
   OP(L'ĉ', Key_X) /* U+0109, XKB_KEY_ccircumflex, LATIN SMALL LETTER C WITH CIRCUMFLEX */ \
   OP(L'Ĝ', LSHIFT(Key_W)) /* U+011c, XKB_KEY_Gcircumflex, LATIN CAPITAL LETTER G WITH CIRCUMFLEX */ \
   OP(L'ĝ', Key_W) /* U+011d, XKB_KEY_gcircumflex, LATIN SMALL LETTER G WITH CIRCUMFLEX */ \
   OP(L'Ĥ', LSHIFT(Key_RightBracket)) /* U+0124, XKB_KEY_Hcircumflex, LATIN CAPITAL LETTER H WITH CIRCUMFLEX */ \
   OP(L'ĥ', Key_RightBracket) /* U+0125, XKB_KEY_hcircumflex, LATIN SMALL LETTER H WITH CIRCUMFLEX */ \
   OP(L'Ĵ', LSHIFT(Key_LeftBracket)) /* U+0134, XKB_KEY_Jcircumflex, LATIN CAPITAL LETTER J WITH CIRCUMFLEX */ \
   OP(L'ĵ', Key_LeftBracket) /* U+0135, XKB_KEY_jcircumflex, LATIN SMALL LETTER J WITH CIRCUMFLEX */ \
   OP(L'Ŝ', LSHIFT(Key_Q)) /* U+015c, XKB_KEY_Scircumflex, LATIN CAPITAL LETTER S WITH CIRCUMFLEX */ \
   OP(L'ŝ', Key_Q) /* U+015d, XKB_KEY_scircumflex, LATIN SMALL LETTER S WITH CIRCUMFLEX */ \
   ...
   OP(L'‘', RALT(Key_A)) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_S)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'“', RALT(Key_D)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_F)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccircumflex, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Gcircumflex, LSHIFT(Key_W)) \
   OP(XKB_KEY_H, LSHIFT(Key_H)) \
   OP(XKB_KEY_Hcircumflex, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Jcircumflex, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Scircumflex, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_braceleft, RALT(Key_O)) \
   OP(XKB_KEY_braceright, RALT(Key_P)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcircumflex, Key_W) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_Period)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hcircumflex, Key_RightBracket) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_jcircumflex, Key_LeftBracket) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_D)) \
   OP(XKB_KEY_leftsinglequotemark, RALT(Key_A)) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_F)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_S)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scircumflex, Key_Q) \
