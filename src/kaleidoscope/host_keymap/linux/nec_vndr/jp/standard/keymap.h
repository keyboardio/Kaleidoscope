...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('=', LSHIFT(Key_Minus)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP('}', LSHIFT(Key_NonUsPound)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', LSHIFT(Key_LeftBracket)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'=', LSHIFT(Key_Minus)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP(L'}', LSHIFT(Key_NonUsPound)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', LSHIFT(Key_LeftBracket)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Clear, Key_Home) /* XKB_KEY_Clear */ \
   ...
   OP(XKB_KEY_Home, LSHIFT(Key_Home)) /* XKB_KEY_Home */ \
   ...
   OP(XKB_KEY_Mode_switch, Key_RightAlt) /* XKB_KEY_Mode_switch, Character set switch  */ \
   ...
   OP(XKB_KEY_asciitilde, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_at, Key_LeftBracket) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_braceleft, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_braceright, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_equal, LSHIFT(Key_Minus)) \
   ...
   OP(XKB_KEY_plus, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_q, Key_Q) \
