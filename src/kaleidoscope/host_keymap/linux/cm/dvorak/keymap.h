...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(';', RALT(Key_Z)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('[', RALT(Key_Minus)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', Key_NonUsPound) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_Equals)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP('{', RALT(LSHIFT(Key_Minus))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(LSHIFT(Key_Equals))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L';', RALT(Key_Z)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'[', RALT(Key_Minus)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', Key_NonUsPound) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_Equals)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP(L'{', RALT(LSHIFT(Key_Minus))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(LSHIFT(Key_Equals))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   ...
   OP(L'«', RALT(LSHIFT(Key_W))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'®', RALT(LSHIFT(Key_O))) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'±', RALT(LSHIFT(Key_RightBracket))) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'»', RALT(LSHIFT(Key_E))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¼', RALT(Key_1)) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(Key_2)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(Key_3)) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   OP(L'Æ', RALT(LSHIFT(Key_Y))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'×', RALT(LSHIFT(Key_8))) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Ø', RALT(LSHIFT(Key_R))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'æ', RALT(Key_Y)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   ...
   OP(L'Ŋ', RALT(LSHIFT(Key_L))) \
   OP(L'ŋ', RALT(Key_L)) \
   OP(L'Œ', RALT(LSHIFT(Key_K))) \
   OP(L'œ', RALT(Key_K)) \
   OP(L'Ɓ', RALT(LSHIFT(Key_N))) \
   OP(L'Ɔ', RALT(LSHIFT(Key_S))) \
   OP(L'Ɗ', RALT(LSHIFT(Key_H))) \
   OP(L'Ə', RALT(LSHIFT(Key_D))) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'Ɛ', RALT(LSHIFT(Key_A))) \
   OP(L'Ɨ', RALT(LSHIFT(Key_G))) \
   OP(L'Ƴ', RALT(LSHIFT(Key_T))) \
   OP(L'ƴ', RALT(Key_T)) \
   OP(L'Ʉ', RALT(LSHIFT(Key_F))) \
   OP(L'ɑ', RALT(Key_J)) \
   OP(L'ɓ', RALT(Key_N)) \
   OP(L'ɔ', RALT(Key_S)) \
   OP(L'ɗ', RALT(Key_H)) \
   OP(L'ə', RALT(Key_D)) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   OP(L'ɛ', RALT(Key_A)) \
   OP(L'ɨ', RALT(Key_G)) \
   OP(L'ʉ', RALT(Key_F)) \
   OP(L'ʔ', RALT(LSHIFT(Key_LeftBracket))) \
   OP(L'ʼ', RALT(Key_U)) \
   OP(L'̀', Key_Q) \
   OP(L'́', Key_Minus) \
   OP(L'̂', LSHIFT(Key_Q)) \
   OP(L'̃', LSHIFT(Key_Backtick)) \
   OP(L'̄', RALT(Key_Quote)) \
   OP(L'̌', LSHIFT(Key_Minus)) \
   OP(L'̍', Key_Backtick) \
   OP(L'̣', RALT(LSHIFT(Key_C))) \
   OP(L'̧', Key_Equals) \
   OP(L'̰', RALT(Key_C)) \
   OP(L'᷄', RALT(LSHIFT(Key_P))) \
   OP(L'᷅', RALT(Key_V)) \
   OP(L'᷆', RALT(Key_P)) \
   OP(L'᷇', RALT(LSHIFT(Key_V))) \
   OP(L'Ẅ', RALT(LSHIFT(Key_Comma))) /* U+1e84, XKB_KEY_Wdiaeresis, LATIN CAPITAL LETTER W WITH DIAERESIS */ \
   OP(L'ẅ', RALT(Key_Comma)) /* U+1e85, XKB_KEY_wdiaeresis, LATIN SMALL LETTER W WITH DIAERESIS */ \
   ...
   OP(L'◌', RALT(Key_O)) \
   OP(L'Ɑ', RALT(LSHIFT(Key_J))) \
   OP(L'Ꞌ', RALT(LSHIFT(Key_U))) \
   OP(L'ꞌ', RALT(Key_Period)) \

#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   OP(XKB_KEY_A, LSHIFT(Key_A)) \
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_ISO_Level3_Latch, Key_Z) /* XKB_KEY_ISO_Level3_Latch */ \
   ...
   OP(XKB_KEY_SCHWA, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Wdiaeresis, RALT(LSHIFT(Key_Comma))) \
   ...
   OP(XKB_KEY_braceleft, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_braceright, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_bracketleft, RALT(Key_Minus)) \
   OP(XKB_KEY_bracketright, RALT(Key_Equals)) \
   ...
   OP(XKB_KEY_dead_diaeresis, LSHIFT(Key_Equals)) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   ...
   OP(XKB_KEY_multiply, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_onehalf, RALT(Key_2)) \
   OP(XKB_KEY_onequarter, RALT(Key_1)) \
