...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Æ', LSHIFT(Key_NonUsPound)) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ø', LSHIFT(Key_LeftBracket)) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'æ', Key_NonUsPound) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ø', Key_LeftBracket) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   ...
   OP(L'Œ', LSHIFT(Key_Semicolon)) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', Key_Semicolon) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Š', LSHIFT(Key_R)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_R) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ǝ', RALT(LSHIFT(Key_E))) \
   OP(L'Ɛ', RALT(LSHIFT(Key_I))) \
   OP(L'ǝ', RALT(Key_E)) \
   OP(L'ǲ', RALT(LSHIFT(Key_Z))) \
   OP(L'ǳ', RALT(Key_Z)) \
   OP(L'ɛ', RALT(Key_I)) \
   OP(L'̀', RALT(Key_F)) \
   OP(L'́', RALT(Key_D)) \
   ...
   OP(L'Σ', LSHIFT(Key_RightBracket)) /* U+03a3, XKB_KEY_Greek_SIGMA, GREEK CAPITAL LETTER SIGMA */ \
   OP(L'Φ', RALT(LSHIFT(Key_O))) /* U+03a6, XKB_KEY_Greek_PHI, GREEK CAPITAL LETTER PHI */ \
   OP(L'Ω', RALT(LSHIFT(Key_U))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'π', RALT(Key_P)) /* U+03c0, XKB_KEY_Greek_pi, GREEK SMALL LETTER PI */ \
   OP(L'σ', Key_RightBracket) /* U+03c3, XKB_KEY_Greek_sigma, GREEK SMALL LETTER SIGMA */ \
   OP(L'φ', RALT(Key_O)) /* U+03c6, XKB_KEY_Greek_phi, GREEK SMALL LETTER PHI */ \
   OP(L'ω', RALT(Key_U)) /* U+03c9, XKB_KEY_Greek_omega, GREEK SMALL LETTER OMEGA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Greek_OMEGA, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_Greek_PHI, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Greek_PI, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Greek_SIGMA, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Greek_omega, RALT(Key_U)) \
   OP(XKB_KEY_Greek_phi, RALT(Key_O)) \
   OP(XKB_KEY_Greek_pi, RALT(Key_P)) \
   OP(XKB_KEY_Greek_sigma, Key_RightBracket) \
   ...
   OP(XKB_KEY_OE, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Oslash, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_R)) \
   ...
   OP(XKB_KEY_dead_belowdot, RALT(LSHIFT(Key_Equals))) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_grave, Key_Backtick) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_macron, Key_Minus) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oe, Key_Semicolon) \
   OP(XKB_KEY_oslash, Key_LeftBracket) \
   OP(XKB_KEY_p, Key_P) \
