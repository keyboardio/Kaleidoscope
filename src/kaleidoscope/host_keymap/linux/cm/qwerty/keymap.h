...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'̈', LSHIFT(Key_RightBracket)) \
   OP(L'̌', LSHIFT(Key_LeftBracket)) \
   OP(L'̍', Key_Backtick) \
   OP(L'̣', RALT(LSHIFT(Key_J))) \
   OP(L'̧', Key_RightBracket) \
   OP(L'̰', RALT(Key_J)) \
   OP(L'᷄', RALT(LSHIFT(Key_L))) \
   OP(L'᷅', RALT(Key_K)) \
   OP(L'᷆', RALT(Key_L)) \
   OP(L'᷇', RALT(LSHIFT(Key_K))) \
   OP(L'Ẅ', RALT(LSHIFT(Key_W))) /* U+1e84, XKB_KEY_Wdiaeresis, LATIN CAPITAL LETTER W WITH DIAERESIS */ \
   OP(L'ẅ', RALT(Key_W)) /* U+1e85, XKB_KEY_wdiaeresis, LATIN SMALL LETTER W WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Latch, Key_Semicolon) /* XKB_KEY_ISO_Level3_Latch */ \
   ...
   OP(XKB_KEY_Wdiaeresis, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_wdiaeresis, RALT(Key_W)) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_z, Key_Z) \
