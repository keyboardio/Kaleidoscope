...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', Key_NonUsPound) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('#', RALT(Key_1)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP('$', RALT(Key_RightBracket)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP('%', RALT(Key_Minus)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP('<', RALT(Key_5)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_6)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(']', RALT(Key_7)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('^', RALT(Key_LeftBracket)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP('{', Key_5) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', Key_6) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', Key_NonUsPound) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'#', RALT(Key_1)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP(L'$', RALT(Key_RightBracket)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP(L'%', RALT(Key_Minus)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP(L'<', RALT(Key_5)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_6)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L']', RALT(Key_7)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'^', RALT(Key_LeftBracket)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'{', Key_5) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', Key_6) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   ...
   OP(L'°', RALT(LSHIFT(Key_Minus))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'»', RALT(Key_8)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'œ', RALT(Key_E)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Ɔ', LSHIFT(Key_Quote)) \
   OP(L'Ɛ', LSHIFT(Key_LeftBracket)) \
   OP(L'Ɨ', RALT(LSHIFT(Key_I))) \
   OP(L'Ʉ', RALT(LSHIFT(Key_U))) \
   OP(L'ɔ', Key_Quote) \
   OP(L'ɛ', Key_LeftBracket) \
   OP(L'ɨ', RALT(Key_I)) \
   OP(L'ʉ', RALT(Key_U)) \
   OP(L'̀', Key_3) \
   OP(L'́', Key_2) \
   OP(L'̂', Key_8) \
   OP(L'̃', RALT(Key_Backtick)) \
   OP(L'̈', Key_0) \
   OP(L'̌', Key_9) \
   OP(L'̍', RALT(Key_9)) \
   OP(L'̧', RALT(Key_M)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_greater, RALT(Key_6)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_3)) \
   OP(XKB_KEY_guillemotright, RALT(Key_8)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_less, RALT(Key_5)) \
