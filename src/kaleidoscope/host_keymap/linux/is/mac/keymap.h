...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', Key_RightBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('+', Key_NonUsPound) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP('<', Key_Backtick) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', LSHIFT(Key_Backtick)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', LSHIFT(Key_RightBracket)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP('|', RALT(Key_H)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', Key_RightBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'+', Key_NonUsPound) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP(L'<', Key_Backtick) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', LSHIFT(Key_Backtick)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', LSHIFT(Key_RightBracket)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'|', RALT(Key_H)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'§', RALT(LSHIFT(Key_W))) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_G)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(LSHIFT(Key_I))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(LSHIFT(Key_Comma))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_K)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'¯', RALT(LSHIFT(Key_F))) /* U+00af, XKB_KEY_macron, MACRON */ \
   OP(L'°', Key_NonUsBackslashAndPipe) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(LSHIFT(Key_NonUsPound))) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(LSHIFT(Key_Q))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_RightBracket))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'¸', RALT(LSHIFT(Key_H))) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   OP(L'º', RALT(LSHIFT(Key_O))) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'»', RALT(LSHIFT(Key_Period))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¿', RALT(LSHIFT(Key_E))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'Å', RALT(LSHIFT(Key_A))) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   OP(L'Æ', LSHIFT(Key_Semicolon)) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ç', RALT(LSHIFT(Key_C))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Ð', LSHIFT(Key_LeftBracket)) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ö', LSHIFT(Key_Minus)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ø', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Þ', LSHIFT(Key_Slash)) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   OP(L'ß', RALT(Key_S)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'å', RALT(Key_A)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', Key_Semicolon) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_C)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ð', Key_LeftBracket) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ö', Key_Minus) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(LSHIFT(Key_7))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', RALT(Key_NonUsBackslashAndPipe)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'þ', Key_Slash) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'ı', RALT(Key_I)) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'ƒ', RALT(Key_F)) /* U+0192, XKB_KEY_function, LATIN SMALL LETTER F WITH HOOK */ \
   OP(L'ˇ', RALT(LSHIFT(Key_L))) /* U+02c7, XKB_KEY_caron, CARON */ \
   OP(L'˘', RALT(LSHIFT(Key_G))) /* U+02d8, XKB_KEY_breve, BREVE */ \
   OP(L'˙', RALT(LSHIFT(Key_S))) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
   OP(L'˚', RALT(LSHIFT(Key_D))) \
   OP(L'˛', RALT(LSHIFT(Key_K))) \
   OP(L'˝', RALT(LSHIFT(Key_J))) /* U+02dd, XKB_KEY_doubleacute, DOUBLE ACUTE ACCENT */ \
   OP(L'Π', RALT(LSHIFT(Key_P))) /* U+03a0, XKB_KEY_Greek_PI, GREEK CAPITAL LETTER PI */ \
   OP(L'Ω', RALT(Key_Z)) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'π', RALT(Key_P)) /* U+03c0, XKB_KEY_Greek_pi, GREEK SMALL LETTER PI */ \
   OP(L'–', RALT(Key_Equals)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Equals))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_Quote))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_Slash)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_LeftBracket))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_Slash))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_LeftBracket)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'•', RALT(LSHIFT(Key_T))) \
   OP(L'…', RALT(Key_L)) /* U+2026, XKB_KEY_ellipsis, HORIZONTAL ELLIPSIS */ \
   OP(L'‰', RALT(Key_5)) \
   OP(L'⁄', RALT(LSHIFT(Key_6))) \
   OP(L'€', RALT(Key_E)) \
   OP(L'™', RALT(Key_3)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'∂', RALT(Key_D)) /* U+2202, XKB_KEY_partialderivative, PARTIAL DIFFERENTIAL */ \
   OP(L'∆', RALT(Key_J)) \
   OP(L'∑', RALT(Key_W)) \
   OP(L'√', RALT(Key_V)) /* U+221a, XKB_KEY_radical, SQUARE ROOT */ \
   OP(L'∞', RALT(LSHIFT(Key_5))) /* U+221e, XKB_KEY_infinity, INFINITY */ \
   OP(L'∫', RALT(Key_B)) /* U+222b, XKB_KEY_integral, INTEGRAL */ \
   OP(L'≈', RALT(LSHIFT(Key_0))) /* U+2248, XKB_KEY_approxeq, ALMOST EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Alt_L, Key_LeftAlt) /* XKB_KEY_Alt_L, Left alt  */ \
   OP(XKB_KEY_Aring, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_ETH, LSHIFT(Key_LeftBracket)) /* XKB_KEY_Eth, deprecated  */ \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Escape, Key_Escape) /* XKB_KEY_Escape */ \
   OP(XKB_KEY_EuroSign, RALT(LSHIFT(Key_4))) \
   ...
   OP(XKB_KEY_Greek_OMEGA, RALT(Key_Z)) \
   OP(XKB_KEY_Greek_PI, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Greek_pi, RALT(Key_P)) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   ...
   OP(XKB_KEY_THORN, LSHIFT(Key_Slash)) /* XKB_KEY_Thorn, deprecated  */ \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abovedot, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_ae, Key_Semicolon) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_6)) \
   OP(XKB_KEY_apostrophe, Key_RightBracket) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_approxeq, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_aring, RALT(Key_A)) \
   ...
   OP(XKB_KEY_breve, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caron, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_ccedilla, RALT(Key_C)) \
   OP(XKB_KEY_cedilla, RALT(LSHIFT(Key_H))) \
   OP(XKB_KEY_cent, RALT(Key_4)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Period)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_G)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_acute, Key_Quote) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_O)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_U)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_N)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doubleacute, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_doublelowquotemark, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_ellipsis, RALT(Key_L)) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_endash, RALT(Key_Equals)) \
   OP(XKB_KEY_equal, LSHIFT(Key_0)) \
   OP(XKB_KEY_eth, Key_LeftBracket) \
   OP(XKB_KEY_exclam, LSHIFT(Key_1)) \
   OP(XKB_KEY_exclamdown, RALT(Key_1)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_function, RALT(Key_F)) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(Key_NonUsPound)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_greaterthanequal, RALT(Key_Period)) \
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_idotless, RALT(Key_I)) \
   OP(XKB_KEY_infinity, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_integral, RALT(Key_B)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_leftsinglequotemark, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_less, Key_Backtick) \
   OP(XKB_KEY_lessthanequal, RALT(Key_Comma)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_masculine, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_minus, Key_Equals) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_notsign, RALT(Key_K)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_odiaeresis, Key_Minus) \
   OP(XKB_KEY_oe, RALT(Key_Semicolon)) \
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_oslash, RALT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_8)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_9)) \
   OP(XKB_KEY_partialderivative, RALT(Key_D)) \
   OP(XKB_KEY_percent, LSHIFT(Key_5)) \
   OP(XKB_KEY_period, Key_Period) \
   OP(XKB_KEY_periodcentered, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_plus, Key_NonUsPound) \
   OP(XKB_KEY_plusminus, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_q, Key_Q) \
   OP(XKB_KEY_question, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_questiondown, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_2)) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_radical, RALT(Key_V)) \
   OP(XKB_KEY_registered, RALT(Key_R)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_Slash)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_thorn, Key_Slash) \
   OP(XKB_KEY_trademark, RALT(Key_3)) \
   OP(XKB_KEY_u, Key_U) \
