...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\\', RALT(Key_7)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP('{', RALT(LSHIFT(Key_8))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_H)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(LSHIFT(Key_9))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(Key_X)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\\', RALT(Key_7)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'{', RALT(LSHIFT(Key_8))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_H)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(LSHIFT(Key_9))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(Key_X)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'£', Key_Backtick) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   ...
   OP(L'¿', RALT(Key_RightBracket)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   ...
   OP(L'™', RALT(Key_3)) \
   OP(L'∂', RALT(Key_D)) /* U+2202, XKB_KEY_partdifferential, PARTIAL DIFFERENTIAL */ \
   OP(L'∆', RALT(Key_J)) \
   OP(L'∑', RALT(Key_W)) \
   OP(L'√', RALT(Key_V)) /* U+221a, XKB_KEY_squareroot, SQUARE ROOT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciitilde, RALT(Key_X)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_at, RALT(Key_2)) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(Key_7)) \
   OP(XKB_KEY_bar, RALT(Key_H)) \
   OP(XKB_KEY_braceleft, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_braceright, RALT(LSHIFT(Key_9))) \
   ...
   OP(XKB_KEY_dead_grave, RALT(Key_E)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_N)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, RALT(Key_T)) \
   ...
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(Key_Q)) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_8)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_9)) \
   OP(XKB_KEY_partdifferential, RALT(Key_D)) \
   ...
   OP(XKB_KEY_questiondown, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_squareroot, RALT(Key_V)) \
   OP(XKB_KEY_ssharp, RALT(Key_S)) \
   OP(XKB_KEY_sterling, Key_Backtick) \
   OP(XKB_KEY_t, Key_T) \
