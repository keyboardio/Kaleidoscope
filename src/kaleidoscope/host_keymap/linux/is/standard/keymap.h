...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('^', RALT(Key_Semicolon)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'^', RALT(Key_Semicolon)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'­', RALT(LSHIFT(Key_Backtick))) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_dead_abovering, Key_Backtick) /* XKB_KEY_dead_abovering */ \
   ...
   OP(XKB_KEY_hyphen, RALT(LSHIFT(Key_Backtick))) \
   OP(XKB_KEY_i, Key_I) \
