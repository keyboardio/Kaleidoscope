...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Æ', RALT(LSHIFT(Key_Semicolon))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ð', RALT(LSHIFT(Key_H))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ö', RALT(LSHIFT(Key_S))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Þ', RALT(LSHIFT(Key_Slash))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   OP(L'ß', RALT(Key_N)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'æ', RALT(Key_Semicolon)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ö', RALT(Key_S)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'þ', RALT(Key_Slash)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'ẞ', RALT(LSHIFT(Key_N))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_THORN, RALT(LSHIFT(Key_Slash))) /* XKB_KEY_Thorn, deprecated  */ \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_ae, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_odiaeresis, RALT(Key_S)) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_ssharp, RALT(Key_N)) \
   OP(XKB_KEY_t, Key_K) \
   OP(XKB_KEY_thorn, RALT(Key_Slash)) \
   OP(XKB_KEY_u, Key_F) \
