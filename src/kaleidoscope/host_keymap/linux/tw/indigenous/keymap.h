...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'°', RALT(LSHIFT(Key_Q))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(LSHIFT(Key_Minus))) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   ...
   OP(L'ʉ', RALT(Key_U)) \
   OP(L'ʼ', Key_Quote) \
   OP(L'ː', RALT(Key_Semicolon)) \
   OP(L'̍', RALT(Key_1)) \
   OP(L'͘', RALT(Key_2)) \
   OP(L'Ḏ', RALT(LSHIFT(Key_D))) \
   OP(L'ḏ', RALT(Key_D)) \
   OP(L'Ḻ', RALT(LSHIFT(Key_L))) \
   OP(L'ḻ', RALT(Key_L)) \
   OP(L'Ṟ', RALT(LSHIFT(Key_R))) \
   OP(L'ṟ', RALT(Key_R)) \
   OP(L'Ṯ', RALT(LSHIFT(Key_T))) \
   OP(L'ṯ', RALT(Key_T)) \
   OP(L'Ṳ', RALT(LSHIFT(Key_Y))) \
   OP(L'ṳ', RALT(Key_Y)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_0)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, RALT(LSHIFT(Key_0))) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_7)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowcomma, RALT(Key_Comma)) /* XKB_KEY_dead_belowcomma */ \
   ...
   OP(XKB_KEY_dead_cedilla, RALT(Key_8)) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_6)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_Semicolon))) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_doubleacute */ \
   ...
   OP(XKB_KEY_dead_ogonek, RALT(Key_9)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_Backtick))) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_Q))) \
   ...
   OP(XKB_KEY_plusminus, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_q, Key_Q) \
