...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', RALT(Key_Equals)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('&', RALT(Key_7)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP('\'', RALT(Key_Minus)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('-', Key_2) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP('=', Key_8) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_X)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', Key_Minus) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP('@', RALT(Key_1)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('Q', LSHIFT(Key_NonUsPound)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP('X', LSHIFT(Key_Equals)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP('_', RALT(Key_2)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP('q', Key_NonUsPound) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP('x', Key_Equals) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', RALT(Key_Equals)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'&', RALT(Key_7)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP(L'\'', RALT(Key_Minus)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'-', Key_2) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP(L'=', Key_8) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_X)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', Key_Minus) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP(L'@', RALT(Key_1)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'Q', LSHIFT(Key_NonUsPound)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP(L'X', LSHIFT(Key_Equals)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP(L'_', RALT(Key_2)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP(L'q', Key_NonUsPound) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP(L'x', Key_Equals) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   ...
   OP(L'Ą', LSHIFT(Key_Q)) /* U+0104, XKB_KEY_Aogonek, LATIN CAPITAL LETTER A WITH OGONEK */ \
   OP(L'ą', Key_Q) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'Č', LSHIFT(Key_Comma)) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', Key_Comma) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'đ', RALT(Key_F)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ė', LSHIFT(Key_Quote)) /* U+0116, XKB_KEY_Eabovedot, LATIN CAPITAL LETTER E WITH DOT ABOVE */ \
   OP(L'ė', Key_Quote) /* U+0117, XKB_KEY_eabovedot, LATIN SMALL LETTER E WITH DOT ABOVE */ \
   OP(L'Ę', LSHIFT(Key_Slash)) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', Key_Slash) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   ...
   OP(L'Į', LSHIFT(Key_LeftBracket)) /* U+012e, XKB_KEY_Iogonek, LATIN CAPITAL LETTER I WITH OGONEK */ \
   OP(L'į', Key_LeftBracket) /* U+012f, XKB_KEY_iogonek, LATIN SMALL LETTER I WITH OGONEK */ \
   ...
   OP(L'Š', LSHIFT(Key_F)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_F) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   ...
   OP(L'Ū', LSHIFT(Key_X)) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', Key_X) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ų', LSHIFT(Key_Semicolon)) /* U+0172, XKB_KEY_Uogonek, LATIN CAPITAL LETTER U WITH OGONEK */ \
   OP(L'ų', Key_Semicolon) /* U+0173, XKB_KEY_uogonek, LATIN SMALL LETTER U WITH OGONEK */ \
   OP(L'Ž', LSHIFT(Key_W)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_W) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'–', RALT(Key_C)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   ...
   OP(L'„', RALT(Key_Comma)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aogonek, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Ccaron, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Eabovedot, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Eogonek, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_Iogonek, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Q, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_F)) \
   ...
   OP(XKB_KEY_dead_acute, RALT(Key_Semicolon)) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Semicolon))) /* XKB_KEY_dead_doubleacute */ \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(Key_Comma)) \
   OP(XKB_KEY_downarrow, RALT(Key_U)) \
   OP(XKB_KEY_dstroke, RALT(Key_F)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eabovedot, Key_Quote) \
   OP(XKB_KEY_endash, RALT(Key_C)) \
   OP(XKB_KEY_eng, RALT(Key_G)) \
   OP(XKB_KEY_eogonek, Key_Slash) \
   OP(XKB_KEY_equal, Key_8) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_umacron, Key_X) \
   OP(XKB_KEY_underscore, RALT(Key_2)) \
   OP(XKB_KEY_uogonek, Key_Semicolon) \
   OP(XKB_KEY_uparrow, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_RightBracket) \
   OP(XKB_KEY_x, Key_Equals) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, Key_W) \
