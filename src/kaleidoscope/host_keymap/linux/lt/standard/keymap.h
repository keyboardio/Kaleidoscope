...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ą', LSHIFT(Key_1)) /* U+0104, XKB_KEY_Aogonek, LATIN CAPITAL LETTER A WITH OGONEK */ \
   OP(L'ą', Key_1) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'Č', LSHIFT(Key_2)) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', Key_2) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'đ', RALT(Key_F)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ė', LSHIFT(Key_4)) /* U+0116, XKB_KEY_Eabovedot, LATIN CAPITAL LETTER E WITH DOT ABOVE */ \
   OP(L'ė', Key_4) /* U+0117, XKB_KEY_eabovedot, LATIN SMALL LETTER E WITH DOT ABOVE */ \
   OP(L'Ę', LSHIFT(Key_3)) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', Key_3) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   ...
   OP(L'Į', LSHIFT(Key_5)) /* U+012e, XKB_KEY_Iogonek, LATIN CAPITAL LETTER I WITH OGONEK */ \
   OP(L'į', Key_5) /* U+012f, XKB_KEY_iogonek, LATIN SMALL LETTER I WITH OGONEK */ \
   ...
   OP(L'Š', LSHIFT(Key_6)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_6) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   ...
   OP(L'Ū', LSHIFT(Key_8)) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', Key_8) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ų', LSHIFT(Key_7)) /* U+0172, XKB_KEY_Uogonek, LATIN CAPITAL LETTER U WITH OGONEK */ \
   OP(L'ų', Key_7) /* U+0173, XKB_KEY_uogonek, LATIN SMALL LETTER U WITH OGONEK */ \
   OP(L'Ž', LSHIFT(Key_Equals)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_Equals) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'–', Key_NonUsBackslashAndPipe) /* U+2013, XKB_KEY_endash, EN DASH */ \
   ...
   OP(L'“', Key_0) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_B)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', Key_9) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aogonek, LSHIFT(Key_1)) \
   ...
   OP(XKB_KEY_Ccaron, LSHIFT(Key_2)) \
   ...
   OP(XKB_KEY_Eabovedot, LSHIFT(Key_4)) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Eogonek, LSHIFT(Key_3)) \
   ...
   OP(XKB_KEY_Iogonek, LSHIFT(Key_5)) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_6)) \
   ...
   OP(XKB_KEY_Umacron, LSHIFT(Key_8)) \
   OP(XKB_KEY_Uogonek, LSHIFT(Key_7)) \
   ...
   OP(XKB_KEY_doublelowquotemark, Key_9) \
   OP(XKB_KEY_downarrow, RALT(Key_U)) \
   OP(XKB_KEY_dstroke, RALT(Key_F)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eabovedot, Key_4) \
   OP(XKB_KEY_endash, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_eng, RALT(Key_G)) \
   OP(XKB_KEY_eogonek, Key_3) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_umacron, Key_8) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_uogonek, Key_7) \
