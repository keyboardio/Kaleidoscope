...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('?', Key_8) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP('_', Key_Minus) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'?', Key_8) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'_', Key_Minus) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP(L'Š', LSHIFT(Key_Period)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_Period) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   ...
   OP(L'“', LSHIFT(Key_RightBracket)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_B)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', Key_RightBracket) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_doublelowquotemark, Key_RightBracket) \
   ...
   OP(XKB_KEY_leftdoublequotemark, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_underscore, Key_Minus) \
