...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ą', RALT(LSHIFT(Key_1))) /* U+0104, XKB_KEY_Aogonek, LATIN CAPITAL LETTER A WITH OGONEK */ \
   OP(L'ą', RALT(Key_1)) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'Č', RALT(LSHIFT(Key_2))) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', RALT(Key_2)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Ė', RALT(LSHIFT(Key_4))) /* U+0116, XKB_KEY_Eabovedot, LATIN CAPITAL LETTER E WITH DOT ABOVE */ \
   OP(L'ė', RALT(Key_4)) /* U+0117, XKB_KEY_eabovedot, LATIN SMALL LETTER E WITH DOT ABOVE */ \
   OP(L'Ę', RALT(LSHIFT(Key_3))) /* U+0118, XKB_KEY_Eogonek, LATIN CAPITAL LETTER E WITH OGONEK */ \
   OP(L'ę', RALT(Key_3)) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   OP(L'Į', RALT(LSHIFT(Key_5))) /* U+012e, XKB_KEY_Iogonek, LATIN CAPITAL LETTER I WITH OGONEK */ \
   OP(L'į', RALT(Key_5)) /* U+012f, XKB_KEY_iogonek, LATIN SMALL LETTER I WITH OGONEK */ \
   OP(L'Š', RALT(LSHIFT(Key_6))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_6)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ū', RALT(LSHIFT(Key_8))) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', RALT(Key_8)) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ų', RALT(LSHIFT(Key_7))) /* U+0172, XKB_KEY_Uogonek, LATIN CAPITAL LETTER U WITH OGONEK */ \
   OP(L'ų', RALT(Key_7)) /* U+0173, XKB_KEY_uogonek, LATIN SMALL LETTER U WITH OGONEK */ \
   ...
   OP(L'“', RALT(Key_0)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_9)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aogonek, RALT(LSHIFT(Key_1))) \
   ...
   OP(XKB_KEY_Ccaron, RALT(LSHIFT(Key_2))) \
   ...
   OP(XKB_KEY_Eabovedot, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Eogonek, RALT(LSHIFT(Key_3))) \
   ...
   OP(XKB_KEY_Iogonek, RALT(LSHIFT(Key_5))) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_6))) \
   ...
   OP(XKB_KEY_Umacron, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_Uogonek, RALT(LSHIFT(Key_7))) \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(Key_9)) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_eabovedot, RALT(Key_4)) \
   OP(XKB_KEY_eogonek, RALT(Key_3)) \
   ...
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_iogonek, RALT(Key_5)) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_0)) \
