...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ž', RALT(LSHIFT(Key_Equals))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_Equals)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, RALT(Key_Equals)) \
