...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'У', LSHIFT(Key_0)) /* U+0423, XKB_KEY_Cyrillic_U, CYRILLIC CAPITAL LETTER U */ \
   ...
   OP(L'у', Key_0) /* U+0443, XKB_KEY_Cyrillic_u, CYRILLIC SMALL LETTER U */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_U, LSHIFT(Key_0)) \
