...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ё', LSHIFT(Key_4)) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   ...
   OP(L'Ж', LSHIFT(Key_Period)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   ...
   OP(L'Ч', LSHIFT(Key_RightBracket)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', LSHIFT(Key_Minus)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_Equals)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   OP(L'Ъ', LSHIFT(Key_6)) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ы', LSHIFT(Key_T)) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', LSHIFT(Key_B)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   ...
   OP(L'ж', Key_Period) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   ...
   OP(L'ч', Key_RightBracket) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', Key_Minus) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_Equals) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   OP(L'ъ', LSHIFT(Key_5)) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', Key_T) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', Key_B) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   ...
   OP(L'ё', LSHIFT(Key_3)) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_Period)) \
   OP(XKB_KEY_Cyrillic_a, Key_A) \
   OP(XKB_KEY_Cyrillic_be, Key_N) \
   OP(XKB_KEY_Cyrillic_che, Key_RightBracket) \
   ...
   OP(XKB_KEY_Cyrillic_zhe, Key_Period) \
