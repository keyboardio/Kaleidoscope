...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(';', RALT(Key_P)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('D', RALT(LSHIFT(Key_G))) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', RALT(LSHIFT(Key_K))) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', RALT(LSHIFT(Key_E))) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', RALT(LSHIFT(Key_T))) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', RALT(LSHIFT(Key_H))) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', RALT(LSHIFT(Key_L))) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', RALT(LSHIFT(Key_Y))) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', RALT(LSHIFT(Key_N))) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', RALT(LSHIFT(Key_U))) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('M', RALT(LSHIFT(Key_M))) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP('N', RALT(LSHIFT(Key_J))) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP('O', RALT(LSHIFT(Key_Semicolon))) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', RALT(LSHIFT(Key_R))) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP('Q', RALT(LSHIFT(Key_Q))) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP('R', RALT(LSHIFT(Key_S))) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP('S', RALT(LSHIFT(Key_D))) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP('T', RALT(LSHIFT(Key_F))) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP('U', RALT(LSHIFT(Key_I))) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   ...
   OP('Y', RALT(LSHIFT(Key_O))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP('Z', RALT(LSHIFT(Key_Z))) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP('[', RALT(Key_9)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_0)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('^', LSHIFT(Key_6)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', RALT(Key_NonUsBackslashAndPipe)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('d', RALT(Key_G)) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', RALT(Key_K)) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', RALT(Key_E)) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', RALT(Key_T)) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', RALT(Key_H)) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', RALT(Key_L)) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', RALT(Key_Y)) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', RALT(Key_N)) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', RALT(Key_U)) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', RALT(Key_M)) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', RALT(Key_J)) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', RALT(Key_Semicolon)) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', RALT(Key_R)) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', RALT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', RALT(Key_S)) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', RALT(Key_D)) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', RALT(Key_F)) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', RALT(Key_I)) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   ...
   OP('y', RALT(Key_O)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP('|', RALT(LSHIFT(Key_NonUsPound))) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(LSHIFT(Key_RightBracket))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L';', RALT(Key_P)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'D', RALT(LSHIFT(Key_G))) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', RALT(LSHIFT(Key_K))) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', RALT(LSHIFT(Key_E))) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', RALT(LSHIFT(Key_T))) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', RALT(LSHIFT(Key_H))) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', RALT(LSHIFT(Key_L))) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', RALT(LSHIFT(Key_Y))) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', RALT(LSHIFT(Key_N))) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', RALT(LSHIFT(Key_U))) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'M', RALT(LSHIFT(Key_M))) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP(L'N', RALT(LSHIFT(Key_J))) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP(L'O', RALT(LSHIFT(Key_Semicolon))) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', RALT(LSHIFT(Key_R))) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP(L'Q', RALT(LSHIFT(Key_Q))) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP(L'R', RALT(LSHIFT(Key_S))) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP(L'S', RALT(LSHIFT(Key_D))) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP(L'T', RALT(LSHIFT(Key_F))) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP(L'U', RALT(LSHIFT(Key_I))) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   ...
   OP(L'Y', RALT(LSHIFT(Key_O))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP(L'Z', RALT(LSHIFT(Key_Z))) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP(L'[', RALT(Key_9)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_0)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'^', LSHIFT(Key_6)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', RALT(Key_NonUsBackslashAndPipe)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'd', RALT(Key_G)) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', RALT(Key_K)) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', RALT(Key_E)) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', RALT(Key_T)) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', RALT(Key_H)) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', RALT(Key_L)) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', RALT(Key_Y)) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', RALT(Key_N)) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', RALT(Key_U)) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', RALT(Key_M)) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', RALT(Key_J)) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', RALT(Key_Semicolon)) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', RALT(Key_R)) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', RALT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', RALT(Key_S)) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', RALT(Key_D)) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', RALT(Key_F)) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', RALT(Key_I)) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   ...
   OP(L'y', RALT(Key_O)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP(L'̀', RALT(Key_Backtick)) \
   OP(L'́', Key_NonUsBackslashAndPipe) \
   OP(L'̆', RALT(Key_6)) \
   OP(L'̇', RALT(Key_7)) \
   OP(L'̋', RALT(Key_2)) \
   ...
   OP(L'Г', LSHIFT(Key_T)) /* U+0413, XKB_KEY_Cyrillic_GHE, CYRILLIC CAPITAL LETTER GHE */ \
   OP(L'Д', LSHIFT(Key_G)) /* U+0414, XKB_KEY_Cyrillic_DE, CYRILLIC CAPITAL LETTER DE */ \
   OP(L'Е', LSHIFT(Key_K)) /* U+0415, XKB_KEY_Cyrillic_IE, CYRILLIC CAPITAL LETTER IE */ \
   OP(L'Ж', LSHIFT(Key_W)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', LSHIFT(Key_Z)) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   OP(L'И', LSHIFT(Key_L)) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   OP(L'Й', LSHIFT(Key_Y)) /* U+0419, XKB_KEY_Cyrillic_SHORTI, CYRILLIC CAPITAL LETTER SHORT I */ \
   OP(L'К', LSHIFT(Key_N)) /* U+041a, XKB_KEY_Cyrillic_KA, CYRILLIC CAPITAL LETTER KA */ \
   OP(L'Л', LSHIFT(Key_U)) /* U+041b, XKB_KEY_Cyrillic_EL, CYRILLIC CAPITAL LETTER EL */ \
   OP(L'М', LSHIFT(Key_M)) /* U+041c, XKB_KEY_Cyrillic_EM, CYRILLIC CAPITAL LETTER EM */ \
   OP(L'Н', LSHIFT(Key_J)) /* U+041d, XKB_KEY_Cyrillic_EN, CYRILLIC CAPITAL LETTER EN */ \
   OP(L'О', LSHIFT(Key_Semicolon)) /* U+041e, XKB_KEY_Cyrillic_O, CYRILLIC CAPITAL LETTER O */ \
   OP(L'П', LSHIFT(Key_R)) /* U+041f, XKB_KEY_Cyrillic_PE, CYRILLIC CAPITAL LETTER PE */ \
   OP(L'Р', LSHIFT(Key_S)) /* U+0420, XKB_KEY_Cyrillic_ER, CYRILLIC CAPITAL LETTER ER */ \
   OP(L'С', LSHIFT(Key_D)) /* U+0421, XKB_KEY_Cyrillic_ES, CYRILLIC CAPITAL LETTER ES */ \
   OP(L'Т', LSHIFT(Key_F)) /* U+0422, XKB_KEY_Cyrillic_TE, CYRILLIC CAPITAL LETTER TE */ \
   OP(L'У', LSHIFT(Key_I)) /* U+0423, XKB_KEY_Cyrillic_U, CYRILLIC CAPITAL LETTER U */ \
   OP(L'Ф', LSHIFT(Key_E)) /* U+0424, XKB_KEY_Cyrillic_EF, CYRILLIC CAPITAL LETTER EF */ \
   OP(L'Х', LSHIFT(Key_X)) /* U+0425, XKB_KEY_Cyrillic_HA, CYRILLIC CAPITAL LETTER HA */ \
   OP(L'Ц', LSHIFT(Key_C)) /* U+0426, XKB_KEY_Cyrillic_TSE, CYRILLIC CAPITAL LETTER TSE */ \
   OP(L'Ч', LSHIFT(Key_H)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   ...
   OP(L'Ъ', LSHIFT(Key_Equals)) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ы', LSHIFT(Key_O)) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', LSHIFT(Key_Quote)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', LSHIFT(Key_NonUsPound)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', LSHIFT(Key_P)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_Q)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   ...
   OP(L'г', Key_T) /* U+0433, XKB_KEY_Cyrillic_ghe, CYRILLIC SMALL LETTER GHE */ \
   OP(L'д', Key_G) /* U+0434, XKB_KEY_Cyrillic_de, CYRILLIC SMALL LETTER DE */ \
   OP(L'е', Key_K) /* U+0435, XKB_KEY_Cyrillic_ie, CYRILLIC SMALL LETTER IE */ \
   OP(L'ж', Key_W) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', Key_Z) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   OP(L'и', Key_L) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   OP(L'й', Key_Y) /* U+0439, XKB_KEY_Cyrillic_shorti, CYRILLIC SMALL LETTER SHORT I */ \
   OP(L'к', Key_N) /* U+043a, XKB_KEY_Cyrillic_ka, CYRILLIC SMALL LETTER KA */ \
   OP(L'л', Key_U) /* U+043b, XKB_KEY_Cyrillic_el, CYRILLIC SMALL LETTER EL */ \
   OP(L'м', Key_M) /* U+043c, XKB_KEY_Cyrillic_em, CYRILLIC SMALL LETTER EM */ \
   OP(L'н', Key_J) /* U+043d, XKB_KEY_Cyrillic_en, CYRILLIC SMALL LETTER EN */ \
   OP(L'о', Key_Semicolon) /* U+043e, XKB_KEY_Cyrillic_o, CYRILLIC SMALL LETTER O */ \
   OP(L'п', Key_R) /* U+043f, XKB_KEY_Cyrillic_pe, CYRILLIC SMALL LETTER PE */ \
   OP(L'р', Key_S) /* U+0440, XKB_KEY_Cyrillic_er, CYRILLIC SMALL LETTER ER */ \
   OP(L'с', Key_D) /* U+0441, XKB_KEY_Cyrillic_es, CYRILLIC SMALL LETTER ES */ \
   OP(L'т', Key_F) /* U+0442, XKB_KEY_Cyrillic_te, CYRILLIC SMALL LETTER TE */ \
   OP(L'у', Key_I) /* U+0443, XKB_KEY_Cyrillic_u, CYRILLIC SMALL LETTER U */ \
   OP(L'ф', Key_E) /* U+0444, XKB_KEY_Cyrillic_ef, CYRILLIC SMALL LETTER EF */ \
   OP(L'х', Key_X) /* U+0445, XKB_KEY_Cyrillic_ha, CYRILLIC SMALL LETTER HA */ \
   OP(L'ц', Key_C) /* U+0446, XKB_KEY_Cyrillic_tse, CYRILLIC SMALL LETTER TSE */ \
   OP(L'ч', Key_H) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   ...
   OP(L'ъ', Key_Equals) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', Key_O) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', Key_Quote) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', Key_NonUsPound) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', Key_P) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', Key_Q) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ё', Key_Backtick) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'–', RALT(Key_Minus)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Minus))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_H)) \
   OP(XKB_KEY_Cyrillic_DE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_E, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_Cyrillic_EF, LSHIFT(Key_E)) \
   OP(XKB_KEY_Cyrillic_EL, LSHIFT(Key_U)) \
   OP(XKB_KEY_Cyrillic_EM, LSHIFT(Key_M)) \
   OP(XKB_KEY_Cyrillic_EN, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_ER, LSHIFT(Key_S)) \
   OP(XKB_KEY_Cyrillic_ES, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_GHE, LSHIFT(Key_T)) \
   OP(XKB_KEY_Cyrillic_HA, LSHIFT(Key_X)) \
   OP(XKB_KEY_Cyrillic_HARDSIGN, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_L)) \
   OP(XKB_KEY_Cyrillic_IE, LSHIFT(Key_K)) \
   OP(XKB_KEY_Cyrillic_IO, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_N)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_R)) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Cyrillic_TE, LSHIFT(Key_F)) \
   OP(XKB_KEY_Cyrillic_TSE, LSHIFT(Key_C)) \
   OP(XKB_KEY_Cyrillic_U, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_VE, LSHIFT(Key_V)) \
   OP(XKB_KEY_Cyrillic_YA, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Cyrillic_YERU, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_P)) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_a, Key_A) \
   OP(XKB_KEY_Cyrillic_be, Key_B) \
   OP(XKB_KEY_Cyrillic_che, Key_H) \
   OP(XKB_KEY_Cyrillic_de, Key_G) \
   OP(XKB_KEY_Cyrillic_e, Key_NonUsPound) \
   OP(XKB_KEY_Cyrillic_ef, Key_E) \
   OP(XKB_KEY_Cyrillic_el, Key_U) \
   OP(XKB_KEY_Cyrillic_em, Key_M) \
   OP(XKB_KEY_Cyrillic_en, Key_J) \
   OP(XKB_KEY_Cyrillic_er, Key_S) \
   OP(XKB_KEY_Cyrillic_es, Key_D) \
   OP(XKB_KEY_Cyrillic_ghe, Key_T) \
   OP(XKB_KEY_Cyrillic_ha, Key_X) \
   OP(XKB_KEY_Cyrillic_hardsign, Key_Equals) \
   OP(XKB_KEY_Cyrillic_i, Key_L) \
   OP(XKB_KEY_Cyrillic_ie, Key_K) \
   OP(XKB_KEY_Cyrillic_io, Key_Backtick) \
   OP(XKB_KEY_Cyrillic_ka, Key_N) \
   OP(XKB_KEY_Cyrillic_o, Key_Semicolon) \
   OP(XKB_KEY_Cyrillic_pe, Key_R) \
   OP(XKB_KEY_Cyrillic_sha, Key_LeftBracket) \
   OP(XKB_KEY_Cyrillic_shcha, Key_RightBracket) \
   OP(XKB_KEY_Cyrillic_shorti, Key_Y) \
   OP(XKB_KEY_Cyrillic_softsign, Key_Quote) \
   OP(XKB_KEY_Cyrillic_te, Key_F) \
   OP(XKB_KEY_Cyrillic_tse, Key_C) \
   OP(XKB_KEY_Cyrillic_u, Key_I) \
   OP(XKB_KEY_Cyrillic_ve, Key_V) \
   OP(XKB_KEY_Cyrillic_ya, Key_Q) \
   OP(XKB_KEY_Cyrillic_yeru, Key_O) \
   OP(XKB_KEY_Cyrillic_yu, Key_P) \
   OP(XKB_KEY_Cyrillic_ze, Key_Z) \
   OP(XKB_KEY_Cyrillic_zhe, Key_W) \
   OP(XKB_KEY_D, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_Delete, Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(XKB_KEY_Down, Key_DownArrow) /* XKB_KEY_Down, Move down, down arrow  */ \
   OP(XKB_KEY_E, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Escape, Key_Escape) /* XKB_KEY_Escape */ \
   OP(XKB_KEY_EuroSign, RALT(Key_5)) \
   OP(XKB_KEY_F, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_J, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_K, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_L, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Mode_switch, Key_PcApplication) /* XKB_KEY_Mode_switch, Character set switch  */ \
   OP(XKB_KEY_Multi_key, LSHIFT(Key_PcApplication)) /* XKB_KEY_Multi_key, Multi-key character compose  */ \
   OP(XKB_KEY_N, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Next, Key_PageDown) /* XKB_KEY_Next, Next  */ \
   OP(XKB_KEY_Num_Lock, Key_KeypadNumLock) /* XKB_KEY_Num_Lock */ \
   OP(XKB_KEY_O, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_P, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_R, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_S, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_T, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Y, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_asciitilde, LSHIFT(Key_NonUsBackslashAndPipe)) \
