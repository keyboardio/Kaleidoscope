...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('<', RALT(LSHIFT(Key_W))) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('>', RALT(LSHIFT(Key_X))) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'<', RALT(LSHIFT(Key_W))) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'>', RALT(LSHIFT(Key_X))) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_greater, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_less, RALT(LSHIFT(Key_W))) \
