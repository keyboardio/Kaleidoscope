...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('(', Key_2) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', Key_3) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(':', Key_4) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'(', Key_2) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', Key_3) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L':', Key_4) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_parenleft, Key_2) \
   OP(XKB_KEY_parenright, Key_3) \
