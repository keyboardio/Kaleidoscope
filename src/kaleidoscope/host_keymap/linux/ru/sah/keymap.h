...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ѡ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'ѡ', RALT(Key_Semicolon)) \
   OP(L'Ҋ', RALT(LSHIFT(Key_Q))) \
   OP(L'ҋ', RALT(Key_Q)) \
   OP(L'Ҕ', RALT(LSHIFT(Key_U))) \
   OP(L'ҕ', RALT(Key_U)) \
   OP(L'Ҥ', RALT(LSHIFT(Key_Y))) \
   OP(L'ҥ', RALT(Key_Y)) \
   OP(L'Ү', RALT(LSHIFT(Key_E))) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', RALT(Key_E)) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   ...
   OP(L'Ӄ', RALT(LSHIFT(Key_R))) \
   OP(L'ӄ', RALT(Key_R)) \
   OP(L'Ӈ', RALT(LSHIFT(Key_V))) \
   OP(L'ӈ', RALT(Key_V)) \
   OP(L'Ӡ', RALT(LSHIFT(Key_P))) \
   OP(L'ӡ', RALT(Key_P)) \
   OP(L'Ӣ', RALT(LSHIFT(Key_B))) /* U+04e2, XKB_KEY_Cyrillic_I_macron, CYRILLIC CAPITAL LETTER I WITH MACRON */ \
   OP(L'ӣ', RALT(Key_B)) /* U+04e3, XKB_KEY_Cyrillic_i_macron, CYRILLIC SMALL LETTER I WITH MACRON */ \
   ...
   OP(L'Ӫ', RALT(LSHIFT(Key_Backtick))) \
   OP(L'ӫ', RALT(Key_Backtick)) \
   OP(L'Ӯ', RALT(LSHIFT(Key_X))) /* U+04ee, XKB_KEY_Cyrillic_U_macron, CYRILLIC CAPITAL LETTER U WITH MACRON */ \
   OP(L'ӯ', RALT(Key_X)) /* U+04ef, XKB_KEY_Cyrillic_u_macron, CYRILLIC SMALL LETTER U WITH MACRON */ \
   OP(L'₽', RALT(Key_8)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_I_macron, RALT(LSHIFT(Key_B))) \
   ...
   OP(XKB_KEY_Cyrillic_U_macron, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Cyrillic_U_straight, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Cyrillic_i_macron, RALT(Key_B)) \
   ...
   OP(XKB_KEY_Cyrillic_u_macron, RALT(Key_X)) \
   OP(XKB_KEY_Cyrillic_u_straight, RALT(Key_E)) \
