...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('{', RALT(LSHIFT(Key_9))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(LSHIFT(Key_0))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'{', RALT(LSHIFT(Key_9))) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', LSHIFT(Key_NonUsPound)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(LSHIFT(Key_0))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'¤', RALT(LSHIFT(Key_3))) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'§', LSHIFT(Key_3)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'×', RALT(Key_V)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'÷', RALT(LSHIFT(Key_V))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'̀', RALT(LSHIFT(Key_Backtick))) \
   OP(L'́', RALT(Key_Backtick)) \
   OP(L'̄', RALT(Key_1)) \
   OP(L'̆', RALT(LSHIFT(Key_1))) \
   OP(L'̋', RALT(Key_7)) \
   OP(L'̏', RALT(LSHIFT(Key_7))) \
   OP(L'̱', RALT(Key_8)) \
   OP(L'̲', RALT(LSHIFT(Key_8))) \
   OP(L'̵', RALT(Key_6)) \
   OP(L'̶', RALT(LSHIFT(Key_6))) \
   OP(L'Ё', RALT(LSHIFT(Key_T))) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   OP(L'Ђ', RALT(LSHIFT(Key_Semicolon))) /* U+0402, XKB_KEY_Serbian_DJE, CYRILLIC CAPITAL LETTER DJE */ \
   ...
   OP(L'Ј', RALT(LSHIFT(Key_Q))) /* U+0408, XKB_KEY_Cyrillic_JE, CYRILLIC CAPITAL LETTER JE */ \
   OP(L'Љ', RALT(LSHIFT(Key_K))) /* U+0409, XKB_KEY_Cyrillic_LJE, CYRILLIC CAPITAL LETTER LJE */ \
   OP(L'Њ', RALT(LSHIFT(Key_Y))) /* U+040a, XKB_KEY_Cyrillic_NJE, CYRILLIC CAPITAL LETTER NJE */ \
   OP(L'Ћ', RALT(LSHIFT(Key_X))) /* U+040b, XKB_KEY_Serbian_TSHE, CYRILLIC CAPITAL LETTER TSHE */ \
   OP(L'Ў', RALT(LSHIFT(Key_E))) /* U+040e, XKB_KEY_Byelorussian_SHORTU, CYRILLIC CAPITAL LETTER SHORT U */ \
   OP(L'Џ', RALT(LSHIFT(Key_L))) /* U+040f, XKB_KEY_Cyrillic_DZHE, CYRILLIC CAPITAL LETTER DZHE */ \
   ...
   OP(L'ё', RALT(Key_T)) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'ђ', RALT(Key_Semicolon)) /* U+0452, XKB_KEY_Serbian_dje, CYRILLIC SMALL LETTER DJE */ \
   ...
   OP(L'ј', RALT(Key_Q)) /* U+0458, XKB_KEY_Cyrillic_je, CYRILLIC SMALL LETTER JE */ \
   OP(L'љ', RALT(Key_K)) /* U+0459, XKB_KEY_Cyrillic_lje, CYRILLIC SMALL LETTER LJE */ \
   OP(L'њ', RALT(Key_Y)) /* U+045a, XKB_KEY_Cyrillic_nje, CYRILLIC SMALL LETTER NJE */ \
   OP(L'ћ', RALT(Key_X)) /* U+045b, XKB_KEY_Serbian_tshe, CYRILLIC SMALL LETTER TSHE */ \
   OP(L'ў', RALT(Key_E)) /* U+045e, XKB_KEY_Byelorussian_shortu, CYRILLIC SMALL LETTER SHORT U */ \
   OP(L'џ', RALT(Key_L)) /* U+045f, XKB_KEY_Cyrillic_dzhe, CYRILLIC SMALL LETTER DZHE */ \
   OP(L'Ѩ', RALT(LSHIFT(Key_Z))) \
   OP(L'ѩ', RALT(Key_Z)) \
   OP(L'Ѭ', RALT(LSHIFT(Key_C))) \
   OP(L'ѭ', RALT(Key_C)) \
   OP(L'Ѳ', RALT(LSHIFT(Key_A))) \
   OP(L'ѳ', RALT(Key_A)) \
   OP(L'Ѵ', RALT(LSHIFT(Key_B))) \
   OP(L'ѵ', RALT(Key_B)) \
   OP(L'Ҁ', RALT(LSHIFT(Key_H))) \
   OP(L'ҁ', RALT(Key_H)) \
   OP(L'Ґ', RALT(LSHIFT(Key_U))) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', RALT(Key_U)) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
   OP(L'Ҕ', LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(L'ҕ', Key_NonUsBackslashAndPipe) \
   OP(L'Қ', RALT(LSHIFT(Key_R))) /* U+049a, XKB_KEY_Cyrillic_KA_descender, CYRILLIC CAPITAL LETTER KA WITH DESCENDER */ \
   OP(L'қ', RALT(Key_R)) /* U+049b, XKB_KEY_Cyrillic_ka_descender, CYRILLIC SMALL LETTER KA WITH DESCENDER */ \
   OP(L'Ҡ', RALT(LSHIFT(Key_I))) \
   OP(L'ҡ', RALT(Key_I)) \
   OP(L'Ҥ', RALT(LSHIFT(Key_M))) \
   OP(L'ҥ', RALT(Key_M)) \
   OP(L'Ҭ', RALT(LSHIFT(Key_N))) \
   OP(L'ҭ', RALT(Key_N)) \
   OP(L'Ҵ', RALT(LSHIFT(Key_W))) \
   OP(L'ҵ', RALT(Key_W)) \
   OP(L'Һ', RALT(LSHIFT(Key_LeftBracket))) /* U+04ba, XKB_KEY_Cyrillic_SHHA, CYRILLIC CAPITAL LETTER SHHA */ \
   OP(L'һ', RALT(Key_LeftBracket)) /* U+04bb, XKB_KEY_Cyrillic_shha, CYRILLIC SMALL LETTER SHHA */ \
   OP(L'Ә', RALT(LSHIFT(Key_F))) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', RALT(Key_F)) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ӡ', RALT(LSHIFT(Key_P))) \
   OP(L'ӡ', RALT(Key_P)) \
   OP(L'Ө', RALT(LSHIFT(Key_J))) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', RALT(Key_J)) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
   OP(L'Ԁ', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(L'ԁ', RALT(Key_NonUsBackslashAndPipe)) \
   OP(L'Ԅ', RALT(LSHIFT(Key_O))) \
   OP(L'ԅ', RALT(Key_O)) \
   OP(L'Ԝ', RALT(LSHIFT(Key_D))) \
   OP(L'ԝ', RALT(Key_D)) \
   OP(L'Ԥ', RALT(LSHIFT(Key_G))) \
   OP(L'ԥ', RALT(Key_G)) \
   OP(L'–', RALT(LSHIFT(Key_Minus))) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_Minus)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'’', Key_Backtick) \
   OP(L'“', RALT(LSHIFT(Key_Period))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_Comma))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'•', RALT(LSHIFT(Key_Slash))) /* U+2022, XKB_KEY_enfilledcircbullet, BULLET */ \
   OP(L'…', RALT(Key_Slash)) /* U+2026, XKB_KEY_ellipsis, HORIZONTAL ELLIPSIS */ \
   OP(L'‰', RALT(LSHIFT(Key_5))) \
   OP(L'€', RALT(LSHIFT(Key_4))) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'₴', RALT(Key_3)) \
   OP(L'₿', RALT(LSHIFT(Key_2))) \
   OP(L'№', RALT(Key_2)) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Byelorussian_SHORTU, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Byelorussian_shortu, RALT(Key_E)) \
   ...
   OP(XKB_KEY_Cyrillic_DZHE, RALT(LSHIFT(Key_L))) /* XKB_KEY_Serbian_DZE, deprecated  */ \
   ...
   OP(XKB_KEY_Cyrillic_IO, RALT(LSHIFT(Key_T))) \
   OP(XKB_KEY_Cyrillic_JE, RALT(LSHIFT(Key_Q))) /* XKB_KEY_Serbian_JE, deprecated  */ \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_R)) \
   OP(XKB_KEY_Cyrillic_KA_descender, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Cyrillic_LJE, RALT(LSHIFT(Key_K))) /* XKB_KEY_Serbian_LJE, deprecated  */ \
   OP(XKB_KEY_Cyrillic_NJE, RALT(LSHIFT(Key_Y))) /* XKB_KEY_Serbian_NJE, deprecated  */ \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_O_bar, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_SCHWA, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_SHHA, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_Cyrillic_dzhe, RALT(Key_L)) /* XKB_KEY_Serbian_dze, deprecated  */ \
   ...
   OP(XKB_KEY_Cyrillic_io, RALT(Key_T)) \
   OP(XKB_KEY_Cyrillic_je, RALT(Key_Q)) /* XKB_KEY_Serbian_je, deprecated  */ \
   OP(XKB_KEY_Cyrillic_ka, Key_R) \
   OP(XKB_KEY_Cyrillic_ka_descender, RALT(Key_R)) \
   OP(XKB_KEY_Cyrillic_lje, RALT(Key_K)) /* XKB_KEY_Serbian_lje, deprecated  */ \
   OP(XKB_KEY_Cyrillic_nje, RALT(Key_Y)) /* XKB_KEY_Serbian_nje, deprecated  */ \
   OP(XKB_KEY_Cyrillic_o, Key_J) \
   OP(XKB_KEY_Cyrillic_o_bar, RALT(Key_J)) \
   OP(XKB_KEY_Cyrillic_pe, Key_G) \
   OP(XKB_KEY_Cyrillic_schwa, RALT(Key_F)) \
   OP(XKB_KEY_Cyrillic_sha, Key_I) \
   OP(XKB_KEY_Cyrillic_shcha, Key_O) \
   OP(XKB_KEY_Cyrillic_shha, RALT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_ISO_Level5_Shift, Key_CapsLock) /* XKB_KEY_ISO_Level5_Shift */ \
   ...
   OP(XKB_KEY_Serbian_DJE, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Serbian_TSHE, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Serbian_dje, RALT(Key_Semicolon)) \
   OP(XKB_KEY_Serbian_tshe, RALT(Key_X)) \
   OP(XKB_KEY_Shift_L, Key_LeftShift) /* XKB_KEY_Shift_L, Left shift  */ \
   OP(XKB_KEY_Shift_Lock, LSHIFT(Key_LeftShift)) /* XKB_KEY_Shift_Lock, Shift lock  */ \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, RALT(Key_U)) \
   ...
   OP(XKB_KEY_braceleft, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_braceright, RALT(LSHIFT(Key_0))) \
   ...
   OP(XKB_KEY_currency, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_degree, RALT(Key_5)) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_dollar, RALT(Key_4)) \
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_ellipsis, RALT(Key_Slash)) \
   OP(XKB_KEY_emdash, RALT(Key_Minus)) \
   OP(XKB_KEY_endash, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_enfilledcircbullet, RALT(LSHIFT(Key_Slash))) \
   ...
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_multiply, RALT(Key_V)) \
   OP(XKB_KEY_notequal, RALT(Key_Equals)) \
   OP(XKB_KEY_numerosign, RALT(Key_2)) \
   ...
   OP(XKB_KEY_section, LSHIFT(Key_3)) \
