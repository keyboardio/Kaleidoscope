...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('<', RALT(Key_6)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_7)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'<', RALT(Key_6)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_7)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'§', RALT(Key_3)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'÷', RALT(Key_1)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   ...
   OP(L'™', RALT(Key_N)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'∞', RALT(LSHIFT(Key_2))) /* U+221e, XKB_KEY_infinity, INFINITY */ \
   OP(L'≈', RALT(LSHIFT(Key_1))) /* U+2248, XKB_KEY_approxeq, ALMOST EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_approxeq, RALT(LSHIFT(Key_1))) \
