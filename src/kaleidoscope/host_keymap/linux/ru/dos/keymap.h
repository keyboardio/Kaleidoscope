...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', LSHIFT(Key_0)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('(', LSHIFT(Key_Backtick)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', Key_Backtick) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP('?', LSHIFT(Key_9)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', LSHIFT(Key_0)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'(', LSHIFT(Key_Backtick)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', Key_Backtick) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L'?', LSHIFT(Key_9)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_parenleft, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_parenright, Key_Backtick) \
   OP(XKB_KEY_percent, LSHIFT(Key_0)) \
   OP(XKB_KEY_period, LSHIFT(Key_7)) \
   OP(XKB_KEY_plus, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_question, LSHIFT(Key_9)) \
