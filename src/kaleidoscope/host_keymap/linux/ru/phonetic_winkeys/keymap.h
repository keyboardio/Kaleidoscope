...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ь', LSHIFT(Key_Equals)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   ...
   OP(L'ь', Key_Equals) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_Cyrillic_softsign, Key_Equals) \
