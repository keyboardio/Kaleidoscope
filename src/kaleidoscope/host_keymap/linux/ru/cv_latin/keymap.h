...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ü', RALT(LSHIFT(Key_W))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'ü', RALT(Key_W)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Ă', RALT(LSHIFT(Key_A))) /* U+0102, XKB_KEY_Abreve, LATIN CAPITAL LETTER A WITH BREVE */ \
   OP(L'ă', RALT(Key_A)) /* U+0103, XKB_KEY_abreve, LATIN SMALL LETTER A WITH BREVE */ \
   OP(L'Ĕ', RALT(LSHIFT(Key_E))) \
   OP(L'ĕ', RALT(Key_E)) \
   ...
   OP(L'Ĭ', RALT(LSHIFT(Key_I))) /* U+012c, XKB_KEY_Ibreve, LATIN CAPITAL LETTER I WITH BREVE */ \
   OP(L'ĭ', RALT(Key_I)) /* U+012d, XKB_KEY_ibreve, LATIN SMALL LETTER I WITH BREVE */ \
   OP(L'İ', RALT(LSHIFT(Key_J))) \
   OP(L'ı', RALT(Key_J)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Abreve, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_Ibreve, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_Comma))) /* XKB_KEY_dead_caron */ \
   ...
   OP(XKB_KEY_dead_doubleacute, RALT(Key_Equals)) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, Key_Backtick) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(Key_Slash)) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(LSHIFT(Key_Equals))) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(Key_Minus)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_Semicolon)) /* XKB_KEY_dead_ogonek */ \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_udiaeresis, RALT(Key_W)) \
