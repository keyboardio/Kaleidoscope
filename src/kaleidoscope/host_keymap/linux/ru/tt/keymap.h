...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Җ', LSHIFT(Key_M)) /* U+0496, XKB_KEY_Cyrillic_ZHE_descender, CYRILLIC CAPITAL LETTER ZHE WITH DESCENDER */ \
   OP(L'җ', Key_M) /* U+0497, XKB_KEY_Cyrillic_zhe_descender, CYRILLIC SMALL LETTER ZHE WITH DESCENDER */ \
   OP(L'Ң', LSHIFT(Key_Semicolon)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_Semicolon) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ү', LSHIFT(Key_RightBracket)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_RightBracket) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   OP(L'Һ', LSHIFT(Key_Backtick)) /* U+04ba, XKB_KEY_Cyrillic_SHHA, CYRILLIC CAPITAL LETTER SHHA */ \
   OP(L'һ', Key_Backtick) /* U+04bb, XKB_KEY_Cyrillic_shha, CYRILLIC SMALL LETTER SHHA */ \
   OP(L'Ә', LSHIFT(Key_O)) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', Key_O) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ө', LSHIFT(Key_W)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_W) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
   OP(L'₽', RALT(Key_8)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_EN_descender, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_Cyrillic_O_bar, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_SCHWA, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_SHCHA, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Cyrillic_SHHA, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_ZHE_descender, LSHIFT(Key_M)) \
   ...
   OP(XKB_KEY_Cyrillic_en_descender, Key_Semicolon) \
   ...
   OP(XKB_KEY_Cyrillic_o_bar, Key_W) \
   OP(XKB_KEY_Cyrillic_pe, Key_G) \
   OP(XKB_KEY_Cyrillic_schwa, Key_O) \
   OP(XKB_KEY_Cyrillic_sha, Key_I) \
   OP(XKB_KEY_Cyrillic_shcha, RALT(Key_O)) \
   OP(XKB_KEY_Cyrillic_shha, Key_Backtick) \
   ...
   OP(XKB_KEY_Cyrillic_u_straight, Key_RightBracket) \
   ...
   OP(XKB_KEY_Cyrillic_zhe_descender, Key_M) \
