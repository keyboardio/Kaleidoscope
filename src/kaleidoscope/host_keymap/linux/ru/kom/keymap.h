...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'І', RALT(LSHIFT(Key_B))) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   ...
   OP(L'і', RALT(Key_B)) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ӧ', RALT(LSHIFT(Key_J))) \
   OP(L'ӧ', RALT(Key_J)) \
   OP(L'₽', RALT(Key_8)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ukrainian_I, RALT(LSHIFT(Key_B))) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_i, RALT(Key_B)) /* XKB_KEY_Ukranian_i, deprecated  */ \
