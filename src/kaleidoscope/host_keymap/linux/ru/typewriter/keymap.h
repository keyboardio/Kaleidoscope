...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', Key_4) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('%', Key_0) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('(', LSHIFT(Key_NonUsPound)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', Key_NonUsPound) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(';', Key_Equals) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('=', LSHIFT(Key_Minus)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('?', Key_9) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP('\\', LSHIFT(Key_Equals)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', Key_4) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'%', Key_0) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'(', LSHIFT(Key_NonUsPound)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', Key_NonUsPound) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L';', Key_Equals) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'=', LSHIFT(Key_Minus)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'?', Key_9) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP(L'\\', LSHIFT(Key_Equals)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'Ё', LSHIFT(Key_Slash)) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   ...
   OP(L'ё', Key_Slash) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'№', Key_1) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_IO, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_Cyrillic_io, Key_Slash) \
   ...
   OP(XKB_KEY_backslash, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_numerosign, Key_1) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_parenright, Key_NonUsPound) \
   OP(XKB_KEY_percent, Key_0) \
   OP(XKB_KEY_period, Key_7) \
   OP(XKB_KEY_plus, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_question, Key_9) \
   OP(XKB_KEY_quotedbl, Key_4) \
   OP(XKB_KEY_semicolon, Key_Equals) \
