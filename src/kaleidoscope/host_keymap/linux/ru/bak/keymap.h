...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', LSHIFT(Key_Minus)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP('?', Key_9) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', LSHIFT(Key_Minus)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP(L'?', Key_9) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'Ғ', LSHIFT(Key_4)) /* U+0492, XKB_KEY_Cyrillic_GHE_bar, CYRILLIC CAPITAL LETTER GHE WITH STROKE */ \
   OP(L'ғ', Key_4) /* U+0493, XKB_KEY_Cyrillic_ghe_bar, CYRILLIC SMALL LETTER GHE WITH STROKE */ \
   OP(L'Ҙ', LSHIFT(Key_7)) \
   OP(L'ҙ', Key_7) \
   OP(L'Ҡ', LSHIFT(Key_3)) \
   OP(L'ҡ', Key_3) \
   OP(L'Ң', LSHIFT(Key_NonUsPound)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_NonUsPound) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ҫ', LSHIFT(Key_5)) \
   OP(L'ҫ', Key_5) \
   OP(L'Ү', LSHIFT(Key_Equals)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_Equals) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   ...
   OP(L'Ә', LSHIFT(Key_Backtick)) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', Key_Backtick) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ө', LSHIFT(Key_2)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_2) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
   OP(L'№', Key_0) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_O_bar, LSHIFT(Key_2)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_SCHWA, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_Cyrillic_o_bar, Key_2) \
   OP(XKB_KEY_Cyrillic_pe, Key_G) \
   OP(XKB_KEY_Cyrillic_schwa, Key_Backtick) \
   ...
   OP(XKB_KEY_Cyrillic_u_straight, Key_Equals) \
