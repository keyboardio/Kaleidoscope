...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', LSHIFT(Key_4)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP('?', LSHIFT(Key_NonUsPound)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', LSHIFT(Key_4)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP(L'?', LSHIFT(Key_NonUsPound)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'Ë', LSHIFT(Key_Slash)) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'ë', Key_Slash) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ediaeresis, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_ediaeresis, Key_Slash) \
