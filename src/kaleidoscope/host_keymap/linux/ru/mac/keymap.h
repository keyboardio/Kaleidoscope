...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('[', LSHIFT(Key_Backtick)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'[', LSHIFT(Key_Backtick)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   ...
   OP(L'Ё', LSHIFT(Key_NonUsPound)) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   ...
   OP(L'ё', Key_NonUsPound) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'₽', RALT(Key_H)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_IO, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Cyrillic_io, Key_NonUsPound) \
   ...
   OP(XKB_KEY_bracketleft, LSHIFT(Key_Backtick)) \
