...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('$', RALT(Key_W)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   ...
   OP('*', Key_5) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   ...
   OP(':', LSHIFT(Key_0)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', Key_0) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('?', Key_1) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'$', RALT(Key_W)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   ...
   OP(L'*', Key_5) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   ...
   OP(L':', LSHIFT(Key_0)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', Key_0) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'?', Key_1) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'Ё', RALT(LSHIFT(Key_Backtick))) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   ...
   OP(L'ё', RALT(Key_Backtick)) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'Җ', LSHIFT(Key_9)) /* U+0496, XKB_KEY_Cyrillic_ZHE_descender, CYRILLIC CAPITAL LETTER ZHE WITH DESCENDER */ \
   OP(L'җ', Key_9) /* U+0497, XKB_KEY_Cyrillic_zhe_descender, CYRILLIC SMALL LETTER ZHE WITH DESCENDER */ \
   OP(L'Ң', LSHIFT(Key_6)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_6) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ү', LSHIFT(Key_3)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_3) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   OP(L'Һ', LSHIFT(Key_8)) /* U+04ba, XKB_KEY_Cyrillic_SHHA, CYRILLIC CAPITAL LETTER SHHA */ \
   OP(L'һ', Key_8) /* U+04bb, XKB_KEY_Cyrillic_shha, CYRILLIC SMALL LETTER SHHA */ \
   OP(L'Ә', LSHIFT(Key_4)) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', Key_4) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ө', LSHIFT(Key_7)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_7) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
   OP(L'€', RALT(Key_E)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'№', Key_2) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_EN_descender, LSHIFT(Key_6)) \
   ...
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_3)) \
   ...
   OP(XKB_KEY_Cyrillic_ZHE_descender, LSHIFT(Key_9)) \
   ...
   OP(XKB_KEY_Cyrillic_en_descender, Key_6) \
   ...
   OP(XKB_KEY_Cyrillic_u_straight, Key_3) \
   ...
   OP(XKB_KEY_Cyrillic_zhe_descender, Key_9) \
