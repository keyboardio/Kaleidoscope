...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ђ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'Ј', RALT(LSHIFT(Key_Q))) \
   OP(L'Љ', RALT(LSHIFT(Key_K))) \
   OP(L'Њ', RALT(LSHIFT(Key_Y))) \
   OP(L'Ћ', RALT(LSHIFT(Key_X))) \
   OP(L'Џ', RALT(LSHIFT(Key_L))) \
