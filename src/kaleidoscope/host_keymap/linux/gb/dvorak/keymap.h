...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('@', LSHIFT(Key_Q)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'@', LSHIFT(Key_Q)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'â', RALT(Key_Z)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'ä', RALT(Key_W)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ç', RALT(Key_I)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', RALT(Key_C)) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   ...
   OP(L'î', RALT(Key_G)) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ï', RALT(Key_B)) /* U+00ef, XKB_KEY_idiaeresis, LATIN SMALL LETTER I WITH DIAERESIS */ \
   OP(L'ô', RALT(Key_S)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'ö', RALT(Key_X)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ù', RALT(Key_V)) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'û', RALT(Key_F)) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acircumflex, RALT(Key_Z)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_W)) \
   ...
   OP(XKB_KEY_d, Key_H) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_I))) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_acute, RALT(Key_Q)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_W))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_R))) /* XKB_KEY_dead_cedilla */ \
   ...
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_icircumflex, RALT(Key_G)) \
   OP(XKB_KEY_idiaeresis, RALT(Key_B)) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   ...
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_ocircumflex, RALT(Key_S)) \
   ...
   OP(XKB_KEY_u, Key_F) \
   OP(XKB_KEY_ucircumflex, RALT(Key_F)) \
   OP(XKB_KEY_udiaeresis, RALT(Key_T)) \
   OP(XKB_KEY_ugrave, RALT(Key_V)) \
