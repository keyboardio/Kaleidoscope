...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ẃ', RALT(LSHIFT(Key_W))) /* U+1e82, XKB_KEY_Wacute, LATIN CAPITAL LETTER W WITH ACUTE */ \
   OP(L'ẃ', RALT(Key_W)) /* U+1e83, XKB_KEY_wacute, LATIN SMALL LETTER W WITH ACUTE */ \
   ...
   OP(L'⅓', RALT(LSHIFT(Key_3))) /* U+2153, XKB_KEY_onethird, VULGAR FRACTION ONE THIRD */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Wacute, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(Key_2)) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_onethird, RALT(LSHIFT(Key_3))) \
