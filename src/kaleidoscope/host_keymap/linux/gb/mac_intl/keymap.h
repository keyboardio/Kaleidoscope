...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'±', LSHIFT(Key_Backtick)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'²', RALT(Key_3)) /* U+00b2, XKB_KEY_twosuperior, SUPERSCRIPT TWO */ \
   OP(L'³', RALT(Key_4)) /* U+00b3, XKB_KEY_threesuperior, SUPERSCRIPT THREE */ \
   ...
   OP(L'€', RALT(Key_2)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EuroSign, RALT(Key_2)) \
   ...
   OP(XKB_KEY_dead_grave, Key_NonUsBackslashAndPipe) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_plusminus, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_q, Key_Q) \
   ...
   OP(XKB_KEY_threesuperior, RALT(Key_4)) \
   OP(XKB_KEY_trademark, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_tslash, RALT(Key_T)) \
   OP(XKB_KEY_twosuperior, RALT(Key_3)) \
   OP(XKB_KEY_u, Key_U) \
