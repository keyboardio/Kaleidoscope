...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('|', RALT(Key_Backtick)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'|', RALT(Key_Backtick)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Multi_key, LSHIFT(Key_RightAlt)) /* XKB_KEY_Multi_key, Multi-key character compose  */ \
   ...
   OP(XKB_KEY_bar, RALT(Key_Backtick)) \
   ...
   OP(XKB_KEY_dead_circumflex, RALT(Key_Quote)) /* XKB_KEY_dead_circumflex */ \
