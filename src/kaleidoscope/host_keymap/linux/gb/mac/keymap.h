...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', Key_NonUsBackslashAndPipe) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', Key_NonUsBackslashAndPipe) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Shift, Key_KeypadEnter) /* XKB_KEY_ISO_Level3_Shift */ \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, Key_NonUsBackslashAndPipe) /* XKB_KEY_quoteleft, deprecated  */ \
