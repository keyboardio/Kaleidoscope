...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'⅙', RALT(LSHIFT(Key_6))) /* U+2159, XKB_KEY_onesixth, VULGAR FRACTION ONE SIXTH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_diaeresis, LSHIFT(Key_2)) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_onesixth, RALT(LSHIFT(Key_6))) \
