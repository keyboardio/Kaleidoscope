...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', RALT(Key_KeypadDot)) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP('<', LSHIFT(Key_Period)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', RALT(Key_KeypadDot)) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(L'<', LSHIFT(Key_Period)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   ...
   OP(L'«', LSHIFT(Key_S)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'»', LSHIFT(Key_A)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'ء', LSHIFT(Key_V)) /* U+0621, XKB_KEY_Arabic_hamza, ARABIC LETTER HAMZA */ \
   OP(L'آ', LSHIFT(Key_H)) /* U+0622, XKB_KEY_Arabic_maddaonalef, ARABIC LETTER ALEF WITH MADDA ABOVE */ \
   OP(L'أ', LSHIFT(Key_B)) /* U+0623, XKB_KEY_Arabic_hamzaonalef, ARABIC LETTER ALEF WITH HAMZA ABOVE */ \
   OP(L'ؤ', LSHIFT(Key_M)) /* U+0624, XKB_KEY_Arabic_hamzaonwaw, ARABIC LETTER WAW WITH HAMZA ABOVE */ \
   OP(L'إ', LSHIFT(Key_N)) /* U+0625, XKB_KEY_Arabic_hamzaunderalef, ARABIC LETTER ALEF WITH HAMZA BELOW */ \
   OP(L'ئ', LSHIFT(Key_C)) /* U+0626, XKB_KEY_Arabic_hamzaonyeh, ARABIC LETTER YEH WITH HAMZA ABOVE */ \
   OP(L'ا', Key_H) /* U+0627, XKB_KEY_Arabic_alef, ARABIC LETTER ALEF */ \
   OP(L'ب', Key_F) /* U+0628, XKB_KEY_Arabic_beh, ARABIC LETTER BEH */ \
   OP(L'ة', Key_RightBracket) /* U+0629, XKB_KEY_Arabic_tehmarbuta, ARABIC LETTER TEH MARBUTA */ \
   ...
   OP(L'د', Key_V) /* U+062f, XKB_KEY_Arabic_dal, ARABIC LETTER DAL */ \
   OP(L'ذ', Key_C) /* U+0630, XKB_KEY_Arabic_thal, ARABIC LETTER THAL */ \
   OP(L'ر', Key_N) /* U+0631, XKB_KEY_Arabic_ra, ARABIC LETTER REH */ \
   OP(L'ز', Key_B) /* U+0632, XKB_KEY_Arabic_zain, ARABIC LETTER ZAIN */ \
   ...
   OP(L'ـ', Key_Backtick) /* U+0640, XKB_KEY_Arabic_tatweel, ARABIC TATWEEL */ \
   ...
   OP(L'و', Key_M) /* U+0648, XKB_KEY_Arabic_waw, ARABIC LETTER WAW */ \
   OP(L'ى', LSHIFT(Key_D)) /* U+0649, XKB_KEY_Arabic_alefmaksura, ARABIC LETTER ALEF MAKSURA */ \
   ...
   OP(L'ٌ', LSHIFT(Key_Y)) /* U+064c, XKB_KEY_Arabic_dammatan, ARABIC DAMMATAN */ \
   OP(L'ٍ', LSHIFT(Key_R)) /* U+064d, XKB_KEY_Arabic_kasratan, ARABIC KASRATAN */ \
   OP(L'َ', LSHIFT(Key_Q)) /* U+064e, XKB_KEY_Arabic_fatha, ARABIC FATHA */ \
   OP(L'ُ', LSHIFT(Key_T)) /* U+064f, XKB_KEY_Arabic_damma, ARABIC DAMMA */ \
   OP(L'ِ', LSHIFT(Key_E)) /* U+0650, XKB_KEY_Arabic_kasra, ARABIC KASRA */ \
   OP(L'ّ', LSHIFT(Key_I)) /* U+0651, XKB_KEY_Arabic_shadda, ARABIC SHADDA */ \
   OP(L'ْ', LSHIFT(Key_U)) /* U+0652, XKB_KEY_Arabic_sukun, ARABIC SUKUN */ \
   ...
   OP(L'٬', RALT(Key_Comma)) \
   OP(L'٭', RALT(Key_Slash)) \
   OP(L'ٰ', LSHIFT(Key_F)) /* U+0670, XKB_KEY_Arabic_superscript_alef, ARABIC LETTER SUPERSCRIPT ALEF */ \
   OP(L'ٱ', RALT(Key_H)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_hamza, LSHIFT(Key_V)) \
   OP(XKB_KEY_Arabic_hamzaonalef, LSHIFT(Key_B)) \
   OP(XKB_KEY_Arabic_hamzaonwaw, LSHIFT(Key_M)) \
   OP(XKB_KEY_Arabic_hamzaonyeh, LSHIFT(Key_C)) \
   OP(XKB_KEY_Arabic_hamzaunderalef, LSHIFT(Key_N)) \
   OP(XKB_KEY_Arabic_jeem, Key_LeftBracket) \
   OP(XKB_KEY_Arabic_jeh, RALT(Key_Period)) \
   OP(XKB_KEY_Arabic_kaf, Key_Semicolon) \
   OP(XKB_KEY_Arabic_kasra, LSHIFT(Key_E)) \
   OP(XKB_KEY_Arabic_kasratan, LSHIFT(Key_R)) \
   ...
   OP(XKB_KEY_comma, RALT(Key_KeypadDot)) \
   ...
   OP(XKB_KEY_guillemotleft, LSHIFT(Key_S)) \
   OP(XKB_KEY_guillemotright, LSHIFT(Key_A)) \
   OP(XKB_KEY_less, LSHIFT(Key_Period)) \
