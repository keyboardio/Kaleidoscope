...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(';', LSHIFT(Key_P)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('?', Key_N) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP('@', LSHIFT(Key_2)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   OP('[', LSHIFT(Key_D)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', Key_NonUsPound) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', LSHIFT(Key_F)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP('{', LSHIFT(Key_C)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', Key_NonUsBackslashAndPipe) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', LSHIFT(Key_V)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L';', LSHIFT(Key_P)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'?', Key_N) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP(L'@', LSHIFT(Key_2)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   OP(L'[', LSHIFT(Key_D)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', Key_NonUsPound) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', LSHIFT(Key_F)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP(L'{', LSHIFT(Key_C)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', Key_NonUsBackslashAndPipe) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', LSHIFT(Key_V)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'«', LSHIFT(Key_Z)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'·', LSHIFT(Key_Slash)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'ʼ', Key_M) \
   OP(L'–', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   ...
   OP(L'𐎀', Key_H) \
   OP(L'𐎁', Key_F) \
   OP(L'𐎂', Key_LeftBracket) \
   OP(L'𐎃', Key_O) \
   OP(L'𐎄', Key_RightBracket) \
   OP(L'𐎅', Key_I) \
   OP(L'𐎆', Key_Comma) \
   OP(L'𐎇', Key_Period) \
   OP(L'𐎈', Key_P) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_braceleft, LSHIFT(Key_C)) \
   OP(XKB_KEY_braceright, LSHIFT(Key_V)) \
   OP(XKB_KEY_bracketleft, LSHIFT(Key_D)) \
   OP(XKB_KEY_bracketright, LSHIFT(Key_F)) \
   ...
   OP(XKB_KEY_endash, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_guillemotleft, LSHIFT(Key_Z)) \
   ...
   OP(XKB_KEY_periodcentered, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_plus, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_question, Key_N) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_P)) \
