...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('&', LSHIFT(Key_G)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   ...
   OP('<', LSHIFT(Key_S)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', LSHIFT(Key_A)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('^', LSHIFT(Key_B)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'&', LSHIFT(Key_G)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   ...
   OP(L'<', LSHIFT(Key_S)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', LSHIFT(Key_A)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'^', LSHIFT(Key_B)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'£', LSHIFT(Key_6)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   ...
   OP(L'ٍ', LSHIFT(Key_V)) /* U+064d, XKB_KEY_Arabic_kasratan, ARABIC KASRATAN */ \
   OP(L'َ', LSHIFT(Key_Q)) /* U+064e, XKB_KEY_Arabic_fatha, ARABIC FATHA */ \
   OP(L'ُ', LSHIFT(Key_E)) /* U+064f, XKB_KEY_Arabic_damma, ARABIC DAMMA */ \
   OP(L'ِ', LSHIFT(Key_C)) /* U+0650, XKB_KEY_Arabic_kasra, ARABIC KASRA */ \
   OP(L'ّ', LSHIFT(Key_T)) /* U+0651, XKB_KEY_Arabic_shadda, ARABIC SHADDA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_kasra, LSHIFT(Key_C)) \
   OP(XKB_KEY_Arabic_kasratan, LSHIFT(Key_V)) \
   ...
   OP(XKB_KEY_Arabic_shadda, LSHIFT(Key_T)) \
   ...
   OP(XKB_KEY_sterling, LSHIFT(Key_6)) \
