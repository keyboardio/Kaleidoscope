...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ؠ', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   ...
   OP(L'٘', RALT(LSHIFT(Key_G))) \
   OP(L'٠', RALT(Key_0)) /* U+0660, XKB_KEY_Arabic_0, ARABIC-INDIC DIGIT ZERO */ \
   OP(L'١', RALT(Key_1)) /* U+0661, XKB_KEY_Arabic_1, ARABIC-INDIC DIGIT ONE */ \
   OP(L'٢', RALT(Key_2)) /* U+0662, XKB_KEY_Arabic_2, ARABIC-INDIC DIGIT TWO */ \
   OP(L'٣', RALT(Key_3)) /* U+0663, XKB_KEY_Arabic_3, ARABIC-INDIC DIGIT THREE */ \
   OP(L'٤', RALT(Key_4)) /* U+0664, XKB_KEY_Arabic_4, ARABIC-INDIC DIGIT FOUR */ \
   OP(L'٥', RALT(Key_5)) /* U+0665, XKB_KEY_Arabic_5, ARABIC-INDIC DIGIT FIVE */ \
   OP(L'٦', RALT(Key_6)) /* U+0666, XKB_KEY_Arabic_6, ARABIC-INDIC DIGIT SIX */ \
   OP(L'٧', RALT(Key_7)) /* U+0667, XKB_KEY_Arabic_7, ARABIC-INDIC DIGIT SEVEN */ \
   OP(L'٨', RALT(Key_8)) /* U+0668, XKB_KEY_Arabic_8, ARABIC-INDIC DIGIT EIGHT */ \
   OP(L'٩', RALT(Key_9)) /* U+0669, XKB_KEY_Arabic_9, ARABIC-INDIC DIGIT NINE */ \
   OP(L'٪', RALT(Key_Backtick)) /* U+066a, XKB_KEY_Arabic_percent, ARABIC PERCENT SIGN */ \
   OP(L'٫', RALT(Key_K)) \
   OP(L'٬', RALT(Key_Comma)) \
   OP(L'ٰ', RALT(Key_N)) /* U+0670, XKB_KEY_Arabic_superscript_alef, ARABIC LETTER SUPERSCRIPT ALEF */ \
   OP(L'ٱ', RALT(Key_H)) \
   OP(L'ٷ', RALT(LSHIFT(Key_C))) \
   OP(L'ٹ', RALT(Key_Slash)) /* U+0679, XKB_KEY_Arabic_tteh, ARABIC LETTER TTEH */ \
   OP(L'ٺ', RALT(LSHIFT(Key_J))) \
   OP(L'ٻ', RALT(LSHIFT(Key_F))) \
   OP(L'ټ', RALT(Key_S)) \
   OP(L'ٽ', RALT(Key_J)) \
   OP(L'پ', RALT(Key_F)) /* U+067e, XKB_KEY_Arabic_peh, ARABIC LETTER PEH */ \
   OP(L'ٿ', RALT(Key_E)) \
   OP(L'ڀ', RALT(LSHIFT(Key_S))) \
   OP(L'ځ', RALT(Key_O)) \
   OP(L'ڃ', RALT(Key_P)) \
   OP(L'ڄ', RALT(Key_RightBracket)) \
   OP(L'څ', RALT(Key_Y)) \
   OP(L'چ', RALT(Key_LeftBracket)) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڇ', RALT(LSHIFT(Key_O))) \
   OP(L'ڈ', RALT(LSHIFT(Key_Backtick))) /* U+0688, XKB_KEY_Arabic_ddal, ARABIC LETTER DDAL */ \
   OP(L'ډ', RALT(Key_Q)) \
   OP(L'ڍ', RALT(LSHIFT(Key_T))) \
   OP(L'ڑ', LSHIFT(Key_U)) /* U+0691, XKB_KEY_Arabic_rreh, ARABIC LETTER RREH */ \
   OP(L'ړ', RALT(Key_V)) \
   OP(L'ږ', RALT(LSHIFT(Key_Period))) \
   OP(L'ژ', RALT(Key_Period)) /* U+0698, XKB_KEY_Arabic_jeh, ARABIC LETTER JEH */ \
   OP(L'ڙ', RALT(LSHIFT(Key_V))) \
   OP(L'ڤ', RALT(Key_T)) /* U+06a4, XKB_KEY_Arabic_veh, ARABIC LETTER VEH */ \
   OP(L'ڦ', RALT(Key_R)) \
   OP(L'ک', RALT(LSHIFT(Key_Semicolon))) /* U+06a9, XKB_KEY_Arabic_keheh, ARABIC LETTER KEHEH */ \
   OP(L'ڪ', RALT(LSHIFT(Key_M))) \
   OP(L'ګ', RALT(Key_B)) \
   OP(L'ڭ', RALT(LSHIFT(Key_B))) \
   OP(L'گ', RALT(Key_Semicolon)) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
   OP(L'ڱ', RALT(LSHIFT(Key_L))) \
   OP(L'ڳ', RALT(Key_L)) \
   OP(L'ں', RALT(LSHIFT(Key_H))) /* U+06ba, XKB_KEY_Arabic_noon_ghunna, ARABIC LETTER NOON GHUNNA */ \
   OP(L'ڻ', RALT(LSHIFT(Key_K))) \
   OP(L'ھ', RALT(Key_I)) /* U+06be, XKB_KEY_Arabic_heh_doachashmee, ARABIC LETTER HEH DOACHASHMEE */ \
   OP(L'ۀ', RALT(Key_NonUsBackslashAndPipe)) \
   OP(L'ہ', RALT(Key_U)) /* U+06c1, XKB_KEY_Arabic_heh_goal, ARABIC LETTER HEH GOAL */ \
   OP(L'ۆ', RALT(Key_A)) \
   OP(L'ۇ', RALT(Key_C)) \
   OP(L'ۉ', RALT(LSHIFT(Key_A))) \
   OP(L'ۋ', RALT(LSHIFT(Key_Comma))) \
   OP(L'ی', LSHIFT(Key_6)) /* U+06cc, XKB_KEY_Farsi_yeh, ARABIC LETTER FARSI YEH */ \
   OP(L'ۍ', RALT(LSHIFT(Key_D))) \
   OP(L'ې', RALT(Key_D)) \
   OP(L'ے', RALT(LSHIFT(Key_N))) /* U+06d2, XKB_KEY_Arabic_yeh_baree, ARABIC LETTER YEH BARREE */ \
   OP(L'۔', RALT(Key_M)) /* U+06d4, XKB_KEY_Arabic_fullstop, ARABIC FULL STOP */ \
   OP(L'ە', RALT(Key_W)) \
   OP(L'۰', RALT(LSHIFT(Key_0))) /* U+06f0, XKB_KEY_Farsi_0, EXTENDED ARABIC-INDIC DIGIT ZERO */ \
   OP(L'۱', RALT(LSHIFT(Key_1))) /* U+06f1, XKB_KEY_Farsi_1, EXTENDED ARABIC-INDIC DIGIT ONE */ \
   OP(L'۲', RALT(LSHIFT(Key_2))) /* U+06f2, XKB_KEY_Farsi_2, EXTENDED ARABIC-INDIC DIGIT TWO */ \
   OP(L'۳', RALT(LSHIFT(Key_3))) /* U+06f3, XKB_KEY_Farsi_3, EXTENDED ARABIC-INDIC DIGIT THREE */ \
   OP(L'۴', RALT(LSHIFT(Key_4))) /* U+06f4, XKB_KEY_Farsi_4, EXTENDED ARABIC-INDIC DIGIT FOUR */ \
   OP(L'۵', RALT(LSHIFT(Key_5))) /* U+06f5, XKB_KEY_Farsi_5, EXTENDED ARABIC-INDIC DIGIT FIVE */ \
   OP(L'۶', RALT(LSHIFT(Key_6))) /* U+06f6, XKB_KEY_Farsi_6, EXTENDED ARABIC-INDIC DIGIT SIX */ \
   OP(L'۷', RALT(LSHIFT(Key_7))) /* U+06f7, XKB_KEY_Farsi_7, EXTENDED ARABIC-INDIC DIGIT SEVEN */ \
   OP(L'۸', RALT(LSHIFT(Key_8))) /* U+06f8, XKB_KEY_Farsi_8, EXTENDED ARABIC-INDIC DIGIT EIGHT */ \
   OP(L'۹', RALT(LSHIFT(Key_9))) /* U+06f9, XKB_KEY_Farsi_9, EXTENDED ARABIC-INDIC DIGIT NINE */ \
   OP(L'ݪ', RALT(Key_G)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_0, RALT(Key_0)) \
   OP(XKB_KEY_Arabic_1, RALT(Key_1)) \
   OP(XKB_KEY_Arabic_2, RALT(Key_2)) \
   OP(XKB_KEY_Arabic_3, RALT(Key_3)) \
   OP(XKB_KEY_Arabic_4, RALT(Key_4)) \
   OP(XKB_KEY_Arabic_5, RALT(Key_5)) \
   OP(XKB_KEY_Arabic_6, RALT(Key_6)) \
   OP(XKB_KEY_Arabic_7, RALT(Key_7)) \
   OP(XKB_KEY_Arabic_8, RALT(Key_8)) \
   OP(XKB_KEY_Arabic_9, RALT(Key_9)) \
   ...
   OP(XKB_KEY_Arabic_heh_doachashmee, RALT(Key_I)) \
   OP(XKB_KEY_Arabic_heh_goal, RALT(Key_U)) \
   ...
   OP(XKB_KEY_Arabic_keheh, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Farsi_0, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_Farsi_1, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_Farsi_2, RALT(LSHIFT(Key_2))) \
   OP(XKB_KEY_Farsi_3, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_Farsi_4, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_Farsi_5, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_Farsi_6, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_Farsi_7, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_Farsi_8, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_Farsi_9, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_Farsi_yeh, LSHIFT(Key_6)) \
