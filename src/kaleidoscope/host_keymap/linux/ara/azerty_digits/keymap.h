...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'٠', LSHIFT(Key_0)) /* U+0660, XKB_KEY_Arabic_0, ARABIC-INDIC DIGIT ZERO */ \
   OP(L'١', LSHIFT(Key_1)) /* U+0661, XKB_KEY_Arabic_1, ARABIC-INDIC DIGIT ONE */ \
   OP(L'٢', LSHIFT(Key_2)) /* U+0662, XKB_KEY_Arabic_2, ARABIC-INDIC DIGIT TWO */ \
   OP(L'٣', LSHIFT(Key_3)) /* U+0663, XKB_KEY_Arabic_3, ARABIC-INDIC DIGIT THREE */ \
   OP(L'٤', LSHIFT(Key_4)) /* U+0664, XKB_KEY_Arabic_4, ARABIC-INDIC DIGIT FOUR */ \
   OP(L'٥', LSHIFT(Key_5)) /* U+0665, XKB_KEY_Arabic_5, ARABIC-INDIC DIGIT FIVE */ \
   OP(L'٦', LSHIFT(Key_6)) /* U+0666, XKB_KEY_Arabic_6, ARABIC-INDIC DIGIT SIX */ \
   OP(L'٧', LSHIFT(Key_7)) /* U+0667, XKB_KEY_Arabic_7, ARABIC-INDIC DIGIT SEVEN */ \
   OP(L'٨', LSHIFT(Key_8)) /* U+0668, XKB_KEY_Arabic_8, ARABIC-INDIC DIGIT EIGHT */ \
   OP(L'٩', LSHIFT(Key_9)) /* U+0669, XKB_KEY_Arabic_9, ARABIC-INDIC DIGIT NINE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_0, LSHIFT(Key_0)) \
   OP(XKB_KEY_Arabic_1, LSHIFT(Key_1)) \
   OP(XKB_KEY_Arabic_2, LSHIFT(Key_2)) \
   OP(XKB_KEY_Arabic_3, LSHIFT(Key_3)) \
   OP(XKB_KEY_Arabic_4, LSHIFT(Key_4)) \
   OP(XKB_KEY_Arabic_5, LSHIFT(Key_5)) \
   OP(XKB_KEY_Arabic_6, LSHIFT(Key_6)) \
   OP(XKB_KEY_Arabic_7, LSHIFT(Key_7)) \
   OP(XKB_KEY_Arabic_8, LSHIFT(Key_8)) \
   OP(XKB_KEY_Arabic_9, LSHIFT(Key_9)) \
