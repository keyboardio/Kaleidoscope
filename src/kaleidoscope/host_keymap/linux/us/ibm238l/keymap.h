...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('<', Key_Backtick) /* U+003c, XKB_KEY_leftcaret, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', LSHIFT(Key_Backtick)) /* U+003e, XKB_KEY_rightcaret, GREATER-THAN SIGN */ \
   ...
   OP('`', Key_NonUsPound) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'<', Key_Backtick) /* U+003c, XKB_KEY_leftcaret, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', LSHIFT(Key_Backtick)) /* U+003e, XKB_KEY_rightcaret, GREATER-THAN SIGN */ \
   ...
   OP(L'`', Key_NonUsPound) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, Key_NonUsPound) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftcaret, Key_Backtick) \
   OP(XKB_KEY_m, Key_M) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightcaret, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_s, Key_S) \
