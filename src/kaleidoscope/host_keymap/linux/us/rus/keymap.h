...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ю', LSHIFT(Key_Quote)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   ...
   OP(L'ю', Key_Quote) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_yu, Key_Quote) \
