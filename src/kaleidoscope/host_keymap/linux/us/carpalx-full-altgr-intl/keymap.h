...
// layout: us
// variant: carpalx-full-altgr-intl
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¼', RALT(LSHIFT(Key_6))) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(LSHIFT(Key_7))) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(LSHIFT(Key_8))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_circumflex, RALT(Key_6)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_2))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Backtick)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(LSHIFT(Key_Slash))) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(Key_7)) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(LSHIFT(Key_3))) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_8)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_Backtick))) /* XKB_KEY_dead_tilde */ \
   ...
   OP(XKB_KEY_onehalf, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_onequarter, RALT(LSHIFT(Key_6))) \
   ...
   OP(XKB_KEY_threequarters, RALT(LSHIFT(Key_8))) \
...
namespace linux {
namespace us {
namespace carpalx_full_altgr_intl {
