...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'°', RALT(LSHIFT(Key_Semicolon))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'¶', RALT(Key_Semicolon)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   ...
   OP(L'Ë', RALT(LSHIFT(Key_R))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Í', RALT(LSHIFT(Key_I))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ï', RALT(LSHIFT(Key_J))) /* U+00cf, XKB_KEY_Idiaeresis, LATIN CAPITAL LETTER I WITH DIAERESIS */ \
   ...
   OP(L'Ü', RALT(LSHIFT(Key_Y))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'ë', RALT(Key_R)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'í', RALT(Key_I)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ï', RALT(Key_J)) /* U+00ef, XKB_KEY_idiaeresis, LATIN SMALL LETTER I WITH DIAERESIS */ \
   ...
   OP(L'ü', RALT(Key_Y)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'þ', RALT(Key_T)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'Œ', RALT(LSHIFT(Key_K))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_K)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Idiaeresis, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_K))) \
   ...
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_udiaeresis, RALT(Key_Y)) \
