...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('B', LSHIFT(Key_O)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   ...
   OP('F', LSHIFT(Key_U)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP('b', Key_O) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   ...
   OP('f', Key_U) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'B', LSHIFT(Key_O)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   ...
   OP(L'F', LSHIFT(Key_U)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP(L'b', Key_O) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   ...
   OP(L'f', Key_U) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
