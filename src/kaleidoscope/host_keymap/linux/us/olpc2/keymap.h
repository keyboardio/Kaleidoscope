...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'£', RALT(Key_H)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¤', RALT(Key_Quote)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¦', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', RALT(Key_NonUsPound)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'ª', RALT(LSHIFT(Key_Semicolon))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_Comma)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_2)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'º', RALT(Key_Semicolon)) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_W))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   ...
   OP(L'ø', RALT(Key_W)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   ...
   OP(L'̭', RALT(Key_U)) \
   OP(L'̮', RALT(Key_T)) \
   OP(L'̰', RALT(Key_RightBracket)) \
   OP(L'̱', RALT(Key_LeftBracket)) \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'ω', RALT(Key_Q)) /* U+03c9, XKB_KEY_Greek_omega, GREEK SMALL LETTER OMEGA */ \
   OP(L'ẜ', RALT(LSHIFT(Key_S))) \
   OP(L'€', RALT(Key_J)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EuroSign, RALT(Key_J)) \
   ...
   OP(XKB_KEY_Greek_omega, RALT(Key_Q)) \
   ...
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_currency, RALT(Key_Quote)) \
   OP(XKB_KEY_d, Key_D) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, RALT(Key_Semicolon)) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_notsign, RALT(Key_2)) \
