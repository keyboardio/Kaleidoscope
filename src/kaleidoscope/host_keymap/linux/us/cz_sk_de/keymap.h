...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Á', RALT(LSHIFT(Key_8))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Ä', RALT(LSHIFT(Key_Quote))) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'É', RALT(LSHIFT(Key_0))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Í', RALT(LSHIFT(Key_9))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   ...
   OP(L'Ú', RALT(LSHIFT(Key_1))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ü', RALT(LSHIFT(Key_LeftBracket))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Ý', RALT(LSHIFT(Key_7))) /* U+00dd, XKB_KEY_Yacute, LATIN CAPITAL LETTER Y WITH ACUTE */ \
   OP(L'ß', RALT(Key_Minus)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'á', RALT(Key_8)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'ä', RALT(Key_Quote)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'é', RALT(Key_0)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'í', RALT(Key_9)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   ...
   OP(L'ú', RALT(Key_1)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ü', RALT(Key_LeftBracket)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ý', RALT(Key_7)) /* U+00fd, XKB_KEY_yacute, LATIN SMALL LETTER Y WITH ACUTE */ \
   OP(L'Č', RALT(LSHIFT(Key_4))) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', RALT(Key_4)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Ď', RALT(LSHIFT(Key_D))) /* U+010e, XKB_KEY_Dcaron, LATIN CAPITAL LETTER D WITH CARON */ \
   OP(L'ď', RALT(Key_D)) /* U+010f, XKB_KEY_dcaron, LATIN SMALL LETTER D WITH CARON */ \
   OP(L'Ě', RALT(LSHIFT(Key_2))) /* U+011a, XKB_KEY_Ecaron, LATIN CAPITAL LETTER E WITH CARON */ \
   OP(L'ě', RALT(Key_2)) /* U+011b, XKB_KEY_ecaron, LATIN SMALL LETTER E WITH CARON */ \
   OP(L'Ľ', RALT(LSHIFT(Key_L))) /* U+013d, XKB_KEY_Lcaron, LATIN CAPITAL LETTER L WITH CARON */ \
   OP(L'ľ', RALT(Key_L)) /* U+013e, XKB_KEY_lcaron, LATIN SMALL LETTER L WITH CARON */ \
   OP(L'Ň', RALT(LSHIFT(Key_N))) /* U+0147, XKB_KEY_Ncaron, LATIN CAPITAL LETTER N WITH CARON */ \
   OP(L'ň', RALT(Key_N)) /* U+0148, XKB_KEY_ncaron, LATIN SMALL LETTER N WITH CARON */ \
   OP(L'Ř', RALT(LSHIFT(Key_5))) /* U+0158, XKB_KEY_Rcaron, LATIN CAPITAL LETTER R WITH CARON */ \
   OP(L'ř', RALT(Key_5)) /* U+0159, XKB_KEY_rcaron, LATIN SMALL LETTER R WITH CARON */ \
   OP(L'Š', RALT(LSHIFT(Key_3))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_3)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ť', RALT(LSHIFT(Key_T))) /* U+0164, XKB_KEY_Tcaron, LATIN CAPITAL LETTER T WITH CARON */ \
   OP(L'ť', RALT(Key_T)) /* U+0165, XKB_KEY_tcaron, LATIN SMALL LETTER T WITH CARON */ \
   OP(L'Ů', RALT(LSHIFT(Key_U))) /* U+016e, XKB_KEY_Uring, LATIN CAPITAL LETTER U WITH RING ABOVE */ \
   OP(L'ů', RALT(Key_U)) /* U+016f, XKB_KEY_uring, LATIN SMALL LETTER U WITH RING ABOVE */ \
   OP(L'Ž', RALT(LSHIFT(Key_6))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_6)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'ẞ', RALT(LSHIFT(Key_Minus))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_8))) \
   ...
   OP(XKB_KEY_Ccaron, RALT(LSHIFT(Key_4))) \
   ...
   OP(XKB_KEY_Dcaron, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_Ecaron, RALT(LSHIFT(Key_2))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_9))) \
   ...
   OP(XKB_KEY_Lcaron, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Ncaron, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_Rcaron, RALT(LSHIFT(Key_5))) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_3))) \
   ...
   OP(XKB_KEY_Tcaron, RALT(LSHIFT(Key_T))) \
   OP(XKB_KEY_U, LSHIFT(Key_U)) \
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_Uring, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Yacute, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_Z, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, RALT(Key_8)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccaron, RALT(Key_4)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dcaron, RALT(Key_D)) \
   OP(XKB_KEY_dead_acute, RALT(Key_Equals)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_Equals))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, RALT(Key_0)) \
   OP(XKB_KEY_ecaron, RALT(Key_2)) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, RALT(Key_9)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_lcaron, RALT(Key_L)) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_ncaron, RALT(Key_N)) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rcaron, RALT(Key_5)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scaron, RALT(Key_3)) \
   OP(XKB_KEY_semicolon, Key_Semicolon) \
   OP(XKB_KEY_slash, Key_Slash) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_ssharp, RALT(Key_Minus)) \
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_tcaron, RALT(Key_T)) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, RALT(Key_1)) \
   OP(XKB_KEY_udiaeresis, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_uring, RALT(Key_U)) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yacute, RALT(Key_7)) \
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, RALT(Key_6)) \
