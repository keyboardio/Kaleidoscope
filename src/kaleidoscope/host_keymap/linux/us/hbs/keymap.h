...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', RALT(LSHIFT(Key_Period))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'÷', RALT(LSHIFT(Key_8))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   ...
   OP(L'ǅ', RALT(LSHIFT(Key_Z))) \
   OP(L'ǆ', RALT(Key_Z)) \
   OP(L'ǈ', RALT(LSHIFT(Key_L))) \
   OP(L'ǉ', RALT(Key_L)) \
   OP(L'ǋ', RALT(LSHIFT(Key_N))) \
   OP(L'ǌ', RALT(Key_N)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_caron, LSHIFT(Key_6)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_8))) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_Period))) \
