...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'̄', RALT(LSHIFT(Key_3))) \
   OP(L'̆', RALT(LSHIFT(Key_9))) \
   OP(L'̇', RALT(Key_Period)) \
   OP(L'̈', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'̉', RALT(LSHIFT(Key_Slash))) \
   OP(L'̊', RALT(LSHIFT(Key_0))) \
   OP(L'̋', RALT(Key_Equals)) \
   OP(L'̌', RALT(LSHIFT(Key_Comma))) \
   OP(L'̛', RALT(LSHIFT(Key_7))) \
   OP(L'̣', RALT(LSHIFT(Key_Minus))) \
   OP(L'̧', RALT(Key_Comma)) \
   OP(L'̨', RALT(Key_Semicolon)) \
