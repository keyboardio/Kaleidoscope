...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', RALT(LSHIFT(Key_Q))) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', RALT(LSHIFT(Key_Q))) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'¢', RALT(LSHIFT(Key_I))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'©', RALT(Key_I)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'«', RALT(Key_Minus)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_NonUsPound)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'®', RALT(Key_O)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', RALT(LSHIFT(Key_Z))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'¶', RALT(Key_Z)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'¹', RALT(LSHIFT(Key_1))) /* U+00b9, XKB_KEY_onesuperior, SUPERSCRIPT ONE */ \
   OP(L'»', RALT(Key_Equals)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Ä', RALT(LSHIFT(Key_X))) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Å', RALT(LSHIFT(Key_Comma))) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   OP(L'Æ', RALT(LSHIFT(Key_Slash))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ç', RALT(LSHIFT(Key_W))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'É', RALT(LSHIFT(Key_D))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Í', RALT(LSHIFT(Key_G))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ð', RALT(LSHIFT(Key_H))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ñ', RALT(LSHIFT(Key_L))) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   OP(L'Ó', RALT(LSHIFT(Key_S))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ö', RALT(LSHIFT(Key_R))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ø', RALT(LSHIFT(Key_P))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ú', RALT(LSHIFT(Key_F))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   ...
   OP(L'ä', RALT(Key_X)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', RALT(Key_Comma)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', RALT(Key_Slash)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_W)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'é', RALT(Key_D)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'í', RALT(Key_G)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ñ', RALT(Key_L)) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   OP(L'ó', RALT(Key_S)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ö', RALT(Key_R)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ø', RALT(Key_P)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ú', RALT(Key_F)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   ...
   OP(L'“', RALT(LSHIFT(Key_Minus))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_Equals))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_Adiaeresis, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Alt_L, Key_LeftAlt) /* XKB_KEY_Alt_L, Left alt  */ \
   OP(XKB_KEY_Aring, RALT(LSHIFT(Key_Comma))) \
   ...
   OP(XKB_KEY_Ccedilla, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_Ntilde, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_F))) \
   ...
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_ccedilla, RALT(Key_W)) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_colon, LSHIFT(Key_Z)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_copyright, RALT(Key_I)) \
   ...
   OP(XKB_KEY_dead_acute, Key_Q) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_9))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_E))) /* XKB_KEY_dead_caron */ \
   ...
   OP(XKB_KEY_dead_diaeresis, LSHIFT(Key_Q)) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_dead_hook, RALT(LSHIFT(Key_LeftBracket))) /* XKB_KEY_dead_hook */ \
   ...
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_eacute, RALT(Key_D)) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(Key_Minus)) \
   OP(XKB_KEY_guillemotright, RALT(Key_Equals)) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_iacute, RALT(Key_G)) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_Minus))) \
   ...
   OP(XKB_KEY_p, Key_R) \
   OP(XKB_KEY_paragraph, RALT(Key_Z)) \
   ...
   OP(XKB_KEY_quotedbl, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_r, Key_O) \
   OP(XKB_KEY_registered, RALT(Key_O)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_Equals))) \
