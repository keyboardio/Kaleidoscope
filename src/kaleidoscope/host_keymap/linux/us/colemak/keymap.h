...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ß', RALT(Key_D)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_circumflex, RALT(Key_X)) /* XKB_KEY_dead_circumflex */ \
