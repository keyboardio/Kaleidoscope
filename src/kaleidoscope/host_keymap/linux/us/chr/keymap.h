...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ꮂ', LSHIFT(Key_H)) \
   OP(L'Ꮃ', Key_W) \
   OP(L'Ꮄ', LSHIFT(Key_Period)) \
   OP(L'Ꮅ', Key_L) \
   OP(L'Ꮆ', Key_RightBracket) \
   OP(L'Ꮇ', LSHIFT(Key_M)) \
   OP(L'Ꮈ', Key_K) \
   OP(L'Ꮉ', LSHIFT(Key_5)) \
   OP(L'Ꮊ', LSHIFT(Key_8)) \
   OP(L'Ꮋ', LSHIFT(Key_N)) \
   OP(L'Ꮌ', LSHIFT(Key_Minus)) \
   OP(L'Ꮍ', LSHIFT(Key_Equals)) \
   OP(L'Ꮎ', Key_N) \
   OP(L'Ꮏ', Key_Minus) \
   OP(L'Ꮑ', Key_P) \
   OP(L'Ꮒ', Key_Slash) \
   ...
   OP(L'Ꮗ', LSHIFT(Key_2)) \
   OP(L'Ꮘ', LSHIFT(Key_F)) \
   OP(L'Ꮙ', LSHIFT(Key_Slash)) \
   OP(L'Ꮚ', LSHIFT(Key_Backtick)) \
   OP(L'Ꮛ', Key_7) \
   OP(L'Ꮜ', LSHIFT(Key_A)) \
   OP(L'Ꮝ', Key_S) \
   OP(L'Ꮞ', LSHIFT(Key_S)) \
   OP(L'Ꮟ', LSHIFT(Key_R)) \
   OP(L'Ꮠ', LSHIFT(Key_D)) \
   OP(L'Ꮡ', LSHIFT(Key_LeftBracket)) \
   OP(L'Ꮢ', Key_9) \
   OP(L'Ꮣ', Key_C) \
   OP(L'Ꮤ', Key_T) \
   OP(L'Ꮥ', Key_LeftBracket) \
   OP(L'Ꮦ', Key_8) \
   OP(L'Ꮧ', Key_D) \
   OP(L'Ꮨ', LSHIFT(Key_T)) \
   OP(L'Ꮩ', Key_4) \
   ...
   OP(L'Ꮮ', LSHIFT(Key_V)) \
   OP(L'Ꮯ', LSHIFT(Key_C)) \
   OP(L'Ꮰ', LSHIFT(Key_Semicolon)) \
   OP(L'Ꮱ', LSHIFT(Key_7)) \
   OP(L'Ꮲ', LSHIFT(Key_Comma)) \
   OP(L'Ꮳ', LSHIFT(Key_E)) \
   OP(L'Ꮴ', LSHIFT(Key_RightBracket)) \
   OP(L'Ꮵ', LSHIFT(Key_G)) \
   OP(L'Ꮶ', Key_5) \
   OP(L'Ꮷ', LSHIFT(Key_3)) \
   OP(L'Ꮸ', Key_Semicolon) \
   OP(L'Ꮹ', Key_NonUsPound) \
   OP(L'Ꮺ', LSHIFT(Key_P)) \
   OP(L'Ꮻ', LSHIFT(Key_W)) \
   OP(L'Ꮼ', LSHIFT(Key_O)) \
   OP(L'Ꮽ', LSHIFT(Key_X)) \
   OP(L'Ꮾ', LSHIFT(Key_NonUsPound)) \
   OP(L'Ꮿ', Key_Y) \
   OP(L'Ᏸ', LSHIFT(Key_B)) \
   OP(L'Ᏹ', LSHIFT(Key_I)) \
   OP(L'Ᏺ', LSHIFT(Key_Y)) \
