...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('B', LSHIFT(Key_T)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP('C', LSHIFT(Key_V)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP('D', LSHIFT(Key_W)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   ...
   OP('H', LSHIFT(Key_D)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_Semicolon)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_Y)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_N)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', LSHIFT(Key_M)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('M', LSHIFT(Key_C)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP('N', LSHIFT(Key_J)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP('O', LSHIFT(Key_L)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', LSHIFT(Key_O)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP('V', LSHIFT(Key_B)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP('W', LSHIFT(Key_R)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP('X', LSHIFT(Key_X)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', LSHIFT(Key_H)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP('b', Key_T) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP('c', Key_V) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP('d', Key_W) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   ...
   OP('h', Key_D) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', Key_Semicolon) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', Key_Y) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', Key_N) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', Key_M) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', Key_C) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', Key_J) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', Key_L) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', Key_O) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP('v', Key_B) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', Key_R) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', Key_X) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', Key_H) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'B', LSHIFT(Key_T)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP(L'C', LSHIFT(Key_V)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP(L'D', LSHIFT(Key_W)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   ...
   OP(L'H', LSHIFT(Key_D)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_Semicolon)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_Y)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_N)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', LSHIFT(Key_M)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'M', LSHIFT(Key_C)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP(L'N', LSHIFT(Key_J)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP(L'O', LSHIFT(Key_L)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', LSHIFT(Key_O)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP(L'V', LSHIFT(Key_B)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP(L'W', LSHIFT(Key_R)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP(L'X', LSHIFT(Key_X)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', LSHIFT(Key_H)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP(L'b', Key_T) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP(L'c', Key_V) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP(L'd', Key_W) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   ...
   OP(L'h', Key_D) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', Key_Semicolon) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', Key_Y) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', Key_N) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', Key_M) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', Key_C) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', Key_J) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', Key_L) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', Key_O) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP(L'v', Key_B) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', Key_R) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', Key_X) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', Key_H) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP(L'¢', RALT(LSHIFT(Key_V))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'©', RALT(Key_V)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   ...
   OP(L'®', RALT(Key_E)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', RALT(LSHIFT(Key_P))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'²', RALT(Key_2)) /* U+00b2, XKB_KEY_twosuperior, SUPERSCRIPT TWO */ \
   OP(L'³', RALT(Key_3)) /* U+00b3, XKB_KEY_threesuperior, SUPERSCRIPT THREE */ \
   OP(L'µ', RALT(Key_C)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   ...
   OP(L'Á', RALT(LSHIFT(Key_A))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Ä', RALT(LSHIFT(Key_Q))) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Å', RALT(LSHIFT(Key_R))) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   OP(L'Æ', RALT(LSHIFT(Key_Z))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ç', RALT(LSHIFT(Key_Comma))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'É', RALT(LSHIFT(Key_K))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Í', RALT(LSHIFT(Key_Semicolon))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ð', RALT(LSHIFT(Key_W))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ñ', RALT(LSHIFT(Key_J))) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_M))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ú', RALT(LSHIFT(Key_I))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ü', RALT(LSHIFT(Key_H))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Þ', RALT(LSHIFT(Key_F))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   OP(L'ß', RALT(Key_S)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'á', RALT(Key_A)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'ä', RALT(Key_Q)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', RALT(Key_R)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', RALT(Key_Z)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_Comma)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'é', RALT(Key_K)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'í', RALT(Key_Semicolon)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ð', RALT(Key_W)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ñ', RALT(Key_J)) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   ...
   OP(L'ø', RALT(Key_M)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ú', RALT(Key_I)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ü', RALT(Key_H)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'þ', RALT(Key_F)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'Œ', RALT(LSHIFT(Key_N))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_N)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ETH, RALT(LSHIFT(Key_W))) /* XKB_KEY_Eth, deprecated  */ \
   ...
   OP(XKB_KEY_H, LSHIFT(Key_D)) \
   OP(XKB_KEY_Home, Key_Home) /* XKB_KEY_Home */ \
   OP(XKB_KEY_I, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_THORN, RALT(LSHIFT(Key_F))) /* XKB_KEY_Thorn, deprecated  */ \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, LSHIFT(Key_I)) \
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_H))) \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_V, LSHIFT(Key_B)) \
   OP(XKB_KEY_W, LSHIFT(Key_R)) \
   ...
   OP(XKB_KEY_Y, LSHIFT(Key_H)) \
   OP(XKB_KEY_Z, LSHIFT(Key_Z)) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, RALT(Key_A)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_Q)) \
   OP(XKB_KEY_ae, RALT(Key_Z)) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_7)) \
   OP(XKB_KEY_apostrophe, RALT(Key_Quote)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_aring, RALT(Key_R)) \
   ...
   OP(XKB_KEY_c, Key_V) \
   OP(XKB_KEY_ccedilla, RALT(Key_Comma)) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_colon, LSHIFT(Key_P)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_V)) \
   ...
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_P))) \
   ...
   OP(XKB_KEY_h, Key_D) \
   OP(XKB_KEY_i, Key_Semicolon) \
   OP(XKB_KEY_iacute, RALT(Key_Semicolon)) \
   OP(XKB_KEY_j, Key_Y) \
   OP(XKB_KEY_k, Key_N) \
   OP(XKB_KEY_l, Key_M) \
   ...
   OP(XKB_KEY_r, Key_E) \
   OP(XKB_KEY_registered, RALT(Key_E)) \
