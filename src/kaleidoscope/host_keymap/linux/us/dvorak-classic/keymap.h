...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_5)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', LSHIFT(Key_LeftBracket)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('#', LSHIFT(Key_4)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP('$', LSHIFT(Key_9)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP('%', LSHIFT(Key_3)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('&', LSHIFT(Key_2)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP('\'', Key_LeftBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', LSHIFT(Key_6)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_7)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP('0', Key_7) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   OP('1', Key_5) /* U+0031, XKB_KEY_1, DIGIT ONE */ \
   OP('2', Key_8) /* U+0032, XKB_KEY_2, DIGIT TWO */ \
   OP('3', Key_4) /* U+0033, XKB_KEY_3, DIGIT THREE */ \
   OP('4', Key_9) /* U+0034, XKB_KEY_4, DIGIT FOUR */ \
   OP('5', Key_3) /* U+0035, XKB_KEY_5, DIGIT FIVE */ \
   OP('6', Key_0) /* U+0036, XKB_KEY_6, DIGIT SIX */ \
   OP('7', Key_2) /* U+0037, XKB_KEY_7, DIGIT SEVEN */ \
   OP('8', Key_Minus) /* U+0038, XKB_KEY_8, DIGIT EIGHT */ \
   OP('9', Key_6) /* U+0039, XKB_KEY_9, DIGIT NINE */ \
   ...
   OP('@', LSHIFT(Key_8)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('^', LSHIFT(Key_0)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_5)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', LSHIFT(Key_LeftBracket)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'#', LSHIFT(Key_4)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP(L'$', LSHIFT(Key_9)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP(L'%', LSHIFT(Key_3)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'&', LSHIFT(Key_2)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP(L'\'', Key_LeftBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', LSHIFT(Key_6)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_7)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L'0', Key_7) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   OP(L'1', Key_5) /* U+0031, XKB_KEY_1, DIGIT ONE */ \
   OP(L'2', Key_8) /* U+0032, XKB_KEY_2, DIGIT TWO */ \
   OP(L'3', Key_4) /* U+0033, XKB_KEY_3, DIGIT THREE */ \
   OP(L'4', Key_9) /* U+0034, XKB_KEY_4, DIGIT FOUR */ \
   OP(L'5', Key_3) /* U+0035, XKB_KEY_5, DIGIT FIVE */ \
   OP(L'6', Key_0) /* U+0036, XKB_KEY_6, DIGIT SIX */ \
   OP(L'7', Key_2) /* U+0037, XKB_KEY_7, DIGIT SEVEN */ \
   OP(L'8', Key_Minus) /* U+0038, XKB_KEY_8, DIGIT EIGHT */ \
   OP(L'9', Key_6) /* U+0039, XKB_KEY_9, DIGIT NINE */ \
   ...
   OP(L'@', LSHIFT(Key_8)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'^', LSHIFT(Key_0)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_exclam, LSHIFT(Key_5)) \
   OP(XKB_KEY_f, Key_Y) \
   OP(XKB_KEY_g, Key_U) \
   ...
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_4)) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_p, Key_R) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_6)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_7)) \
   OP(XKB_KEY_percent, LSHIFT(Key_3)) \
   OP(XKB_KEY_period, Key_E) \
   OP(XKB_KEY_plus, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_q, Key_X) \
   OP(XKB_KEY_question, LSHIFT(Key_Q)) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_r, Key_O) \
