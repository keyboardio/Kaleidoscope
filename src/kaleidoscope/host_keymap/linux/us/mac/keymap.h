...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'§', Key_NonUsBackslashAndPipe) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'¨', RALT(LSHIFT(Key_U))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'±', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'´', RALT(LSHIFT(Key_E))) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   ...
   OP(L'¼', RALT(LSHIFT(Key_Y))) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(LSHIFT(Key_J))) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(LSHIFT(Key_M))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   ...
   OP(L'Þ', RALT(LSHIFT(Key_L))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   ...
   OP(L'ð', RALT(LSHIFT(Key_D))) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   ...
   OP(L'þ', RALT(LSHIFT(Key_Semicolon))) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'ı', RALT(LSHIFT(Key_B))) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'‚', RALT(LSHIFT(Key_0))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   ...
   OP(L'„', RALT(LSHIFT(Key_W))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'†', RALT(Key_T)) /* U+2020, XKB_KEY_dagger, DAGGER */ \
   OP(L'‡', RALT(LSHIFT(Key_7))) /* U+2021, XKB_KEY_doubledagger, DOUBLE DAGGER */ \
   ...
   OP(L'€', RALT(LSHIFT(Key_2))) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   ...
   OP(L'∞', RALT(Key_5)) /* U+221e, XKB_KEY_infinity, INFINITY */ \
   OP(L'∫', RALT(Key_B)) /* U+222b, XKB_KEY_integral, INTEGRAL */ \
   OP(L'≈', RALT(Key_X)) /* U+2248, XKB_KEY_approxeq, ALMOST EQUAL TO */ \
   ...
   OP(L'ﬁ', RALT(LSHIFT(Key_5))) \
   OP(L'ﬂ', RALT(LSHIFT(Key_6))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EuroSign, RALT(LSHIFT(Key_2))) \
   ...
   OP(XKB_KEY_THORN, RALT(LSHIFT(Key_L))) /* XKB_KEY_Thorn, deprecated  */ \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_approxeq, RALT(Key_X)) \
   ...
   OP(XKB_KEY_dead_abovedot, RALT(Key_H)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, RALT(Key_K)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_E)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowdot, RALT(LSHIFT(Key_H))) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_Period))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_T))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_Z))) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_I)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_U)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_G))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Backtick)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(LSHIFT(Key_F))) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(LSHIFT(Key_Backtick))) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(LSHIFT(Key_Comma))) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(LSHIFT(Key_X))) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_stroke, RALT(LSHIFT(Key_S))) /* XKB_KEY_dead_stroke */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_N)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_diaeresis, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_division, RALT(Key_Slash)) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doubledagger, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_e, Key_E) \
   ...
   OP(XKB_KEY_eth, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_idotless, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_infinity, RALT(Key_5)) \
   ...
   OP(XKB_KEY_onehalf, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_onequarter, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_plusminus, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_q, Key_Q) \
   ...
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_semicolon, Key_Semicolon) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_0))) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_thorn, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_threequarters, RALT(LSHIFT(Key_M))) \
