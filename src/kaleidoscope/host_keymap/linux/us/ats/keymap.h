...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Č', RALT(LSHIFT(Key_RightBracket))) \
   OP(L'č', RALT(Key_RightBracket)) \
   OP(L'Ɔ', RALT(LSHIFT(Key_C))) \
   OP(L'ɔ', RALT(Key_C)) \
   OP(L'ʔ', RALT(Key_Slash)) \
   OP(L'̓', RALT(Key_Comma)) \
   OP(L'θ', RALT(Key_LeftBracket)) \
