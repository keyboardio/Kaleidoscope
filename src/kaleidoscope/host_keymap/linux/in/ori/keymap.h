...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ଘ', LSHIFT(Key_I)) \
   OP(L'ଙ', LSHIFT(Key_U)) \
   OP(L'ଚ', Key_Semicolon) \
   OP(L'ଛ', LSHIFT(Key_Semicolon)) \
   OP(L'ଜ', Key_P) \
   OP(L'ଝ', LSHIFT(Key_P)) \
   OP(L'ଞ', LSHIFT(Key_RightBracket)) \
   OP(L'ଟ', Key_Quote) \
   OP(L'ଠ', LSHIFT(Key_Quote)) \
   OP(L'ଡ', Key_LeftBracket) \
   OP(L'ଢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ଣ', LSHIFT(Key_C)) \
   OP(L'ତ', Key_L) \
   OP(L'ଥ', LSHIFT(Key_L)) \
   OP(L'ଦ', Key_O) \
   ...
   OP(L'ଵ', Key_B) \
   OP(L'ଶ', LSHIFT(Key_M)) \
   OP(L'ଷ', LSHIFT(Key_Comma)) \
   OP(L'ସ', Key_M) \
   OP(L'ହ', Key_U) \
   OP(L'଼', Key_RightBracket) \
   OP(L'ା', Key_E) \
   OP(L'ି', Key_F) \
   OP(L'ୀ', Key_R) \
   OP(L'ୁ', Key_G) \
