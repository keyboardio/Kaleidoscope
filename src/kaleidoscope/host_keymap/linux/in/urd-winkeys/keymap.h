...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'٭', LSHIFT(Key_8)) \
   OP(L'ٹ', Key_T) /* U+0679, XKB_KEY_Arabic_tteh, ARABIC LETTER TTEH */ \
   OP(L'پ', Key_Y) /* U+067e, XKB_KEY_Arabic_peh, ARABIC LETTER PEH */ \
   OP(L'چ', LSHIFT(Key_O)) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڈ', LSHIFT(Key_R)) /* U+0688, XKB_KEY_Arabic_ddal, ARABIC LETTER DDAL */ \
   OP(L'ڑ', LSHIFT(Key_D)) /* U+0691, XKB_KEY_Arabic_rreh, ARABIC LETTER RREH */ \
   OP(L'ژ', LSHIFT(Key_A)) /* U+0698, XKB_KEY_Arabic_jeh, ARABIC LETTER JEH */ \
   OP(L'ک', Key_K) /* U+06a9, XKB_KEY_Arabic_keheh, ARABIC LETTER KEHEH */ \
   OP(L'گ', LSHIFT(Key_K)) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
   OP(L'ں', LSHIFT(Key_F)) /* U+06ba, XKB_KEY_Arabic_noon_ghunna, ARABIC LETTER NOON GHUNNA */ \
   OP(L'ھ', Key_E) /* U+06be, XKB_KEY_Arabic_heh_doachashmee, ARABIC LETTER HEH DOACHASHMEE */ \
   OP(L'ہ', Key_H) /* U+06c1, XKB_KEY_Arabic_heh_goal, ARABIC LETTER HEH GOAL */ \
   OP(L'ۂ', LSHIFT(Key_G)) \
   OP(L'ۃ', LSHIFT(Key_U)) \
   OP(L'ی', Key_L) /* U+06cc, XKB_KEY_Farsi_yeh, ARABIC LETTER FARSI YEH */ \
   OP(L'ے', Key_C) /* U+06d2, XKB_KEY_Arabic_yeh_baree, ARABIC LETTER YEH BARREE */ \
   OP(L'ۓ', LSHIFT(Key_C)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_ddal, LSHIFT(Key_R)) \
   OP(XKB_KEY_Arabic_fullstop, Key_Period) \
   OP(XKB_KEY_Arabic_gaf, LSHIFT(Key_K)) \
   OP(XKB_KEY_Arabic_heh_doachashmee, Key_E) \
   OP(XKB_KEY_Arabic_heh_goal, Key_H) \
   OP(XKB_KEY_Arabic_jeh, LSHIFT(Key_A)) \
   OP(XKB_KEY_Arabic_keheh, Key_K) \
   OP(XKB_KEY_Arabic_noon_ghunna, LSHIFT(Key_F)) \
   OP(XKB_KEY_Arabic_peh, Key_Y) \
   OP(XKB_KEY_Arabic_percent, LSHIFT(Key_5)) \
   OP(XKB_KEY_Arabic_rreh, LSHIFT(Key_D)) \
   OP(XKB_KEY_Arabic_tcheh, LSHIFT(Key_O)) \
   OP(XKB_KEY_Arabic_tteh, Key_T) \
   OP(XKB_KEY_Arabic_yeh_baree, Key_C) \
