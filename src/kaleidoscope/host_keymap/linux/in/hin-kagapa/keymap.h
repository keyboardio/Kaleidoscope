...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ऍ', RALT(LSHIFT(Key_Comma))) \
   OP(L'ऎ', RALT(Key_E)) \
   OP(L'ए', RALT(LSHIFT(Key_E))) \
   OP(L'ऐ', RALT(Key_Y)) \
   OP(L'ऑ', RALT(LSHIFT(Key_Period))) \
   OP(L'ऒ', RALT(Key_O)) \
   OP(L'ओ', RALT(LSHIFT(Key_O))) \
   OP(L'औ', RALT(Key_V)) \
   OP(L'क', Key_K) \
   OP(L'ख', LSHIFT(Key_K)) \
   OP(L'ग', Key_G) \
   ...
   OP(L'ृ', LSHIFT(Key_R)) \
   OP(L'ॄ', LSHIFT(Key_F)) \
   OP(L'ॅ', RALT(Key_Comma)) \
   OP(L'ॆ', Key_E) \
   OP(L'े', LSHIFT(Key_E)) \
   OP(L'ै', LSHIFT(Key_Y)) \
   OP(L'ॉ', RALT(Key_Period)) \
   OP(L'ॊ', Key_O) \
   OP(L'ो', LSHIFT(Key_O)) \
   OP(L'ौ', LSHIFT(Key_V)) \
   OP(L'्', Key_F) \
   OP(L'ॐ', RALT(LSHIFT(Key_M))) \
   OP(L'॑', RALT(Key_Quote)) \
   OP(L'॒', RALT(Key_Minus)) \
   OP(L'क़', RALT(Key_K)) \
   OP(L'ख़', RALT(LSHIFT(Key_K))) \
   OP(L'ग़', RALT(Key_G)) \
   OP(L'ज़', RALT(Key_J)) \
   OP(L'ड़', RALT(Key_W)) \
   OP(L'ढ़', RALT(LSHIFT(Key_W))) \
   OP(L'फ़', RALT(Key_P)) \
   OP(L'य़', RALT(LSHIFT(Key_Y))) \
   OP(L'ॠ', RALT(Key_F)) \
   OP(L'ॢ', RALT(Key_L)) \
   ...
   OP(L'ॲ', RALT(LSHIFT(Key_A))) \
   OP(L'ᳲ', RALT(Key_Semicolon)) \
   OP(L'ᳳ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'ᳵ', RALT(Key_H)) \
   OP(L'ᳶ', RALT(LSHIFT(Key_H))) \
   OP(L'‌', RALT(LSHIFT(Key_6))) \
   OP(L'‍', RALT(LSHIFT(Key_7))) \
   OP(L'“', RALT(Key_Backtick)) \
   OP(L'”', RALT(LSHIFT(Key_Quote))) \
   OP(L'₨', RALT(LSHIFT(Key_2))) /* U+20a8, XKB_KEY_RupeeSign, RUPEE SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_RupeeSign, RALT(LSHIFT(Key_2))) \
