...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('2', RALT(Key_Backtick)) /* U+0032, XKB_KEY_2, DIGIT TWO */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'2', RALT(Key_Backtick)) /* U+0032, XKB_KEY_2, DIGIT TWO */ \
   ...
   OP(L'ौ', LSHIFT(Key_O)) \
   OP(L'्', Key_A) \
   OP(L'ॐ', RALT(LSHIFT(Key_Z))) \
   OP(L'ॠ', RALT(LSHIFT(Key_Q))) \
   OP(L'ॢ', LSHIFT(Key_L)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   OP(XKB_KEY_2, RALT(Key_Backtick)) \
   OP(XKB_KEY_3, RALT(LSHIFT(Key_Backtick))) \
