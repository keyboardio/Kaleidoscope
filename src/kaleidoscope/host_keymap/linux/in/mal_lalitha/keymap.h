...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ം', LSHIFT(Key_Backtick)) \
   OP(L'ഃ', LSHIFT(Key_H)) \
   OP(L'അ', LSHIFT(Key_A)) \
   OP(L'ആ', RALT(Key_A)) \
   OP(L'ഇ', RALT(Key_I)) \
   OP(L'ഈ', RALT(LSHIFT(Key_I))) \
   OP(L'ഉ', RALT(Key_U)) \
   OP(L'ഊ', RALT(LSHIFT(Key_U))) \
   OP(L'ഋ', RALT(LSHIFT(Key_R))) \
   OP(L'എ', RALT(Key_E)) \
   OP(L'ഏ', RALT(LSHIFT(Key_E))) \
   OP(L'ഐ', RALT(Key_Q)) \
   OP(L'ഒ', RALT(Key_O)) \
   OP(L'ഓ', RALT(LSHIFT(Key_O))) \
   OP(L'ഔ', RALT(LSHIFT(Key_Q))) \
   OP(L'ക', Key_K) \
   OP(L'ഖ', LSHIFT(Key_K)) \
   OP(L'ഗ', Key_G) \
   OP(L'ഘ', LSHIFT(Key_G)) \
   ...
   OP(L'ജ', Key_J) \
   OP(L'ഝ', LSHIFT(Key_J)) \
   OP(L'ഞ', RALT(LSHIFT(Key_N))) \
   OP(L'ട', RALT(Key_T)) \
   OP(L'ഠ', RALT(LSHIFT(Key_T))) \
   OP(L'ഡ', RALT(Key_D)) \
   OP(L'ഢ', RALT(LSHIFT(Key_D))) \
   OP(L'ണ', LSHIFT(Key_N)) \
   OP(L'ത', Key_T) \
   OP(L'ഥ', LSHIFT(Key_T)) \
   OP(L'ദ', Key_D) \
