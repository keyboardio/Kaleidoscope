...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('@', LSHIFT(Key_Slash)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'@', LSHIFT(Key_Slash)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'ಉ', LSHIFT(Key_G)) \
   OP(L'ಊ', LSHIFT(Key_T)) \
   OP(L'ಋ', LSHIFT(Key_Equals)) \
   OP(L'ಎ', LSHIFT(Key_Z)) \
   OP(L'ಏ', LSHIFT(Key_S)) \
   OP(L'ಐ', LSHIFT(Key_W)) \
   OP(L'ಒ', LSHIFT(Key_Backtick)) \
   OP(L'ಓ', LSHIFT(Key_A)) \
   OP(L'ಔ', LSHIFT(Key_Q)) \
   OP(L'ಕ', Key_K) \
   OP(L'ಖ', LSHIFT(Key_K)) \
   ...
   OP(L'ಘ', LSHIFT(Key_I)) \
   OP(L'ಙ', LSHIFT(Key_U)) \
   OP(L'ಚ', Key_Semicolon) \
   OP(L'ಛ', LSHIFT(Key_Semicolon)) \
   OP(L'ಜ', Key_P) \
   OP(L'ಝ', LSHIFT(Key_P)) \
   OP(L'ಞ', LSHIFT(Key_RightBracket)) \
   OP(L'ಟ', Key_Quote) \
   OP(L'ಠ', LSHIFT(Key_Quote)) \
   OP(L'ಡ', Key_LeftBracket) \
   OP(L'ಢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ಣ', LSHIFT(Key_C)) \
   OP(L'ತ', Key_L) \
   OP(L'ಥ', LSHIFT(Key_L)) \
   OP(L'ದ', Key_O) \
   ...
   OP(L'ವ', Key_B) \
   OP(L'ಶ', LSHIFT(Key_M)) \
   OP(L'ಷ', LSHIFT(Key_Comma)) \
   OP(L'ಸ', Key_M) \
   OP(L'ಹ', Key_U) \
   OP(L'಼', Key_RightBracket) \
   OP(L'ಾ', Key_E) \
   OP(L'ಿ', Key_F) \
   OP(L'ೀ', Key_R) \
   OP(L'ು', Key_G) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_at, LSHIFT(Key_Slash)) \
