...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ഉ', LSHIFT(Key_G)) \
   OP(L'ഊ', LSHIFT(Key_T)) \
   OP(L'ഋ', LSHIFT(Key_Equals)) \
   OP(L'എ', LSHIFT(Key_Z)) \
   OP(L'ഏ', LSHIFT(Key_S)) \
   OP(L'ഐ', LSHIFT(Key_W)) \
   OP(L'ഒ', LSHIFT(Key_Backtick)) \
   OP(L'ഓ', LSHIFT(Key_A)) \
   OP(L'ഔ', LSHIFT(Key_Q)) \
   OP(L'ക', Key_K) \
   OP(L'ഖ', LSHIFT(Key_K)) \
   ...
   OP(L'ഘ', LSHIFT(Key_I)) \
   OP(L'ങ', LSHIFT(Key_U)) \
   OP(L'ച', Key_Semicolon) \
   OP(L'ഛ', LSHIFT(Key_Semicolon)) \
   OP(L'ജ', Key_P) \
   OP(L'ഝ', LSHIFT(Key_P)) \
   OP(L'ഞ', LSHIFT(Key_RightBracket)) \
   OP(L'ട', Key_Quote) \
   OP(L'ഠ', LSHIFT(Key_Quote)) \
   OP(L'ഡ', Key_LeftBracket) \
   OP(L'ഢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ണ', LSHIFT(Key_C)) \
   OP(L'ത', Key_L) \
   OP(L'ഥ', LSHIFT(Key_L)) \
   OP(L'ദ', Key_O) \
   ...
   OP(L'ൺ', LSHIFT(Key_X)) \
   OP(L'ൻ', LSHIFT(Key_V)) \
   OP(L'ർ', Key_NonUsPound) \
   OP(L'ൽ', LSHIFT(Key_Period)) \
   OP(L'ൾ', LSHIFT(Key_8)) \
