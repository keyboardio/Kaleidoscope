...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(':', Key_Backtick) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L':', Key_Backtick) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP(L'ঁ', LSHIFT(Key_X)) \
   OP(L'ং', Key_X) \
   OP(L'ঃ', LSHIFT(Key_Minus)) \
   OP(L'অ', LSHIFT(Key_E)) \
   OP(L'ই', LSHIFT(Key_F)) \
   OP(L'ঈ', LSHIFT(Key_R)) \
   OP(L'উ', LSHIFT(Key_G)) \
   OP(L'ঊ', LSHIFT(Key_T)) \
   OP(L'ঋ', LSHIFT(Key_Equals)) \
   OP(L'এ', LSHIFT(Key_S)) \
   OP(L'ঐ', LSHIFT(Key_W)) \
   OP(L'ও', LSHIFT(Key_A)) \
   OP(L'ঔ', LSHIFT(Key_Q)) \
   ...
   OP(L'ঘ', LSHIFT(Key_I)) \
   OP(L'ঙ', LSHIFT(Key_U)) \
   OP(L'চ', Key_Semicolon) \
   OP(L'ছ', LSHIFT(Key_Semicolon)) \
   OP(L'জ', Key_P) \
   OP(L'ঝ', LSHIFT(Key_P)) \
   OP(L'ঞ', LSHIFT(Key_RightBracket)) \
   OP(L'ট', Key_Quote) \
   OP(L'ঠ', LSHIFT(Key_Quote)) \
   OP(L'ড', Key_LeftBracket) \
   OP(L'ঢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ণ', LSHIFT(Key_C)) \
   OP(L'ত', Key_L) \
   OP(L'থ', LSHIFT(Key_L)) \
   OP(L'দ', Key_O) \
