...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ఁ', RALT(LSHIFT(Key_8))) \
   OP(L'ం', LSHIFT(Key_M)) \
   OP(L'ః', LSHIFT(Key_H)) \
   OP(L'అ', RALT(Key_A)) \
   OP(L'ఆ', LSHIFT(Key_A)) \
   OP(L'ఇ', RALT(Key_I)) \
   OP(L'ఈ', RALT(LSHIFT(Key_I))) \
   OP(L'ఉ', RALT(Key_U)) \
   OP(L'ఊ', RALT(LSHIFT(Key_U))) \
   OP(L'ఋ', RALT(Key_R)) \
   OP(L'ఌ', RALT(LSHIFT(Key_L))) \
   OP(L'ఎ', RALT(Key_E)) \
   OP(L'ఏ', RALT(LSHIFT(Key_E))) \
   OP(L'ఐ', RALT(Key_Y)) \
   OP(L'ఒ', RALT(Key_O)) \
   OP(L'ఓ', RALT(LSHIFT(Key_O))) \
   OP(L'ఔ', RALT(Key_V)) \
   OP(L'క', Key_K) \
   OP(L'ఖ', LSHIFT(Key_K)) \
   OP(L'గ', Key_G) \
   ...
   OP(L'ౌ', LSHIFT(Key_V)) \
   OP(L'్', Key_F) \
   OP(L'ౘ', RALT(Key_Comma)) \
   OP(L'ౙ', RALT(Key_Period)) \
   OP(L'ౠ', RALT(Key_F)) \
   OP(L'ౢ', RALT(Key_L)) \
   OP(L'౦', RALT(Key_0)) \
   OP(L'౧', RALT(Key_1)) \
