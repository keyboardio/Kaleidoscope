...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'उ', LSHIFT(Key_G)) \
   OP(L'ऊ', LSHIFT(Key_T)) \
   OP(L'ऋ', LSHIFT(Key_Equals)) \
   OP(L'ऌ', RALT(LSHIFT(Key_F))) \
   OP(L'ऍ', LSHIFT(Key_1)) \
   OP(L'ऎ', LSHIFT(Key_Z)) \
   OP(L'ए', LSHIFT(Key_S)) \
   OP(L'ऐ', LSHIFT(Key_W)) \
   OP(L'ऑ', LSHIFT(Key_NonUsPound)) \
   OP(L'ऒ', LSHIFT(Key_Backtick)) \
   OP(L'ओ', LSHIFT(Key_A)) \
   OP(L'औ', LSHIFT(Key_Q)) \
   OP(L'क', Key_K) \
   OP(L'ख', LSHIFT(Key_K)) \
   ...
   OP(L'घ', LSHIFT(Key_I)) \
   OP(L'ङ', LSHIFT(Key_U)) \
   OP(L'च', Key_Semicolon) \
   OP(L'छ', LSHIFT(Key_Semicolon)) \
   OP(L'ज', Key_P) \
   OP(L'झ', LSHIFT(Key_P)) \
   OP(L'ञ', LSHIFT(Key_RightBracket)) \
   OP(L'ट', Key_Quote) \
   OP(L'ठ', LSHIFT(Key_Quote)) \
   OP(L'ड', Key_LeftBracket) \
   OP(L'ढ', LSHIFT(Key_LeftBracket)) \
   OP(L'ण', LSHIFT(Key_C)) \
   OP(L'त', Key_L) \
   OP(L'थ', LSHIFT(Key_L)) \
   OP(L'द', Key_O) \
   ...
   OP(L'व', Key_B) \
   OP(L'श', LSHIFT(Key_M)) \
   OP(L'ष', LSHIFT(Key_Comma)) \
   OP(L'स', Key_M) \
   OP(L'ह', Key_U) \
   OP(L'़', Key_RightBracket) \
   OP(L'ऽ', RALT(LSHIFT(Key_Period))) \
   OP(L'ा', Key_E) \
   OP(L'ि', Key_F) \
   OP(L'ी', Key_R) \
   OP(L'ु', Key_G) \
   OP(L'ू', Key_T) \
   OP(L'ृ', Key_Equals) \
   OP(L'ॄ', RALT(Key_Equals)) \
   OP(L'ॅ', LSHIFT(Key_2)) \
   OP(L'ॆ', Key_Z) \
   OP(L'े', Key_S) \
   OP(L'ै', Key_W) \
   OP(L'ॉ', Key_NonUsPound) \
   OP(L'ॊ', Key_Backtick) \
   OP(L'ो', Key_A) \
   OP(L'ौ', Key_Q) \
   OP(L'्', Key_D) \
   OP(L'ॐ', RALT(LSHIFT(Key_X))) \
   OP(L'॑', RALT(LSHIFT(Key_Quote))) \
   OP(L'॒', RALT(Key_Semicolon)) \
   OP(L'॓', RALT(Key_Z)) \
   OP(L'॔', RALT(Key_C)) \
   OP(L'क़', RALT(Key_K)) \
   OP(L'ख़', RALT(LSHIFT(Key_K))) \
   OP(L'ग़', RALT(Key_I)) \
   OP(L'ज़', RALT(Key_P)) \
   OP(L'ड़', RALT(Key_LeftBracket)) \
   OP(L'ढ़', RALT(LSHIFT(Key_LeftBracket))) \
   OP(L'फ़', RALT(LSHIFT(Key_H))) \
   OP(L'य़', LSHIFT(Key_Slash)) \
   OP(L'ॠ', RALT(LSHIFT(Key_Equals))) \
   OP(L'ॡ', RALT(LSHIFT(Key_R))) \
   OP(L'ॢ', RALT(Key_F)) \
   OP(L'ॣ', RALT(Key_R)) \
