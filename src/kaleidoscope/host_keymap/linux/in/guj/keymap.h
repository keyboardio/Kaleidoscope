...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ઘ', LSHIFT(Key_I)) \
   OP(L'ઙ', LSHIFT(Key_U)) \
   OP(L'ચ', Key_Semicolon) \
   OP(L'છ', LSHIFT(Key_Semicolon)) \
   OP(L'જ', Key_P) \
   OP(L'ઝ', LSHIFT(Key_P)) \
   OP(L'ઞ', LSHIFT(Key_RightBracket)) \
   OP(L'ટ', Key_Quote) \
   OP(L'ઠ', LSHIFT(Key_Quote)) \
   OP(L'ડ', Key_LeftBracket) \
   OP(L'ઢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ણ', LSHIFT(Key_C)) \
   OP(L'ત', Key_L) \
   OP(L'થ', LSHIFT(Key_L)) \
   OP(L'દ', Key_O) \
   ...
   OP(L'વ', Key_B) \
   OP(L'શ', LSHIFT(Key_M)) \
   OP(L'ષ', LSHIFT(Key_Comma)) \
   OP(L'સ', Key_M) \
   OP(L'હ', Key_U) \
   OP(L'઼', Key_RightBracket) \
   OP(L'ા', Key_E) \
   OP(L'િ', Key_F) \
   OP(L'ી', Key_R) \
   OP(L'ુ', Key_G) \
   OP(L'ૂ', Key_T) \
   OP(L'ૃ', LSHIFT(Key_Equals)) \
   OP(L'ૅ', LSHIFT(Key_2)) \
   OP(L'ે', Key_S) \
   OP(L'ૈ', Key_W) \
   OP(L'ૉ', Key_NonUsPound) \
   OP(L'ો', Key_A) \
   OP(L'ૌ', Key_Q) \
   OP(L'્', Key_D) \
   OP(L'૦', Key_0) \
