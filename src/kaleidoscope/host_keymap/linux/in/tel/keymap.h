...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ఉ', LSHIFT(Key_G)) \
   OP(L'ఊ', LSHIFT(Key_T)) \
   OP(L'ఋ', LSHIFT(Key_Equals)) \
   OP(L'ఎ', LSHIFT(Key_Z)) \
   OP(L'ఏ', LSHIFT(Key_S)) \
   OP(L'ఐ', LSHIFT(Key_W)) \
   OP(L'ఒ', LSHIFT(Key_Backtick)) \
   OP(L'ఓ', LSHIFT(Key_A)) \
   OP(L'ఔ', LSHIFT(Key_Q)) \
   OP(L'క', Key_K) \
   OP(L'ఖ', LSHIFT(Key_K)) \
   ...
   OP(L'ఘ', LSHIFT(Key_I)) \
   OP(L'ఙ', LSHIFT(Key_U)) \
   OP(L'చ', Key_Semicolon) \
   OP(L'ఛ', LSHIFT(Key_Semicolon)) \
   OP(L'జ', Key_P) \
   OP(L'ఝ', LSHIFT(Key_P)) \
   OP(L'ఞ', Key_RightBracket) \
   OP(L'ట', Key_Quote) \
   OP(L'ఠ', LSHIFT(Key_Quote)) \
   OP(L'డ', Key_LeftBracket) \
   OP(L'ఢ', LSHIFT(Key_LeftBracket)) \
   OP(L'ణ', LSHIFT(Key_C)) \
   OP(L'త', Key_L) \
   OP(L'థ', LSHIFT(Key_L)) \
   OP(L'ద', Key_O) \
