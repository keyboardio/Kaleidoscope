...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ಆ', LSHIFT(Key_A)) \
   OP(L'ಇ', RALT(Key_I)) \
   OP(L'ಈ', RALT(LSHIFT(Key_I))) \
   OP(L'ಉ', RALT(Key_U)) \
   OP(L'ಊ', RALT(LSHIFT(Key_U))) \
   OP(L'ಋ', RALT(Key_R)) \
   OP(L'ಌ', RALT(LSHIFT(Key_L))) \
   OP(L'ಎ', RALT(Key_E)) \
   OP(L'ಏ', RALT(LSHIFT(Key_E))) \
   OP(L'ಐ', RALT(Key_Y)) \
   OP(L'ಒ', RALT(Key_O)) \
   OP(L'ಓ', RALT(LSHIFT(Key_O))) \
   OP(L'ಔ', RALT(Key_V)) \
   OP(L'ಕ', Key_K) \
   OP(L'ಖ', LSHIFT(Key_K)) \
   OP(L'ಗ', Key_G) \
