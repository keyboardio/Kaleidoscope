...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ু', Key_U) \
   OP(L'ূ', Key_W) \
   OP(L'ৃ', LSHIFT(Key_Comma)) \
   OP(L'ে', Key_LeftBracket) \
   OP(L'ৈ', LSHIFT(Key_LeftBracket)) \
   OP(L'ো', Key_RightBracket) \
   OP(L'ৌ', LSHIFT(Key_RightBracket)) \
   OP(L'্', Key_Slash) \
   OP(L'ৎ', LSHIFT(Key_8)) \
   OP(L'ড়', LSHIFT(Key_R)) \
   OP(L'ঢ়', LSHIFT(Key_X)) \
