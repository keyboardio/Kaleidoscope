...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Š', RALT(LSHIFT(Key_W))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_W)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   ...
   OP(L'Ŭ', RALT(LSHIFT(Key_U))) /* U+016c, XKB_KEY_Ubreve, LATIN CAPITAL LETTER U WITH BREVE */ \
   OP(L'ŭ', RALT(Key_U)) /* U+016d, XKB_KEY_ubreve, LATIN SMALL LETTER U WITH BREVE */ \
   OP(L'Ź', RALT(LSHIFT(Key_Z))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_Z)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_Z))) \
