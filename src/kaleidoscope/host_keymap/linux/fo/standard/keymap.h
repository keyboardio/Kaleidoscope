...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¦', RALT(LSHIFT(Key_Equals))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   ...
   OP(L'Ð', LSHIFT(Key_RightBracket)) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   ...
   OP(L'ð', Key_RightBracket) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ETH, LSHIFT(Key_RightBracket)) /* XKB_KEY_Eth, deprecated  */ \
   ...
   OP(XKB_KEY_brokenbar, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_c, Key_C) \
   ...
   OP(XKB_KEY_eth, Key_RightBracket) \
