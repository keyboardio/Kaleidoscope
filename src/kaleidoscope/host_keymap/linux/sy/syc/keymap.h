...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('[', Key_X) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(']', Key_Z) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'[', Key_X) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L']', Key_Z) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'«', LSHIFT(Key_Minus)) \
   OP(L'»', LSHIFT(Key_8)) \
   OP(L'̃', LSHIFT(Key_LeftBracket)) \
   OP(L'̄', LSHIFT(Key_O)) \
   OP(L'̇', LSHIFT(Key_P)) \
   OP(L'̈', LSHIFT(Key_I)) \
   OP(L'̊', LSHIFT(Key_2)) \
   OP(L'̣', LSHIFT(Key_Semicolon)) \
   OP(L'̤', LSHIFT(Key_K)) \
   OP(L'̥', LSHIFT(Key_3)) \
   OP(L'̮', LSHIFT(Key_Backtick)) \
   OP(L'̰', LSHIFT(Key_Quote)) \
   OP(L'̱', LSHIFT(Key_L)) \
   OP(L'،', LSHIFT(Key_Comma)) /* U+060c, XKB_KEY_Arabic_comma, ARABIC COMMA */ \
   ...
   OP(L'ܑ', LSHIFT(Key_H)) \
   OP(L'ܒ', Key_F) \
   OP(L'ܓ', Key_LeftBracket) \
   OP(L'ܔ', Key_Q) \
   OP(L'ܕ', Key_RightBracket) \
   OP(L'ܖ', Key_E) \
   OP(L'ܗ', Key_I) \
   OP(L'ܘ', Key_Comma) \
   OP(L'ܙ', Key_Period) \
   ...
   OP(L'݂', LSHIFT(Key_M)) \
   OP(L'݉', LSHIFT(Key_4)) \
   OP(L'݊', LSHIFT(Key_RightBracket)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_comma, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_Arabic_question_mark, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Arabic_semicolon, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_bracketleft, Key_X) \
   OP(XKB_KEY_bracketright, Key_Z) \
