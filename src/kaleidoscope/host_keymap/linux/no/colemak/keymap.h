...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¢', RALT(LSHIFT(Key_K))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', RALT(Key_3)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¤', LSHIFT(Key_4)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¥', RALT(Key_6)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'¦', RALT(Key_Backtick)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', LSHIFT(Key_Backtick)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_A)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'®', RALT(Key_S)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   ...
   OP(L'º', RALT(LSHIFT(Key_A))) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   ...
   OP(L'¾', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   ...
   OP(L'Ð', RALT(LSHIFT(Key_G))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'×', RALT(Key_KeypadMultiply)) \
   OP(L'Ø', LSHIFT(Key_P)) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   ...
   OP(L'ð', RALT(Key_G)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'÷', RALT(Key_KeypadDivide)) \
   OP(L'ø', Key_P) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'þ', RALT(Key_F)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'đ', RALT(Key_E)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   ...
   OP(L'ı', RALT(LSHIFT(Key_L))) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   OP(L'ĸ', RALT(Key_N)) /* U+0138, XKB_KEY_kra, LATIN SMALL LETTER KRA */ \
   ...
   OP(L'Ŋ', RALT(LSHIFT(Key_T))) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ŋ', RALT(Key_T)) /* U+014b, XKB_KEY_eng, LATIN SMALL LETTER ENG */ \
   OP(L'Œ', RALT(LSHIFT(Key_Semicolon))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_Semicolon)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Π', RALT(LSHIFT(Key_R))) /* U+03a0, XKB_KEY_Greek_PI, GREEK CAPITAL LETTER PI */ \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'π', RALT(Key_R)) /* U+03c0, XKB_KEY_Greek_pi, GREEK SMALL LETTER PI */ \
   ...
   OP(L'€', RALT(Key_K)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(LSHIFT(Key_S))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   ...
   OP(L'↑', RALT(LSHIFT(Key_I))) /* U+2191, XKB_KEY_uparrow, UPWARDS ARROW */ \
   OP(L'→', RALT(Key_L)) /* U+2192, XKB_KEY_rightarrow, RIGHTWARDS ARROW */ \
   OP(L'↓', RALT(Key_I)) /* U+2193, XKB_KEY_downarrow, DOWNWARDS ARROW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ENG, RALT(LSHIFT(Key_T))) \
   OP(XKB_KEY_ETH, RALT(LSHIFT(Key_G))) /* XKB_KEY_Eth, deprecated  */ \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Escape, Key_Escape) /* XKB_KEY_Escape */ \
   OP(XKB_KEY_EuroSign, RALT(Key_K)) \
   ...
   OP(XKB_KEY_Greek_PI, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Greek_pi, RALT(Key_R)) \
   ...
   OP(XKB_KEY_Oslash, LSHIFT(Key_P)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_K))) \
   ...
   OP(XKB_KEY_dead_acute, RALT(Key_Equals)) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_dead_doubleacute, RALT(Key_NonUsPound)) /* XKB_KEY_dead_doubleacute */ \
   ...
   OP(XKB_KEY_i, Key_L) \
   OP(XKB_KEY_idotless, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_j, Key_Y) \
   OP(XKB_KEY_k, Key_N) \
   OP(XKB_KEY_kra, RALT(Key_N)) /* XKB_KEY_kappa, deprecated  */ \
   OP(XKB_KEY_l, Key_U) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_r, Key_S) \
   OP(XKB_KEY_registered, RALT(Key_S)) \
   ...
   OP(XKB_KEY_s, Key_D) \
   OP(XKB_KEY_section, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_threequarters, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(XKB_KEY_threesuperior, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_trademark, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_twosuperior, RALT(LSHIFT(Key_2))) \
   OP(XKB_KEY_u, Key_I) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_uparrow, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_O) \
   OP(XKB_KEY_yen, RALT(Key_6)) \
   OP(XKB_KEY_z, Key_Z) \
