...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¨', Key_RightBracket) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'¯', RALT(LSHIFT(Key_RightBracket))) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'¸', RALT(Key_Comma)) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'˙', RALT(LSHIFT(Key_Period))) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
   OP(L'˛', RALT(LSHIFT(Key_Equals))) /* U+02db, XKB_KEY_ogonek, OGONEK */ \
   OP(L'˝', RALT(LSHIFT(Key_Semicolon))) /* U+02dd, XKB_KEY_doubleacute, DOUBLE ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abovedot, RALT(LSHIFT(Key_Period))) \
   ...
   OP(XKB_KEY_cedilla, RALT(Key_Comma)) \
   ...
   OP(XKB_KEY_diaeresis, Key_RightBracket) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_dollar, RALT(Key_4)) \
   OP(XKB_KEY_doubleacute, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(LSHIFT(Key_RightBracket))) \
