...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', RALT(Key_NonUsPound)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('<', RALT(LSHIFT(Key_3))) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(LSHIFT(Key_4))) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('\\', Key_Equals) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_9)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('^', RALT(LSHIFT(Key_RightBracket))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP('|', Key_Backtick) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(LSHIFT(Key_Equals))) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', RALT(Key_NonUsPound)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'<', RALT(LSHIFT(Key_3))) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(LSHIFT(Key_4))) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'\\', Key_Equals) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_9)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'^', RALT(LSHIFT(Key_RightBracket))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'|', Key_Backtick) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(LSHIFT(Key_Equals))) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'¦', RALT(Key_Backtick)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', RALT(Key_6)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_1)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_F)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(LSHIFT(Key_V))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_J)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'­', RALT(LSHIFT(Key_L))) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', RALT(Key_L)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'´', RALT(Key_Equals)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'¶', RALT(LSHIFT(Key_6))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_Period))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'»', RALT(LSHIFT(Key_B))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¿', RALT(LSHIFT(Key_Minus))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'À', RALT(LSHIFT(Key_A))) /* U+00c0, XKB_KEY_Agrave, LATIN CAPITAL LETTER A WITH GRAVE */ \
   OP(L'Á', LSHIFT(Key_Q)) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Â', RALT(LSHIFT(Key_LeftBracket))) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   OP(L'Ä', RALT(LSHIFT(Key_Quote))) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Å', LSHIFT(Key_LeftBracket)) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   OP(L'Æ', LSHIFT(Key_Quote)) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ç', RALT(LSHIFT(Key_C))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'É', RALT(LSHIFT(Key_E))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Ï', RALT(LSHIFT(Key_I))) /* U+00cf, XKB_KEY_Idiaeresis, LATIN CAPITAL LETTER I WITH DIAERESIS */ \
   OP(L'Ð', RALT(LSHIFT(Key_D))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ö', RALT(LSHIFT(Key_Semicolon))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'×', RALT(LSHIFT(Key_J))) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Ø', LSHIFT(Key_Semicolon)) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ü', RALT(LSHIFT(Key_U))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'à', RALT(Key_A)) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   OP(L'á', Key_Q) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'â', RALT(Key_LeftBracket)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'ä', RALT(Key_Quote)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', Key_LeftBracket) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', Key_Quote) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_C)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'é', RALT(Key_E)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ï', RALT(Key_I)) /* U+00ef, XKB_KEY_idiaeresis, LATIN SMALL LETTER I WITH DIAERESIS */ \
   OP(L'ð', RALT(Key_D)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ö', RALT(Key_Semicolon)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(Key_Minus)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', Key_Semicolon) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ü', RALT(Key_U)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'Č', LSHIFT(Key_X)) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', Key_X) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Đ', LSHIFT(Key_NonUsPound)) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', Key_NonUsPound) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ŋ', LSHIFT(Key_RightBracket)) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ŋ', Key_RightBracket) /* U+014b, XKB_KEY_eng, LATIN SMALL LETTER ENG */ \
   OP(L'Œ', RALT(LSHIFT(Key_O))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_O)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Š', LSHIFT(Key_W)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_W) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   ...
   OP(L'Ž', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_NonUsBackslashAndPipe) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'Ʒ', RALT(LSHIFT(Key_Z))) /* U+01b7, XKB_KEY_EZH, LATIN CAPITAL LETTER EZH */ \
   OP(L'Ǥ', RALT(LSHIFT(Key_H))) \
   OP(L'ǥ', RALT(Key_H)) \
   OP(L'Ǧ', RALT(LSHIFT(Key_G))) /* U+01e6, XKB_KEY_Gcaron, LATIN CAPITAL LETTER G WITH CARON */ \
   OP(L'ǧ', RALT(Key_G)) /* U+01e7, XKB_KEY_gcaron, LATIN SMALL LETTER G WITH CARON */ \
   OP(L'Ǩ', RALT(LSHIFT(Key_K))) \
   OP(L'ǩ', RALT(Key_K)) \
   OP(L'Ǯ', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(L'ǯ', RALT(Key_NonUsBackslashAndPipe)) \
   OP(L'ʒ', RALT(Key_Z)) /* U+0292, XKB_KEY_ezh, LATIN SMALL LETTER EZH */ \
   OP(L'–', RALT(Key_Slash)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Slash))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(Key_N)) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_M)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(Key_Comma)) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_N))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_M))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_Comma))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'•', RALT(Key_5)) \
   OP(L'…', RALT(Key_Period)) /* U+2026, XKB_KEY_ellipsis, HORIZONTAL ELLIPSIS */ \
   OP(L'‰', RALT(LSHIFT(Key_5))) \
   OP(L'™', RALT(LSHIFT(Key_R))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'≠', RALT(LSHIFT(Key_0))) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
   OP(L'≤', RALT(Key_V)) /* U+2264, XKB_KEY_lessthanequal, LESS-THAN OR EQUAL TO */ \
   OP(L'≥', RALT(Key_B)) /* U+2265, XKB_KEY_greaterthanequal, GREATER-THAN OR EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Aacute, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Acircumflex, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_Adiaeresis, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_Agrave, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_Alt_L, Key_LeftAlt) /* XKB_KEY_Alt_L, Left alt  */ \
   OP(XKB_KEY_Aring, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Ccaron, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Dstroke, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_E, LSHIFT(Key_E)) \
   OP(XKB_KEY_ENG, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_ETH, RALT(LSHIFT(Key_D))) /* XKB_KEY_Eth, deprecated  */ \
   OP(XKB_KEY_EZH, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Gcaron, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_Zcaron, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, Key_Q) \
   OP(XKB_KEY_acircumflex, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_acute, RALT(Key_Equals)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_Quote)) \
   OP(XKB_KEY_ae, Key_Quote) \
   OP(XKB_KEY_agrave, RALT(Key_A)) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_6)) \
   OP(XKB_KEY_apostrophe, RALT(Key_NonUsPound)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_aring, Key_LeftBracket) \
   OP(XKB_KEY_asciicircum, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_asciitilde, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_asterisk, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_at, RALT(Key_2)) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, Key_Equals) \
   OP(XKB_KEY_bar, Key_Backtick) \
   ...
   OP(XKB_KEY_brokenbar, RALT(Key_Backtick)) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccaron, Key_X) \
   OP(XKB_KEY_ccedilla, RALT(Key_C)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Period)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_1)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_degree, RALT(Key_L)) \
   OP(XKB_KEY_division, RALT(Key_Minus)) \
   OP(XKB_KEY_dollar, RALT(Key_4)) \
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_dstroke, Key_NonUsPound) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, RALT(Key_E)) \
   OP(XKB_KEY_ellipsis, RALT(Key_Period)) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_endash, RALT(Key_Slash)) \
   OP(XKB_KEY_eng, Key_RightBracket) \
   ...
   OP(XKB_KEY_ezh, RALT(Key_Z)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcaron, RALT(Key_G)) \
   OP(XKB_KEY_grave, LSHIFT(Key_Equals)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_greaterthanequal, RALT(Key_B)) \
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hyphen, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_idiaeresis, RALT(Key_I)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_leftsinglequotemark, RALT(Key_N)) \
   OP(XKB_KEY_less, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_lessthanequal, RALT(Key_V)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_Slash) \
   OP(XKB_KEY_multiply, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_notequal, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_notsign, RALT(Key_J)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_odiaeresis, RALT(Key_Semicolon)) \
   OP(XKB_KEY_oe, RALT(Key_O)) \
   OP(XKB_KEY_ordfeminine, RALT(Key_F)) \
   OP(XKB_KEY_oslash, Key_Semicolon) \
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_6))) \
   ...
   OP(XKB_KEY_periodcentered, RALT(LSHIFT(Key_Period))) \
   ...
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_M)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scaron, Key_W) \
   OP(XKB_KEY_section, RALT(Key_6)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_singlelowquotemark, RALT(Key_Comma)) \
   ...
   OP(XKB_KEY_trademark, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_tslash, RALT(Key_T)) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_udiaeresis, RALT(Key_U)) \
   ...
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, Key_NonUsBackslashAndPipe) \
