...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('@', Key_NonUsPound) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('`', Key_Equals) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'@', Key_NonUsPound) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'`', Key_Equals) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'´', LSHIFT(Key_Equals)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, Key_Equals) /* XKB_KEY_quoteleft, deprecated  */ \
