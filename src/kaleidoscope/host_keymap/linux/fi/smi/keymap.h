...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_Semicolon))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   ...
   OP(L'ø', RALT(Key_Semicolon)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_oslash, RALT(Key_Semicolon)) \
   OP(XKB_KEY_p, Key_P) \
