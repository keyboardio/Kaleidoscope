...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', RALT(LSHIFT(Key_4))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'»', RALT(LSHIFT(Key_3))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Ŋ', RALT(LSHIFT(Key_N))) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ŋ', RALT(Key_N)) /* U+014b, XKB_KEY_eng, LATIN SMALL LETTER ENG */ \
   ...
   OP(L'—', RALT(LSHIFT(Key_M))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_Comma))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_Comma)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(Key_6)) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ENG, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_dead_belowcomma, RALT(LSHIFT(Key_Slash))) /* XKB_KEY_dead_belowcomma */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_Period)) /* XKB_KEY_dead_belowdot */ \
   ...
   OP(XKB_KEY_dead_doubleacute, RALT(Key_LeftBracket)) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, LSHIFT(Key_Equals)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(LSHIFT(Key_P))) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(Key_P)) /* XKB_KEY_dead_horn */ \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_endash, RALT(Key_Slash)) \
   OP(XKB_KEY_eng, RALT(Key_N)) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
