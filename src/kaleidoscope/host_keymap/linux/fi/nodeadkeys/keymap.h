...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ª', RALT(LSHIFT(Key_6))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'¬', RALT(LSHIFT(Key_Period))) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   ...
   OP(L'±', RALT(LSHIFT(Key_7))) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   ...
   OP(L'º', RALT(LSHIFT(Key_5))) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'¼', RALT(Key_Backtick)) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   ...
   OP(L'÷', RALT(LSHIFT(Key_X))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   ...
   OP(L'ˇ', RALT(Key_NonUsPound)) /* U+02c7, XKB_KEY_caron, CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caron, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_division, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_masculine, RALT(LSHIFT(Key_5))) \
   ...
   OP(XKB_KEY_notsign, RALT(LSHIFT(Key_Period))) \
   ...
   OP(XKB_KEY_onequarter, RALT(Key_Backtick)) \
   OP(XKB_KEY_onesuperior, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_6))) \
   ...
   OP(XKB_KEY_plusminus, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_q, Key_Q) \
