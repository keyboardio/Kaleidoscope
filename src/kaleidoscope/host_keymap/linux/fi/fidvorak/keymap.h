...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('<', RALT(Key_W)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_RightBracket) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_E)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'<', RALT(Key_W)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_RightBracket) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_E)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'¢', RALT(Key_2)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'¬', RALT(Key_P)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'­', RALT(Key_N)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'°', RALT(LSHIFT(Key_0))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_B))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'Å', RALT(LSHIFT(Key_S))) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   OP(L'Æ', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_X))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ü', RALT(LSHIFT(Key_F))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'å', RALT(Key_S)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', RALT(Key_NonUsBackslashAndPipe)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   ...
   OP(L'ø', RALT(Key_X)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ü', RALT(Key_F)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'Ə', RALT(LSHIFT(Key_A))) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'Ʒ', RALT(LSHIFT(Key_Slash))) /* U+01b7, XKB_KEY_EZH, LATIN CAPITAL LETTER EZH */ \
   OP(L'ə', RALT(Key_A)) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   OP(L'ʒ', RALT(Key_Slash)) /* U+0292, XKB_KEY_ezh, LATIN SMALL LETTER EZH */ \
   OP(L'ẞ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'–', RALT(Key_Quote)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Quote))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_W))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_7))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_5))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_2))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_6))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'‰', RALT(Key_5)) /* U+2030, XKB_KEY_permille, PER MILLE SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EZH, RALT(LSHIFT(Key_Slash))) \
   ...
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_SCHWA, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_F))) \
   ...
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_cent, RALT(Key_2)) \
   OP(XKB_KEY_colon, LSHIFT(Key_E)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_currency, RALT(Key_4)) \
   OP(XKB_KEY_d, Key_H) \
   OP(XKB_KEY_dead_abovering, RALT(Key_0)) /* XKB_KEY_dead_abovering */ \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(Key_Z)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Q))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Backtick)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_macron, RALT(LSHIFT(Key_Z))) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_endash, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_ezh, RALT(Key_Slash)) \
   OP(XKB_KEY_f, Key_Y) \
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_E)) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_hyphen, RALT(Key_N)) \
   OP(XKB_KEY_i, Key_G) \
   ...
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_leftsinglequotemark, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_less, RALT(Key_W)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_Quote) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_multiply, RALT(Key_B)) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_notsign, RALT(Key_P)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_odiaeresis, Key_Z) \
   OP(XKB_KEY_oslash, RALT(Key_X)) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_periodcentered, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_permille, RALT(Key_5)) \
   ...
   OP(XKB_KEY_schwa, RALT(Key_A)) \
   OP(XKB_KEY_section, RALT(Key_7)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_W)) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_7))) \
   ...
   OP(XKB_KEY_u, Key_F) \
   OP(XKB_KEY_udiaeresis, RALT(Key_F)) \
