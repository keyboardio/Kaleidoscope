...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_K)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', Key_Backtick) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('$', LSHIFT(Key_Period)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP('%', LSHIFT(Key_Semicolon)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('\'', LSHIFT(Key_Backtick)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', LSHIFT(Key_X)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_Slash)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP('*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP('+', Key_KeypadAdd) /* XKB_KEY_KP_Add */ \
   OP(',', Key_KeypadDot) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_KeypadSubtract) /* XKB_KEY_KP_Subtract */ \
   OP('.', LSHIFT(Key_D)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   OP('/', Key_NonUsPound) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   OP('0', LSHIFT(Key_W)) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   ...
   OP('5', LSHIFT(Key_7)) /* U+0035, XKB_KEY_5, DIGIT FIVE */ \
   OP('6', LSHIFT(Key_8)) /* U+0036, XKB_KEY_6, DIGIT SIX */ \
   OP('7', LSHIFT(Key_9)) /* U+0037, XKB_KEY_7, DIGIT SEVEN */ \
   OP('8', LSHIFT(Key_0)) /* U+0038, XKB_KEY_8, DIGIT EIGHT */ \
   OP('9', LSHIFT(Key_Minus)) /* U+0039, XKB_KEY_9, DIGIT NINE */ \
   OP(':', LSHIFT(Key_G)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', LSHIFT(Key_S)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('<', Key_NonUsBackslashAndPipe) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_Quote)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', LSHIFT(Key_L)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP('\\', LSHIFT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP('_', LSHIFT(Key_R)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('x', LSHIFT(Key_V)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_K)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', Key_Backtick) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'$', LSHIFT(Key_Period)) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP(L'%', LSHIFT(Key_Semicolon)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'\'', LSHIFT(Key_Backtick)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', LSHIFT(Key_X)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_Slash)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP(L'*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP(L'+', Key_KeypadAdd) /* XKB_KEY_KP_Add */ \
   OP(L',', Key_KeypadDot) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_KeypadSubtract) /* XKB_KEY_KP_Subtract */ \
   OP(L'.', LSHIFT(Key_D)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   OP(L'/', Key_NonUsPound) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   OP(L'0', LSHIFT(Key_W)) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   ...
   OP(L'5', LSHIFT(Key_7)) /* U+0035, XKB_KEY_5, DIGIT FIVE */ \
   OP(L'6', LSHIFT(Key_8)) /* U+0036, XKB_KEY_6, DIGIT SIX */ \
   OP(L'7', LSHIFT(Key_9)) /* U+0037, XKB_KEY_7, DIGIT SEVEN */ \
   OP(L'8', LSHIFT(Key_0)) /* U+0038, XKB_KEY_8, DIGIT EIGHT */ \
   OP(L'9', LSHIFT(Key_Minus)) /* U+0039, XKB_KEY_9, DIGIT NINE */ \
   OP(L':', LSHIFT(Key_G)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', LSHIFT(Key_S)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'<', Key_NonUsBackslashAndPipe) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_Quote)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', LSHIFT(Key_L)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   OP(L'\\', LSHIFT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L'_', LSHIFT(Key_R)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'x', LSHIFT(Key_V)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   ...
   OP(L'ຢ', Key_1) \
   OP(L'ຣ', LSHIFT(Key_I)) \
   OP(L'ລ', Key_RightBracket) \
   OP(L'ວ', Key_Semicolon) \
   OP(L'ສ', Key_L) \
   OP(L'ຫ', Key_S) \
   OP(L'ອ', Key_V) \
   OP(L'ຮ', Key_I) \
   ...
   OP(L'໙', RALT(Key_9)) \
   OP(L'ໜ', LSHIFT(Key_O)) \
   OP(L'ໝ', LSHIFT(Key_Comma)) \
   OP(L'₭', LSHIFT(Key_Z)) \

#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   OP(XKB_KEY_0, LSHIFT(Key_W)) \
   OP(XKB_KEY_1, LSHIFT(Key_1)) \
   OP(XKB_KEY_2, LSHIFT(Key_2)) \
   OP(XKB_KEY_3, LSHIFT(Key_3)) \
   OP(XKB_KEY_4, LSHIFT(Key_4)) \
   OP(XKB_KEY_5, LSHIFT(Key_7)) \
   OP(XKB_KEY_6, LSHIFT(Key_8)) \
   OP(XKB_KEY_7, LSHIFT(Key_9)) \
   OP(XKB_KEY_8, LSHIFT(Key_0)) \
   OP(XKB_KEY_9, LSHIFT(Key_Minus)) \
   ...
   OP(XKB_KEY_asterisk, LSHIFT(Key_E)) \
   OP(XKB_KEY_backslash, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_bar, RALT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_brokenbar, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(XKB_KEY_colon, LSHIFT(Key_G)) \
   OP(XKB_KEY_comma, Key_KeypadDot) \
   OP(XKB_KEY_dollar, LSHIFT(Key_Period)) \
   OP(XKB_KEY_equal, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_exclam, LSHIFT(Key_K)) \
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_minus, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_X)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_percent, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_period, LSHIFT(Key_D)) \
   OP(XKB_KEY_plus, LSHIFT(Key_T)) \
   OP(XKB_KEY_question, LSHIFT(Key_L)) \
   OP(XKB_KEY_quotedbl, Key_Backtick) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_S)) \
   OP(XKB_KEY_slash, Key_NonUsPound) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_underscore, LSHIFT(Key_R)) \
   OP(XKB_KEY_x, LSHIFT(Key_V)) \
