...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', LSHIFT(Key_F)) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP('`', LSHIFT(Key_Comma)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', LSHIFT(Key_F)) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(L'`', LSHIFT(Key_Comma)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'໗', LSHIFT(Key_9)) \
   OP(L'໘', LSHIFT(Key_0)) \
   OP(L'໙', LSHIFT(Key_Minus)) \
   OP(L'ໜ', Key_NonUsPound) \
   OP(L'ໝ', LSHIFT(Key_NonUsPound)) \
   OP(L'‍', Key_Backtick) \
   OP(L'₭', LSHIFT(Key_Z)) \
