...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ŋ', LSHIFT(Key_C)) \
   OP(L'ŋ', Key_C) \
   OP(L'Ɔ', LSHIFT(Key_LeftBracket)) \
   OP(L'Ɖ', LSHIFT(Key_NonUsPound)) \
   OP(L'Ɛ', LSHIFT(Key_Q)) \
   OP(L'Ƒ', LSHIFT(Key_J)) \
   OP(L'ƒ', Key_J) \
   OP(L'Ɣ', RALT(LSHIFT(Key_G))) \
   OP(L'Ʋ', LSHIFT(Key_RightBracket)) \
   OP(L'ɔ', Key_LeftBracket) \
   OP(L'ɖ', Key_NonUsPound) \
   OP(L'ɛ', Key_Q) \
   OP(L'ɣ', RALT(Key_G)) \
   OP(L'ʋ', Key_RightBracket) \
   OP(L'₵', LSHIFT(Key_4)) \
