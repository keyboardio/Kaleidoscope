...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ç', RALT(LSHIFT(Key_C))) \
   OP(L'ç', RALT(Key_C)) \
   OP(L'Ŋ', LSHIFT(Key_Equals)) \
   OP(L'ŋ', Key_Equals) \
   OP(L'Ɔ', LSHIFT(Key_RightBracket)) \
   OP(L'Ɖ', RALT(LSHIFT(Key_D))) \
   OP(L'Ǝ', RALT(LSHIFT(Key_E))) \
   OP(L'Ɛ', LSHIFT(Key_LeftBracket)) \
   OP(L'Ƒ', RALT(LSHIFT(Key_F))) \
   OP(L'ƒ', RALT(Key_F)) \
   OP(L'Ɣ', RALT(LSHIFT(Key_G))) \
   OP(L'Ɩ', LSHIFT(Key_X)) \
   OP(L'Ʊ', RALT(LSHIFT(Key_U))) \
   OP(L'Ʋ', LSHIFT(Key_Q)) \
   OP(L'Ʒ', RALT(LSHIFT(Key_Z))) /* U+01b7, XKB_KEY_EZH, LATIN CAPITAL LETTER EZH */ \
   OP(L'ǝ', RALT(Key_E)) \
   OP(L'ɔ', Key_RightBracket) \
   OP(L'ɖ', RALT(Key_D)) \
   ...
   OP(L'̄', RALT(LSHIFT(Key_Minus))) \
   OP(L'̱', RALT(Key_Minus)) \
