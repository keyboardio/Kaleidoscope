...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ƶ', RALT(LSHIFT(Key_Z))) /* U+01b5, XKB_KEY_Zstroke, LATIN CAPITAL LETTER Z WITH STROKE */ \
   OP(L'ƶ', RALT(Key_Z)) /* U+01b6, XKB_KEY_zstroke, LATIN SMALL LETTER Z WITH STROKE */ \
   OP(L'ɔ', RALT(Key_C)) \
   OP(L'ɖ', RALT(Key_D)) \
   OP(L'ɛ', RALT(Key_E)) \
   OP(L'ɣ', RALT(Key_G)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zstroke, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_a, Key_A) \
