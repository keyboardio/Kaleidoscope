...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(';', Key_Slash) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('B', LSHIFT(Key_Period)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   ...
   OP('G', LSHIFT(Key_I)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   ...
   OP('L', LSHIFT(Key_N)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP('Q', LSHIFT(Key_Y)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP('b', Key_Period) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   ...
   OP('g', Key_I) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   ...
   OP('l', Key_N) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP('q', Key_Y) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L';', Key_Slash) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'B', LSHIFT(Key_Period)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   ...
   OP(L'G', LSHIFT(Key_I)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   ...
   OP(L'L', LSHIFT(Key_N)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP(L'Q', LSHIFT(Key_Y)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP(L'b', Key_Period) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   ...
   OP(L'g', Key_I) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   ...
   OP(L'l', Key_N) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP(L'q', Key_Y) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP(L'¤', RALT(LSHIFT(Key_2))) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   ...
   OP(L'¬', RALT(Key_Quote)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'®', RALT(Key_O)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', RALT(LSHIFT(Key_5))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(Key_RightBracket)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   ...
   OP(L'¶', RALT(LSHIFT(Key_O))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_X))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'»', RALT(LSHIFT(Key_Z))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'¿', RALT(LSHIFT(Key_LeftBracket))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'Æ', RALT(LSHIFT(Key_S))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_A))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'æ', RALT(Key_S)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   ...
   OP(L'ø', RALT(Key_A)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'İ', RALT(LSHIFT(Key_F))) \
   OP(L'ı', RALT(Key_F)) \
   OP(L'Œ', RALT(LSHIFT(Key_D))) \
   OP(L'œ', RALT(Key_D)) \
   OP(L'Ə', RALT(LSHIFT(Key_NonUsPound))) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'ə', RALT(Key_NonUsPound)) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   OP(L'̀', RALT(Key_Backtick)) \
   OP(L'́', RALT(Key_Q)) \
   OP(L'̂', RALT(LSHIFT(Key_6))) \
   OP(L'̃', RALT(LSHIFT(Key_Backtick))) \
   OP(L'̋', RALT(LSHIFT(Key_Q))) \
   OP(L'̧', RALT(Key_W)) \
   OP(L'̨', RALT(LSHIFT(Key_W))) \
   OP(L'͠', RALT(LSHIFT(Key_Quote))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_Alt_L, Key_LeftAlt) /* XKB_KEY_Alt_L, Left alt  */ \
   OP(XKB_KEY_B, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_SCHWA, RALT(LSHIFT(Key_NonUsPound))) \
   ...
   OP(XKB_KEY_currency, RALT(LSHIFT(Key_2))) \
   OP(XKB_KEY_d, Key_H) \
   ...
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_F) \
   OP(XKB_KEY_j, Key_B) \
   OP(XKB_KEY_k, Key_P) \
   ...
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_notsign, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_oslash, RALT(Key_A)) \
   OP(XKB_KEY_p, Key_R) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_O))) \
