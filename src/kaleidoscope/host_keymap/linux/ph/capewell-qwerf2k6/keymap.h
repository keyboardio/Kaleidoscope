...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('F', LSHIFT(Key_T)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP('K', LSHIFT(Key_I)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   ...
   OP('P', LSHIFT(Key_Semicolon)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP('U', LSHIFT(Key_J)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   ...
   OP('f', Key_T) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   ...
   OP('k', Key_I) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   ...
   OP('p', Key_Semicolon) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP('u', Key_J) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'F', LSHIFT(Key_T)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP(L'K', LSHIFT(Key_I)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   ...
   OP(L'P', LSHIFT(Key_Semicolon)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP(L'U', LSHIFT(Key_J)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   ...
   OP(L'f', Key_T) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   ...
   OP(L'k', Key_I) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   ...
   OP(L'p', Key_Semicolon) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP(L'u', Key_J) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   ...
   OP(L'¥', RALT(Key_U)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   ...
   OP(L'ª', RALT(LSHIFT(Key_T))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'¶', RALT(LSHIFT(Key_R))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   ...
   OP(L'İ', RALT(LSHIFT(Key_K))) \
   OP(L'ı', RALT(Key_K)) \
   OP(L'Œ', RALT(LSHIFT(Key_E))) \
   OP(L'œ', RALT(Key_E)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_P, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_T))) \
   OP(XKB_KEY_oslash, RALT(Key_L)) \
   OP(XKB_KEY_p, Key_Semicolon) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_R))) \
