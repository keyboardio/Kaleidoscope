...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¥', RALT(Key_O)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'¦', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', RALT(Key_D)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(LSHIFT(Key_E))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_Z)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_Minus)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   ...
   OP(L'¶', RALT(LSHIFT(Key_S))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   ...
   OP(L'İ', RALT(LSHIFT(Key_L))) \
   OP(L'ı', RALT(Key_L)) \
   OP(L'Œ', RALT(LSHIFT(Key_K))) \
   OP(L'œ', RALT(Key_K)) \
   ...
   OP(L'́', RALT(Key_Quote)) \
   OP(L'̂', RALT(LSHIFT(Key_6))) \
   OP(L'̃', RALT(LSHIFT(Key_Backtick))) \
   OP(L'̋', RALT(LSHIFT(Key_Quote))) \
   OP(L'̧', RALT(Key_Comma)) \
   OP(L'̨', RALT(LSHIFT(Key_Comma))) \
   OP(L'͠', RALT(LSHIFT(Key_Minus))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_n, Key_J) \
   OP(XKB_KEY_notsign, RALT(Key_Minus)) \
   ...
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_oslash, RALT(Key_Semicolon)) \
   OP(XKB_KEY_p, Key_R) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_S))) \
