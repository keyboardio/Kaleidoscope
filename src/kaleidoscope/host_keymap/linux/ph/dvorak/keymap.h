...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'»', RALT(LSHIFT(Key_Slash))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
