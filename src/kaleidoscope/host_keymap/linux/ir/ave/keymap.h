...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'𐬀', Key_A) \
   OP(L'𐬁', LSHIFT(Key_A)) \
   OP(L'𐬂', Key_RightBracket) \
   OP(L'𐬃', LSHIFT(Key_RightBracket)) \
   OP(L'𐬄', Key_NonUsPound) \
   OP(L'𐬅', LSHIFT(Key_NonUsPound)) \
   OP(L'𐬆', Key_LeftBracket) \
   OP(L'𐬇', LSHIFT(Key_LeftBracket)) \
   OP(L'𐬈', Key_E) \
   OP(L'𐬉', LSHIFT(Key_E)) \
   OP(L'𐬊', Key_O) \
   OP(L'𐬋', LSHIFT(Key_O)) \
