...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('X', LSHIFT(Key_E)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP('i', Key_R) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   ...
   OP('x', Key_E) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'X', LSHIFT(Key_E)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP(L'i', Key_R) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   ...
   OP(L'x', Key_E) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   ...
   OP(L'Ê', LSHIFT(Key_X)) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Î', LSHIFT(Key_S)) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ô', RALT(LSHIFT(Key_T))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ö', RALT(LSHIFT(Key_X))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'×', RALT(Key_Comma)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Û', LSHIFT(Key_A)) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
   OP(L'Ü', RALT(LSHIFT(Key_A))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'ê', Key_X) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'î', Key_S) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ô', RALT(Key_T)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'ö', RALT(Key_X)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(Key_Period)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'û', Key_A) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
   OP(L'ü', RALT(Key_A)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Ğ', RALT(LSHIFT(Key_E))) /* U+011e, XKB_KEY_Gbreve, LATIN CAPITAL LETTER G WITH BREVE */ \
   OP(L'ğ', RALT(Key_E)) /* U+011f, XKB_KEY_gbreve, LATIN SMALL LETTER G WITH BREVE */ \
   OP(L'İ', RALT(LSHIFT(Key_S))) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ecircumflex, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Gbreve, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Iabovedot, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_Icircumflex, LSHIFT(Key_S)) \
   ...
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_odiaeresis, RALT(Key_X)) \
   ...
   OP(XKB_KEY_u, Key_G) \
   OP(XKB_KEY_ucircumflex, Key_A) \
   OP(XKB_KEY_udiaeresis, RALT(Key_A)) \
