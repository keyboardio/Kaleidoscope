...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ဥ', LSHIFT(Key_U)) \
   OP(L'ဦ', LSHIFT(Key_M)) \
   OP(L'ဧ', LSHIFT(Key_LeftBracket)) \
   OP(L'ဩ', Key_RightBracket) \
   OP(L'ဪ', LSHIFT(Key_RightBracket)) \
   OP(L'ါ', Key_G) \
   OP(L'ာ', Key_M) \
   OP(L'ိ', Key_D) \
   OP(L'ီ', LSHIFT(Key_D)) \
