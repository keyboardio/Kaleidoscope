...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¥', RALT(Key_2)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   ...
   OP(L'Ḓ', RALT(LSHIFT(Key_D))) \
   OP(L'ḓ', RALT(Key_D)) \
   OP(L'Ḽ', RALT(LSHIFT(Key_L))) \
   OP(L'ḽ', RALT(Key_L)) \
   OP(L'Ṅ', RALT(LSHIFT(Key_M))) \
   OP(L'ṅ', RALT(Key_M)) \
   OP(L'Ṋ', RALT(LSHIFT(Key_N))) \
   OP(L'ṋ', RALT(Key_N)) \
   OP(L'Ṱ', RALT(LSHIFT(Key_T))) \
   OP(L'ṱ', RALT(Key_T)) \
