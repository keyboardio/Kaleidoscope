...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('*', Key_Minus) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'*', Key_Minus) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   ...
   OP(L'é', LSHIFT(Key_Backtick)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, LSHIFT(Key_Backtick)) \
