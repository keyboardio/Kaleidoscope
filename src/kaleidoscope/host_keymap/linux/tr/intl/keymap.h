...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'±', RALT(Key_Backtick)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   ...
   OP(L'÷', RALT(Key_Equals)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_circumflex, LSHIFT(Key_3)) /* XKB_KEY_dead_circumflex */ \
   ...
   OP(XKB_KEY_division, RALT(Key_Equals)) \
   ...
   OP(XKB_KEY_plusminus, RALT(Key_Backtick)) \
   OP(XKB_KEY_q, Key_Q) \
