...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ğ', RALT(LSHIFT(Key_G))) /* U+011e, XKB_KEY_Gbreve, LATIN CAPITAL LETTER G WITH BREVE */ \
   OP(L'ğ', RALT(Key_G)) /* U+011f, XKB_KEY_gbreve, LATIN SMALL LETTER G WITH BREVE */ \
   ...
   OP(L'İ', RALT(LSHIFT(Key_I))) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
   ...
   OP(L'─', RALT(Key_Minus)) /* U+2500, XKB_KEY_horizlinescan5, BOX DRAWINGS LIGHT HORIZONTAL */ \
   OP(L'│', RALT(LSHIFT(Key_Minus))) /* U+2502, XKB_KEY_vertbar, BOX DRAWINGS LIGHT VERTICAL */ \
   OP(L'┌', RALT(LSHIFT(Key_7))) /* U+250c, XKB_KEY_upleftcorner, BOX DRAWINGS LIGHT DOWN AND RIGHT */ \
   OP(L'┐', RALT(LSHIFT(Key_0))) /* U+2510, XKB_KEY_uprightcorner, BOX DRAWINGS LIGHT DOWN AND LEFT */ \
   OP(L'└', RALT(Key_7)) /* U+2514, XKB_KEY_lowleftcorner, BOX DRAWINGS LIGHT UP AND RIGHT */ \
   OP(L'┘', RALT(Key_0)) /* U+2518, XKB_KEY_lowrightcorner, BOX DRAWINGS LIGHT UP AND LEFT */ \
   OP(L'├', RALT(Key_8)) /* U+251c, XKB_KEY_leftt, BOX DRAWINGS LIGHT VERTICAL AND RIGHT */ \
   OP(L'┤', RALT(Key_9)) /* U+2524, XKB_KEY_rightt, BOX DRAWINGS LIGHT VERTICAL AND LEFT */ \
   OP(L'┬', RALT(LSHIFT(Key_8))) /* U+252c, XKB_KEY_topt, BOX DRAWINGS LIGHT DOWN AND HORIZONTAL */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Gbreve, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_Iabovedot, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_bott, RALT(LSHIFT(Key_9))) \
   ...
   OP(XKB_KEY_crossinglines, RALT(Key_Equals)) \
   OP(XKB_KEY_d, Key_D) \
   ...
   OP(XKB_KEY_horizlinescan5, RALT(Key_Minus)) \
   ...
   OP(XKB_KEY_leftt, RALT(Key_8)) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_lowleftcorner, RALT(Key_7)) \
   OP(XKB_KEY_lowrightcorner, RALT(Key_0)) \
   ...
   OP(XKB_KEY_topt, RALT(LSHIFT(Key_8))) \
   ...
   OP(XKB_KEY_upleftcorner, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_uprightcorner, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_vertbar, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
