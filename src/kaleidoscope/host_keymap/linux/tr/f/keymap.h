...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('/', Key_Minus) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP('X', LSHIFT(Key_NonUsPound)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP('x', Key_NonUsPound) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'/', Key_Minus) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP(L'X', LSHIFT(Key_NonUsPound)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP(L'x', Key_NonUsPound) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_X, LSHIFT(Key_NonUsPound)) \
