...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', Key_LeftBracket) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_Quote) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP('.', Key_Z) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(';', LSHIFT(Key_LeftBracket)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('`', RALT(LSHIFT(Key_Period))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', Key_LeftBracket) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_Quote) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP(L'.', Key_Z) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(L';', LSHIFT(Key_LeftBracket)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'`', RALT(LSHIFT(Key_Period))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'ª', RALT(LSHIFT(Key_Y))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_Slash)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'·', RALT(Key_Z)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'Ä', LSHIFT(Key_W)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   ...
   OP(L'Ö', LSHIFT(Key_E)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'ä', Key_W) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   ...
   OP(L'ö', Key_E) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'Ħ', RALT(LSHIFT(Key_J))) /* U+0126, XKB_KEY_Hstroke, LATIN CAPITAL LETTER H WITH STROKE */ \
   OP(L'ħ', RALT(Key_J)) /* U+0127, XKB_KEY_hstroke, LATIN SMALL LETTER H WITH STROKE */ \
   OP(L'ı', RALT(LSHIFT(Key_G))) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'Ŋ', RALT(LSHIFT(Key_U))) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ŋ', RALT(Key_U)) /* U+014b, XKB_KEY_eng, LATIN SMALL LETTER ENG */ \
   ...
   OP(L'Ŧ', RALT(LSHIFT(Key_K))) /* U+0166, XKB_KEY_Tslash, LATIN CAPITAL LETTER T WITH STROKE */ \
   OP(L'ŧ', RALT(Key_K)) /* U+0167, XKB_KEY_tslash, LATIN SMALL LETTER T WITH STROKE */ \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'“', RALT(Key_Period)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   ...
   OP(L'←', RALT(Key_T)) /* U+2190, XKB_KEY_leftarrow, LEFTWARDS ARROW */ \
   OP(L'↑', RALT(LSHIFT(Key_F))) /* U+2191, XKB_KEY_uparrow, UPWARDS ARROW */ \
   OP(L'→', RALT(Key_G)) /* U+2192, XKB_KEY_rightarrow, RIGHTWARDS ARROW */ \
   OP(L'↓', RALT(Key_F)) /* U+2193, XKB_KEY_downarrow, DOWNWARDS ARROW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Adiaeresis, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_ENG, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Hstroke, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_E)) \
   ...
   OP(XKB_KEY_Tslash, RALT(LSHIFT(Key_K))) \
   ...
   OP(XKB_KEY_comma, Key_LeftBracket) \
   OP(XKB_KEY_copyright, RALT(Key_I)) \
   OP(XKB_KEY_currency, LSHIFT(Key_4)) \
   OP(XKB_KEY_d, Key_H) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_acute, Key_Equals) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_Quote)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_LeftBracket)) /* XKB_KEY_dead_cedilla */ \
   ...
   OP(XKB_KEY_dead_ogonek, RALT(LSHIFT(Key_LeftBracket))) /* XKB_KEY_dead_ogonek */ \
   ...
   OP(XKB_KEY_downarrow, RALT(Key_F)) \
   OP(XKB_KEY_dstroke, RALT(Key_Y)) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_eng, RALT(Key_U)) \
   ...
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, RALT(LSHIFT(Key_Period))) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_Slash)) \
   OP(XKB_KEY_guillemotright, RALT(Key_B)) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_hstroke, RALT(Key_J)) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_idotless, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_kra, RALT(Key_V)) /* XKB_KEY_kappa, deprecated  */ \
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_leftarrow, RALT(Key_T)) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_Period)) \
   ...
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_period, Key_Z) \
   OP(XKB_KEY_periodcentered, RALT(Key_Z)) \
