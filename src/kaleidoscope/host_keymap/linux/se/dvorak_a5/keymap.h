...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(':', RALT(Key_Z)) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP('>', RALT(Key_P)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('^', RALT(Key_J)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Quote)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', RALT(Key_Quote)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('|', RALT(Key_G)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(Key_Semicolon)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L':', RALT(Key_Z)) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP(L'>', RALT(Key_P)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'^', RALT(Key_J)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Quote)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', RALT(Key_Quote)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'|', RALT(Key_G)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(Key_Semicolon)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'»', RALT(LSHIFT(Key_9))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'ł', RALT(Key_Comma)) /* U+0142, XKB_KEY_lstroke, LATIN SMALL LETTER L WITH STROKE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_J)) \
   OP(XKB_KEY_asciitilde, RALT(Key_Semicolon)) \
   OP(XKB_KEY_asterisk, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_at, RALT(Key_2)) \
   OP(XKB_KEY_b, Key_N) \
   OP(XKB_KEY_backslash, RALT(Key_Minus)) \
   OP(XKB_KEY_bar, RALT(Key_G)) \
   ...
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, RALT(Key_Quote)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_P)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_Slash)) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   ...
   OP(XKB_KEY_lstroke, RALT(Key_Comma)) \
   OP(XKB_KEY_m, Key_M) \
