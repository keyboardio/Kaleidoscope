...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ˇ', RALT(LSHIFT(Key_RightBracket))) /* U+02c7, XKB_KEY_caron, CARON */ \
   OP(L'˙', RALT(LSHIFT(Key_Period))) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
   OP(L'˛', RALT(LSHIFT(Key_Comma))) /* U+02db, XKB_KEY_ogonek, OGONEK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caron, RALT(LSHIFT(Key_RightBracket))) \
   ...
   OP(XKB_KEY_ogonek, RALT(LSHIFT(Key_Comma))) \
