...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'«', RALT(LSHIFT(Key_8))) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Ш', LSHIFT(Key_Semicolon)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_Quote)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   ...
   OP(L'ш', Key_Semicolon) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_Quote) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_sha, Key_Semicolon) \
   OP(XKB_KEY_Cyrillic_shcha, Key_Quote) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(LSHIFT(Key_8))) \
