...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(':', LSHIFT(Key_NonUsPound)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', Key_NonUsPound) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('|', RALT(Key_Quote)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L':', LSHIFT(Key_NonUsPound)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', Key_NonUsPound) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'|', RALT(Key_Quote)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'Ä', LSHIFT(Key_Z)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Å', LSHIFT(Key_Q)) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   ...
   OP(L'Ö', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'ä', Key_Z) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', Key_Q) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   ...
   OP(L'ö', Key_NonUsBackslashAndPipe) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Adiaeresis, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Alt_L, Key_LeftAlt) /* XKB_KEY_Alt_L, Left alt  */ \
   OP(XKB_KEY_Aring, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_colon, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(Key_NonUsBackslashAndPipe)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_2))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Z)) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_odiaeresis, Key_NonUsBackslashAndPipe) \
   ...
   OP(XKB_KEY_semicolon, Key_NonUsPound) \
