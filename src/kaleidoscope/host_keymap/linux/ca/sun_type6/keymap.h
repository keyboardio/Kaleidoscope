...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', RALT(Key_Slash)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', RALT(Key_Slash)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'Ú', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   ...
   OP(L'ú', Key_NonUsBackslashAndPipe) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Uacute, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(Key_Slash)) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, Key_NonUsBackslashAndPipe) \
