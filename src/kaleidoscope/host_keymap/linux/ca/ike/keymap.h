...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('(', LSHIFT(Key_G)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_H)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP('?', LSHIFT(Key_V)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'(', LSHIFT(Key_G)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_H)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L'?', LSHIFT(Key_V)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'ᐅ', Key_S) \
   OP(L'ᐊ', Key_X) \
   OP(L'ᐞ', LSHIFT(Key_RightBracket)) \
   OP(L'ᐱ', LSHIFT(Key_W)) \
   OP(L'ᐳ', LSHIFT(Key_S)) \
   OP(L'ᐸ', LSHIFT(Key_X)) \
   OP(L'ᑉ', Key_2) \
   ...
   OP(L'ᕕ', LSHIFT(Key_F)) \
   OP(L'ᕗ', LSHIFT(Key_K)) \
   OP(L'ᕙ', LSHIFT(Key_Slash)) \
   OP(L'ᕝ', Key_Equals) \
   OP(L'ᕵ', LSHIFT(Key_Backtick)) \
   OP(L'ᕷ', LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(L'ᕹ', Key_NonUsBackslashAndPipe) \
   OP(L'ᕻ', Key_Backtick) \
   OP(L'ᕼ', LSHIFT(Key_B)) \
   OP(L'ᕿ', Key_E) \
   OP(L'ᖁ', Key_D) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_abovedot, Key_RightBracket) /* XKB_KEY_dead_abovedot */ \
   ...
   OP(XKB_KEY_parenleft, LSHIFT(Key_G)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_H)) \
   OP(XKB_KEY_period, Key_Period) \
   OP(XKB_KEY_question, LSHIFT(Key_V)) \
