...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('|', RALT(Key_Minus)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'|', RALT(Key_Minus)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'°', Key_Backtick) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_RightBracket))) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_degree, Key_Backtick) \
