...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'­', RALT(Key_Period)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'¯', RALT(Key_Comma)) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'¾', RALT(Key_Equals)) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_cedilla, Key_RightBracket) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, Key_LeftBracket) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, LSHIFT(Key_RightBracket)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_grave, Key_Quote) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hyphen, RALT(Key_Period)) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(Key_Comma)) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_threequarters, RALT(Key_Equals)) \
