...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('#', Key_Backtick) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP('\'', LSHIFT(Key_W)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('?', LSHIFT(Key_6)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP('{', RALT(Key_Q)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   ...
   OP('~', RALT(Key_Z)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'#', Key_Backtick) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP(L'\'', LSHIFT(Key_W)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'?', LSHIFT(Key_6)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'{', RALT(Key_Q)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   ...
   OP(L'~', RALT(Key_Z)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'¤', RALT(Key_5)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¦', RALT(Key_7)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   ...
   OP(L'­', RALT(Key_E)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'¯', RALT(Key_W)) /* U+00af, XKB_KEY_macron, MACRON */ \
   OP(L'°', RALT(Key_NonUsBackslashAndPipe)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(Key_1)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'²', RALT(Key_8)) /* U+00b2, XKB_KEY_twosuperior, SUPERSCRIPT TWO */ \
   OP(L'³', RALT(Key_9)) /* U+00b3, XKB_KEY_threesuperior, SUPERSCRIPT THREE */ \
   ...
   OP(L'¼', RALT(Key_0)) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(Key_Quote)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(Key_RightBracket)) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   OP(L'É', LSHIFT(Key_LeftBracket)) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'é', Key_LeftBracket) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_apostrophe, LSHIFT(Key_W)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciitilde, RALT(Key_Z)) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(Key_W)) \
   OP(XKB_KEY_minus, Key_Quote) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_notsign, RALT(Key_6)) \
   OP(XKB_KEY_numbersign, Key_Backtick) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_onehalf, RALT(Key_Quote)) \
   OP(XKB_KEY_onequarter, RALT(Key_0)) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_q, Key_X) \
   OP(XKB_KEY_question, LSHIFT(Key_6)) \
   ...
   OP(XKB_KEY_t, Key_K) \
   OP(XKB_KEY_threequarters, RALT(Key_RightBracket)) \
   OP(XKB_KEY_threesuperior, RALT(Key_9)) \
   OP(XKB_KEY_twosuperior, RALT(Key_8)) \
   OP(XKB_KEY_u, Key_F) \
