...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', LSHIFT(Key_Period)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', LSHIFT(Key_Comma)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('/', Key_Backtick) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP('}', RALT(Key_8)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', LSHIFT(Key_Period)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', LSHIFT(Key_Comma)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'/', Key_Backtick) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP(L'}', RALT(Key_8)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   ...
   OP(L'°', RALT(Key_Semicolon)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'½', RALT(Key_Minus)) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'À', LSHIFT(Key_NonUsPound)) /* U+00c0, XKB_KEY_Agrave, LATIN CAPITAL LETTER A WITH GRAVE */ \
   OP(L'Ç', LSHIFT(Key_RightBracket)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'È', LSHIFT(Key_Quote)) /* U+00c8, XKB_KEY_Egrave, LATIN CAPITAL LETTER E WITH GRAVE */ \
   OP(L'É', LSHIFT(Key_Slash)) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Ù', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'à', Key_NonUsPound) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   OP(L'ç', Key_RightBracket) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', Key_Quote) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'é', Key_Slash) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ù', Key_NonUsBackslashAndPipe) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Agrave, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Eacute, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Egrave, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Ugrave, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_agrave, Key_NonUsPound) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_7)) \
   OP(XKB_KEY_apostrophe, LSHIFT(Key_Comma)) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_braceright, RALT(Key_8)) \
   ...
   OP(XKB_KEY_dead_grave, RALT(Key_LeftBracket)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_degree, RALT(Key_Semicolon)) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, Key_Slash) \
   OP(XKB_KEY_egrave, Key_Quote) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_onehalf, RALT(Key_Minus)) \
   OP(XKB_KEY_p, Key_P) \
