...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Є', LSHIFT(Key_W)) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'Ї', LSHIFT(Key_X)) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'Г', LSHIFT(Key_Quote)) /* U+0413, XKB_KEY_Cyrillic_GHE, CYRILLIC CAPITAL LETTER GHE */ \
   ...
   OP(L'Ь', LSHIFT(Key_Backtick)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   ...
   OP(L'г', Key_Quote) /* U+0433, XKB_KEY_Cyrillic_ghe, CYRILLIC SMALL LETTER GHE */ \
   ...
   OP(L'ь', Key_Backtick) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   ...
   OP(L'є', Key_W) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'ї', Key_X) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_GHE, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Cyrillic_ghe, Key_Quote) \
   ...
   OP(XKB_KEY_Cyrillic_softsign, Key_Backtick) \
   ...
   OP(XKB_KEY_Ukrainian_IE, LSHIFT(Key_W)) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, LSHIFT(Key_X)) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, Key_G) \
   OP(XKB_KEY_Ukrainian_ie, Key_W) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, Key_X) /* XKB_KEY_Ukranian_yi, deprecated  */ \
