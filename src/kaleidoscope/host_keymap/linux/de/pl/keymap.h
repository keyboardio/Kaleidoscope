...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', LSHIFT(Key_NonUsPound)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', LSHIFT(Key_NonUsPound)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'¨', RALT(Key_LeftBracket)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'´', Key_Equals) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   ...
   OP(L'Ż', RALT(LSHIFT(Key_Y))) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', RALT(Key_Y)) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   OP(L'˝', RALT(Key_Semicolon)) /* U+02dd, XKB_KEY_doubleacute, DOUBLE ACUTE ACCENT */ \
   ...
   OP(L'’', RALT(Key_NonUsPound)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zabovedot, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_apostrophe, LSHIFT(Key_NonUsPound)) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_J))) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_J)) /* XKB_KEY_dead_belowdot */ \
   ...
   OP(XKB_KEY_diaeresis, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doubleacute, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_s, Key_S) \
   ...
   OP(XKB_KEY_y, Key_Z) \
   OP(XKB_KEY_z, Key_Y) \
   OP(XKB_KEY_zabovedot, RALT(Key_Y)) \
