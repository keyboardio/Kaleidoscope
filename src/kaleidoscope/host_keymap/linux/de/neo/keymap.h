...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('C', LSHIFT(Key_R)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   ...
   OP('F', LSHIFT(Key_O)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_I)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', LSHIFT(Key_U)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_S)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_Slash)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_Y)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', LSHIFT(Key_E)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP('P', LSHIFT(Key_V)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP('Q', LSHIFT(Key_P)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP('R', LSHIFT(Key_K)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP('S', LSHIFT(Key_H)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP('T', LSHIFT(Key_L)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP('U', LSHIFT(Key_A)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP('V', LSHIFT(Key_W)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   ...
   OP('k', Key_Y) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', Key_E) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP('p', Key_V) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', Key_P) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', Key_K) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', Key_H) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', Key_L) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', Key_A) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP('v', Key_W) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', Key_T) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', Key_Q) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', Key_Quote) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', Key_B) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'C', LSHIFT(Key_R)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   ...
   OP(L'F', LSHIFT(Key_O)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_I)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', LSHIFT(Key_U)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_S)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_Slash)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_Y)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', LSHIFT(Key_E)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP(L'P', LSHIFT(Key_V)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP(L'Q', LSHIFT(Key_P)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP(L'R', LSHIFT(Key_K)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP(L'S', LSHIFT(Key_H)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP(L'T', LSHIFT(Key_L)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP(L'U', LSHIFT(Key_A)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP(L'V', LSHIFT(Key_W)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   ...
   OP(L'k', Key_Y) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', Key_E) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP(L'p', Key_V) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', Key_P) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', Key_K) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', Key_H) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', Key_L) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', Key_A) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP(L'v', Key_W) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', Key_T) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', Key_Q) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', Key_Quote) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', Key_B) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   ...
   OP(L'Ä', LSHIFT(Key_C)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   ...
   OP(L'Ü', LSHIFT(Key_Z)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ß', Key_LeftBracket) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'ä', Key_C) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ö', Key_X) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_Z) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Adiaeresis, LSHIFT(Key_C)) \
   ...
   OP(XKB_KEY_Z, LSHIFT(Key_B)) \
   OP(XKB_KEY_a, Key_D) \
   OP(XKB_KEY_adiaeresis, Key_C) \
   OP(XKB_KEY_b, Key_N) \
   OP(XKB_KEY_c, Key_R) \
