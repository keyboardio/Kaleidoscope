...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Č', RALT(LSHIFT(Key_V))) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', RALT(Key_V)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'đ', RALT(Key_F)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ě', RALT(LSHIFT(Key_E))) /* U+011a, XKB_KEY_Ecaron, LATIN CAPITAL LETTER E WITH CARON */ \
   OP(L'ě', RALT(Key_E)) /* U+011b, XKB_KEY_ecaron, LATIN SMALL LETTER E WITH CARON */ \
   ...
   OP(L'Ŕ', RALT(LSHIFT(Key_R))) /* U+0154, XKB_KEY_Racute, LATIN CAPITAL LETTER R WITH ACUTE */ \
   OP(L'ŕ', RALT(Key_R)) /* U+0155, XKB_KEY_racute, LATIN SMALL LETTER R WITH ACUTE */ \
   ...
   OP(L'€', RALT(LSHIFT(Key_T))) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'₵', RALT(Key_T)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccaron, RALT(LSHIFT(Key_V))) \
   ...
   OP(XKB_KEY_Racute, RALT(LSHIFT(Key_R))) \
