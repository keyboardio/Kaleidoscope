...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ж', LSHIFT(Key_X)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   ...
   OP(L'Ю', LSHIFT(Key_NonUsPound)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   ...
   OP(L'ж', Key_X) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   ...
   OP(L'ю', Key_NonUsPound) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Cyrillic_yu, Key_NonUsPound) \
   OP(XKB_KEY_Cyrillic_ze, Key_Y) \
   OP(XKB_KEY_Cyrillic_zhe, Key_X) \
