...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('#', Key_Slash) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP('\'', LSHIFT(Key_Slash)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('-', Key_NonUsPound) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP(':', LSHIFT(Key_E)) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP('L', LSHIFT(Key_Quote)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP('T', LSHIFT(Key_O)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   ...
   OP('Z', LSHIFT(Key_P)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP('[', RALT(Key_8)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', LSHIFT(Key_RightBracket)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP('l', Key_Quote) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP('t', Key_O) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   ...
   OP('z', Key_P) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP('{', RALT(Key_7)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_4)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(Key_Minus)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'#', Key_Slash) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP(L'\'', LSHIFT(Key_Slash)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'-', Key_NonUsPound) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP(L':', LSHIFT(Key_E)) /* U+003a, XKB_KEY_colon, COLON */ \
   ...
   OP(L'L', LSHIFT(Key_Quote)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   ...
   OP(L'T', LSHIFT(Key_O)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   ...
   OP(L'Z', LSHIFT(Key_P)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP(L'[', RALT(Key_8)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', LSHIFT(Key_RightBracket)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'l', Key_Quote) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   ...
   OP(L't', Key_O) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   ...
   OP(L'z', Key_P) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP(L'{', RALT(Key_7)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_4)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_0)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(Key_Minus)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'¦', RALT(Key_6)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', LSHIFT(Key_3)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'¨', RALT(LSHIFT(Key_NonUsPound))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   OP(L'©', RALT(Key_I)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'­', RALT(Key_NonUsPound)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_K)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', LSHIFT(Key_Backtick)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'Ä', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Ó', RALT(LSHIFT(Key_S))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ö', LSHIFT(Key_Z)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ü', LSHIFT(Key_Q)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ß', LSHIFT(Key_LeftBracket)) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'ä', Key_NonUsBackslashAndPipe) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ó', RALT(Key_S)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ö', Key_Z) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_Q) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ą', RALT(LSHIFT(Key_A))) /* U+0105, XKB_KEY_aogonek, LATIN SMALL LETTER A WITH OGONEK */ \
   OP(L'Ć', RALT(LSHIFT(Key_I))) /* U+0106, XKB_KEY_Cacute, LATIN CAPITAL LETTER C WITH ACUTE */ \
   OP(L'ę', RALT(LSHIFT(Key_D))) /* U+0119, XKB_KEY_eogonek, LATIN SMALL LETTER E WITH OGONEK */ \
   OP(L'Ł', RALT(LSHIFT(Key_Quote))) /* U+0141, XKB_KEY_Lstroke, LATIN CAPITAL LETTER L WITH STROKE */ \
   OP(L'ł', RALT(Key_Quote)) /* U+0142, XKB_KEY_lstroke, LATIN SMALL LETTER L WITH STROKE */ \
   ...
   OP(L'Ż', RALT(LSHIFT(Key_P))) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', RALT(Key_P)) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   OP(L'€', RALT(Key_D)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(Key_O)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Adiaeresis, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_L, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Left, Key_LeftArrow) /* XKB_KEY_Left, Move left, left arrow  */ \
   OP(XKB_KEY_Lstroke, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_Z)) \
   ...
   OP(XKB_KEY_T, LSHIFT(Key_O)) \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, LSHIFT(Key_G)) \
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Z, LSHIFT(Key_P)) \
   OP(XKB_KEY_Zabovedot, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_adiaeresis, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_6)) \
   OP(XKB_KEY_aogonek, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_apostrophe, LSHIFT(Key_Slash)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciicircum, Key_Backtick) \
   OP(XKB_KEY_asciitilde, RALT(Key_Minus)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_at, RALT(Key_Q)) \
   OP(XKB_KEY_b, Key_N) \
   OP(XKB_KEY_backslash, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_bar, RALT(Key_4)) \
   ...
   OP(XKB_KEY_brokenbar, RALT(Key_6)) \
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_colon, LSHIFT(Key_E)) \
   OP(XKB_KEY_comma, Key_W) \
   OP(XKB_KEY_copyright, RALT(Key_I)) \
   OP(XKB_KEY_d, Key_J) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_E)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_acute, RALT(Key_RightBracket)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_W))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_circumflex, RALT(LSHIFT(Key_6))) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_W)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Z))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Equals)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_Z)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_Backtick))) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_diaeresis, RALT(LSHIFT(Key_NonUsPound))) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hyphen, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_i, Key_F) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_Quote) \
   OP(XKB_KEY_less, Key_Equals) \
   OP(XKB_KEY_lstroke, RALT(Key_Quote)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_minus, Key_NonUsPound) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_nacute, RALT(Key_L)) \
   OP(XKB_KEY_numbersign, Key_Slash) \
   OP(XKB_KEY_o, Key_S) \
   OP(XKB_KEY_oacute, RALT(Key_S)) \
   OP(XKB_KEY_odiaeresis, Key_Z) \
   ...
   OP(XKB_KEY_r, Key_K) \
   OP(XKB_KEY_registered, RALT(Key_K)) \
   ...
   OP(XKB_KEY_ssharp, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_t, Key_O) \
   OP(XKB_KEY_threesuperior, RALT(Key_3)) \
   OP(XKB_KEY_trademark, RALT(Key_O)) \
   OP(XKB_KEY_twosuperior, RALT(Key_2)) \
   OP(XKB_KEY_u, Key_G) \
   OP(XKB_KEY_udiaeresis, Key_Q) \
   ...
   OP(XKB_KEY_y, Key_T) \
   OP(XKB_KEY_z, Key_P) \
   OP(XKB_KEY_zabovedot, RALT(Key_P)) \
