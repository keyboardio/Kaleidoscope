...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Á', RALT(LSHIFT(Key_Quote))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   ...
   OP(L'É', RALT(LSHIFT(Key_Semicolon))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   ...
   OP(L'Ó', RALT(LSHIFT(Key_Equals))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   ...
   OP(L'á', RALT(Key_Quote)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   ...
   OP(L'é', RALT(Key_Semicolon)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   ...
   OP(L'ó', RALT(Key_Equals)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   ...
   OP(L'Ő', RALT(LSHIFT(Key_O))) /* U+0150, XKB_KEY_Odoubleacute, LATIN CAPITAL LETTER O WITH DOUBLE ACUTE */ \
   OP(L'ő', RALT(Key_O)) /* U+0151, XKB_KEY_odoubleacute, LATIN SMALL LETTER O WITH DOUBLE ACUTE */ \
   ...
   OP(L'Ű', RALT(LSHIFT(Key_LeftBracket))) /* U+0170, XKB_KEY_Udoubleacute, LATIN CAPITAL LETTER U WITH DOUBLE ACUTE */ \
   OP(L'ű', RALT(Key_LeftBracket)) /* U+0171, XKB_KEY_udoubleacute, LATIN SMALL LETTER U WITH DOUBLE ACUTE */ \
   OP(L'ſ', RALT(Key_S)) \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'ẞ', RALT(LSHIFT(Key_S))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Odoubleacute, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_Udoubleacute, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oacute, RALT(Key_Equals)) \
   OP(XKB_KEY_odiaeresis, Key_Semicolon) \
   OP(XKB_KEY_odoubleacute, RALT(Key_O)) \
   ...
   OP(XKB_KEY_udoubleacute, RALT(Key_LeftBracket)) \
