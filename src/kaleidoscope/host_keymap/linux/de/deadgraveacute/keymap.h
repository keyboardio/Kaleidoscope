...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', RALT(LSHIFT(Key_NonUsPound))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', RALT(LSHIFT(Key_NonUsPound))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(LSHIFT(Key_NonUsPound))) /* XKB_KEY_quoteleft, deprecated  */ \
