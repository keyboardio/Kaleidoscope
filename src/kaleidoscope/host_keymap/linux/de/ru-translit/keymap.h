...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ч', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', LSHIFT(Key_W)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   ...
   OP(L'Ь', LSHIFT(Key_NonUsPound)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   ...
   OP(L'ч', Key_NonUsBackslashAndPipe) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', Key_W) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   ...
   OP(L'ь', Key_NonUsPound) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Cyrillic_che, Key_NonUsBackslashAndPipe) \
   ...
   OP(XKB_KEY_Cyrillic_sha, Key_W) \
   OP(XKB_KEY_Cyrillic_shcha, Key_Q) \
   OP(XKB_KEY_Cyrillic_shorti, Key_J) \
   OP(XKB_KEY_Cyrillic_softsign, Key_NonUsPound) \
