...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('Q', LSHIFT(Key_Quote)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP('q', Key_Quote) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Q', LSHIFT(Key_Quote)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   ...
   OP(L'q', Key_Quote) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   ...
   OP(L'ß', Key_LeftBracket) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ssharp, Key_LeftBracket) \
