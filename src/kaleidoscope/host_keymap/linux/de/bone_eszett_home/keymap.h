...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('A', LSHIFT(Key_R)) /* U+0041, XKB_KEY_A, LATIN CAPITAL LETTER A */ \
   OP('B', LSHIFT(Key_H)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP('C', LSHIFT(Key_A)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP('D', LSHIFT(Key_W)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', LSHIFT(Key_F)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', LSHIFT(Key_Z)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_Semicolon)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', LSHIFT(Key_U)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_D)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_Q)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_Slash)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', LSHIFT(Key_I)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('M', LSHIFT(Key_O)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP('N', LSHIFT(Key_J)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP('O', LSHIFT(Key_G)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', LSHIFT(Key_Y)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP('Q', LSHIFT(Key_LeftBracket)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP('R', LSHIFT(Key_K)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP('S', LSHIFT(Key_L)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP('T', LSHIFT(Key_S)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP('U', LSHIFT(Key_E)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP('V', LSHIFT(Key_X)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP('W', LSHIFT(Key_P)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP('X', LSHIFT(Key_T)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', LSHIFT(Key_N)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP('Z', LSHIFT(Key_M)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP('a', Key_R) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP('b', Key_H) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP('c', Key_A) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP('d', Key_W) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', Key_F) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', Key_Z) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', Key_Semicolon) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', Key_U) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', Key_D) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', Key_Q) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', Key_Slash) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', Key_I) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', Key_O) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', Key_J) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', Key_G) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', Key_Y) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', Key_LeftBracket) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', Key_K) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', Key_L) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', Key_S) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', Key_E) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP('v', Key_X) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', Key_P) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', Key_T) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', Key_N) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', Key_M) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'A', LSHIFT(Key_R)) /* U+0041, XKB_KEY_A, LATIN CAPITAL LETTER A */ \
   OP(L'B', LSHIFT(Key_H)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP(L'C', LSHIFT(Key_A)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP(L'D', LSHIFT(Key_W)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', LSHIFT(Key_F)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', LSHIFT(Key_Z)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_Semicolon)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', LSHIFT(Key_U)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_D)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_Q)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_Slash)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', LSHIFT(Key_I)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'M', LSHIFT(Key_O)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP(L'N', LSHIFT(Key_J)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP(L'O', LSHIFT(Key_G)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', LSHIFT(Key_Y)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP(L'Q', LSHIFT(Key_LeftBracket)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP(L'R', LSHIFT(Key_K)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP(L'S', LSHIFT(Key_L)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP(L'T', LSHIFT(Key_S)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP(L'U', LSHIFT(Key_E)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP(L'V', LSHIFT(Key_X)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP(L'W', LSHIFT(Key_P)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP(L'X', LSHIFT(Key_T)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', LSHIFT(Key_N)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP(L'Z', LSHIFT(Key_M)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   OP(L'a', Key_R) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP(L'b', Key_H) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP(L'c', Key_A) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP(L'd', Key_W) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', Key_F) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', Key_Z) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', Key_Semicolon) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', Key_U) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', Key_D) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', Key_Q) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', Key_Slash) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', Key_I) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', Key_O) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', Key_J) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', Key_G) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', Key_Y) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', Key_LeftBracket) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', Key_K) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', Key_L) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', Key_S) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', Key_E) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP(L'v', Key_X) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', Key_P) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', Key_T) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', Key_N) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', Key_M) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   ...
   OP(L'Ä', LSHIFT(Key_V)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Ö', LSHIFT(Key_B)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'×', RALT(Key_KeypadMultiply)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Ü', LSHIFT(Key_C)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ß', Key_Quote) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'ä', Key_V) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ö', Key_B) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_C) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ẞ', LSHIFT(Key_Quote)) \
   OP(L'–', LSHIFT(Key_Comma)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', LSHIFT(Key_Minus)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_G, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_J, LSHIFT(Key_Q)) \
   OP(XKB_KEY_K, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_O, LSHIFT(Key_G)) \
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_B)) \
   OP(XKB_KEY_P, LSHIFT(Key_Y)) \
   ...
   OP(XKB_KEY_T, LSHIFT(Key_S)) \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, LSHIFT(Key_E)) \
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_C)) \
   OP(XKB_KEY_Undo, RALT(Key_B)) /* XKB_KEY_Undo */ \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_V, LSHIFT(Key_X)) \
   OP(XKB_KEY_W, LSHIFT(Key_P)) \
   ...
   OP(XKB_KEY_Y, LSHIFT(Key_N)) \
   OP(XKB_KEY_Z, LSHIFT(Key_M)) \
   OP(XKB_KEY_a, Key_R) \
   OP(XKB_KEY_adiaeresis, Key_V) \
   OP(XKB_KEY_b, Key_H) \
   OP(XKB_KEY_c, Key_A) \
