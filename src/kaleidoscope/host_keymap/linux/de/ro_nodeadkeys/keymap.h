...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ă', RALT(LSHIFT(Key_Quote))) /* U+0102, XKB_KEY_Abreve, LATIN CAPITAL LETTER A WITH BREVE */ \
   OP(L'ă', RALT(Key_Quote)) /* U+0103, XKB_KEY_abreve, LATIN SMALL LETTER A WITH BREVE */ \
   ...
   OP(L'Ş', RALT(LSHIFT(Key_S))) /* U+015e, XKB_KEY_Scedilla, LATIN CAPITAL LETTER S WITH CEDILLA */ \
   OP(L'ş', RALT(Key_S)) /* U+015f, XKB_KEY_scedilla, LATIN SMALL LETTER S WITH CEDILLA */ \
   OP(L'Ţ', RALT(LSHIFT(Key_T))) /* U+0162, XKB_KEY_Tcedilla, LATIN CAPITAL LETTER T WITH CEDILLA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Abreve, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_Scedilla, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_Tcedilla, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abreve, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scedilla, RALT(Key_S)) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_tcedilla, RALT(Key_T)) \
