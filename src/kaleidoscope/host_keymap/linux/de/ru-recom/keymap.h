...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('#', RALT(Key_NonUsPound)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP('\'', RALT(LSHIFT(Key_NonUsPound))) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('^', RALT(Key_Backtick)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP('~', Key_Minus) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'#', RALT(Key_NonUsPound)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP(L'\'', RALT(LSHIFT(Key_NonUsPound))) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'^', RALT(Key_Backtick)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'~', Key_Minus) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'¤', RALT(LSHIFT(Key_4))) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   ...
   OP(L'·', RALT(Key_Comma)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'̀', LSHIFT(Key_Equals)) \
   OP(L'́', Key_Equals) \
   OP(L'̇', RALT(LSHIFT(Key_Equals))) \
   OP(L'̣', RALT(Key_Equals)) \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'Ё', LSHIFT(Key_Semicolon)) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   OP(L'Є', RALT(LSHIFT(Key_Quote))) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'І', RALT(LSHIFT(Key_I))) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', RALT(LSHIFT(Key_J))) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'В', LSHIFT(Key_W)) /* U+0412, XKB_KEY_Cyrillic_VE, CYRILLIC CAPITAL LETTER VE */ \
   ...
   OP(L'Ж', LSHIFT(Key_H)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   ...
   OP(L'Ц', LSHIFT(Key_Y)) /* U+0426, XKB_KEY_Cyrillic_TSE, CYRILLIC CAPITAL LETTER TSE */ \
   OP(L'Ч', LSHIFT(Key_C)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', LSHIFT(Key_RightBracket)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_Q)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   OP(L'Ъ', LSHIFT(Key_NonUsPound)) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ы', LSHIFT(Key_Z)) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', LSHIFT(Key_V)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', LSHIFT(Key_Quote)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', LSHIFT(Key_LeftBracket)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_Backtick)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   ...
   OP(L'в', Key_W) /* U+0432, XKB_KEY_Cyrillic_ve, CYRILLIC SMALL LETTER VE */ \
   ...
   OP(L'ж', Key_H) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', Key_NonUsBackslashAndPipe) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   ...
   OP(L'ц', Key_Y) /* U+0446, XKB_KEY_Cyrillic_tse, CYRILLIC SMALL LETTER TSE */ \
   OP(L'ч', Key_C) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', Key_RightBracket) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_Q) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   OP(L'ъ', Key_NonUsPound) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', Key_Z) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', Key_V) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', Key_Quote) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', Key_LeftBracket) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', Key_Backtick) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ё', Key_Semicolon) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'є', RALT(Key_Quote)) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'і', RALT(Key_I)) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', RALT(Key_J)) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'Ґ', RALT(LSHIFT(Key_G))) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', RALT(Key_G)) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
   OP(L'–', RALT(Key_Slash)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Slash))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_B))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(LSHIFT(Key_N))) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_V))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(Key_B)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_N)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_V)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_C)) \
   ...
   OP(XKB_KEY_Cyrillic_HARDSIGN, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_IE, LSHIFT(Key_E)) \
   OP(XKB_KEY_Cyrillic_IO, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_K)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_O)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_P)) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_V)) \
   OP(XKB_KEY_Cyrillic_TE, LSHIFT(Key_T)) \
   OP(XKB_KEY_Cyrillic_TSE, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_U, LSHIFT(Key_U)) \
   OP(XKB_KEY_Cyrillic_VE, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_YA, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_Cyrillic_YERU, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_H)) \
   OP(XKB_KEY_Cyrillic_a, Key_A) \
   OP(XKB_KEY_Cyrillic_be, Key_B) \
   OP(XKB_KEY_Cyrillic_che, Key_C) \
   ...
   OP(XKB_KEY_Cyrillic_hardsign, Key_NonUsPound) \
   OP(XKB_KEY_Cyrillic_i, Key_I) \
   OP(XKB_KEY_Cyrillic_ie, Key_E) \
   OP(XKB_KEY_Cyrillic_io, Key_Semicolon) \
   OP(XKB_KEY_Cyrillic_ka, Key_K) \
   OP(XKB_KEY_Cyrillic_o, Key_O) \
   OP(XKB_KEY_Cyrillic_pe, Key_P) \
   OP(XKB_KEY_Cyrillic_sha, Key_RightBracket) \
   OP(XKB_KEY_Cyrillic_shcha, Key_Q) \
   OP(XKB_KEY_Cyrillic_shorti, Key_J) \
   OP(XKB_KEY_Cyrillic_softsign, Key_V) \
   OP(XKB_KEY_Cyrillic_te, Key_T) \
   OP(XKB_KEY_Cyrillic_tse, Key_Y) \
   OP(XKB_KEY_Cyrillic_u, Key_U) \
   OP(XKB_KEY_Cyrillic_ve, Key_W) \
   OP(XKB_KEY_Cyrillic_ya, Key_Backtick) \
   OP(XKB_KEY_Cyrillic_yeru, Key_Z) \
   OP(XKB_KEY_Cyrillic_yu, Key_LeftBracket) \
   OP(XKB_KEY_Cyrillic_ze, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_Cyrillic_zhe, Key_H) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_Ukrainian_I, RALT(LSHIFT(Key_I))) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, RALT(LSHIFT(Key_J))) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, RALT(Key_G)) \
   OP(XKB_KEY_Ukrainian_i, RALT(Key_I)) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, RALT(Key_Quote)) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, RALT(Key_J)) /* XKB_KEY_Ukranian_yi, deprecated  */ \
   ...
   OP(XKB_KEY_apostrophe, RALT(LSHIFT(Key_NonUsPound))) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciicircum, RALT(Key_Backtick)) \
   OP(XKB_KEY_asciitilde, Key_Minus) \
   OP(XKB_KEY_asterisk, RALT(LSHIFT(Key_RightBracket))) \
   ...
   OP(XKB_KEY_currency, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_dead_abovering, RALT(LSHIFT(Key_LeftBracket))) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_belowdot, RALT(LSHIFT(Key_Semicolon))) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_belowmacron, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* XKB_KEY_dead_belowmacron */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_LeftBracket)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(Key_Semicolon)) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doublelowquotemark, RALT(Key_V)) \
   ...
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_B)) \
   OP(XKB_KEY_leftsinglequotemark, RALT(LSHIFT(Key_B))) \
   ...
   OP(XKB_KEY_numbersign, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_periodcentered, RALT(Key_Comma)) \
   OP(XKB_KEY_plus, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_V))) \
