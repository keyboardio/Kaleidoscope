...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¥', RALT(LSHIFT(Key_Z))) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   ...
   OP(L'«', RALT(Key_Y)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'←', RALT(Key_Z)) /* U+2190, XKB_KEY_leftarrow, LEFTWARDS ARROW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(Key_Y)) \
   OP(XKB_KEY_h, Key_H) \
   ...
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftarrow, RALT(Key_Z)) \
   ...
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_z, Key_Z) \
