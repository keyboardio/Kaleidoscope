...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('@', RALT(Key_L)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'@', RALT(Key_L)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'¨', RALT(Key_U)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'«', RALT(Key_Q)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Á', RALT(LSHIFT(Key_U))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   ...
   OP(L'Û', RALT(LSHIFT(Key_I))) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Ucircumflex, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_diaeresis, RALT(Key_U)) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(Key_Q)) \
