...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ź', RALT(LSHIFT(Key_U))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_U)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
   OP(L'Ž', RALT(LSHIFT(Key_Y))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_Y)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_y, Key_Z) \
   OP(XKB_KEY_z, Key_Y) \
   OP(XKB_KEY_zacute, RALT(Key_U)) \
   OP(XKB_KEY_zcaron, RALT(Key_Y)) \
