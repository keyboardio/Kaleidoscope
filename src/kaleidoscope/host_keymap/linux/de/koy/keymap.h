...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', Key_R) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_Minus) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP('.', Key_W) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP('F', LSHIFT(Key_Quote)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP('O', LSHIFT(Key_E)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   ...
   OP('f', Key_Quote) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   ...
   OP('o', Key_E) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', Key_R) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_Minus) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP(L'.', Key_W) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(L'F', LSHIFT(Key_Quote)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   ...
   OP(L'O', LSHIFT(Key_E)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   ...
   OP(L'f', Key_Quote) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   ...
   OP(L'o', Key_E) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   ...
   OP(L'Ü', LSHIFT(Key_V)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ß', Key_P) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   ...
   OP(L'ü', Key_V) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ẞ', LSHIFT(Key_P)) \
   OP(L'–', LSHIFT(Key_R)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   ...
   OP(L'•', LSHIFT(Key_W)) /* U+2022, XKB_KEY_enfilledcircbullet, BULLET */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_V)) \
   ...
   OP(XKB_KEY_endash, LSHIFT(Key_R)) \
   OP(XKB_KEY_enfilledcircbullet, LSHIFT(Key_W)) \
   OP(XKB_KEY_exclamdown, RALT(Key_Y)) \
   OP(XKB_KEY_f, Key_Quote) \
   OP(XKB_KEY_g, Key_U) \
   ...
   OP(XKB_KEY_ssharp, Key_P) \
   OP(XKB_KEY_sterling, RALT(Key_6)) \
   OP(XKB_KEY_t, Key_J) \
   OP(XKB_KEY_u, Key_G) \
   OP(XKB_KEY_udiaeresis, Key_V) \
   OP(XKB_KEY_v, Key_Y) \
