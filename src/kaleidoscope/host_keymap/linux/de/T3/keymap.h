...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¡', RALT(Key_5)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   ...
   OP(L'®', RALT(Key_NonUsPound)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   ...
   OP(L'¿', RALT(Key_6)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   ...
   OP(L'×', RALT(Key_Backtick)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   ...
   OP(L'Ĳ', RALT(LSHIFT(Key_J))) \
   OP(L'Ŀ', RALT(LSHIFT(Key_Slash))) \
   ...
   OP(L'Œ', RALT(LSHIFT(Key_E))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   ...
   OP(L'Ƞ', RALT(LSHIFT(Key_N))) \
   OP(L'Ȣ', RALT(LSHIFT(Key_U))) \
   OP(L'Ɂ', RALT(LSHIFT(Key_Q))) \
   OP(L'ʻ', RALT(Key_Comma)) \
   OP(L'μ', RALT(Key_M)) /* U+03bc, XKB_KEY_Greek_mu, GREEK SMALL LETTER MU */ \
   OP(L'ẞ', RALT(Key_H)) \
   OP(L'‌', RALT(Key_Period)) \
   OP(L'–', RALT(Key_N)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_4)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(LSHIFT(Key_V))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_1)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_X))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'′', RALT(Key_F)) /* U+2032, XKB_KEY_minutes, PRIME */ \
   OP(L'″', RALT(Key_G)) /* U+2033, XKB_KEY_seconds, DOUBLE PRIME */ \
   OP(L'‹', RALT(Key_B)) \
   OP(L'›', RALT(Key_Z)) \
   OP(L'€', RALT(Key_E)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(LSHIFT(Key_0))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'Ω', RALT(LSHIFT(Key_W))) \
   OP(L'⅍', RALT(LSHIFT(Key_I))) \
   OP(L'←', RALT(LSHIFT(Key_7))) /* U+2190, XKB_KEY_leftarrow, LEFTWARDS ARROW */ \
   OP(L'↑', RALT(LSHIFT(Key_5))) /* U+2191, XKB_KEY_uparrow, UPWARDS ARROW */ \
   OP(L'→', RALT(LSHIFT(Key_8))) /* U+2192, XKB_KEY_rightarrow, RIGHTWARDS ARROW */ \
   OP(L'↓', RALT(LSHIFT(Key_6))) /* U+2193, XKB_KEY_downarrow, DOWNWARDS ARROW */ \
   OP(L'≤', RALT(Key_A)) /* U+2264, XKB_KEY_lessthanequal, LESS-THAN OR EQUAL TO */ \
   OP(L'≥', RALT(Key_S)) /* U+2265, XKB_KEY_greaterthanequal, GREATER-THAN OR EQUAL TO */ \
   OP(L'⌀', RALT(Key_D)) \
   OP(L'Ꞌ', RALT(LSHIFT(Key_T))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level5_Latch, RALT(Key_LeftShift)) /* XKB_KEY_ISO_Level5_Latch */ \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_Equals)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, RALT(Key_O)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, Key_Equals) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowcomma, RALT(Key_K)) /* XKB_KEY_dead_belowcomma */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_Semicolon)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_breve, RALT(Key_U)) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(Key_W)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_J)) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, Key_Backtick) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_R)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(Key_Y)) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, LSHIFT(Key_Equals)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(Key_P)) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(Key_LeftBracket)) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(Key_T)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_L)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_stroke, RALT(Key_Quote)) /* XKB_KEY_dead_stroke */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_I)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_downarrow, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_emdash, RALT(Key_4)) \
   OP(XKB_KEY_endash, RALT(Key_N)) \
   OP(XKB_KEY_equal, LSHIFT(Key_0)) \
   OP(XKB_KEY_exclam, LSHIFT(Key_1)) \
   OP(XKB_KEY_exclamdown, RALT(Key_5)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_greaterthanequal, RALT(Key_S)) \
   ...
   OP(XKB_KEY_questiondown, RALT(Key_6)) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_2)) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_rightarrow, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_1)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_seconds, RALT(Key_G)) \
   OP(XKB_KEY_section, LSHIFT(Key_3)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_uparrow, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Z) \
