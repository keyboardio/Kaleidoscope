...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_abovecomma, LSHIFT(Key_Semicolon)) /* XKB_KEY_dead_abovecomma */ \
   OP(XKB_KEY_dead_abovereversedcomma, LSHIFT(Key_Quote)) /* XKB_KEY_dead_abovereversedcomma */ \
   ...
   OP(XKB_KEY_dead_iota, Key_RightBracket) /* XKB_KEY_dead_iota */ \
   OP(XKB_KEY_dead_macron, RALT(Key_LeftBracket)) /* XKB_KEY_dead_macron */ \
