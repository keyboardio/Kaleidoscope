...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', RALT(LSHIFT(Key_7))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', RALT(LSHIFT(Key_7))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'¨', LSHIFT(Key_Backtick)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'«', RALT(Key_D)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'¸', Key_Backtick) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   OP(L'º', RALT(LSHIFT(Key_M))) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'»', RALT(Key_S)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_cedilla, Key_Backtick) \
   ...
   OP(XKB_KEY_diaeresis, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(LSHIFT(Key_7))) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_Period)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_D)) \
   OP(XKB_KEY_guillemotright, RALT(Key_S)) \
   OP(XKB_KEY_h, Key_H) \
