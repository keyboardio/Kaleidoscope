...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ḥ', RALT(Key_H)) \
   OP(L'Ḷ', RALT(LSHIFT(Key_L))) /* U+1e36, XKB_KEY_Lbelowdot, LATIN CAPITAL LETTER L WITH DOT BELOW */ \
   OP(L'ḷ', RALT(Key_L)) /* U+1e37, XKB_KEY_lbelowdot, LATIN SMALL LETTER L WITH DOT BELOW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Lbelowdot, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_lbelowdot, RALT(Key_L)) \
