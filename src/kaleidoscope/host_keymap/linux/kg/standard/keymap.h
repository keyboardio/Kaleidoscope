...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ң', LSHIFT(Key_Equals)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_Equals) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ү', LSHIFT(Key_NonUsPound)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_NonUsPound) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_EN_descender, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Cyrillic_en_descender, Key_Equals) \
   ...
   OP(XKB_KEY_Cyrillic_u_straight, Key_NonUsPound) \
