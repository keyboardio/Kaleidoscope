...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ж', LSHIFT(Key_C)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   ...
   OP(L'Ц', LSHIFT(Key_Comma)) /* U+0426, XKB_KEY_Cyrillic_TSE, CYRILLIC CAPITAL LETTER TSE */ \
   OP(L'Ч', LSHIFT(Key_LeftBracket)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', LSHIFT(Key_RightBracket)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_Period)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   ...
   OP(L'Э', LSHIFT(Key_Semicolon)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', LSHIFT(Key_Equals)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', LSHIFT(Key_Minus)) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   ...
   OP(L'ж', Key_C) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   ...
   OP(L'ц', Key_Comma) /* U+0446, XKB_KEY_Cyrillic_tse, CYRILLIC SMALL LETTER TSE */ \
   OP(L'ч', Key_LeftBracket) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', Key_RightBracket) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_Period) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   ...
   OP(L'э', Key_Semicolon) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', Key_Equals) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', Key_Minus) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'ё', Key_Backtick) /* U+0451, XKB_KEY_Cyrillic_io, CYRILLIC SMALL LETTER IO */ \
   OP(L'Ң', LSHIFT(Key_H)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_H) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ү', LSHIFT(Key_W)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_W) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   OP(L'Ө', LSHIFT(Key_Q)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_Q) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_DE, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_E, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_Cyrillic_EN_descender, LSHIFT(Key_H)) \
