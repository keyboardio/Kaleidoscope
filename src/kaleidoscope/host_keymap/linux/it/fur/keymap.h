...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'½', RALT(LSHIFT(Key_5))) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   ...
   OP(L'ᵀ', RALT(LSHIFT(Key_T))) \
   OP(L'ᵉ', RALT(LSHIFT(Key_3))) \
   OP(L'ᵐ', RALT(Key_M)) \
   OP(L'ᵗ', RALT(Key_T)) \
   OP(L'ᶜ', RALT(Key_C)) \
   OP(L'ᶠ', RALT(Key_F)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_onehalf, RALT(LSHIFT(Key_5))) \
