...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ê', RALT(LSHIFT(Key_E))) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ë', RALT(Key_R)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'í', Key_Equals) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   ...
   OP(L'ù', RALT(Key_NonUsPound)) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'ú', Key_NonUsPound) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   ...
   OP(L'Š', RALT(LSHIFT(Key_S))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_S)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_dead_macron, RALT(Key_Slash)) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, Key_NonUsPound) \
   OP(XKB_KEY_ucircumflex, RALT(Key_U)) \
   OP(XKB_KEY_ugrave, RALT(Key_NonUsPound)) \
