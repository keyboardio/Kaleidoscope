...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_Slash)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', Key_2) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', Key_3) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', Key_4) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', Key_7) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP('[', RALT(LSHIFT(Key_4))) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(LSHIFT(Key_Period))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(LSHIFT(Key_7))) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('^', LSHIFT(Key_LeftBracket)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP('|', RALT(Key_Period)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_7)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_Slash)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', Key_2) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', Key_3) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', Key_4) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', Key_7) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L'[', RALT(LSHIFT(Key_4))) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(LSHIFT(Key_Period))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(LSHIFT(Key_7))) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'^', LSHIFT(Key_LeftBracket)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'|', RALT(Key_Period)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_7)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'¡', RALT(Key_Slash)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   OP(L'£', Key_8) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¦', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', Key_NonUsPound) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'«', RALT(Key_1)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'°', LSHIFT(Key_NonUsPound)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'»', RALT(LSHIFT(Key_1))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Ç', RALT(Key_5)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   ...
   OP(L'Í', RALT(LSHIFT(Key_5))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   ...
   OP(L'Ó', RALT(LSHIFT(Key_0))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   ...
   OP(L'à', Key_9) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   ...
   OP(L'ç', Key_5) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', Key_6) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'é', Key_0) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ì', Key_LeftBracket) /* U+00ec, XKB_KEY_igrave, LATIN SMALL LETTER I WITH GRAVE */ \
   ...
   OP(L'ò', Key_Slash) /* U+00f2, XKB_KEY_ograve, LATIN SMALL LETTER O WITH GRAVE */ \
   OP(L'ù', Key_Quote) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'ÿ', RALT(LSHIFT(Key_Y))) /* U+00ff, XKB_KEY_ydiaeresis, LATIN SMALL LETTER Y WITH DIAERESIS */ \
   OP(L'€', RALT(Key_E)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'∞', RALT(Key_8)) /* U+221e, XKB_KEY_infinity, INFINITY */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccedilla, RALT(Key_5)) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_5))) \
   ...
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_0))) \
   ...
   OP(XKB_KEY_agrave, Key_9) \
   OP(XKB_KEY_ampersand, Key_1) \
   OP(XKB_KEY_apostrophe, Key_3) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_aring, RALT(Key_A)) \
   OP(XKB_KEY_asciicircum, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_at, Key_Backtick) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_bar, RALT(Key_Period)) \
   OP(XKB_KEY_braceleft, RALT(Key_4)) \
   OP(XKB_KEY_braceright, RALT(Key_7)) \
   OP(XKB_KEY_bracketleft, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_bracketright, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_brokenbar, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, Key_5) \
   ...
   OP(XKB_KEY_degree, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_dollar, Key_RightBracket) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, Key_0) \
   OP(XKB_KEY_egrave, Key_6) \
   OP(XKB_KEY_equal, Key_Equals) \
   OP(XKB_KEY_exclam, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_guillemotleft, RALT(Key_1)) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_icircumflex, RALT(Key_I)) \
   OP(XKB_KEY_idiaeresis, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_igrave, Key_LeftBracket) \
   OP(XKB_KEY_infinity, RALT(Key_8)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_quotedbl, Key_2) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(Key_R)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, Key_NonUsPound) \
