...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Á', RALT(LSHIFT(Key_Z))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   ...
   OP(L'Í', RALT(LSHIFT(Key_K))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   ...
   OP(L'á', RALT(Key_Z)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   ...
   OP(L'í', RALT(Key_K)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_K))) \
