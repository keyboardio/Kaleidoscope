...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ë', RALT(LSHIFT(Key_P))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   ...
   OP(L'ë', RALT(Key_P)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_P))) \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovering, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_abovering */ \
   ...
   OP(XKB_KEY_ediaeresis, RALT(Key_P)) \
