...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¨', RALT(LSHIFT(Key_Period))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'¯', RALT(Key_Slash)) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'´', RALT(Key_Comma)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   ...
   OP(L'¸', RALT(LSHIFT(Key_Semicolon))) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'˛', RALT(LSHIFT(Key_0))) /* U+02db, XKB_KEY_ogonek, OGONEK */ \
   OP(L'˝', RALT(LSHIFT(Key_2))) /* U+02dd, XKB_KEY_doubleacute, DOUBLE ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(Key_Comma)) \
   ...
   OP(XKB_KEY_diaeresis, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doubleacute, RALT(LSHIFT(Key_2))) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(Key_Slash)) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_ogonek, RALT(LSHIFT(Key_0))) \
