...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ā', LSHIFT(Key_Y)) /* U+0100, XKB_KEY_Amacron, LATIN CAPITAL LETTER A WITH MACRON */ \
   OP(L'ā', Key_Y) /* U+0101, XKB_KEY_amacron, LATIN SMALL LETTER A WITH MACRON */ \
   OP(L'Č', LSHIFT(Key_2)) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', LSHIFT(Key_3)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Ē', LSHIFT(Key_W)) /* U+0112, XKB_KEY_Emacron, LATIN CAPITAL LETTER E WITH MACRON */ \
   OP(L'ē', Key_W) /* U+0113, XKB_KEY_emacron, LATIN SMALL LETTER E WITH MACRON */ \
   OP(L'Ģ', LSHIFT(Key_Period)) /* U+0122, XKB_KEY_Gcedilla, LATIN CAPITAL LETTER G WITH CEDILLA */ \
   OP(L'ģ', LSHIFT(Key_Comma)) /* U+0123, XKB_KEY_gcedilla, LATIN SMALL LETTER G WITH CEDILLA */ \
   OP(L'Ī', LSHIFT(Key_Semicolon)) /* U+012a, XKB_KEY_Imacron, LATIN CAPITAL LETTER I WITH MACRON */ \
   OP(L'ī', Key_Semicolon) /* U+012b, XKB_KEY_imacron, LATIN SMALL LETTER I WITH MACRON */ \
   OP(L'Ķ', LSHIFT(Key_X)) /* U+0136, XKB_KEY_Kcedilla, LATIN CAPITAL LETTER K WITH CEDILLA */ \
   ...
   OP(L'Ņ', LSHIFT(Key_RightBracket)) /* U+0145, XKB_KEY_Ncedilla, LATIN CAPITAL LETTER N WITH CEDILLA */ \
   OP(L'ņ', Key_RightBracket) /* U+0146, XKB_KEY_ncedilla, LATIN SMALL LETTER N WITH CEDILLA */ \
   ...
   OP(L'Š', LSHIFT(Key_Q)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_Q) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ū', LSHIFT(Key_LeftBracket)) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', Key_LeftBracket) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ž', LSHIFT(Key_4)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', LSHIFT(Key_5)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Amacron, LSHIFT(Key_Y)) \
   ...
   OP(XKB_KEY_Emacron, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_Gcedilla, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_Kcedilla, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Ncedilla, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_Umacron, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Zcaron, LSHIFT(Key_4)) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(Key_Backtick)) \
   OP(XKB_KEY_amacron, Key_Y) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccaron, LSHIFT(Key_3)) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcedilla, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_Period)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_imacron, Key_Semicolon) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_kcedilla, Key_X) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_ncedilla, Key_RightBracket) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_umacron, Key_LeftBracket) \
   ...
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, LSHIFT(Key_5)) \
