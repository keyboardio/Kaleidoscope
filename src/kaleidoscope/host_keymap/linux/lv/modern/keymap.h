...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', LSHIFT(Key_H)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', RALT(Key_H)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(',', Key_Period) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(':', LSHIFT(Key_Slash)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', LSHIFT(Key_Period)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('<', RALT(Key_Period)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_Slash)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', RALT(Key_R)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP('D', LSHIFT(Key_U)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', LSHIFT(Key_A)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', LSHIFT(Key_N)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_P)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', LSHIFT(Key_Comma)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_K)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_Y)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_G)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   ...
   OP('O', LSHIFT(Key_W)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', LSHIFT(Key_R)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP('Q', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP('R', LSHIFT(Key_Semicolon)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP('S', LSHIFT(Key_J)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP('T', LSHIFT(Key_L)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP('U', LSHIFT(Key_S)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP('V', LSHIFT(Key_V)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP('W', LSHIFT(Key_B)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP('X', LSHIFT(Key_Z)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', LSHIFT(Key_M)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP('Z', LSHIFT(Key_X)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   ...
   OP('d', Key_U) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', Key_A) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', Key_N) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', Key_P) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', Key_Comma) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', Key_K) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', Key_Y) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', Key_G) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   ...
   OP('o', Key_W) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', Key_R) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', Key_NonUsBackslashAndPipe) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', Key_Semicolon) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', Key_J) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', Key_L) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', Key_S) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP('v', Key_V) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', Key_B) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', Key_Z) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', Key_M) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', Key_X) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP('{', RALT(Key_7)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_V)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', LSHIFT(Key_H)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', RALT(Key_H)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L',', Key_Period) /* U+002c, XKB_KEY_comma, COMMA */ \
   ...
   OP(L':', LSHIFT(Key_Slash)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', LSHIFT(Key_Period)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'<', RALT(Key_Period)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_Slash)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', RALT(Key_R)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'D', LSHIFT(Key_U)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', LSHIFT(Key_A)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', LSHIFT(Key_N)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_P)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', LSHIFT(Key_Comma)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_K)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_Y)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_G)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   ...
   OP(L'O', LSHIFT(Key_W)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', LSHIFT(Key_R)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP(L'Q', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP(L'R', LSHIFT(Key_Semicolon)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP(L'S', LSHIFT(Key_J)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP(L'T', LSHIFT(Key_L)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP(L'U', LSHIFT(Key_S)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP(L'V', LSHIFT(Key_V)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP(L'W', LSHIFT(Key_B)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP(L'X', LSHIFT(Key_Z)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', LSHIFT(Key_M)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP(L'Z', LSHIFT(Key_X)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   ...
   OP(L'd', Key_U) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', Key_A) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', Key_N) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', Key_P) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', Key_Comma) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', Key_K) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', Key_Y) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', Key_G) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   ...
   OP(L'o', Key_W) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', Key_R) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', Key_NonUsBackslashAndPipe) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', Key_Semicolon) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', Key_J) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', Key_L) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', Key_S) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP(L'v', Key_V) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', Key_B) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', Key_Z) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', Key_M) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', Key_X) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP(L'{', RALT(Key_7)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_V)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'¢', RALT(LSHIFT(Key_4))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', RALT(LSHIFT(Key_3))) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'©', RALT(LSHIFT(Key_Backtick))) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'«', RALT(Key_LeftBracket)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'°', RALT(LSHIFT(Key_0))) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'×', RALT(LSHIFT(Key_Period))) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'÷', RALT(LSHIFT(Key_Slash))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'Ā', LSHIFT(Key_E)) /* U+0100, XKB_KEY_Amacron, LATIN CAPITAL LETTER A WITH MACRON */ \
   OP(L'ā', Key_E) /* U+0101, XKB_KEY_amacron, LATIN SMALL LETTER A WITH MACRON */ \
   OP(L'Č', RALT(LSHIFT(Key_C))) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', RALT(Key_C)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Ē', LSHIFT(Key_Q)) /* U+0112, XKB_KEY_Emacron, LATIN CAPITAL LETTER E WITH MACRON */ \
   OP(L'ē', Key_Q) /* U+0113, XKB_KEY_emacron, LATIN SMALL LETTER E WITH MACRON */ \
   OP(L'Ģ', RALT(LSHIFT(Key_P))) /* U+0122, XKB_KEY_Gcedilla, LATIN CAPITAL LETTER G WITH CEDILLA */ \
   OP(L'ģ', RALT(Key_P)) /* U+0123, XKB_KEY_gcedilla, LATIN SMALL LETTER G WITH CEDILLA */ \
   OP(L'Ī', LSHIFT(Key_I)) /* U+012a, XKB_KEY_Imacron, LATIN CAPITAL LETTER I WITH MACRON */ \
   OP(L'ī', Key_I) /* U+012b, XKB_KEY_imacron, LATIN SMALL LETTER I WITH MACRON */ \
   OP(L'Ķ', RALT(LSHIFT(Key_G))) /* U+0136, XKB_KEY_Kcedilla, LATIN CAPITAL LETTER K WITH CEDILLA */ \
   OP(L'ķ', RALT(Key_G)) /* U+0137, XKB_KEY_kcedilla, LATIN SMALL LETTER K WITH CEDILLA */ \
   OP(L'Ļ', RALT(LSHIFT(Key_O))) /* U+013b, XKB_KEY_Lcedilla, LATIN CAPITAL LETTER L WITH CEDILLA */ \
   OP(L'ļ', RALT(Key_O)) /* U+013c, XKB_KEY_lcedilla, LATIN SMALL LETTER L WITH CEDILLA */ \
   OP(L'Ņ', RALT(LSHIFT(Key_F))) /* U+0145, XKB_KEY_Ncedilla, LATIN CAPITAL LETTER N WITH CEDILLA */ \
   OP(L'ņ', RALT(Key_F)) /* U+0146, XKB_KEY_ncedilla, LATIN SMALL LETTER N WITH CEDILLA */ \
   OP(L'Ō', RALT(LSHIFT(Key_W))) /* U+014c, XKB_KEY_Omacron, LATIN CAPITAL LETTER O WITH MACRON */ \
   OP(L'ō', RALT(Key_W)) /* U+014d, XKB_KEY_omacron, LATIN SMALL LETTER O WITH MACRON */ \
   OP(L'Ŗ', RALT(LSHIFT(Key_Semicolon))) /* U+0156, XKB_KEY_Rcedilla, LATIN CAPITAL LETTER R WITH CEDILLA */ \
   OP(L'ŗ', RALT(Key_Semicolon)) /* U+0157, XKB_KEY_rcedilla, LATIN SMALL LETTER R WITH CEDILLA */ \
   OP(L'Š', RALT(LSHIFT(Key_J))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_J)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ū', RALT(LSHIFT(Key_S))) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', RALT(Key_S)) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ž', RALT(LSHIFT(Key_X))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_X)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'–', RALT(Key_Equals)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_Y)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Amacron, LSHIFT(Key_E)) \
   ...
   OP(XKB_KEY_Ccaron, RALT(LSHIFT(Key_C))) \
   ...
   OP(XKB_KEY_Kcedilla, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_L, LSHIFT(Key_O)) \
   OP(XKB_KEY_Lcedilla, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_Q, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_R, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_S, LSHIFT(Key_J)) \
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_Y, LSHIFT(Key_M)) \
   OP(XKB_KEY_Z, LSHIFT(Key_X)) \
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_a, Key_D) \
   OP(XKB_KEY_acute, RALT(Key_Backtick)) \
   OP(XKB_KEY_amacron, Key_E) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_7)) \
   OP(XKB_KEY_apostrophe, RALT(Key_H)) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccaron, RALT(Key_C)) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_colon, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_comma, Key_Period) \
   OP(XKB_KEY_copyright, RALT(LSHIFT(Key_Backtick))) \
   OP(XKB_KEY_d, Key_U) \
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_A) \
   OP(XKB_KEY_emacron, Key_Q) \
   OP(XKB_KEY_emdash, RALT(Key_Y)) \
   OP(XKB_KEY_endash, RALT(Key_Equals)) \
   ...
   OP(XKB_KEY_g, Key_P) \
   OP(XKB_KEY_gcedilla, RALT(Key_P)) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_Slash)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_guillemotright, RALT(Key_RightBracket)) \
   OP(XKB_KEY_h, Key_Comma) \
   OP(XKB_KEY_i, Key_K) \
   OP(XKB_KEY_imacron, Key_I) \
   OP(XKB_KEY_j, Key_Y) \
   OP(XKB_KEY_k, Key_G) \
   OP(XKB_KEY_kcedilla, RALT(Key_G)) \
   OP(XKB_KEY_l, Key_O) \
   OP(XKB_KEY_lcedilla, RALT(Key_O)) \
   OP(XKB_KEY_leftdoublequotemark, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_less, RALT(Key_Period)) \
   OP(XKB_KEY_m, Key_Quote) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_multiply, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_n, Key_F) \
   OP(XKB_KEY_ncedilla, RALT(Key_F)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_W) \
   OP(XKB_KEY_omacron, RALT(Key_W)) \
   ...
   OP(XKB_KEY_q, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_question, RALT(Key_R)) \
   OP(XKB_KEY_questiondown, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_H)) \
   OP(XKB_KEY_r, Key_Semicolon) \
   OP(XKB_KEY_rcedilla, RALT(Key_Semicolon)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_s, Key_J) \
   OP(XKB_KEY_scaron, RALT(Key_J)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_Period)) \
