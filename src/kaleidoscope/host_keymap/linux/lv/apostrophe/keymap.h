...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ē', RALT(LSHIFT(Key_E))) /* U+0112, XKB_KEY_Emacron, LATIN CAPITAL LETTER E WITH MACRON */ \
   OP(L'ē', RALT(Key_E)) /* U+0113, XKB_KEY_emacron, LATIN SMALL LETTER E WITH MACRON */ \
   OP(L'Ģ', RALT(LSHIFT(Key_G))) /* U+0122, XKB_KEY_Gcedilla, LATIN CAPITAL LETTER G WITH CEDILLA */ \
   OP(L'ģ', RALT(Key_G)) /* U+0123, XKB_KEY_gcedilla, LATIN SMALL LETTER G WITH CEDILLA */ \
   OP(L'Ī', RALT(LSHIFT(Key_I))) /* U+012a, XKB_KEY_Imacron, LATIN CAPITAL LETTER I WITH MACRON */ \
   OP(L'ī', RALT(Key_I)) /* U+012b, XKB_KEY_imacron, LATIN SMALL LETTER I WITH MACRON */ \
   OP(L'Ķ', RALT(LSHIFT(Key_K))) /* U+0136, XKB_KEY_Kcedilla, LATIN CAPITAL LETTER K WITH CEDILLA */ \
   OP(L'ķ', RALT(Key_K)) /* U+0137, XKB_KEY_kcedilla, LATIN SMALL LETTER K WITH CEDILLA */ \
   OP(L'Ļ', RALT(LSHIFT(Key_L))) /* U+013b, XKB_KEY_Lcedilla, LATIN CAPITAL LETTER L WITH CEDILLA */ \
   OP(L'ļ', RALT(Key_L)) /* U+013c, XKB_KEY_lcedilla, LATIN SMALL LETTER L WITH CEDILLA */ \
   OP(L'Ņ', RALT(LSHIFT(Key_N))) /* U+0145, XKB_KEY_Ncedilla, LATIN CAPITAL LETTER N WITH CEDILLA */ \
   OP(L'ņ', RALT(Key_N)) /* U+0146, XKB_KEY_ncedilla, LATIN SMALL LETTER N WITH CEDILLA */ \
   OP(L'Ō', RALT(LSHIFT(Key_O))) /* U+014c, XKB_KEY_Omacron, LATIN CAPITAL LETTER O WITH MACRON */ \
   OP(L'ō', RALT(Key_O)) /* U+014d, XKB_KEY_omacron, LATIN SMALL LETTER O WITH MACRON */ \
   ...
   OP(L'Ū', RALT(LSHIFT(Key_U))) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', RALT(Key_U)) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Emacron, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Gcedilla, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_Imacron, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Kcedilla, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_L, LSHIFT(Key_L)) \
   OP(XKB_KEY_Lcedilla, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Ncedilla, RALT(LSHIFT(Key_N))) \
   ...
   OP(XKB_KEY_Omacron, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gcedilla, RALT(Key_G)) \
   ...
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_imacron, RALT(Key_I)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_kcedilla, RALT(Key_K)) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_lcedilla, RALT(Key_L)) \
   ...
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_ncedilla, RALT(Key_N)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_omacron, RALT(Key_O)) \
