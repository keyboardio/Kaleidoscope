...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'“', RALT(Key_Quote)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_RightBracket))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_Quote))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_e, Key_K) \
   ...
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_Quote)) \
