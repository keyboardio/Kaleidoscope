...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'´', RALT(LSHIFT(Key_Backtick))) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Latch, Key_Backtick) /* XKB_KEY_ISO_Level3_Latch */ \
   ...
   OP(XKB_KEY_acute, RALT(LSHIFT(Key_Backtick))) \
