...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', LSHIFT(Key_Backtick)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('~', Key_Backtick) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', LSHIFT(Key_Backtick)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'~', Key_Backtick) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'–', RALT(Key_RightBracket)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_RightBracket))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'“', RALT(Key_Minus)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_Equals)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_Q))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciitilde, Key_Backtick) \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_emacron, RALT(Key_D)) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_endash, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_grave, LSHIFT(Key_Backtick)) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_Minus)) \
   ...
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_Equals)) \
