...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ē', RALT(LSHIFT(Key_K))) /* U+0112, XKB_KEY_Emacron, LATIN CAPITAL LETTER E WITH MACRON */ \
   OP(L'ē', RALT(Key_K)) /* U+0113, XKB_KEY_emacron, LATIN SMALL LETTER E WITH MACRON */ \
   OP(L'Ģ', RALT(LSHIFT(Key_T))) /* U+0122, XKB_KEY_Gcedilla, LATIN CAPITAL LETTER G WITH CEDILLA */ \
   OP(L'ģ', RALT(Key_T)) /* U+0123, XKB_KEY_gcedilla, LATIN SMALL LETTER G WITH CEDILLA */ \
   OP(L'Ī', RALT(LSHIFT(Key_L))) /* U+012a, XKB_KEY_Imacron, LATIN CAPITAL LETTER I WITH MACRON */ \
   OP(L'ī', RALT(Key_L)) /* U+012b, XKB_KEY_imacron, LATIN SMALL LETTER I WITH MACRON */ \
   OP(L'Ķ', RALT(LSHIFT(Key_N))) /* U+0136, XKB_KEY_Kcedilla, LATIN CAPITAL LETTER K WITH CEDILLA */ \
   OP(L'ķ', RALT(Key_N)) /* U+0137, XKB_KEY_kcedilla, LATIN SMALL LETTER K WITH CEDILLA */ \
   OP(L'Ļ', RALT(LSHIFT(Key_U))) /* U+013b, XKB_KEY_Lcedilla, LATIN CAPITAL LETTER L WITH CEDILLA */ \
   OP(L'ļ', RALT(Key_U)) /* U+013c, XKB_KEY_lcedilla, LATIN SMALL LETTER L WITH CEDILLA */ \
   OP(L'Ņ', RALT(LSHIFT(Key_J))) /* U+0145, XKB_KEY_Ncedilla, LATIN CAPITAL LETTER N WITH CEDILLA */ \
   OP(L'ņ', RALT(Key_J)) /* U+0146, XKB_KEY_ncedilla, LATIN SMALL LETTER N WITH CEDILLA */ \
   OP(L'Ō', RALT(LSHIFT(Key_Semicolon))) /* U+014c, XKB_KEY_Omacron, LATIN CAPITAL LETTER O WITH MACRON */ \
   OP(L'ō', RALT(Key_Semicolon)) /* U+014d, XKB_KEY_omacron, LATIN SMALL LETTER O WITH MACRON */ \
   OP(L'Ŗ', RALT(LSHIFT(Key_S))) /* U+0156, XKB_KEY_Rcedilla, LATIN CAPITAL LETTER R WITH CEDILLA */ \
   OP(L'ŗ', RALT(Key_S)) /* U+0157, XKB_KEY_rcedilla, LATIN SMALL LETTER R WITH CEDILLA */ \
   OP(L'Š', RALT(LSHIFT(Key_D))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_D)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ū', RALT(LSHIFT(Key_I))) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', RALT(Key_I)) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ž', RALT(LSHIFT(Key_Z))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_Z)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'˘', RALT(LSHIFT(Key_NonUsPound))) /* U+02d8, XKB_KEY_breve, BREVE */ \
   OP(L'˙', RALT(LSHIFT(Key_Slash))) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Emacron, RALT(LSHIFT(Key_K))) \
   ...
   OP(XKB_KEY_Gcedilla, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_Imacron, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Kcedilla, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_L, LSHIFT(Key_U)) \
   OP(XKB_KEY_Lcedilla, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_Ncedilla, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_Omacron, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Rcedilla, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Umacron, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abovedot, RALT(LSHIFT(Key_Slash))) \
   ...
   OP(XKB_KEY_g, Key_T) \
   OP(XKB_KEY_gcedilla, RALT(Key_T)) \
   ...
   OP(XKB_KEY_i, Key_L) \
   OP(XKB_KEY_imacron, RALT(Key_L)) \
   OP(XKB_KEY_j, Key_Y) \
   OP(XKB_KEY_k, Key_N) \
   OP(XKB_KEY_kcedilla, RALT(Key_N)) \
   OP(XKB_KEY_l, Key_U) \
   OP(XKB_KEY_lcedilla, RALT(Key_U)) \
   ...
   OP(XKB_KEY_n, Key_J) \
   OP(XKB_KEY_ncedilla, RALT(Key_J)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_Semicolon) \
   OP(XKB_KEY_omacron, RALT(Key_Semicolon)) \
