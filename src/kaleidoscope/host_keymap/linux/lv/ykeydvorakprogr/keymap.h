...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('-', Key_Quote) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP('Y', RALT(LSHIFT(Key_T))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP('_', LSHIFT(Key_Quote)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP('y', RALT(Key_T)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'-', Key_Quote) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   ...
   OP(L'Y', RALT(LSHIFT(Key_T))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP(L'_', LSHIFT(Key_Quote)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP(L'y', RALT(Key_T)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   ...
   OP(L'¿', RALT(LSHIFT(Key_Quote))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ISO_Level3_Latch, Key_T) /* XKB_KEY_ISO_Level3_Latch */ \
   ...
   OP(XKB_KEY_Y, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_questiondown, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_underscore, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_v, Key_Period) \
   OP(XKB_KEY_w, Key_Comma) \
   OP(XKB_KEY_x, Key_B) \
   OP(XKB_KEY_y, RALT(Key_T)) \
