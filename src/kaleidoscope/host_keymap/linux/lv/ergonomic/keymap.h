...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('B', LSHIFT(Key_X)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP('C', LSHIFT(Key_Semicolon)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP('D', LSHIFT(Key_H)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', LSHIFT(Key_L)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', LSHIFT(Key_Equals)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_W)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', LSHIFT(Key_RightBracket)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_F)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_E)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_V)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', LSHIFT(Key_G)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('M', LSHIFT(Key_T)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP('N', LSHIFT(Key_U)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP('O', LSHIFT(Key_N)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', LSHIFT(Key_B)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP('V', LSHIFT(Key_Y)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP('W', RALT(LSHIFT(Key_Y))) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP('X', RALT(LSHIFT(Key_X))) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', RALT(LSHIFT(Key_U))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP('Z', LSHIFT(Key_I)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   ...
   OP('b', Key_X) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP('c', Key_Semicolon) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP('d', Key_H) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', Key_L) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', Key_Equals) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', Key_W) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', Key_RightBracket) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', Key_F) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', Key_E) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', Key_V) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', Key_G) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', Key_T) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', Key_U) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', Key_N) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', Key_B) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP('v', Key_Y) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', RALT(Key_Y)) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', RALT(Key_X)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', RALT(Key_U)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', Key_I) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'B', LSHIFT(Key_X)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP(L'C', LSHIFT(Key_Semicolon)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP(L'D', LSHIFT(Key_H)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', LSHIFT(Key_L)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', LSHIFT(Key_Equals)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_W)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', LSHIFT(Key_RightBracket)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_F)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_E)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_V)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', LSHIFT(Key_G)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'M', LSHIFT(Key_T)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP(L'N', LSHIFT(Key_U)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP(L'O', LSHIFT(Key_N)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', LSHIFT(Key_B)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   ...
   OP(L'V', LSHIFT(Key_Y)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP(L'W', RALT(LSHIFT(Key_Y))) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP(L'X', RALT(LSHIFT(Key_X))) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', RALT(LSHIFT(Key_U))) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   OP(L'Z', LSHIFT(Key_I)) /* U+005a, XKB_KEY_Z, LATIN CAPITAL LETTER Z */ \
   ...
   OP(L'b', Key_X) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP(L'c', Key_Semicolon) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP(L'd', Key_H) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', Key_L) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', Key_Equals) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', Key_W) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', Key_RightBracket) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', Key_F) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', Key_E) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', Key_V) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', Key_G) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', Key_T) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', Key_U) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', Key_N) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', Key_B) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   ...
   OP(L'v', Key_Y) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', RALT(Key_Y)) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', RALT(Key_X)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', RALT(Key_U)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', Key_I) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   ...
   OP(L'Ā', LSHIFT(Key_M)) /* U+0100, XKB_KEY_Amacron, LATIN CAPITAL LETTER A WITH MACRON */ \
   OP(L'ā', Key_M) /* U+0101, XKB_KEY_amacron, LATIN SMALL LETTER A WITH MACRON */ \
   OP(L'Č', LSHIFT(Key_P)) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', Key_P) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Ē', LSHIFT(Key_O)) /* U+0112, XKB_KEY_Emacron, LATIN CAPITAL LETTER E WITH MACRON */ \
   OP(L'ē', Key_O) /* U+0113, XKB_KEY_emacron, LATIN SMALL LETTER E WITH MACRON */ \
   OP(L'Ģ', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+0122, XKB_KEY_Gcedilla, LATIN CAPITAL LETTER G WITH CEDILLA */ \
   OP(L'ģ', Key_NonUsBackslashAndPipe) /* U+0123, XKB_KEY_gcedilla, LATIN SMALL LETTER G WITH CEDILLA */ \
   OP(L'Ī', LSHIFT(Key_C)) /* U+012a, XKB_KEY_Imacron, LATIN CAPITAL LETTER I WITH MACRON */ \
   OP(L'ī', Key_C) /* U+012b, XKB_KEY_imacron, LATIN SMALL LETTER I WITH MACRON */ \
   OP(L'Ķ', LSHIFT(Key_NonUsPound)) /* U+0136, XKB_KEY_Kcedilla, LATIN CAPITAL LETTER K WITH CEDILLA */ \
   OP(L'ķ', Key_NonUsPound) /* U+0137, XKB_KEY_kcedilla, LATIN SMALL LETTER K WITH CEDILLA */ \
   OP(L'Ļ', LSHIFT(Key_Slash)) /* U+013b, XKB_KEY_Lcedilla, LATIN CAPITAL LETTER L WITH CEDILLA */ \
   OP(L'ļ', Key_Slash) /* U+013c, XKB_KEY_lcedilla, LATIN SMALL LETTER L WITH CEDILLA */ \
   OP(L'Ņ', LSHIFT(Key_Z)) /* U+0145, XKB_KEY_Ncedilla, LATIN CAPITAL LETTER N WITH CEDILLA */ \
   OP(L'ņ', Key_Z) /* U+0146, XKB_KEY_ncedilla, LATIN SMALL LETTER N WITH CEDILLA */ \
   OP(L'Ō', RALT(LSHIFT(Key_N))) /* U+014c, XKB_KEY_Omacron, LATIN CAPITAL LETTER O WITH MACRON */ \
   OP(L'ō', RALT(Key_N)) /* U+014d, XKB_KEY_omacron, LATIN SMALL LETTER O WITH MACRON */ \
   OP(L'Ŗ', RALT(LSHIFT(Key_R))) /* U+0156, XKB_KEY_Rcedilla, LATIN CAPITAL LETTER R WITH CEDILLA */ \
   OP(L'ŗ', RALT(Key_R)) /* U+0157, XKB_KEY_rcedilla, LATIN SMALL LETTER R WITH CEDILLA */ \
   OP(L'Š', LSHIFT(Key_A)) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', Key_A) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ū', LSHIFT(Key_Q)) /* U+016a, XKB_KEY_Umacron, LATIN CAPITAL LETTER U WITH MACRON */ \
   OP(L'ū', Key_Q) /* U+016b, XKB_KEY_umacron, LATIN SMALL LETTER U WITH MACRON */ \
   OP(L'Ž', LSHIFT(Key_LeftBracket)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_LeftBracket) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Gcedilla, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_H, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Home, Key_Home) /* XKB_KEY_Home */ \
   OP(XKB_KEY_I, LSHIFT(Key_F)) \
   ...
   OP(XKB_KEY_Kcedilla, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_L, LSHIFT(Key_G)) \
   OP(XKB_KEY_Lcedilla, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Left, Key_LeftArrow) /* XKB_KEY_Left, Move left, left arrow  */ \
   OP(XKB_KEY_M, LSHIFT(Key_T)) \
   OP(XKB_KEY_Menu, Key_PcApplication) /* XKB_KEY_Menu */ \
   OP(XKB_KEY_Meta_L, LSHIFT(Key_LeftAlt)) /* XKB_KEY_Meta_L, Left meta  */ \
   OP(XKB_KEY_N, LSHIFT(Key_U)) \
   OP(XKB_KEY_Ncedilla, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Next, Key_PageDown) /* XKB_KEY_Next, Next  */ \
   OP(XKB_KEY_Num_Lock, Key_KeypadNumLock) /* XKB_KEY_Num_Lock */ \
   OP(XKB_KEY_O, LSHIFT(Key_N)) \
   OP(XKB_KEY_Omacron, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_P, LSHIFT(Key_B)) \
   ...
   OP(XKB_KEY_Rcedilla, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Scaron, LSHIFT(Key_A)) \
   ...
   OP(XKB_KEY_Umacron, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_V, LSHIFT(Key_Y)) \
   OP(XKB_KEY_W, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_Z, LSHIFT(Key_I)) \
   OP(XKB_KEY_Zcaron, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_a, Key_J) \
   OP(XKB_KEY_acute, RALT(Key_Backtick)) \
   OP(XKB_KEY_amacron, Key_M) \
   ...
   OP(XKB_KEY_c, Key_Semicolon) \
   OP(XKB_KEY_ccaron, Key_P) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rcedilla, RALT(Key_R)) \
   OP(XKB_KEY_s, Key_D) \
   OP(XKB_KEY_scaron, Key_A) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_seveneighths, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_slash, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_u, Key_S) \
   OP(XKB_KEY_umacron, Key_Q) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_v, Key_Y) \
   OP(XKB_KEY_w, RALT(Key_Y)) \
   OP(XKB_KEY_x, RALT(Key_X)) \
   OP(XKB_KEY_y, RALT(Key_U)) \
   OP(XKB_KEY_z, Key_I) \
   OP(XKB_KEY_zcaron, Key_LeftBracket) \
