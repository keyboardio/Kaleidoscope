...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'È', RALT(LSHIFT(Key_E))) /* U+00c8, XKB_KEY_Egrave, LATIN CAPITAL LETTER E WITH GRAVE */ \
   OP(L'Ì', RALT(LSHIFT(Key_I))) /* U+00cc, XKB_KEY_Igrave, LATIN CAPITAL LETTER I WITH GRAVE */ \
   ...
   OP(L'è', RALT(Key_E)) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'ì', RALT(Key_I)) /* U+00ec, XKB_KEY_igrave, LATIN SMALL LETTER I WITH GRAVE */ \
   ...
   OP(L'ù', RALT(Key_U)) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'þ', RALT(Key_P)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'Ċ', LSHIFT(Key_Backtick)) /* U+010a, XKB_KEY_Cabovedot, LATIN CAPITAL LETTER C WITH DOT ABOVE */ \
   OP(L'ċ', Key_Backtick) /* U+010b, XKB_KEY_cabovedot, LATIN SMALL LETTER C WITH DOT ABOVE */ \
   OP(L'đ', RALT(Key_F)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ġ', LSHIFT(Key_LeftBracket)) /* U+0120, XKB_KEY_Gabovedot, LATIN CAPITAL LETTER G WITH DOT ABOVE */ \
   OP(L'ġ', Key_LeftBracket) /* U+0121, XKB_KEY_gabovedot, LATIN SMALL LETTER G WITH DOT ABOVE */ \
   OP(L'Ħ', LSHIFT(Key_RightBracket)) /* U+0126, XKB_KEY_Hstroke, LATIN CAPITAL LETTER H WITH STROKE */ \
   OP(L'ħ', Key_RightBracket) /* U+0127, XKB_KEY_hstroke, LATIN SMALL LETTER H WITH STROKE */ \
   ...
   OP(L'Ż', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', Key_NonUsBackslashAndPipe) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
   ...
   OP(L'€', LSHIFT(Key_3)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cabovedot, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Igrave, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Zabovedot, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cabovedot, Key_Backtick) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gabovedot, Key_LeftBracket) \
   ...
   OP(XKB_KEY_hstroke, Key_RightBracket) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_igrave, RALT(Key_I)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   ...
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zabovedot, Key_NonUsBackslashAndPipe) \
