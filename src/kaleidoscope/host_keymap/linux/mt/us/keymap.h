...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ż', LSHIFT(Key_NonUsPound)) /* U+017b, XKB_KEY_Zabovedot, LATIN CAPITAL LETTER Z WITH DOT ABOVE */ \
   OP(L'ż', Key_NonUsPound) /* U+017c, XKB_KEY_zabovedot, LATIN SMALL LETTER Z WITH DOT ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zabovedot, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zabovedot, Key_NonUsPound) \
