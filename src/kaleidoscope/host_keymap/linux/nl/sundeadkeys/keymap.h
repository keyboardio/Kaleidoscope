...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', LSHIFT(Key_0)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', LSHIFT(Key_8)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_9)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP('*', Key_RightBracket) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   OP('+', Key_Semicolon) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP('=', LSHIFT(Key_Slash)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP('[', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(Key_Minus)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', Key_NonUsBackslashAndPipe) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP('|', LSHIFT(Key_RightBracket)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', LSHIFT(Key_0)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', LSHIFT(Key_8)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_9)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP(L'*', Key_RightBracket) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   OP(L'+', Key_Semicolon) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP(L'=', LSHIFT(Key_Slash)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP(L'[', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(Key_Minus)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', Key_NonUsBackslashAndPipe) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP(L'|', LSHIFT(Key_RightBracket)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'£', RALT(Key_7)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   ...
   OP(L'°', Key_Equals) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', LSHIFT(Key_Semicolon)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   ...
   OP(L'Ò', RALT(LSHIFT(Key_O))) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   ...
   OP(L'ò', RALT(Key_O)) /* U+00f2, XKB_KEY_ograve, LATIN SMALL LETTER O WITH GRAVE */ \
   ...
   OP(L'μ', RALT(Key_M)) /* U+03bc, XKB_KEY_Greek_mu, GREEK SMALL LETTER MU */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Greek_mu, RALT(Key_M)) \
   ...
   OP(XKB_KEY_Ograve, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_apostrophe, LSHIFT(Key_0)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciicircum, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_asciitilde, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_asterisk, Key_RightBracket) \
   OP(XKB_KEY_at, Key_Backtick) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(Key_Minus)) \
   OP(XKB_KEY_bar, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_braceleft, RALT(Key_8)) \
   OP(XKB_KEY_braceright, RALT(Key_9)) \
   OP(XKB_KEY_bracketleft, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_bracketright, Key_NonUsBackslashAndPipe) \
   ...
   OP(XKB_KEY_dead_diaeresis, Key_LeftBracket) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_dead_tilde, LSHIFT(Key_Equals)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, Key_Equals) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eng, RALT(Key_G)) \
   OP(XKB_KEY_equal, LSHIFT(Key_Slash)) \
   ...
   OP(XKB_KEY_sterling, RALT(Key_7)) \
   OP(XKB_KEY_t, Key_T) \
