...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('^', RALT(Key_NonUsPound)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'^', RALT(Key_NonUsPound)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'¦', RALT(Key_NonUsBackslashAndPipe)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_brokenbar, RALT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_c, Key_C) \
