...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'І', LSHIFT(Key_X)) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   ...
   OP(L'і', Key_X) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ғ', LSHIFT(Key_O)) /* U+0492, XKB_KEY_Cyrillic_GHE_bar, CYRILLIC CAPITAL LETTER GHE WITH STROKE */ \
   OP(L'ғ', Key_O) /* U+0493, XKB_KEY_Cyrillic_ghe_bar, CYRILLIC SMALL LETTER GHE WITH STROKE */ \
   OP(L'Қ', LSHIFT(Key_D)) /* U+049a, XKB_KEY_Cyrillic_KA_descender, CYRILLIC CAPITAL LETTER KA WITH DESCENDER */ \
   OP(L'қ', Key_D) /* U+049b, XKB_KEY_Cyrillic_ka_descender, CYRILLIC SMALL LETTER KA WITH DESCENDER */ \
   OP(L'Ң', LSHIFT(Key_W)) /* U+04a2, XKB_KEY_Cyrillic_EN_descender, CYRILLIC CAPITAL LETTER EN WITH DESCENDER */ \
   OP(L'ң', Key_W) /* U+04a3, XKB_KEY_Cyrillic_en_descender, CYRILLIC SMALL LETTER EN WITH DESCENDER */ \
   OP(L'Ү', LSHIFT(Key_M)) /* U+04ae, XKB_KEY_Cyrillic_U_straight, CYRILLIC CAPITAL LETTER STRAIGHT U */ \
   OP(L'ү', Key_M) /* U+04af, XKB_KEY_Cyrillic_u_straight, CYRILLIC SMALL LETTER STRAIGHT U */ \
   OP(L'Ұ', LSHIFT(Key_RightBracket)) /* U+04b0, XKB_KEY_Cyrillic_U_straight_bar, CYRILLIC CAPITAL LETTER STRAIGHT U WITH STROKE */ \
   OP(L'ұ', Key_RightBracket) /* U+04b1, XKB_KEY_Cyrillic_u_straight_bar, CYRILLIC SMALL LETTER STRAIGHT U WITH STROKE */ \
   OP(L'Ә', LSHIFT(Key_Quote)) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', Key_Quote) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ө', LSHIFT(Key_A)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_A) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_KA_descender, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_O_bar, LSHIFT(Key_A)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_SCHWA, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_U_straight, LSHIFT(Key_M)) \
   OP(XKB_KEY_Cyrillic_U_straight_bar, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_ka_descender, Key_D) \
   OP(XKB_KEY_Cyrillic_o, Key_J) \
   OP(XKB_KEY_Cyrillic_o_bar, Key_A) \
   OP(XKB_KEY_Cyrillic_pe, Key_G) \
   OP(XKB_KEY_Cyrillic_schwa, Key_Quote) \
   OP(XKB_KEY_Cyrillic_sha, Key_I) \
   OP(XKB_KEY_Cyrillic_shorti, Key_Q) \
   OP(XKB_KEY_Cyrillic_te, Key_N) \
   OP(XKB_KEY_Cyrillic_u, Key_E) \
   OP(XKB_KEY_Cyrillic_u_straight, Key_M) \
   OP(XKB_KEY_Cyrillic_u_straight_bar, Key_RightBracket) \
   ...
   OP(XKB_KEY_Ukrainian_I, LSHIFT(Key_X)) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_i, Key_X) /* XKB_KEY_Ukranian_i, deprecated  */ \
