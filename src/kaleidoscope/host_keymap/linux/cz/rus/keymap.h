...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_Period)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', Key_7) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('$', Key_9) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP('%', Key_Minus) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('&', LSHIFT(Key_1)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP('\'', Key_Equals) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', LSHIFT(Key_RightBracket)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', Key_RightBracket) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(':', LSHIFT(Key_Quote)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', Key_Quote) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('<', RALT(Key_Semicolon)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_0) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_Period)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', Key_7) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'$', Key_9) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   OP(L'%', Key_Minus) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'&', LSHIFT(Key_1)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   ...
   OP(L')', Key_RightBracket) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L':', LSHIFT(Key_Quote)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', Key_Quote) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'<', RALT(Key_Semicolon)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_0) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP(L'¦', LSHIFT(Key_NonUsPound)) /* U+00a6, XKB_KEY_brokenbar, BROKEN BAR */ \
   OP(L'§', Key_8) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'Ж', LSHIFT(Key_6)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   ...
   OP(L'Ч', LSHIFT(Key_4)) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', LSHIFT(Key_3)) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', LSHIFT(Key_5)) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   OP(L'Ы', LSHIFT(Key_Y)) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', LSHIFT(Key_Semicolon)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', LSHIFT(Key_LeftBracket)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   OP(L'Ю', LSHIFT(Key_W)) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   ...
   OP(L'ж', Key_6) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   ...
   OP(L'ч', Key_4) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', Key_3) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', Key_5) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   OP(L'ъ', Key_2) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', Key_Y) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', Key_Semicolon) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', Key_LeftBracket) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   OP(L'ю', Key_W) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   ...
   OP(L'№', Key_Q) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE, LSHIFT(Key_4)) \
   OP(XKB_KEY_Cyrillic_DE, LSHIFT(Key_D)) \
   OP(XKB_KEY_Cyrillic_E, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_3)) \
   OP(XKB_KEY_Cyrillic_SHCHA, LSHIFT(Key_5)) \
   OP(XKB_KEY_Cyrillic_SHORTI, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_Cyrillic_YU, LSHIFT(Key_W)) \
   OP(XKB_KEY_Cyrillic_ZE, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_6)) \
   OP(XKB_KEY_Cyrillic_a, Key_A) \
   OP(XKB_KEY_Cyrillic_be, Key_B) \
   OP(XKB_KEY_Cyrillic_che, Key_4) \
   OP(XKB_KEY_Cyrillic_de, Key_D) \
   OP(XKB_KEY_Cyrillic_e, Key_LeftBracket) \
   ...
   OP(XKB_KEY_Cyrillic_hardsign, Key_2) \
   ...
   OP(XKB_KEY_Cyrillic_sha, Key_3) \
   OP(XKB_KEY_Cyrillic_shcha, Key_5) \
   OP(XKB_KEY_Cyrillic_shorti, Key_J) \
   OP(XKB_KEY_Cyrillic_softsign, Key_Semicolon) \
   ...
   OP(XKB_KEY_Cyrillic_yu, Key_W) \
   OP(XKB_KEY_Cyrillic_ze, Key_Z) \
   OP(XKB_KEY_Cyrillic_zhe, Key_6) \
   ...
   OP(XKB_KEY_ampersand, LSHIFT(Key_1)) \
   ...
   OP(XKB_KEY_brokenbar, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_c, RALT(Key_C)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_dollar, Key_9) \
   OP(XKB_KEY_e, RALT(Key_E)) \
   OP(XKB_KEY_equal, Key_0) \
   OP(XKB_KEY_exclam, LSHIFT(Key_Period)) \
