...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ě', Key_2) /* U+011b, XKB_KEY_ecaron, LATIN SMALL LETTER E WITH CARON */ \
   ...
   OP(L'ř', Key_5) /* U+0159, XKB_KEY_rcaron, LATIN SMALL LETTER R WITH CARON */ \
   ...
   OP(L'ů', Key_Semicolon) /* U+016f, XKB_KEY_uring, LATIN SMALL LETTER U WITH RING ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_diaeresis, Key_NonUsPound) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_uring, Key_Semicolon) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Z) \
