...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'É', RALT(LSHIFT(Key_C))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   ...
   OP(L'Ú', RALT(LSHIFT(Key_V))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ý', RALT(LSHIFT(Key_T))) /* U+00dd, XKB_KEY_Yacute, LATIN CAPITAL LETTER Y WITH ACUTE */ \
   OP(L'á', RALT(Key_A)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'é', RALT(Key_C)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   ...
   OP(L'ú', RALT(Key_V)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ý', RALT(Key_T)) /* U+00fd, XKB_KEY_yacute, LATIN SMALL LETTER Y WITH ACUTE */ \
   ...
   OP(L'Ď', RALT(LSHIFT(Key_H))) /* U+010e, XKB_KEY_Dcaron, LATIN CAPITAL LETTER D WITH CARON */ \
   OP(L'ď', RALT(Key_H)) /* U+010f, XKB_KEY_dcaron, LATIN SMALL LETTER D WITH CARON */ \
   OP(L'Ě', RALT(LSHIFT(Key_D))) /* U+011a, XKB_KEY_Ecaron, LATIN CAPITAL LETTER E WITH CARON */ \
   OP(L'ě', RALT(Key_D)) /* U+011b, XKB_KEY_ecaron, LATIN SMALL LETTER E WITH CARON */ \
   OP(L'Ň', RALT(LSHIFT(Key_L))) /* U+0147, XKB_KEY_Ncaron, LATIN CAPITAL LETTER N WITH CARON */ \
   OP(L'ň', RALT(Key_L)) /* U+0148, XKB_KEY_ncaron, LATIN SMALL LETTER N WITH CARON */ \
   OP(L'Ř', RALT(LSHIFT(Key_O))) /* U+0158, XKB_KEY_Rcaron, LATIN CAPITAL LETTER R WITH CARON */ \
   OP(L'ř', RALT(Key_O)) /* U+0159, XKB_KEY_rcaron, LATIN SMALL LETTER R WITH CARON */ \
   ...
   OP(L'Ť', RALT(LSHIFT(Key_K))) /* U+0164, XKB_KEY_Tcaron, LATIN CAPITAL LETTER T WITH CARON */ \
   OP(L'ť', RALT(Key_K)) /* U+0165, XKB_KEY_tcaron, LATIN SMALL LETTER T WITH CARON */ \
   OP(L'Ů', RALT(LSHIFT(Key_F))) /* U+016e, XKB_KEY_Uring, LATIN CAPITAL LETTER U WITH RING ABOVE */ \
   OP(L'ů', RALT(Key_F)) /* U+016f, XKB_KEY_uring, LATIN SMALL LETTER U WITH RING ABOVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Dcaron, RALT(LSHIFT(Key_H))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_Ecaron, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Ncaron, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Rcaron, RALT(LSHIFT(Key_O))) \
   ...
   OP(XKB_KEY_Tcaron, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_U, LSHIFT(Key_F)) \
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_Uring, RALT(LSHIFT(Key_F))) \
   ...
   OP(XKB_KEY_Yacute, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_e, Key_D) \
   OP(XKB_KEY_eacute, RALT(Key_C)) \
   OP(XKB_KEY_ecaron, RALT(Key_D)) \
   ...
   OP(XKB_KEY_t, Key_K) \
   OP(XKB_KEY_tcaron, RALT(Key_K)) \
   OP(XKB_KEY_u, Key_F) \
   OP(XKB_KEY_uacute, RALT(Key_V)) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_uring, RALT(Key_F)) \
   OP(XKB_KEY_v, Key_Period) \
   OP(XKB_KEY_w, Key_Comma) \
   OP(XKB_KEY_x, Key_B) \
   OP(XKB_KEY_y, Key_T) \
   OP(XKB_KEY_yacute, RALT(Key_T)) \
