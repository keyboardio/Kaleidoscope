...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('X', LSHIFT(Key_LeftBracket)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP('x', Key_LeftBracket) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'X', LSHIFT(Key_LeftBracket)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   ...
   OP(L'x', Key_LeftBracket) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   ...
   OP(L'Ê', LSHIFT(Key_Comma)) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Î', LSHIFT(Key_Quote)) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ô', RALT(LSHIFT(Key_O))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ö', RALT(LSHIFT(Key_Comma))) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Û', LSHIFT(Key_RightBracket)) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
   ...
   OP(L'ê', Key_Comma) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'î', Key_Quote) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ô', RALT(Key_O)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'ö', RALT(Key_Comma)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(LSHIFT(Key_Period))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'û', Key_RightBracket) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
   OP(L'Ğ', RALT(LSHIFT(Key_LeftBracket))) /* U+011e, XKB_KEY_Gbreve, LATIN CAPITAL LETTER G WITH BREVE */ \
   OP(L'ğ', RALT(Key_LeftBracket)) /* U+011f, XKB_KEY_gbreve, LATIN SMALL LETTER G WITH BREVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ecircumflex, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Gbreve, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_Icircumflex, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_Comma))) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_icircumflex, Key_Quote) \
   ...
   OP(XKB_KEY_odiaeresis, RALT(Key_Comma)) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_ucircumflex, Key_RightBracket) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_LeftBracket) \
   OP(XKB_KEY_y, Key_Y) \
