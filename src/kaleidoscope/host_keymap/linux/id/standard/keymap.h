...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('[', RALT(Key_RightBracket)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_LeftBracket)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP('}', RALT(LSHIFT(Key_LeftBracket))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'[', RALT(Key_RightBracket)) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(Key_NonUsPound)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_LeftBracket)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP(L'}', RALT(LSHIFT(Key_LeftBracket))) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   ...
   OP(L'ء', LSHIFT(Key_Q)) /* U+0621, XKB_KEY_Arabic_hamza, ARABIC LETTER HAMZA */ \
   OP(L'آ', LSHIFT(Key_NonUsPound)) /* U+0622, XKB_KEY_Arabic_maddaonalef, ARABIC LETTER ALEF WITH MADDA ABOVE */ \
   OP(L'أ', LSHIFT(Key_U)) /* U+0623, XKB_KEY_Arabic_hamzaonalef, ARABIC LETTER ALEF WITH HAMZA ABOVE */ \
   OP(L'ؤ', LSHIFT(Key_W)) /* U+0624, XKB_KEY_Arabic_hamzaonwaw, ARABIC LETTER WAW WITH HAMZA ABOVE */ \
   ...
   OP(L'ة', LSHIFT(Key_P)) /* U+0629, XKB_KEY_Arabic_tehmarbuta, ARABIC LETTER TEH MARBUTA */ \
   OP(L'ت', Key_T) /* U+062a, XKB_KEY_Arabic_teh, ARABIC LETTER TEH */ \
   OP(L'ث', LSHIFT(Key_V)) /* U+062b, XKB_KEY_Arabic_theh, ARABIC LETTER THEH */ \
   ...
   OP(L'ذ', LSHIFT(Key_C)) /* U+0630, XKB_KEY_Arabic_thal, ARABIC LETTER THAL */ \
   ...
   OP(L'ش', LSHIFT(Key_X)) /* U+0634, XKB_KEY_Arabic_sheen, ARABIC LETTER SHEEN */ \
   ...
   OP(L'ً', Key_LeftBracket) /* U+064b, XKB_KEY_Arabic_fathatan, ARABIC FATHATAN */ \
   OP(L'ٌ', Key_NonUsPound) /* U+064c, XKB_KEY_Arabic_dammatan, ARABIC DAMMATAN */ \
   OP(L'ٍ', Key_RightBracket) /* U+064d, XKB_KEY_Arabic_kasratan, ARABIC KASRATAN */ \
   ...
   OP(L'ٓ', LSHIFT(Key_L)) /* U+0653, XKB_KEY_Arabic_madda_above, ARABIC MADDAH ABOVE */ \
   OP(L'ٖ', LSHIFT(Key_R)) \
   OP(L'ٗ', LSHIFT(Key_4)) \
   ...
   OP(L'ک', LSHIFT(Key_K)) /* U+06a9, XKB_KEY_Arabic_keheh, ARABIC LETTER KEHEH */ \
   OP(L'ڬ', LSHIFT(Key_J)) \
   OP(L'ڽ', LSHIFT(Key_N)) \
   OP(L'ۆ', LSHIFT(Key_O)) \
   OP(L'ێ', LSHIFT(Key_E)) \
   OP(L'ۏ', Key_V) \
   OP(L'۔', RALT(Key_Period)) /* U+06d4, XKB_KEY_Arabic_fullstop, ARABIC FULL STOP */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_dammatan, Key_NonUsPound) \
   OP(XKB_KEY_Arabic_fatha, Key_A) \
   OP(XKB_KEY_Arabic_fathatan, Key_LeftBracket) \
   OP(XKB_KEY_Arabic_feh, Key_F) \
   OP(XKB_KEY_Arabic_fullstop, RALT(Key_Period)) \
   ...
   OP(XKB_KEY_Arabic_hamza, LSHIFT(Key_Q)) \
   OP(XKB_KEY_Arabic_hamzaonalef, LSHIFT(Key_U)) \
   OP(XKB_KEY_Arabic_hamzaonwaw, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_Arabic_kasratan, Key_RightBracket) \
   OP(XKB_KEY_Arabic_keheh, LSHIFT(Key_K)) \
   OP(XKB_KEY_Arabic_khah, Key_X) \
   OP(XKB_KEY_Arabic_lam, Key_L) \
   OP(XKB_KEY_Arabic_madda_above, LSHIFT(Key_L)) \
   ...
   OP(XKB_KEY_Arabic_sheen, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Arabic_tehmarbuta, LSHIFT(Key_P)) \
   OP(XKB_KEY_Arabic_thal, LSHIFT(Key_C)) \
   OP(XKB_KEY_Arabic_theh, LSHIFT(Key_V)) \
   ...
   OP(XKB_KEY_braceright, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_bracketleft, RALT(Key_RightBracket)) \
   OP(XKB_KEY_bracketright, RALT(Key_LeftBracket)) \
