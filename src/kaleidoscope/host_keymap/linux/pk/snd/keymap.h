...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ٖ', RALT(Key_E)) \
   OP(L'ٗ', RALT(Key_O)) \
   OP(L'ٰ', LSHIFT(Key_2)) /* U+0670, XKB_KEY_Arabic_superscript_alef, ARABIC LETTER SUPERSCRIPT ALEF */ \
   OP(L'ٺ', LSHIFT(Key_NonUsPound)) \
   OP(L'ٻ', LSHIFT(Key_B)) \
   OP(L'ٽ', LSHIFT(Key_T)) \
   OP(L'پ', Key_P) /* U+067e, XKB_KEY_Arabic_peh, ARABIC LETTER PEH */ \
   OP(L'ٿ', Key_Y) \
   OP(L'ڀ', Key_V) \
   OP(L'ڃ', LSHIFT(Key_LeftBracket)) \
   OP(L'ڄ', LSHIFT(Key_RightBracket)) \
   OP(L'چ', Key_RightBracket) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڇ', Key_LeftBracket) \
   OP(L'ڊ', LSHIFT(Key_D)) \
   OP(L'ڌ', Key_Equals) \
   OP(L'ڍ', Key_NonUsPound) \
   OP(L'ڏ', Key_Minus) \
   OP(L'ڙ', LSHIFT(Key_R)) \
   OP(L'ڦ', LSHIFT(Key_P)) \
   ...
   OP(L'ڳ', Key_I) \
   OP(L'ڻ', LSHIFT(Key_N)) \
   OP(L'ھ', LSHIFT(Key_I)) /* U+06be, XKB_KEY_Arabic_heh_doachashmee, ARABIC LETTER HEH DOACHASHMEE */ \
   OP(L'ہ', RALT(Key_H)) /* U+06c1, XKB_KEY_Arabic_heh_goal, ARABIC LETTER HEH GOAL */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_heh_doachashmee, LSHIFT(Key_I)) \
   OP(XKB_KEY_Arabic_heh_goal, RALT(Key_H)) \
   OP(XKB_KEY_Arabic_keheh, Key_Semicolon) \
   OP(XKB_KEY_Arabic_peh, Key_P) \
   OP(XKB_KEY_Arabic_question_mark, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_Arabic_superscript_alef, LSHIFT(Key_2)) \
