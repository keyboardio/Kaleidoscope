...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ؒ', LSHIFT(Key_B)) \
   OP(L'ؓ', LSHIFT(Key_L)) \
   OP(L'ؔ', LSHIFT(Key_NonUsPound)) \
   OP(L'؛', Key_Semicolon) \
   OP(L'؟', LSHIFT(Key_Slash)) \
   OP(L'ء', Key_U) \
   OP(L'آ', LSHIFT(Key_Equals)) \
   OP(L'أ', Key_Minus) \
   OP(L'ؤ', Key_Equals) \
   OP(L'ئ', LSHIFT(Key_4)) \
   OP(L'ا', Key_A) \
   ...
   OP(L'ٌ', LSHIFT(Key_8)) \
   OP(L'ٍ', Key_Backtick) \
   OP(L'َ', LSHIFT(Key_Period)) \
   OP(L'ُ', LSHIFT(Key_P)) \
   OP(L'ِ', LSHIFT(Key_Comma)) \
   OP(L'ّ', LSHIFT(Key_Minus)) \
   OP(L'ْ', LSHIFT(Key_Q)) \
   OP(L'ٓ', LSHIFT(Key_A)) /* U+0653, XKB_KEY_Arabic_madda_above, ARABIC MADDAH ABOVE */ \
   OP(L'ٔ', LSHIFT(Key_7)) /* U+0654, XKB_KEY_Arabic_hamza_above, ARABIC HAMZA ABOVE */ \
   OP(L'ٰ', Key_Quote) /* U+0670, XKB_KEY_Arabic_superscript_alef, ARABIC LETTER SUPERSCRIPT ALEF */ \
   ...
   OP(L'ھ', Key_H) /* U+06be, XKB_KEY_Arabic_heh_doachashmee, ARABIC LETTER HEH DOACHASHMEE */ \
