...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ž', LSHIFT(Key_Y)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_Y) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
   OP(L'ǅ', LSHIFT(Key_X)) \
   OP(L'ǆ', Key_X) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zcaron, LSHIFT(Key_Y)) \
   OP(XKB_KEY_a, Key_A) \
