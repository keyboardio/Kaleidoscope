...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ж', LSHIFT(Key_Y)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   ...
   OP(L'ж', Key_Y) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_Y)) \
