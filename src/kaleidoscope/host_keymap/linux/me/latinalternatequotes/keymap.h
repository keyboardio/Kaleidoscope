...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ź', RALT(LSHIFT(Key_Y))) /* U+0179, XKB_KEY_Zacute, LATIN CAPITAL LETTER Z WITH ACUTE */ \
   OP(L'ź', RALT(Key_Y)) /* U+017a, XKB_KEY_zacute, LATIN SMALL LETTER Z WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Zacute, RALT(LSHIFT(Key_Y))) \
...
namespace linux {
namespace me {
namespace latinalternatequotes {
