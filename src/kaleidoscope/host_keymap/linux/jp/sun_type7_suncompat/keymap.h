...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('~', LSHIFT(Key_0)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'~', LSHIFT(Key_0)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Henkan_Mode, Key_Backtick) /* XKB_KEY_Henkan_Mode, Start/Stop Conversion  */ \
   ...
   OP(XKB_KEY_asciitilde, LSHIFT(Key_0)) \
