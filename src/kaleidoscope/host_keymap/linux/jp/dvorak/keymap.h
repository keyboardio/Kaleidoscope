...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('@', Key_Minus) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('`', LSHIFT(Key_Minus)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('~', LSHIFT(Key_Equals)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'@', Key_Minus) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'`', LSHIFT(Key_Minus)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'~', LSHIFT(Key_Equals)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciitilde, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_Q)) \
   OP(XKB_KEY_at, Key_Minus) \
   OP(XKB_KEY_b, Key_N) \
   ...
   OP(XKB_KEY_f, Key_Y) \
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, LSHIFT(Key_Minus)) /* XKB_KEY_quoteleft, deprecated  */ \
