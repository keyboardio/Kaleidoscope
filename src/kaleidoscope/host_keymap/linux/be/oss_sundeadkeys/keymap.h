...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\\', RALT(Key_NonUsBackslashAndPipe)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP('~', RALT(Key_8)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\\', RALT(Key_NonUsBackslashAndPipe)) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'®', RALT(LSHIFT(Key_C))) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   ...
   OP(L'µ', Key_NonUsPound) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   ...
   OP(L'Â', RALT(LSHIFT(Key_W))) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   ...
   OP(L'Ê', RALT(LSHIFT(Key_R))) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Ë', RALT(LSHIFT(Key_D))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Î', RALT(LSHIFT(Key_I))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   ...
   OP(L'Ô', RALT(LSHIFT(Key_P))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_Minus))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ù', RALT(LSHIFT(Key_Quote))) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'Û', RALT(LSHIFT(Key_U))) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
   ...
   OP(L'â', RALT(Key_W)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   ...
   OP(L'ê', RALT(Key_R)) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ë', RALT(Key_D)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'î', RALT(Key_I)) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   OP(L'ï', RALT(Key_K)) /* U+00ef, XKB_KEY_idiaeresis, LATIN SMALL LETTER I WITH DIAERESIS */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ô', RALT(Key_P)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   ...
   OP(L'ø', RALT(Key_Minus)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   ...
   OP(L'ü', RALT(Key_J)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'‘', RALT(Key_F)) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(Key_G)) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_F))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(LSHIFT(Key_Z))) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_X))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_S))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'…', RALT(LSHIFT(Key_M))) \
   OP(L' ', RALT(Key_V)) \
   OP(L'€', RALT(Key_E)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'™', RALT(LSHIFT(Key_6))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'←', RALT(Key_Keypad4)) \
   OP(L'↑', RALT(Key_Keypad8)) \
   OP(L'→', RALT(Key_Keypad6)) \
   OP(L'↓', RALT(Key_B)) /* U+2193, XKB_KEY_downarrow, DOWNWARDS ARROW */ \
   ...
   OP(L'≠', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
   OP(L'≤', RALT(LSHIFT(Key_Backtick))) /* U+2264, XKB_KEY_lessthanequal, LESS-THAN OR EQUAL TO */ \
   OP(L'≥', RALT(LSHIFT(Key_1))) /* U+2265, XKB_KEY_greaterthanequal, GREATER-THAN OR EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Acircumflex, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_Ecircumflex, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Icircumflex, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Ocircumflex, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_Minus))) \
   ...
   OP(XKB_KEY_Ucircumflex, RALT(LSHIFT(Key_U))) \
   ...
   OP(XKB_KEY_asciitilde, RALT(Key_8)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_at, RALT(Key_2)) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_dead_caron, RALT(Key_5)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_4)) /* XKB_KEY_dead_cedilla */ \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_rightarrow, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(Key_G)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, Key_6) \
   OP(XKB_KEY_semicolon, Key_Comma) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_F))) \
