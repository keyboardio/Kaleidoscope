...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('>', RALT(Key_Keypad8)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'>', RALT(Key_Keypad8)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_greater, RALT(Key_Keypad8)) \
