...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(',', LSHIFT(Key_6)) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_Minus) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP('.', LSHIFT(Key_7)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP('^', Key_Backtick) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('a', LSHIFT(Key_A)) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP('b', LSHIFT(Key_B)) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP('c', LSHIFT(Key_C)) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP('d', LSHIFT(Key_D)) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', LSHIFT(Key_E)) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', LSHIFT(Key_F)) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', LSHIFT(Key_G)) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', LSHIFT(Key_H)) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', LSHIFT(Key_I)) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', LSHIFT(Key_J)) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', LSHIFT(Key_K)) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', LSHIFT(Key_L)) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', LSHIFT(Key_M)) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', LSHIFT(Key_N)) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', LSHIFT(Key_O)) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', LSHIFT(Key_P)) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', LSHIFT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', LSHIFT(Key_R)) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', LSHIFT(Key_S)) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', LSHIFT(Key_T)) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', LSHIFT(Key_U)) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP('v', LSHIFT(Key_V)) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', LSHIFT(Key_W)) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', LSHIFT(Key_X)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', LSHIFT(Key_Y)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', LSHIFT(Key_Z)) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP('|', LSHIFT(Key_Equals)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L',', LSHIFT(Key_6)) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_Minus) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP(L'.', LSHIFT(Key_7)) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(L'^', Key_Backtick) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'a', LSHIFT(Key_A)) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP(L'b', LSHIFT(Key_B)) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP(L'c', LSHIFT(Key_C)) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP(L'd', LSHIFT(Key_D)) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', LSHIFT(Key_E)) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', LSHIFT(Key_F)) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', LSHIFT(Key_G)) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', LSHIFT(Key_H)) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', LSHIFT(Key_I)) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', LSHIFT(Key_J)) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', LSHIFT(Key_K)) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', LSHIFT(Key_L)) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', LSHIFT(Key_M)) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', LSHIFT(Key_N)) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', LSHIFT(Key_O)) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', LSHIFT(Key_P)) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', LSHIFT(Key_Q)) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', LSHIFT(Key_R)) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', LSHIFT(Key_S)) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', LSHIFT(Key_T)) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', LSHIFT(Key_U)) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP(L'v', LSHIFT(Key_V)) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', LSHIFT(Key_W)) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', LSHIFT(Key_X)) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', LSHIFT(Key_Y)) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', LSHIFT(Key_Z)) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP(L'|', LSHIFT(Key_Equals)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   ...
   OP(L'ა', Key_F) /* U+10d0, XKB_KEY_Georgian_an, GEORGIAN LETTER AN */ \
   OP(L'ბ', Key_Comma) /* U+10d1, XKB_KEY_Georgian_ban, GEORGIAN LETTER BAN */ \
   OP(L'გ', Key_U) /* U+10d2, XKB_KEY_Georgian_gan, GEORGIAN LETTER GAN */ \
   OP(L'დ', Key_L) /* U+10d3, XKB_KEY_Georgian_don, GEORGIAN LETTER DON */ \
   OP(L'ე', Key_T) /* U+10d4, XKB_KEY_Georgian_en, GEORGIAN LETTER EN */ \
   OP(L'ვ', Key_D) /* U+10d5, XKB_KEY_Georgian_vin, GEORGIAN LETTER VIN */ \
   OP(L'ზ', Key_P) /* U+10d6, XKB_KEY_Georgian_zen, GEORGIAN LETTER ZEN */ \
   OP(L'თ', Key_S) /* U+10d7, XKB_KEY_Georgian_tan, GEORGIAN LETTER TAN */ \
   OP(L'ი', Key_B) /* U+10d8, XKB_KEY_Georgian_in, GEORGIAN LETTER IN */ \
   OP(L'კ', Key_R) /* U+10d9, XKB_KEY_Georgian_kan, GEORGIAN LETTER KAN */ \
   OP(L'ლ', Key_K) /* U+10da, XKB_KEY_Georgian_las, GEORGIAN LETTER LAS */ \
   OP(L'მ', Key_V) /* U+10db, XKB_KEY_Georgian_man, GEORGIAN LETTER MAN */ \
   OP(L'ნ', Key_Y) /* U+10dc, XKB_KEY_Georgian_nar, GEORGIAN LETTER NAR */ \
   OP(L'ო', Key_J) /* U+10dd, XKB_KEY_Georgian_on, GEORGIAN LETTER ON */ \
   OP(L'პ', Key_G) /* U+10de, XKB_KEY_Georgian_par, GEORGIAN LETTER PAR */ \
   OP(L'ჟ', Key_Semicolon) /* U+10df, XKB_KEY_Georgian_zhar, GEORGIAN LETTER ZHAR */ \
   OP(L'რ', Key_H) /* U+10e0, XKB_KEY_Georgian_rae, GEORGIAN LETTER RAE */ \
   OP(L'ს', Key_C) /* U+10e1, XKB_KEY_Georgian_san, GEORGIAN LETTER SAN */ \
   OP(L'ტ', Key_N) /* U+10e2, XKB_KEY_Georgian_tar, GEORGIAN LETTER TAR */ \
   OP(L'უ', Key_E) /* U+10e3, XKB_KEY_Georgian_un, GEORGIAN LETTER UN */ \
   OP(L'ფ', Key_A) /* U+10e4, XKB_KEY_Georgian_phar, GEORGIAN LETTER PHAR */ \
   OP(L'ქ', Key_M) /* U+10e5, XKB_KEY_Georgian_khar, GEORGIAN LETTER KHAR */ \
   OP(L'ღ', Key_Q) /* U+10e6, XKB_KEY_Georgian_ghan, GEORGIAN LETTER GHAN */ \
   OP(L'ყ', Key_Period) /* U+10e7, XKB_KEY_Georgian_qar, GEORGIAN LETTER QAR */ \
   OP(L'შ', Key_I) /* U+10e8, XKB_KEY_Georgian_shin, GEORGIAN LETTER SHIN */ \
   OP(L'ჩ', Key_X) /* U+10e9, XKB_KEY_Georgian_chin, GEORGIAN LETTER CHIN */ \
   OP(L'ც', Key_W) /* U+10ea, XKB_KEY_Georgian_can, GEORGIAN LETTER CAN */ \
   OP(L'ძ', Key_Quote) /* U+10eb, XKB_KEY_Georgian_jil, GEORGIAN LETTER JIL */ \
   OP(L'წ', Key_O) /* U+10ec, XKB_KEY_Georgian_cil, GEORGIAN LETTER CIL */ \
   OP(L'ჭ', Key_Z) /* U+10ed, XKB_KEY_Georgian_char, GEORGIAN LETTER CHAR */ \
   OP(L'ხ', Key_LeftBracket) /* U+10ee, XKB_KEY_Georgian_xan, GEORGIAN LETTER XAN */ \
   OP(L'ჯ', Key_RightBracket) /* U+10ef, XKB_KEY_Georgian_jhan, GEORGIAN LETTER JHAN */ \
   OP(L'ჰ', Key_Slash) /* U+10f0, XKB_KEY_Georgian_hae, GEORGIAN LETTER HAE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Georgian_an, Key_F) \
   OP(XKB_KEY_Georgian_ban, Key_Comma) \
   OP(XKB_KEY_Georgian_can, Key_W) \
   OP(XKB_KEY_Georgian_char, Key_Z) \
   OP(XKB_KEY_Georgian_chin, Key_X) \
   OP(XKB_KEY_Georgian_cil, Key_O) \
   OP(XKB_KEY_Georgian_don, Key_L) \
   OP(XKB_KEY_Georgian_en, Key_T) \
   OP(XKB_KEY_Georgian_gan, Key_U) \
   OP(XKB_KEY_Georgian_ghan, Key_Q) \
   OP(XKB_KEY_Georgian_hae, Key_Slash) \
   OP(XKB_KEY_Georgian_in, Key_B) \
   OP(XKB_KEY_Georgian_jhan, Key_RightBracket) \
   OP(XKB_KEY_Georgian_jil, Key_Quote) \
   OP(XKB_KEY_Georgian_kan, Key_R) \
   OP(XKB_KEY_Georgian_khar, Key_M) \
   OP(XKB_KEY_Georgian_las, Key_K) \
   OP(XKB_KEY_Georgian_man, Key_V) \
   OP(XKB_KEY_Georgian_nar, Key_Y) \
   OP(XKB_KEY_Georgian_on, Key_J) \
   OP(XKB_KEY_Georgian_par, Key_G) \
   OP(XKB_KEY_Georgian_phar, Key_A) \
   OP(XKB_KEY_Georgian_qar, Key_Period) \
   OP(XKB_KEY_Georgian_rae, Key_H) \
   OP(XKB_KEY_Georgian_san, Key_C) \
   OP(XKB_KEY_Georgian_shin, Key_I) \
   OP(XKB_KEY_Georgian_tan, Key_S) \
   OP(XKB_KEY_Georgian_tar, Key_N) \
   OP(XKB_KEY_Georgian_un, Key_E) \
   OP(XKB_KEY_Georgian_vin, Key_D) \
   OP(XKB_KEY_Georgian_xan, Key_LeftBracket) \
   OP(XKB_KEY_Georgian_zen, Key_P) \
   OP(XKB_KEY_Georgian_zhar, Key_Semicolon) \
   ...
   OP(XKB_KEY_asciicircum, Key_Backtick) \
   ...
   OP(XKB_KEY_bar, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_period, LSHIFT(Key_7)) \
