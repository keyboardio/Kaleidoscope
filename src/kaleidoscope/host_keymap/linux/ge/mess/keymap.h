...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('=', Key_NonUsPound) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'=', Key_NonUsPound) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP(L'თ', Key_Semicolon) /* U+10d7, XKB_KEY_Georgian_tan, GEORGIAN LETTER TAN */ \
   ...
   OP(L'ჟ', Key_Equals) /* U+10df, XKB_KEY_Georgian_zhar, GEORGIAN LETTER ZHAR */ \
   ...
   OP(L'ღ', Key_RightBracket) /* U+10e6, XKB_KEY_Georgian_ghan, GEORGIAN LETTER GHAN */ \
   OP(L'ყ', Key_Y) /* U+10e7, XKB_KEY_Georgian_qar, GEORGIAN LETTER QAR */ \
   OP(L'შ', Key_LeftBracket) /* U+10e8, XKB_KEY_Georgian_shin, GEORGIAN LETTER SHIN */ \
   OP(L'ჩ', Key_Quote) /* U+10e9, XKB_KEY_Georgian_chin, GEORGIAN LETTER CHIN */ \
   OP(L'ც', Key_C) /* U+10ea, XKB_KEY_Georgian_can, GEORGIAN LETTER CAN */ \
   OP(L'ძ', Key_Slash) /* U+10eb, XKB_KEY_Georgian_jil, GEORGIAN LETTER JIL */ \
   OP(L'წ', Key_W) /* U+10ec, XKB_KEY_Georgian_cil, GEORGIAN LETTER CIL */ \
   OP(L'ჭ', Key_Backtick) /* U+10ed, XKB_KEY_Georgian_char, GEORGIAN LETTER CHAR */ \
   ...
   OP(L'ჵ', RALT(Key_Z)) /* U+10f5, XKB_KEY_Georgian_hoe, GEORGIAN LETTER HOE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Georgian_char, Key_Backtick) \
   OP(XKB_KEY_Georgian_chin, Key_Quote) \
   ...
   OP(XKB_KEY_Georgian_ghan, Key_RightBracket) \
   ...
   OP(XKB_KEY_Georgian_hoe, RALT(Key_Z)) \
   OP(XKB_KEY_Georgian_in, Key_I) \
   OP(XKB_KEY_Georgian_jhan, Key_J) \
   OP(XKB_KEY_Georgian_jil, Key_Slash) \
   ...
   OP(XKB_KEY_Georgian_shin, Key_LeftBracket) \
   OP(XKB_KEY_Georgian_tan, Key_Semicolon) \
   ...
   OP(XKB_KEY_Georgian_zhar, Key_Equals) \
   ...
   OP(XKB_KEY_equal, Key_NonUsPound) \
