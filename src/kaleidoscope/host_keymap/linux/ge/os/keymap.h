...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Э', LSHIFT(Key_Backtick)) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   ...
   OP(L'э', Key_Backtick) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_E, LSHIFT(Key_Backtick)) \
   ...
   OP(XKB_KEY_Cyrillic_e, Key_Backtick) \
