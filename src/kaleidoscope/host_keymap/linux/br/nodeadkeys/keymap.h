...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('^', LSHIFT(Key_Quote)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', LSHIFT(Key_LeftBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('~', Key_Quote) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'^', LSHIFT(Key_Quote)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Minus)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', LSHIFT(Key_LeftBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'~', Key_Quote) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'¨', LSHIFT(Key_6)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_asciitilde, Key_Quote) \
   ...
   OP(XKB_KEY_diaeresis, LSHIFT(Key_6)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, LSHIFT(Key_LeftBracket)) /* XKB_KEY_quoteleft, deprecated  */ \
