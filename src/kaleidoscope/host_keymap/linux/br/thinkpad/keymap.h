...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('/', Key_RightControl) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP('?', RALT(Key_W)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'/', Key_RightControl) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP(L'?', RALT(Key_W)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'§', RALT(Key_Equals)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'¨', RALT(LSHIFT(Key_6))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_RightBracket)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'°', RALT(Key_RightControl)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'º', RALT(Key_NonUsPound)) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   ...
   OP(L'Ç', LSHIFT(Key_Semicolon)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, Key_Semicolon) \
   ...
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* XKB_KEY_dead_breve */ \
   ...
   OP(XKB_KEY_degree, RALT(Key_RightControl)) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_ordfeminine, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_q, Key_Q) \
   OP(XKB_KEY_question, RALT(Key_W)) \
