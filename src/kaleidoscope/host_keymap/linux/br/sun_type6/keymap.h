...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('?', RALT(Key_Comma)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'?', RALT(Key_Comma)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'¡', RALT(Key_Semicolon)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   ...
   OP(L'¿', RALT(Key_Period)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_exclamdown, RALT(Key_Semicolon)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   ...
   OP(XKB_KEY_q, Key_Q) \
   OP(XKB_KEY_question, RALT(Key_Comma)) \
   OP(XKB_KEY_questiondown, RALT(Key_Period)) \
