...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', LSHIFT(Key_Backtick)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('^', RALT(LSHIFT(Key_Quote))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_NonUsPound)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', RALT(LSHIFT(Key_LeftBracket))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('|', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', LSHIFT(Key_Equals)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(Key_Quote)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', LSHIFT(Key_Backtick)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'^', RALT(LSHIFT(Key_Quote))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_NonUsPound)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', RALT(LSHIFT(Key_LeftBracket))) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'|', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', LSHIFT(Key_Equals)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(Key_Quote)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'§', RALT(Key_RightBracket)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'´', RALT(Key_LeftBracket)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'µ', RALT(LSHIFT(Key_M))) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(LSHIFT(Key_J))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   ...
   OP(L'»', RALT(Key_N)) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'Ç', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_F))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Þ', RALT(LSHIFT(Key_R))) /* U+00de, XKB_KEY_THORN, LATIN CAPITAL LETTER THORN */ \
   ...
   OP(L'ç', Key_NonUsBackslashAndPipe) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'÷', RALT(LSHIFT(Key_B))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', RALT(Key_F)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'þ', RALT(Key_R)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'İ', RALT(LSHIFT(Key_G))) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
   OP(L'ı', RALT(Key_G)) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'Œ', RALT(LSHIFT(Key_S))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_S)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Ŭ', RALT(LSHIFT(Key_Comma))) /* U+016c, XKB_KEY_Ubreve, LATIN CAPITAL LETTER U WITH BREVE */ \
   OP(L'ŭ', RALT(Key_Comma)) /* U+016d, XKB_KEY_ubreve, LATIN SMALL LETTER U WITH BREVE */ \
   OP(L'Ə', RALT(LSHIFT(Key_X))) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'Ʒ', RALT(LSHIFT(Key_C))) /* U+01b7, XKB_KEY_EZH, LATIN CAPITAL LETTER EZH */ \
   OP(L'ə', RALT(Key_X)) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   OP(L'ʒ', RALT(Key_C)) /* U+0292, XKB_KEY_ezh, LATIN SMALL LETTER EZH */ \
   OP(L'̓', RALT(LSHIFT(Key_W))) \
   OP(L'̦', RALT(LSHIFT(Key_Minus))) \
   OP(L'̩', RALT(Key_W)) \
   OP(L'̭', RALT(LSHIFT(Key_Z))) \
   OP(L'̱', RALT(Key_Z)) \
   OP(L'̶', RALT(LSHIFT(Key_NonUsPound))) \
   OP(L'―', RALT(Key_NonUsPound)) \
   OP(L'‘', RALT(LSHIFT(Key_Y))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(LSHIFT(Key_U))) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_Period))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'‛', RALT(LSHIFT(Key_Slash))) \
   OP(L'“', RALT(Key_Y)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_U)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_Period)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'‟', RALT(Key_Slash)) \
   OP(L'•', RALT(Key_E)) \
   ...
   OP(L'™', RALT(LSHIFT(Key_K))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'←', RALT(Key_J)) /* U+2190, XKB_KEY_leftarrow, LEFTWARDS ARROW */ \
   OP(L'↑', RALT(Key_I)) /* U+2191, XKB_KEY_uparrow, UPWARDS ARROW */ \
   OP(L'→', RALT(Key_K)) /* U+2192, XKB_KEY_rightarrow, RIGHTWARDS ARROW */ \
   OP(L'↓', RALT(Key_M)) /* U+2193, XKB_KEY_downarrow, DOWNWARDS ARROW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Iabovedot, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_F))) \
   ...
   OP(XKB_KEY_SCHWA, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_THORN, RALT(LSHIFT(Key_R))) /* XKB_KEY_Thorn, deprecated  */ \
   OP(XKB_KEY_Tab, Key_Tab) /* XKB_KEY_Tab */ \
   OP(XKB_KEY_U, LSHIFT(Key_F)) \
   OP(XKB_KEY_Ubreve, RALT(LSHIFT(Key_Comma))) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_asciicircum, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_asciitilde, RALT(Key_Quote)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_8)) \
   OP(XKB_KEY_at, LSHIFT(Key_2)) \
   OP(XKB_KEY_b, Key_N) \
   OP(XKB_KEY_backslash, RALT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_bar, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   ...
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_ccedilla, Key_NonUsBackslashAndPipe) \
   ...
   OP(XKB_KEY_dead_acute, Key_LeftBracket) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_7)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_0))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, RALT(Key_Backtick)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_9)) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, LSHIFT(Key_Quote)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, LSHIFT(Key_6)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_doubleacute, RALT(LSHIFT(Key_Backtick))) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, LSHIFT(Key_LeftBracket)) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_dead_tilde, Key_Quote) /* XKB_KEY_dead_tilde */ \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(Key_Period)) \
   OP(XKB_KEY_downarrow, RALT(Key_M)) \
   OP(XKB_KEY_e, Key_D) \
   ...
   OP(XKB_KEY_f, Key_Y) \
   OP(XKB_KEY_g, Key_U) \
   OP(XKB_KEY_grave, RALT(LSHIFT(Key_LeftBracket))) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_E)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_V)) \
   OP(XKB_KEY_guillemotright, RALT(Key_N)) \
   OP(XKB_KEY_h, Key_J) \
   OP(XKB_KEY_i, Key_G) \
   OP(XKB_KEY_idotless, RALT(Key_G)) \
   OP(XKB_KEY_j, Key_C) \
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_leftarrow, RALT(Key_J)) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_Y)) \
   OP(XKB_KEY_leftsinglequotemark, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_mu, RALT(LSHIFT(Key_M))) \
   ...
   OP(XKB_KEY_oslash, RALT(Key_F)) \
   OP(XKB_KEY_p, Key_R) \
   OP(XKB_KEY_paragraph, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_quotedbl, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_r, Key_O) \
   OP(XKB_KEY_registered, RALT(Key_O)) \
   OP(XKB_KEY_rightarrow, RALT(Key_K)) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_U)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_s, Key_Semicolon) \
   OP(XKB_KEY_schwa, RALT(Key_X)) \
   OP(XKB_KEY_section, RALT(Key_RightBracket)) \
