...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(':', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L':', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+003a, XKB_KEY_colon, COLON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_colon, LSHIFT(Key_NonUsBackslashAndPipe)) \
