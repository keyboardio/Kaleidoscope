...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ٕ', RALT(Key_Slash)) /* U+0655, XKB_KEY_Arabic_hamza_below, ARABIC HAMZA BELOW */ \
   ...
   OP(L'ٱ', RALT(Key_H)) \
   OP(L'ٹ', RALT(Key_M)) /* U+0679, XKB_KEY_Arabic_tteh, ARABIC LETTER TTEH */ \
   OP(L'ټ', RALT(Key_J)) \
   OP(L'پ', Key_M) /* U+067e, XKB_KEY_Arabic_peh, ARABIC LETTER PEH */ \
   OP(L'ځ', RALT(Key_LeftBracket)) \
   OP(L'څ', RALT(Key_RightBracket)) \
   OP(L'چ', Key_RightBracket) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڈ', RALT(Key_B)) /* U+0688, XKB_KEY_Arabic_ddal, ARABIC LETTER DDAL */ \
   OP(L'ډ', RALT(Key_N)) \
   OP(L'ڑ', RALT(Key_X)) /* U+0691, XKB_KEY_Arabic_rreh, ARABIC LETTER RREH */ \
   OP(L'ړ', RALT(Key_V)) \
   OP(L'ږ', RALT(Key_C)) \
   ...
   OP(L'ګ', RALT(Key_Quote)) \
   OP(L'گ', Key_Quote) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
   OP(L'ڷ', RALT(Key_G)) \
   OP(L'ں', RALT(Key_L)) /* U+06ba, XKB_KEY_Arabic_noon_ghunna, ARABIC LETTER NOON GHUNNA */ \
   OP(L'ڼ', RALT(Key_K)) \
   OP(L'ۇ', LSHIFT(Key_X)) \
   OP(L'ۉ', LSHIFT(Key_Z)) \
   ...
   OP(L'ۍ', RALT(Key_S)) \
   OP(L'ې', LSHIFT(Key_F)) \
   OP(L'ے', RALT(Key_Z)) /* U+06d2, XKB_KEY_Arabic_yeh_baree, ARABIC LETTER YEH BARREE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_ddal, RALT(Key_B)) \
   ...
   OP(XKB_KEY_Arabic_hamza_below, RALT(Key_Slash)) \
   ...
   OP(XKB_KEY_Arabic_noon_ghunna, RALT(Key_L)) \
   ...
   OP(XKB_KEY_Arabic_rreh, RALT(Key_X)) \
   ...
   OP(XKB_KEY_Arabic_tteh, RALT(Key_M)) \
   OP(XKB_KEY_Arabic_waw, Key_Comma) \
   OP(XKB_KEY_Arabic_yeh, LSHIFT(Key_D)) \
   OP(XKB_KEY_Arabic_yeh_baree, RALT(Key_Z)) \
