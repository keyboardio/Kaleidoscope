...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('_', RALT(Key_Minus)) \
   OP('`', RALT(Key_1)) \
   OP('{', RALT(Key_RightBracket)) \
   OP('|', RALT(Key_NonUsPound)) \
   OP('}', RALT(Key_LeftBracket)) \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ٓ', RALT(Key_W)) /* U+0653, XKB_KEY_Arabic_madda_above, ARABIC MADDAH ABOVE */ \
   OP(L'ٔ', RALT(Key_V)) /* U+0654, XKB_KEY_Arabic_hamza_above, ARABIC HAMZA ABOVE */ \
   OP(L'ٕ', RALT(Key_C)) /* U+0655, XKB_KEY_Arabic_hamza_below, ARABIC HAMZA BELOW */ \
   OP(L'٪', LSHIFT(Key_5)) /* U+066a, XKB_KEY_Arabic_percent, ARABIC PERCENT SIGN */ \
   OP(L'٫', LSHIFT(Key_3)) \
   OP(L'٬', LSHIFT(Key_2)) \
   OP(L'ٰ', RALT(Key_I)) /* U+0670, XKB_KEY_Arabic_superscript_alef, ARABIC LETTER SUPERSCRIPT ALEF */ \
   OP(L'ٱ', RALT(Key_H)) \
   OP(L'ٹ', RALT(Key_J)) /* U+0679, XKB_KEY_Arabic_tteh, ARABIC LETTER TTEH */ \
   OP(L'ټ', LSHIFT(Key_J)) \
   ...
   OP(L'ڈ', RALT(Key_N)) /* U+0688, XKB_KEY_Arabic_ddal, ARABIC LETTER DDAL */ \
   OP(L'ډ', LSHIFT(Key_N)) \
   OP(L'ڑ', RALT(Key_M)) /* U+0691, XKB_KEY_Arabic_rreh, ARABIC LETTER RREH */ \
   OP(L'ړ', Key_M) \
   OP(L'ږ', Key_Period) \
   ...
   OP(L'ګ', Key_Quote) \
   OP(L'گ', RALT(Key_Quote)) /* U+06af, XKB_KEY_Arabic_gaf, ARABIC LETTER GAF */ \
   OP(L'ڷ', RALT(Key_G)) \
   OP(L'ں', RALT(Key_F)) /* U+06ba, XKB_KEY_Arabic_noon_ghunna, ARABIC LETTER NOON GHUNNA */ \
   OP(L'ڼ', LSHIFT(Key_K)) \
   OP(L'ۇ', RALT(Key_Period)) \
   OP(L'ۉ', RALT(Key_Slash)) \
   OP(L'ی', Key_D) /* U+06cc, XKB_KEY_Farsi_yeh, ARABIC LETTER FARSI YEH */ \
   OP(L'ۍ', Key_Z) \
   OP(L'ې', Key_X) \
   OP(L'ے', RALT(Key_S)) /* U+06d2, XKB_KEY_Arabic_yeh_baree, ARABIC LETTER YEH BARREE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_rreh, RALT(Key_M)) \
   ...
   OP(XKB_KEY_Arabic_superscript_alef, RALT(Key_I)) \
   ...
   OP(XKB_KEY_Arabic_tteh, RALT(Key_J)) \
   OP(XKB_KEY_Arabic_waw, Key_Comma) \
   OP(XKB_KEY_Arabic_yeh, LSHIFT(Key_D)) \
   OP(XKB_KEY_Arabic_yeh_baree, RALT(Key_S)) \
