...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ḥ', RALT(Key_H)) \
   OP(L'Ṛ', RALT(LSHIFT(Key_R))) \
   OP(L'ṛ', RALT(Key_R)) \
   OP(L'Ṣ', RALT(LSHIFT(Key_S))) \
   OP(L'ṣ', RALT(Key_S)) \
   OP(L'Ṭ', RALT(LSHIFT(Key_T))) \
   OP(L'ṭ', RALT(Key_T)) \
   OP(L'Ẓ', RALT(LSHIFT(Key_W))) \
   OP(L'ẓ', RALT(Key_W)) \
