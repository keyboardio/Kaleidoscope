...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ँ', LSHIFT(Key_V)) \
   OP(L'ं', LSHIFT(Key_M)) \
   OP(L'ः', LSHIFT(Key_NonUsPound)) \
   OP(L'अ', LSHIFT(Key_H)) \
   OP(L'आ', LSHIFT(Key_A)) \
   OP(L'इ', Key_LeftBracket) \
   OP(L'ई', LSHIFT(Key_LeftBracket)) \
   OP(L'उ', Key_F) \
   OP(L'ऊ', LSHIFT(Key_F)) \
   OP(L'ऋ', LSHIFT(Key_Z)) \
   OP(L'ए', Key_RightBracket) \
   OP(L'ऐ', LSHIFT(Key_RightBracket)) \
   OP(L'ओ', LSHIFT(Key_O)) \
   OP(L'औ', LSHIFT(Key_W)) \
   OP(L'क', Key_K) \
   OP(L'ख', LSHIFT(Key_K)) \
   ...
   OP(L'ौ', Key_W) \
   OP(L'्', Key_Slash) \
   OP(L'ॐ', Key_NonUsPound) \
   OP(L'॒', LSHIFT(Key_Minus)) \
   OP(L'।', Key_Period) \
