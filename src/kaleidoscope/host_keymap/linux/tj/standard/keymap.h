...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Қ', LSHIFT(Key_W)) /* U+049a, XKB_KEY_Cyrillic_KA_descender, CYRILLIC CAPITAL LETTER KA WITH DESCENDER */ \
   OP(L'қ', Key_W) /* U+049b, XKB_KEY_Cyrillic_ka_descender, CYRILLIC SMALL LETTER KA WITH DESCENDER */ \
   ...
   OP(L'Ӣ', LSHIFT(Key_M)) /* U+04e2, XKB_KEY_Cyrillic_I_macron, CYRILLIC CAPITAL LETTER I WITH MACRON */ \
   OP(L'ӣ', Key_M) /* U+04e3, XKB_KEY_Cyrillic_i_macron, CYRILLIC SMALL LETTER I WITH MACRON */ \
   OP(L'Ӯ', LSHIFT(Key_Equals)) /* U+04ee, XKB_KEY_Cyrillic_U_macron, CYRILLIC CAPITAL LETTER U WITH MACRON */ \
   OP(L'ӯ', Key_Equals) /* U+04ef, XKB_KEY_Cyrillic_u_macron, CYRILLIC SMALL LETTER U WITH MACRON */ \
   OP(L'–', RALT(Key_6)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE_descender, LSHIFT(Key_S)) \
   ...
   OP(XKB_KEY_Cyrillic_U_macron, LSHIFT(Key_Equals)) \
   ...
   OP(XKB_KEY_Cyrillic_che_descender, Key_S) \
   ...
   OP(XKB_KEY_Cyrillic_u_macron, Key_Equals) \
