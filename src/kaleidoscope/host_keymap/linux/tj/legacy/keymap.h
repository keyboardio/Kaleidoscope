...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ғ', RALT(LSHIFT(Key_U))) /* U+0492, XKB_KEY_Cyrillic_GHE_bar, CYRILLIC CAPITAL LETTER GHE WITH STROKE */ \
   OP(L'ғ', RALT(Key_U)) /* U+0493, XKB_KEY_Cyrillic_ghe_bar, CYRILLIC SMALL LETTER GHE WITH STROKE */ \
   ...
   OP(L'Ҷ', RALT(LSHIFT(Key_X))) /* U+04b6, XKB_KEY_Cyrillic_CHE_descender, CYRILLIC CAPITAL LETTER CHE WITH DESCENDER */ \
   OP(L'ҷ', RALT(Key_X)) /* U+04b7, XKB_KEY_Cyrillic_che_descender, CYRILLIC SMALL LETTER CHE WITH DESCENDER */ \
   ...
   OP(L'Ӯ', RALT(LSHIFT(Key_E))) /* U+04ee, XKB_KEY_Cyrillic_U_macron, CYRILLIC CAPITAL LETTER U WITH MACRON */ \
   OP(L'ӯ', RALT(Key_E)) /* U+04ef, XKB_KEY_Cyrillic_u_macron, CYRILLIC SMALL LETTER U WITH MACRON */ \
   OP(L'–', RALT(Key_6)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE_descender, RALT(LSHIFT(Key_X))) \
   ...
   OP(XKB_KEY_Cyrillic_HA_descender, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_Cyrillic_U_macron, RALT(LSHIFT(Key_E))) \
   ...
   OP(XKB_KEY_Cyrillic_che_descender, RALT(Key_X)) \
   ...
   OP(XKB_KEY_Cyrillic_ghe_bar, RALT(Key_U)) \
   OP(XKB_KEY_Cyrillic_ha, Key_LeftBracket) \
   OP(XKB_KEY_Cyrillic_ha_descender, RALT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_u_macron, RALT(Key_E)) \
