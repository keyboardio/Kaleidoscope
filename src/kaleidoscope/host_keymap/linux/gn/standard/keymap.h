...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', RALT(Key_Quote)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', RALT(Key_Quote)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_percent, RALT(Key_Quote)) \
