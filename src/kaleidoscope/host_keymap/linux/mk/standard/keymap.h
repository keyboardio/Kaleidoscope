...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ѓ', LSHIFT(Key_RightBracket)) /* U+0403, XKB_KEY_Macedonia_GJE, CYRILLIC CAPITAL LETTER GJE */ \
   OP(L'Ѕ', LSHIFT(Key_Y)) /* U+0405, XKB_KEY_Macedonia_DSE, CYRILLIC CAPITAL LETTER DZE */ \
   ...
   OP(L'Ќ', LSHIFT(Key_Quote)) /* U+040c, XKB_KEY_Macedonia_KJE, CYRILLIC CAPITAL LETTER KJE */ \
   ...
   OP(L'ѓ', Key_RightBracket) /* U+0453, XKB_KEY_Macedonia_gje, CYRILLIC SMALL LETTER GJE */ \
   OP(L'ѕ', Key_Y) /* U+0455, XKB_KEY_Macedonia_dse, CYRILLIC SMALL LETTER DZE */ \
   ...
   OP(L'ќ', Key_Quote) /* U+045c, XKB_KEY_Macedonia_kje, CYRILLIC SMALL LETTER KJE */ \
   OP(L'џ', Key_X) /* U+045f, XKB_KEY_Cyrillic_dzhe, CYRILLIC SMALL LETTER DZHE */ \
   OP(L'“', LSHIFT(Key_3)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'„', LSHIFT(Key_2)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Macedonia_DSE, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Macedonia_GJE, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Macedonia_KJE, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Macedonia_dse, Key_Y) \
   OP(XKB_KEY_Macedonia_gje, Key_RightBracket) \
   OP(XKB_KEY_Macedonia_kje, Key_Quote) \
