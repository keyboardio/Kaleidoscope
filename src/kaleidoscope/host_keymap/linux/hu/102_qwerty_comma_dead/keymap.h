...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'´', RALT(LSHIFT(Key_9))) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_acute, RALT(LSHIFT(Key_9))) \
   ...
   OP(XKB_KEY_dead_grave, RALT(LSHIFT(Key_7))) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_1))) /* XKB_KEY_dead_tilde */ \
...
namespace linux {
namespace hu {
namespace 102_qwerty_comma_dead {
