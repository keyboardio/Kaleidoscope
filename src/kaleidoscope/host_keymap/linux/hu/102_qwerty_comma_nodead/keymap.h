...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('&', RALT(Key_C)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   ...
   OP('0', Key_Backtick) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   ...
   OP(';', RALT(Key_Comma)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP('<', RALT(Key_M)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_7)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_Z)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', LSHIFT(Key_Comma)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'&', RALT(Key_C)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   ...
   OP(L'0', Key_Backtick) /* U+0030, XKB_KEY_0, DIGIT ZERO */ \
   ...
   OP(L';', RALT(Key_Comma)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   OP(L'<', RALT(Key_M)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_7)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_Z)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', LSHIFT(Key_Comma)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'¢', RALT(LSHIFT(Key_Semicolon))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'¨', RALT(Key_Minus)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'´', RALT(Key_9)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'¶', RALT(Key_R)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'¸', RALT(Key_Equals)) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'Á', LSHIFT(Key_Quote)) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Ä', RALT(Key_E)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'É', LSHIFT(Key_Semicolon)) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Í', RALT(Key_I)) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ð', RALT(LSHIFT(Key_D))) /* U+00d0, XKB_KEY_ETH, LATIN CAPITAL LETTER ETH */ \
   OP(L'Ó', LSHIFT(Key_Equals)) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ö', LSHIFT(Key_0)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'Ú', LSHIFT(Key_RightBracket)) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ü', LSHIFT(Key_Minus)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   ...
   OP(L'á', Key_Quote) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   ...
   OP(L'í', Key_NonUsBackslashAndPipe) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ó', Key_Equals) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ö', Key_0) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'÷', RALT(Key_LeftBracket)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ú', Key_RightBracket) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ü', Key_Minus) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Đ', RALT(Key_D)) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', RALT(Key_S)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   ...
   OP(L'Ł', RALT(Key_L)) /* U+0141, XKB_KEY_Lstroke, LATIN CAPITAL LETTER L WITH STROKE */ \
   ...
   OP(L'Ő', LSHIFT(Key_LeftBracket)) /* U+0150, XKB_KEY_Odoubleacute, LATIN CAPITAL LETTER O WITH DOUBLE ACUTE */ \
   OP(L'ő', Key_LeftBracket) /* U+0151, XKB_KEY_odoubleacute, LATIN SMALL LETTER O WITH DOUBLE ACUTE */ \
   ...
   OP(L'Ű', LSHIFT(Key_NonUsPound)) /* U+0170, XKB_KEY_Udoubleacute, LATIN CAPITAL LETTER U WITH DOUBLE ACUTE */ \
   OP(L'ű', Key_NonUsPound) /* U+0171, XKB_KEY_udoubleacute, LATIN SMALL LETTER U WITH DOUBLE ACUTE */ \
   OP(L'ˇ', RALT(Key_2)) /* U+02c7, XKB_KEY_caron, CARON */ \
   OP(L'˘', RALT(Key_4)) /* U+02d8, XKB_KEY_breve, BREVE */ \
   OP(L'˙', RALT(Key_8)) /* U+02d9, XKB_KEY_abovedot, DOT ABOVE */ \
   OP(L'˛', RALT(Key_6)) /* U+02db, XKB_KEY_ogonek, OGONEK */ \
   OP(L'˝', RALT(Key_0)) /* U+02dd, XKB_KEY_doubleacute, DOUBLE ACUTE ACCENT */ \
   OP(L'Ω', RALT(LSHIFT(Key_Q))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'–', RALT(Key_Y)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   ...
   OP(L'”', RALT(Key_P)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_O)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'€', RALT(Key_U)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Adiaeresis, RALT(Key_E)) \
   ...
   OP(XKB_KEY_EuroSign, RALT(Key_U)) \
   ...
   OP(XKB_KEY_Oacute, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_0)) \
   OP(XKB_KEY_Odoubleacute, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Uacute, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_Udoubleacute, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, Key_Quote) \
   OP(XKB_KEY_abovedot, RALT(Key_8)) \
   OP(XKB_KEY_acute, RALT(Key_9)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_A)) \
   OP(XKB_KEY_ampersand, RALT(Key_C)) \
   ...
   OP(XKB_KEY_breve, RALT(Key_4)) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caron, RALT(Key_2)) \
   OP(XKB_KEY_cedilla, RALT(Key_Equals)) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_diaeresis, RALT(Key_Minus)) \
   OP(XKB_KEY_division, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_dollar, RALT(Key_Semicolon)) \
   OP(XKB_KEY_doubleacute, RALT(Key_0)) \
   OP(XKB_KEY_doublelowquotemark, RALT(Key_O)) \
   OP(XKB_KEY_dstroke, RALT(Key_S)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, Key_Semicolon) \
   OP(XKB_KEY_endash, RALT(Key_Y)) \
   OP(XKB_KEY_equal, LSHIFT(Key_7)) \
   ...
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oacute, Key_Equals) \
   OP(XKB_KEY_odiaeresis, Key_0) \
   OP(XKB_KEY_odoubleacute, Key_LeftBracket) \
   OP(XKB_KEY_ogonek, RALT(Key_6)) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, Key_RightBracket) \
   OP(XKB_KEY_udiaeresis, Key_Minus) \
   OP(XKB_KEY_udoubleacute, Key_NonUsPound) \
...
namespace linux {
namespace hu {
namespace 102_qwerty_comma_nodead {
