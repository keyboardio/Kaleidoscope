...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', LSHIFT(Key_RightBracket)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('[', Key_Quote) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   ...
   OP('{', LSHIFT(Key_Quote)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', LSHIFT(Key_RightBracket)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'[', Key_Quote) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   ...
   OP(L'{', LSHIFT(Key_Quote)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_apostrophe, LSHIFT(Key_RightBracket)) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_braceleft, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_braceright, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_bracketleft, Key_Quote) \
