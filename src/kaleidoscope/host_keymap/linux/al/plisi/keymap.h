...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('>', Key_RightBracket) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'>', Key_RightBracket) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'§', RALT(Key_H)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'­', RALT(Key_Minus)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_Equals)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   ...
   OP(L'Ç', LSHIFT(Key_LeftBracket)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Ë', LSHIFT(Key_Semicolon)) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'ç', Key_LeftBracket) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ë', Key_Semicolon) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'ı', RALT(LSHIFT(Key_I))) \
   OP(L'ʻ', RALT(Key_Comma)) \
   OP(L'̛', RALT(Key_NonUsPound)) \
   OP(L'̜', RALT(Key_RightBracket)) \
   OP(L'‌', RALT(Key_Period)) \
   OP(L'‑', RALT(Key_Slash)) \
   OP(L'–', RALT(Key_N)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_M)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'’', RALT(Key_1)) \
   OP(L'′', RALT(Key_F)) \
   OP(L'″', RALT(Key_G)) \
   OP(L'‹', RALT(Key_V)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Ediaeresis, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, Key_LeftBracket) \
   OP(XKB_KEY_colon, LSHIFT(Key_Period)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_C)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_P)) /* XKB_KEY_dead_abovedot */ \
   ...
   OP(XKB_KEY_dead_grave, RALT(Key_Q)) /* XKB_KEY_dead_grave */ \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_ediaeresis, Key_Semicolon) \
   OP(XKB_KEY_emdash, RALT(Key_M)) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(Key_Equals)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, RALT(Key_H)) \
