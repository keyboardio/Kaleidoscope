...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¢', RALT(LSHIFT(Key_5))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', RALT(Key_4)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¥', RALT(LSHIFT(Key_4))) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   ...
   OP(L'ª', RALT(Key_2)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'·', RALT(LSHIFT(Key_Semicolon))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'¹', RALT(LSHIFT(Key_1))) /* U+00b9, XKB_KEY_onesuperior, SUPERSCRIPT ONE */ \
   OP(L'º', RALT(Key_3)) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   ...
   OP(L'À', RALT(LSHIFT(Key_Z))) /* U+00c0, XKB_KEY_Agrave, LATIN CAPITAL LETTER A WITH GRAVE */ \
   OP(L'Á', RALT(LSHIFT(Key_X))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   ...
   OP(L'Æ', RALT(LSHIFT(Key_Q))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'Ç', RALT(LSHIFT(Key_C))) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'È', RALT(LSHIFT(Key_F))) /* U+00c8, XKB_KEY_Egrave, LATIN CAPITAL LETTER E WITH GRAVE */ \
   OP(L'É', RALT(LSHIFT(Key_G))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Ë', RALT(LSHIFT(Key_E))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Ì', RALT(LSHIFT(Key_V))) /* U+00cc, XKB_KEY_Igrave, LATIN CAPITAL LETTER I WITH GRAVE */ \
   OP(L'Í', RALT(LSHIFT(Key_B))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   ...
   OP(L'Ò', RALT(LSHIFT(Key_Comma))) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   OP(L'Ó', RALT(LSHIFT(Key_Period))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   ...
   OP(L'Ø', RALT(LSHIFT(Key_L))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ù', RALT(LSHIFT(Key_H))) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'Ú', RALT(LSHIFT(Key_J))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Ü', RALT(LSHIFT(Key_U))) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Ý', RALT(LSHIFT(Key_R))) /* U+00dd, XKB_KEY_Yacute, LATIN CAPITAL LETTER Y WITH ACUTE */ \
   ...
   OP(L'à', RALT(Key_Z)) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   OP(L'á', RALT(Key_X)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'ä', RALT(Key_A)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', RALT(Key_W)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'æ', RALT(Key_Q)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_C)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', RALT(Key_F)) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'é', RALT(Key_G)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ë', RALT(Key_E)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'ì', RALT(Key_V)) /* U+00ec, XKB_KEY_igrave, LATIN SMALL LETTER I WITH GRAVE */ \
   OP(L'í', RALT(Key_B)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   ...
   OP(L'ñ', RALT(Key_N)) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   OP(L'ò', RALT(Key_Comma)) /* U+00f2, XKB_KEY_ograve, LATIN SMALL LETTER O WITH GRAVE */ \
   OP(L'ó', RALT(Key_Period)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   ...
   OP(L'ø', RALT(Key_L)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ù', RALT(Key_H)) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'ú', RALT(Key_J)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ü', RALT(Key_U)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ý', RALT(Key_R)) /* U+00fd, XKB_KEY_yacute, LATIN SMALL LETTER Y WITH ACUTE */ \
   OP(L'þ', RALT(Key_T)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'ÿ', RALT(Key_Y)) /* U+00ff, XKB_KEY_ydiaeresis, LATIN SMALL LETTER Y WITH DIAERESIS */ \
   OP(L'Ĳ', RALT(LSHIFT(Key_K))) \
   OP(L'ĳ', RALT(Key_K)) \
   OP(L'Œ', RALT(LSHIFT(Key_P))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_P)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'Ÿ', RALT(LSHIFT(Key_Y))) /* U+0178, XKB_KEY_Ydiaeresis, LATIN CAPITAL LETTER Y WITH DIAERESIS */ \
   OP(L'‘', RALT(LSHIFT(Key_9))) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(LSHIFT(Key_0))) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_8))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(Key_9)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(Key_0)) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(Key_8)) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'†', RALT(LSHIFT(Key_Quote))) /* U+2020, XKB_KEY_dagger, DAGGER */ \
   ...
   OP(L'№', RALT(LSHIFT(Key_Minus))) /* U+2116, XKB_KEY_numerosign, NUMERO SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Adiaeresis, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_Agrave, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_Eacute, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Egrave, RALT(LSHIFT(Key_F))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_Idiaeresis, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Igrave, RALT(LSHIFT(Key_V))) \
   ...
   OP(XKB_KEY_Multi_key, RALT(Key_M)) /* XKB_KEY_Multi_key, Multi-key character compose  */ \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Ograve, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_Oslash, RALT(LSHIFT(Key_L))) \
   ...
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Udiaeresis, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_Ugrave, RALT(LSHIFT(Key_H))) \
   ...
   OP(XKB_KEY_Yacute, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Ydiaeresis, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_Z, LSHIFT(Key_Z)) \
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, RALT(Key_X)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_A)) \
   OP(XKB_KEY_ae, RALT(Key_Q)) \
   OP(XKB_KEY_agrave, RALT(Key_Z)) \
   ...
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_colon, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_Minus)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dagger, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_dead_abovering, RALT(Key_7)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_Quote)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(LSHIFT(Key_6))) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_6)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_Semicolon)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_grave, RALT(Key_Backtick)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_macron, RALT(LSHIFT(Key_7))) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_doublelowquotemark, RALT(Key_8)) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, RALT(Key_G)) \
   OP(XKB_KEY_ediaeresis, RALT(Key_E)) \
   OP(XKB_KEY_egrave, RALT(Key_F)) \
   ...
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, RALT(Key_B)) \
   OP(XKB_KEY_idiaeresis, RALT(Key_I)) \
   OP(XKB_KEY_igrave, RALT(Key_V)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_9)) \
   OP(XKB_KEY_leftsinglequotemark, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_masculine, RALT(Key_3)) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_multiply, RALT(Key_Equals)) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_notsign, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_ntilde, RALT(Key_N)) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_numerosign, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oacute, RALT(Key_Period)) \
   OP(XKB_KEY_odiaeresis, RALT(Key_O)) \
   OP(XKB_KEY_oe, RALT(Key_P)) \
   OP(XKB_KEY_ograve, RALT(Key_Comma)) \
   OP(XKB_KEY_onesuperior, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_ordfeminine, RALT(Key_2)) \
   OP(XKB_KEY_oslash, RALT(Key_L)) \
   OP(XKB_KEY_p, Key_P) \
   ...
   OP(XKB_KEY_periodcentered, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_rightdoublequotemark, RALT(Key_0)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, RALT(LSHIFT(Key_S))) \
   OP(XKB_KEY_semicolon, Key_Semicolon) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_8))) \
   ...
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, RALT(Key_J)) \
   OP(XKB_KEY_udiaeresis, RALT(Key_U)) \
   OP(XKB_KEY_ugrave, RALT(Key_H)) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_v, Key_V) \
   OP(XKB_KEY_w, Key_W) \
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yacute, RALT(Key_R)) \
   OP(XKB_KEY_ydiaeresis, RALT(Key_Y)) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_z, Key_Z) \
