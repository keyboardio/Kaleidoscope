...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(')', RALT(LSHIFT(Key_NonUsPound))) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L')', RALT(LSHIFT(Key_NonUsPound))) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_parenright, RALT(LSHIFT(Key_NonUsPound))) \
