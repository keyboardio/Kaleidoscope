...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', RALT(Key_P)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', RALT(Key_9)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', RALT(Key_0)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP('<', RALT(Key_Z)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', RALT(Key_P)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', RALT(Key_9)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', RALT(Key_0)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   ...
   OP(L'<', RALT(Key_Z)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_apostrophe, RALT(Key_P)) /* XKB_KEY_quoteright, deprecated  */ \
   ...
   OP(XKB_KEY_parenright, RALT(Key_0)) \
