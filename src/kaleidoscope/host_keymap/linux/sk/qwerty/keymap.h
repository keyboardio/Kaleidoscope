...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', RALT(Key_1)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', LSHIFT(Key_Semicolon)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP('\'', RALT(Key_J)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', LSHIFT(Key_RightBracket)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(')', LSHIFT(Key_NonUsPound)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP('*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP('+', Key_1) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP(';', Key_Backtick) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('`', RALT(Key_H)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('~', RALT(Key_A)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', RALT(Key_1)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', LSHIFT(Key_Semicolon)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   ...
   OP(L'\'', RALT(Key_J)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', LSHIFT(Key_RightBracket)) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   OP(L')', LSHIFT(Key_NonUsPound)) /* U+0029, XKB_KEY_parenright, RIGHT PARENTHESIS */ \
   OP(L'*', Key_KeypadMultiply) /* XKB_KEY_KP_Multiply */ \
   OP(L'+', Key_1) /* U+002b, XKB_KEY_plus, PLUS SIGN */ \
   ...
   OP(L';', Key_Backtick) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'`', RALT(Key_H)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'~', RALT(Key_A)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'§', Key_Quote) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   ...
   OP(L'°', RALT(Key_Z)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   ...
   OP(L'×', RALT(LSHIFT(Key_RightBracket))) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   ...
   OP(L'ß', RALT(LSHIFT(Key_Quote))) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'á', Key_8) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'ä', Key_RightBracket) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'é', Key_0) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'í', Key_9) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ô', Key_Semicolon) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'÷', RALT(LSHIFT(Key_LeftBracket))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', RALT(Key_O)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ú', Key_LeftBracket) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'ý', Key_7) /* U+00fd, XKB_KEY_yacute, LATIN SMALL LETTER Y WITH ACUTE */ \
   OP(L'þ', RALT(Key_P)) /* U+00fe, XKB_KEY_thorn, LATIN SMALL LETTER THORN */ \
   OP(L'č', Key_4) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   ...
   OP(L'ľ', Key_2) /* U+013e, XKB_KEY_lcaron, LATIN SMALL LETTER L WITH CARON */ \
   ...
   OP(L'ň', Key_NonUsPound) /* U+0148, XKB_KEY_ncaron, LATIN SMALL LETTER N WITH CARON */ \
   OP(L'Ŋ', RALT(LSHIFT(Key_G))) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'š', Key_3) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'ť', Key_5) /* U+0165, XKB_KEY_tcaron, LATIN SMALL LETTER T WITH CARON */ \
   ...
   OP(L'ž', Key_6) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_aacute, Key_8) \
   OP(XKB_KEY_adiaeresis, Key_RightBracket) \
   OP(XKB_KEY_ampersand, RALT(Key_7)) \
   OP(XKB_KEY_apostrophe, RALT(Key_J)) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciicircum, RALT(Key_6)) \
   OP(XKB_KEY_asciitilde, RALT(Key_A)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccaron, Key_4) \
   OP(XKB_KEY_colon, LSHIFT(Key_Period)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_8))) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, LSHIFT(Key_Backtick)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, Key_Equals) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_breve, RALT(LSHIFT(Key_4))) /* XKB_KEY_dead_breve */ \
   OP(XKB_KEY_dead_caron, LSHIFT(Key_Equals)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_Equals))) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(LSHIFT(Key_3))) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(LSHIFT(Key_Minus))) /* XKB_KEY_dead_diaeresis */ \
   ...
   OP(XKB_KEY_dead_macron, RALT(Key_Equals)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(LSHIFT(Key_6))) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_1))) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, RALT(Key_Z)) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_exclam, RALT(Key_1)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(Key_H)) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, RALT(Key_Period)) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, Key_9) \
   OP(XKB_KEY_idotless, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_lcaron, Key_2) \
   ...
   OP(XKB_KEY_multiply, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_ncaron, Key_NonUsPound) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_numbersign, RALT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_ocircumflex, Key_Semicolon) \
   OP(XKB_KEY_ordfeminine, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_oslash, RALT(Key_O)) \
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(Key_R)) \
   OP(XKB_KEY_parenleft, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_parenright, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_percent, RALT(Key_5)) \
   OP(XKB_KEY_period, Key_Period) \
   OP(XKB_KEY_plus, Key_1) \
   OP(XKB_KEY_q, Key_Q) \
   OP(XKB_KEY_question, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_rightarrow, RALT(Key_I)) \
   OP(XKB_KEY_rightsinglequotemark, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scaron, Key_3) \
   OP(XKB_KEY_section, Key_Quote) \
   OP(XKB_KEY_semicolon, Key_Backtick) \
   OP(XKB_KEY_slash, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_ssharp, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_tcaron, Key_5) \
   OP(XKB_KEY_thorn, RALT(Key_P)) \
   OP(XKB_KEY_tslash, RALT(Key_T)) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, Key_LeftBracket) \
   ...
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yacute, Key_7) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, Key_6) \
