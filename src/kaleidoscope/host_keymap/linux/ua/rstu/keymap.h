...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('#', Key_3) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP('%', LSHIFT(Key_NonUsPound)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP('*', Key_8) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   ...
   OP('?', LSHIFT(Key_Backtick)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'#', Key_3) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP(L'%', LSHIFT(Key_NonUsPound)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP(L'*', Key_8) /* U+002a, XKB_KEY_asterisk, ASTERISK */ \
   ...
   OP(L'?', LSHIFT(Key_Backtick)) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'І', LSHIFT(Key_B)) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', LSHIFT(Key_Slash)) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'И', LSHIFT(Key_S)) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   ...
   OP(L'и', Key_S) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   ...
   OP(L'і', Key_B) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', Key_Slash) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'Ґ', LSHIFT(Key_RightBracket)) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', Key_RightBracket) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_S)) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_Ukrainian_I, LSHIFT(Key_B)) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, LSHIFT(Key_Quote)) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, LSHIFT(Key_Slash)) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, Key_RightBracket) \
   OP(XKB_KEY_Ukrainian_i, Key_B) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, Key_Quote) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, Key_Slash) /* XKB_KEY_Ukranian_yi, deprecated  */ \
