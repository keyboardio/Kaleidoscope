...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('"', LSHIFT(Key_7)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('%', LSHIFT(Key_5)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('\'', LSHIFT(Key_6)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(':', LSHIFT(Key_4)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', LSHIFT(Key_3)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('_', LSHIFT(Key_Backtick)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'"', LSHIFT(Key_7)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'%', LSHIFT(Key_5)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'\'', LSHIFT(Key_6)) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L':', LSHIFT(Key_4)) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', LSHIFT(Key_3)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'_', LSHIFT(Key_Backtick)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   ...
   OP(L'Є', LSHIFT(Key_Minus)) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'І', LSHIFT(Key_I)) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', LSHIFT(Key_Equals)) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'Ж', LSHIFT(Key_Quote)) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', LSHIFT(Key_Z)) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   OP(L'И', LSHIFT(Key_Y)) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   ...
   OP(L'ж', Key_Quote) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', Key_Z) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   OP(L'и', Key_Y) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   ...
   OP(L'є', Key_Minus) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'і', Key_I) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', Key_Equals) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'Ґ', LSHIFT(Key_G)) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', Key_G) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_Y)) \
   ...
   OP(XKB_KEY_Cyrillic_ZHE, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_zhe, Key_Quote) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, LSHIFT(Key_G)) \
   OP(XKB_KEY_Ukrainian_I, LSHIFT(Key_I)) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, LSHIFT(Key_Minus)) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, LSHIFT(Key_Equals)) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, Key_G) \
   OP(XKB_KEY_Ukrainian_i, Key_I) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, Key_Minus) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, Key_Equals) /* XKB_KEY_Ukranian_yi, deprecated  */ \
   ...
   OP(XKB_KEY_quotedbl, LSHIFT(Key_7)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_3)) \
   OP(XKB_KEY_slash, Key_Slash) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_underscore, LSHIFT(Key_Backtick)) \
