...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('%', Key_0) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('\'', Key_Backtick) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', Key_NonUsPound) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'%', Key_0) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'\'', Key_Backtick) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', Key_NonUsPound) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_parenleft, Key_NonUsPound) \
   OP(XKB_KEY_parenright, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_percent, Key_0) \
