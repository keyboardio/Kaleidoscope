...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP(';', LSHIFT(Key_8)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L';', LSHIFT(Key_8)) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'Є', LSHIFT(Key_Period)) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'І', LSHIFT(Key_I)) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', LSHIFT(Key_Comma)) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'є', Key_Period) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'і', Key_I) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', Key_Comma) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'Ґ', LSHIFT(Key_Semicolon)) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', Key_Semicolon) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_Ukrainian_I, LSHIFT(Key_I)) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, LSHIFT(Key_Period)) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, LSHIFT(Key_Comma)) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, Key_Semicolon) \
   OP(XKB_KEY_Ukrainian_i, Key_I) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, Key_Period) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, Key_Comma) /* XKB_KEY_Ukranian_yi, deprecated  */ \
   ...
   OP(XKB_KEY_asterisk, LSHIFT(Key_4)) \
   ...
   OP(XKB_KEY_semicolon, LSHIFT(Key_8)) \
