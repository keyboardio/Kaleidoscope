...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Є', RALT(LSHIFT(Key_Quote))) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'І', RALT(LSHIFT(Key_S))) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', RALT(LSHIFT(Key_RightBracket))) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   OP(L'А', RALT(LSHIFT(Key_F))) /* U+0410, XKB_KEY_Cyrillic_A, CYRILLIC CAPITAL LETTER A */ \
   OP(L'Б', RALT(LSHIFT(Key_Comma))) /* U+0411, XKB_KEY_Cyrillic_BE, CYRILLIC CAPITAL LETTER BE */ \
   OP(L'В', RALT(LSHIFT(Key_D))) /* U+0412, XKB_KEY_Cyrillic_VE, CYRILLIC CAPITAL LETTER VE */ \
   OP(L'Г', RALT(LSHIFT(Key_U))) /* U+0413, XKB_KEY_Cyrillic_GHE, CYRILLIC CAPITAL LETTER GHE */ \
   OP(L'Д', RALT(LSHIFT(Key_L))) /* U+0414, XKB_KEY_Cyrillic_DE, CYRILLIC CAPITAL LETTER DE */ \
   OP(L'Е', RALT(LSHIFT(Key_T))) /* U+0415, XKB_KEY_Cyrillic_IE, CYRILLIC CAPITAL LETTER IE */ \
   OP(L'Ж', RALT(LSHIFT(Key_Semicolon))) /* U+0416, XKB_KEY_Cyrillic_ZHE, CYRILLIC CAPITAL LETTER ZHE */ \
   OP(L'З', RALT(LSHIFT(Key_P))) /* U+0417, XKB_KEY_Cyrillic_ZE, CYRILLIC CAPITAL LETTER ZE */ \
   OP(L'И', RALT(LSHIFT(Key_B))) /* U+0418, XKB_KEY_Cyrillic_I, CYRILLIC CAPITAL LETTER I */ \
   OP(L'Й', RALT(LSHIFT(Key_Q))) /* U+0419, XKB_KEY_Cyrillic_SHORTI, CYRILLIC CAPITAL LETTER SHORT I */ \
   OP(L'К', RALT(LSHIFT(Key_R))) /* U+041a, XKB_KEY_Cyrillic_KA, CYRILLIC CAPITAL LETTER KA */ \
   OP(L'Л', RALT(LSHIFT(Key_K))) /* U+041b, XKB_KEY_Cyrillic_EL, CYRILLIC CAPITAL LETTER EL */ \
   OP(L'М', RALT(LSHIFT(Key_V))) /* U+041c, XKB_KEY_Cyrillic_EM, CYRILLIC CAPITAL LETTER EM */ \
   OP(L'Н', RALT(LSHIFT(Key_Y))) /* U+041d, XKB_KEY_Cyrillic_EN, CYRILLIC CAPITAL LETTER EN */ \
   OP(L'О', RALT(LSHIFT(Key_J))) /* U+041e, XKB_KEY_Cyrillic_O, CYRILLIC CAPITAL LETTER O */ \
   OP(L'П', RALT(LSHIFT(Key_G))) /* U+041f, XKB_KEY_Cyrillic_PE, CYRILLIC CAPITAL LETTER PE */ \
   OP(L'Р', RALT(LSHIFT(Key_H))) /* U+0420, XKB_KEY_Cyrillic_ER, CYRILLIC CAPITAL LETTER ER */ \
   OP(L'С', RALT(LSHIFT(Key_C))) /* U+0421, XKB_KEY_Cyrillic_ES, CYRILLIC CAPITAL LETTER ES */ \
   OP(L'Т', RALT(LSHIFT(Key_N))) /* U+0422, XKB_KEY_Cyrillic_TE, CYRILLIC CAPITAL LETTER TE */ \
   OP(L'У', RALT(LSHIFT(Key_E))) /* U+0423, XKB_KEY_Cyrillic_U, CYRILLIC CAPITAL LETTER U */ \
   OP(L'Ф', RALT(LSHIFT(Key_A))) /* U+0424, XKB_KEY_Cyrillic_EF, CYRILLIC CAPITAL LETTER EF */ \
   OP(L'Х', RALT(LSHIFT(Key_LeftBracket))) /* U+0425, XKB_KEY_Cyrillic_HA, CYRILLIC CAPITAL LETTER HA */ \
   OP(L'Ц', RALT(LSHIFT(Key_W))) /* U+0426, XKB_KEY_Cyrillic_TSE, CYRILLIC CAPITAL LETTER TSE */ \
   OP(L'Ч', RALT(LSHIFT(Key_X))) /* U+0427, XKB_KEY_Cyrillic_CHE, CYRILLIC CAPITAL LETTER CHE */ \
   OP(L'Ш', RALT(LSHIFT(Key_I))) /* U+0428, XKB_KEY_Cyrillic_SHA, CYRILLIC CAPITAL LETTER SHA */ \
   OP(L'Щ', RALT(LSHIFT(Key_O))) /* U+0429, XKB_KEY_Cyrillic_SHCHA, CYRILLIC CAPITAL LETTER SHCHA */ \
   OP(L'Ь', RALT(LSHIFT(Key_M))) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Ю', RALT(LSHIFT(Key_Period))) /* U+042e, XKB_KEY_Cyrillic_YU, CYRILLIC CAPITAL LETTER YU */ \
   OP(L'Я', RALT(LSHIFT(Key_Z))) /* U+042f, XKB_KEY_Cyrillic_YA, CYRILLIC CAPITAL LETTER YA */ \
   OP(L'а', RALT(Key_F)) /* U+0430, XKB_KEY_Cyrillic_a, CYRILLIC SMALL LETTER A */ \
   OP(L'б', RALT(Key_Comma)) /* U+0431, XKB_KEY_Cyrillic_be, CYRILLIC SMALL LETTER BE */ \
   OP(L'в', RALT(Key_D)) /* U+0432, XKB_KEY_Cyrillic_ve, CYRILLIC SMALL LETTER VE */ \
   OP(L'г', RALT(Key_U)) /* U+0433, XKB_KEY_Cyrillic_ghe, CYRILLIC SMALL LETTER GHE */ \
   OP(L'д', RALT(Key_L)) /* U+0434, XKB_KEY_Cyrillic_de, CYRILLIC SMALL LETTER DE */ \
   OP(L'е', RALT(Key_T)) /* U+0435, XKB_KEY_Cyrillic_ie, CYRILLIC SMALL LETTER IE */ \
   OP(L'ж', RALT(Key_Semicolon)) /* U+0436, XKB_KEY_Cyrillic_zhe, CYRILLIC SMALL LETTER ZHE */ \
   OP(L'з', RALT(Key_P)) /* U+0437, XKB_KEY_Cyrillic_ze, CYRILLIC SMALL LETTER ZE */ \
   OP(L'и', RALT(Key_B)) /* U+0438, XKB_KEY_Cyrillic_i, CYRILLIC SMALL LETTER I */ \
   OP(L'й', RALT(Key_Q)) /* U+0439, XKB_KEY_Cyrillic_shorti, CYRILLIC SMALL LETTER SHORT I */ \
   OP(L'к', RALT(Key_R)) /* U+043a, XKB_KEY_Cyrillic_ka, CYRILLIC SMALL LETTER KA */ \
   OP(L'л', RALT(Key_K)) /* U+043b, XKB_KEY_Cyrillic_el, CYRILLIC SMALL LETTER EL */ \
   OP(L'м', RALT(Key_V)) /* U+043c, XKB_KEY_Cyrillic_em, CYRILLIC SMALL LETTER EM */ \
   OP(L'н', RALT(Key_Y)) /* U+043d, XKB_KEY_Cyrillic_en, CYRILLIC SMALL LETTER EN */ \
   OP(L'о', RALT(Key_J)) /* U+043e, XKB_KEY_Cyrillic_o, CYRILLIC SMALL LETTER O */ \
   OP(L'п', RALT(Key_G)) /* U+043f, XKB_KEY_Cyrillic_pe, CYRILLIC SMALL LETTER PE */ \
   OP(L'р', RALT(Key_H)) /* U+0440, XKB_KEY_Cyrillic_er, CYRILLIC SMALL LETTER ER */ \
   OP(L'с', RALT(Key_C)) /* U+0441, XKB_KEY_Cyrillic_es, CYRILLIC SMALL LETTER ES */ \
   OP(L'т', RALT(Key_N)) /* U+0442, XKB_KEY_Cyrillic_te, CYRILLIC SMALL LETTER TE */ \
   OP(L'у', RALT(Key_E)) /* U+0443, XKB_KEY_Cyrillic_u, CYRILLIC SMALL LETTER U */ \
   OP(L'ф', RALT(Key_A)) /* U+0444, XKB_KEY_Cyrillic_ef, CYRILLIC SMALL LETTER EF */ \
   OP(L'х', RALT(Key_LeftBracket)) /* U+0445, XKB_KEY_Cyrillic_ha, CYRILLIC SMALL LETTER HA */ \
   OP(L'ц', RALT(Key_W)) /* U+0446, XKB_KEY_Cyrillic_tse, CYRILLIC SMALL LETTER TSE */ \
   OP(L'ч', RALT(Key_X)) /* U+0447, XKB_KEY_Cyrillic_che, CYRILLIC SMALL LETTER CHE */ \
   OP(L'ш', RALT(Key_I)) /* U+0448, XKB_KEY_Cyrillic_sha, CYRILLIC SMALL LETTER SHA */ \
   OP(L'щ', RALT(Key_O)) /* U+0449, XKB_KEY_Cyrillic_shcha, CYRILLIC SMALL LETTER SHCHA */ \
   OP(L'ь', RALT(Key_M)) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'ю', RALT(Key_Period)) /* U+044e, XKB_KEY_Cyrillic_yu, CYRILLIC SMALL LETTER YU */ \
   OP(L'я', RALT(Key_Z)) /* U+044f, XKB_KEY_Cyrillic_ya, CYRILLIC SMALL LETTER YA */ \
   OP(L'є', RALT(Key_Quote)) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'і', RALT(Key_S)) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', RALT(Key_RightBracket)) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'Ґ', RALT(LSHIFT(Key_NonUsPound))) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', RALT(Key_NonUsPound)) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_A, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_Cyrillic_BE, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_Cyrillic_CHE, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_Cyrillic_DE, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_Cyrillic_EF, RALT(LSHIFT(Key_A))) \
   OP(XKB_KEY_Cyrillic_EL, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_Cyrillic_EM, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_Cyrillic_EN, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_Cyrillic_ER, RALT(LSHIFT(Key_H))) \
   OP(XKB_KEY_Cyrillic_ES, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_Cyrillic_GHE, RALT(LSHIFT(Key_U))) \
   OP(XKB_KEY_Cyrillic_HA, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_Cyrillic_I, RALT(LSHIFT(Key_B))) \
   OP(XKB_KEY_Cyrillic_IE, RALT(LSHIFT(Key_T))) \
   OP(XKB_KEY_Cyrillic_KA, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_Cyrillic_O, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Cyrillic_PE, RALT(LSHIFT(Key_G))) \
   OP(XKB_KEY_Cyrillic_SHA, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Cyrillic_SHCHA, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Cyrillic_SHORTI, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_Cyrillic_SOFTSIGN, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_Cyrillic_TE, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_Cyrillic_TSE, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_Cyrillic_U, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Cyrillic_VE, RALT(LSHIFT(Key_D))) \
   OP(XKB_KEY_Cyrillic_YA, RALT(LSHIFT(Key_Z))) \
   OP(XKB_KEY_Cyrillic_YU, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_Cyrillic_ZE, RALT(LSHIFT(Key_P))) \
   OP(XKB_KEY_Cyrillic_ZHE, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Cyrillic_a, RALT(Key_F)) \
   OP(XKB_KEY_Cyrillic_be, RALT(Key_Comma)) \
   OP(XKB_KEY_Cyrillic_che, RALT(Key_X)) \
   OP(XKB_KEY_Cyrillic_de, RALT(Key_L)) \
   OP(XKB_KEY_Cyrillic_ef, RALT(Key_A)) \
   OP(XKB_KEY_Cyrillic_el, RALT(Key_K)) \
   OP(XKB_KEY_Cyrillic_em, RALT(Key_V)) \
   OP(XKB_KEY_Cyrillic_en, RALT(Key_Y)) \
   OP(XKB_KEY_Cyrillic_er, RALT(Key_H)) \
   OP(XKB_KEY_Cyrillic_es, RALT(Key_C)) \
   OP(XKB_KEY_Cyrillic_ghe, RALT(Key_U)) \
   OP(XKB_KEY_Cyrillic_ha, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_i, RALT(Key_B)) \
   OP(XKB_KEY_Cyrillic_ie, RALT(Key_T)) \
   OP(XKB_KEY_Cyrillic_ka, RALT(Key_R)) \
   OP(XKB_KEY_Cyrillic_o, RALT(Key_J)) \
   OP(XKB_KEY_Cyrillic_pe, RALT(Key_G)) \
   OP(XKB_KEY_Cyrillic_sha, RALT(Key_I)) \
   OP(XKB_KEY_Cyrillic_shcha, RALT(Key_O)) \
   OP(XKB_KEY_Cyrillic_shorti, RALT(Key_Q)) \
   OP(XKB_KEY_Cyrillic_softsign, RALT(Key_M)) \
   OP(XKB_KEY_Cyrillic_te, RALT(Key_N)) \
   OP(XKB_KEY_Cyrillic_tse, RALT(Key_W)) \
   OP(XKB_KEY_Cyrillic_u, RALT(Key_E)) \
   OP(XKB_KEY_Cyrillic_ve, RALT(Key_D)) \
   OP(XKB_KEY_Cyrillic_ya, RALT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_yu, RALT(Key_Period)) \
   OP(XKB_KEY_Cyrillic_ze, RALT(Key_P)) \
   OP(XKB_KEY_Cyrillic_zhe, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_Ukrainian_I, RALT(LSHIFT(Key_S))) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, RALT(LSHIFT(Key_RightBracket))) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_Ukrainian_i, RALT(Key_S)) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, RALT(Key_Quote)) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, RALT(Key_RightBracket)) /* XKB_KEY_Ukranian_yi, deprecated  */ \
