...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ʼ', LSHIFT(Key_Backtick)) \
   OP(L'́', RALT(Key_Backtick)) \
   OP(L'Ё', RALT(LSHIFT(Key_T))) /* U+0401, XKB_KEY_Cyrillic_IO, CYRILLIC CAPITAL LETTER IO */ \
   OP(L'Є', LSHIFT(Key_Quote)) /* U+0404, XKB_KEY_Ukrainian_IE, CYRILLIC CAPITAL LETTER UKRAINIAN IE */ \
   OP(L'І', LSHIFT(Key_S)) /* U+0406, XKB_KEY_Ukrainian_I, CYRILLIC CAPITAL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'Ї', LSHIFT(Key_RightBracket)) /* U+0407, XKB_KEY_Ukrainian_YI, CYRILLIC CAPITAL LETTER YI */ \
   ...
   OP(L'Ъ', RALT(LSHIFT(Key_RightBracket))) /* U+042a, XKB_KEY_Cyrillic_HARDSIGN, CYRILLIC CAPITAL LETTER HARD SIGN */ \
   OP(L'Ы', RALT(LSHIFT(Key_S))) /* U+042b, XKB_KEY_Cyrillic_YERU, CYRILLIC CAPITAL LETTER YERU */ \
   OP(L'Ь', LSHIFT(Key_M)) /* U+042c, XKB_KEY_Cyrillic_SOFTSIGN, CYRILLIC CAPITAL LETTER SOFT SIGN */ \
   OP(L'Э', RALT(LSHIFT(Key_Quote))) /* U+042d, XKB_KEY_Cyrillic_E, CYRILLIC CAPITAL LETTER E */ \
   ...
   OP(L'ъ', RALT(Key_RightBracket)) /* U+044a, XKB_KEY_Cyrillic_hardsign, CYRILLIC SMALL LETTER HARD SIGN */ \
   OP(L'ы', RALT(Key_S)) /* U+044b, XKB_KEY_Cyrillic_yeru, CYRILLIC SMALL LETTER YERU */ \
   OP(L'ь', Key_M) /* U+044c, XKB_KEY_Cyrillic_softsign, CYRILLIC SMALL LETTER SOFT SIGN */ \
   OP(L'э', RALT(Key_Quote)) /* U+044d, XKB_KEY_Cyrillic_e, CYRILLIC SMALL LETTER E */ \
   ...
   OP(L'є', Key_Quote) /* U+0454, XKB_KEY_Ukrainian_ie, CYRILLIC SMALL LETTER UKRAINIAN IE */ \
   OP(L'і', Key_S) /* U+0456, XKB_KEY_Ukrainian_i, CYRILLIC SMALL LETTER BYELORUSSIAN-UKRAINIAN I */ \
   OP(L'ї', Key_RightBracket) /* U+0457, XKB_KEY_Ukrainian_yi, CYRILLIC SMALL LETTER YI */ \
   OP(L'ў', RALT(Key_E)) /* U+045e, XKB_KEY_Byelorussian_shortu, CYRILLIC SMALL LETTER SHORT U */ \
   OP(L'Ґ', LSHIFT(Key_NonUsPound)) /* U+0490, XKB_KEY_Ukrainian_GHE_WITH_UPTURN, CYRILLIC CAPITAL LETTER GHE WITH UPTURN */ \
   OP(L'ґ', Key_NonUsPound) /* U+0491, XKB_KEY_Ukrainian_ghe_with_upturn, CYRILLIC SMALL LETTER GHE WITH UPTURN */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_E, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_Cyrillic_HARDSIGN, RALT(LSHIFT(Key_RightBracket))) \
   ...
   OP(XKB_KEY_Cyrillic_YERU, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_Cyrillic_e, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_Cyrillic_hardsign, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_yeru, RALT(Key_S)) \
   ...
   OP(XKB_KEY_Ukrainian_GHE_WITH_UPTURN, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_Ukrainian_I, LSHIFT(Key_S)) /* XKB_KEY_Ukranian_I, deprecated  */ \
   OP(XKB_KEY_Ukrainian_IE, LSHIFT(Key_Quote)) /* XKB_KEY_Ukranian_JE, deprecated  */ \
   OP(XKB_KEY_Ukrainian_YI, LSHIFT(Key_RightBracket)) /* XKB_KEY_Ukranian_YI, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ghe_with_upturn, Key_NonUsPound) \
   OP(XKB_KEY_Ukrainian_i, Key_S) /* XKB_KEY_Ukranian_i, deprecated  */ \
   OP(XKB_KEY_Ukrainian_ie, Key_Quote) /* XKB_KEY_Ukranian_je, deprecated  */ \
   OP(XKB_KEY_Ukrainian_yi, Key_RightBracket) /* XKB_KEY_Ukranian_yi, deprecated  */ \
