...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('>', LSHIFT(Key_Slash)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('I', LSHIFT(Key_Quote)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'>', LSHIFT(Key_Slash)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'I', LSHIFT(Key_Quote)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   ...
   OP(L'Ä', LSHIFT(Key_Comma)) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Ç', LSHIFT(Key_X)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Ê', LSHIFT(Key_W)) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Ö', LSHIFT(Key_LeftBracket)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ü', LSHIFT(Key_RightBracket)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ä', Key_Comma) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ç', Key_X) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ê', Key_W) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ö', Key_LeftBracket) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_RightBracket) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'İ', LSHIFT(Key_I)) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
   OP(L'ı', Key_Quote) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   ...
   OP(L'Ţ', LSHIFT(Key_Q)) /* U+0162, XKB_KEY_Tcedilla, LATIN CAPITAL LETTER T WITH CEDILLA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Adiaeresis, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Ecircumflex, LSHIFT(Key_W)) \
   ...
   OP(XKB_KEY_Iabovedot, LSHIFT(Key_I)) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Tcedilla, LSHIFT(Key_Q)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_adiaeresis, Key_Comma) \
   ...
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_odiaeresis, Key_LeftBracket) \
   OP(XKB_KEY_p, Key_P) \
