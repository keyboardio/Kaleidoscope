...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ĥ', RALT(LSHIFT(Key_H))) \
   OP(L'Ŋ', RALT(LSHIFT(Key_N))) \
   OP(L'ŋ', RALT(Key_N)) \
   OP(L'Ɓ', RALT(LSHIFT(Key_B))) \
   OP(L'Ɔ', RALT(LSHIFT(Key_O))) \
   OP(L'Ɖ', RALT(LSHIFT(Key_D))) \
   OP(L'Ɗ', RALT(LSHIFT(Key_T))) \
   OP(L'Ǝ', RALT(LSHIFT(Key_A))) \
   OP(L'Ɛ', RALT(LSHIFT(Key_R))) \
   OP(L'Ƒ', RALT(LSHIFT(Key_F))) \
   OP(L'ƒ', RALT(Key_F)) \
   OP(L'Ɣ', RALT(LSHIFT(Key_G))) \
   OP(L'Ɩ', RALT(LSHIFT(Key_I))) \
   OP(L'Ɨ', RALT(LSHIFT(Key_J))) \
   OP(L'Ɲ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'Ʊ', RALT(LSHIFT(Key_U))) \
   OP(L'Ʋ', RALT(LSHIFT(Key_V))) \
   OP(L'Ƴ', RALT(LSHIFT(Key_Y))) \
   OP(L'ƴ', RALT(Key_Y)) \
   OP(L'Ʒ', RALT(LSHIFT(Key_W))) /* U+01b7, XKB_KEY_EZH, LATIN CAPITAL LETTER EZH */ \
   OP(L'ǝ', RALT(Key_A)) \
   OP(L'ɓ', RALT(Key_B)) \
   OP(L'ɔ', RALT(Key_O)) \
   OP(L'ɖ', RALT(Key_D)) \
   ...
   OP(L'ɨ', RALT(Key_J)) \
   OP(L'ɩ', RALT(Key_I)) \
   OP(L'ɲ', RALT(Key_Semicolon)) \
   OP(L'ʊ', RALT(Key_U)) \
   OP(L'ʋ', RALT(Key_V)) \
   OP(L'ʒ', RALT(Key_W)) /* U+0292, XKB_KEY_ezh, LATIN SMALL LETTER EZH */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_EZH, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_acute, RALT(Key_NonUsPound)) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_dead_macron, RALT(Key_Period)) /* XKB_KEY_dead_macron */ \
