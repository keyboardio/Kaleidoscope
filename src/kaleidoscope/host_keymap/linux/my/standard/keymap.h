...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'چ', LSHIFT(Key_Q)) /* U+0686, XKB_KEY_Arabic_tcheh, ARABIC LETTER TCHEH */ \
   OP(L'ڠ', LSHIFT(Key_W)) \
   OP(L'ڤ', RALT(Key_T)) /* U+06a4, XKB_KEY_Arabic_veh, ARABIC LETTER VEH */ \
   OP(L'ڨ', LSHIFT(Key_S)) \
   OP(L'ک', Key_P) /* U+06a9, XKB_KEY_Arabic_keheh, ARABIC LETTER KEHEH */ \
   OP(L'ڬ', LSHIFT(Key_E)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Arabic_tcheh, LSHIFT(Key_Q)) \
