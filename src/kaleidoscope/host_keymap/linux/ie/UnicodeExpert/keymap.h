...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_doubleacute, RALT(Key_2)) /* XKB_KEY_dead_doubleacute */ \
   OP(XKB_KEY_dead_grave, RALT(Key_NonUsBackslashAndPipe)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(Key_LeftBracket)) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_horn, RALT(Key_RightBracket)) /* XKB_KEY_dead_horn */ \
   OP(XKB_KEY_dead_macron, RALT(Key_Minus)) /* XKB_KEY_dead_macron */ \
   OP(XKB_KEY_dead_ogonek, RALT(Key_0)) /* XKB_KEY_dead_ogonek */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_NonUsPound)) /* XKB_KEY_dead_tilde */ \
