...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('#', Key_NonUsPound) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP('@', LSHIFT(Key_Quote)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('\\', Key_NonUsBackslashAndPipe) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP('|', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', LSHIFT(Key_RightBracket)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', LSHIFT(Key_NonUsPound)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'#', Key_NonUsPound) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   ...
   OP(L'@', LSHIFT(Key_Quote)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'\\', Key_NonUsBackslashAndPipe) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   ...
   OP(L'|', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', LSHIFT(Key_RightBracket)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', LSHIFT(Key_NonUsPound)) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'§', RALT(Key_5)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_3)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_9)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_NonUsPound)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', LSHIFT(Key_Backtick)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   ...
   OP(L'´', RALT(Key_L)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'µ', RALT(LSHIFT(Key_Y))) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(Key_7)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_9))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'¹', RALT(LSHIFT(Key_1))) /* U+00b9, XKB_KEY_onesuperior, SUPERSCRIPT ONE */ \
   OP(L'º', RALT(Key_0)) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'»', RALT(LSHIFT(Key_NonUsPound))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¼', RALT(LSHIFT(Key_J))) /* U+00bc, XKB_KEY_onequarter, VULGAR FRACTION ONE QUARTER */ \
   OP(L'½', RALT(LSHIFT(Key_K))) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(LSHIFT(Key_L))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   OP(L'¿', RALT(LSHIFT(Key_Slash))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'Á', RALT(LSHIFT(Key_A))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Æ', RALT(LSHIFT(Key_Quote))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   OP(L'É', RALT(LSHIFT(Key_E))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Í', RALT(LSHIFT(Key_I))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Ó', RALT(LSHIFT(Key_O))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'×', RALT(Key_X)) /* U+00d7, XKB_KEY_multiply, MULTIPLICATION SIGN */ \
   OP(L'Ú', RALT(LSHIFT(Key_U))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'ß', RALT(LSHIFT(Key_Backtick))) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   OP(L'á', RALT(Key_A)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'æ', RALT(Key_Quote)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'é', RALT(Key_E)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'í', RALT(Key_I)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'ó', RALT(Key_O)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'÷', RALT(Key_Slash)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ú', RALT(Key_U)) /* U+00fa, XKB_KEY_uacute, LATIN SMALL LETTER U WITH ACUTE */ \
   OP(L'Ċ', RALT(LSHIFT(Key_C))) /* U+010a, XKB_KEY_Cabovedot, LATIN CAPITAL LETTER C WITH DOT ABOVE */ \
   OP(L'ċ', RALT(Key_C)) /* U+010b, XKB_KEY_cabovedot, LATIN SMALL LETTER C WITH DOT ABOVE */ \
   OP(L'Ġ', RALT(LSHIFT(Key_G))) /* U+0120, XKB_KEY_Gabovedot, LATIN CAPITAL LETTER G WITH DOT ABOVE */ \
   OP(L'ġ', RALT(Key_G)) /* U+0121, XKB_KEY_gabovedot, LATIN SMALL LETTER G WITH DOT ABOVE */ \
   OP(L'ı', RALT(Key_J)) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   OP(L'Œ', RALT(LSHIFT(Key_Q))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_Q)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   OP(L'ſ', RALT(Key_Z)) \
   OP(L'ɼ', RALT(Key_R)) \
   OP(L'Ḃ', RALT(LSHIFT(Key_B))) /* U+1e02, XKB_KEY_Babovedot, LATIN CAPITAL LETTER B WITH DOT ABOVE */ \
   OP(L'ḃ', RALT(Key_B)) /* U+1e03, XKB_KEY_babovedot, LATIN SMALL LETTER B WITH DOT ABOVE */ \
   OP(L'Ḋ', RALT(LSHIFT(Key_D))) /* U+1e0a, XKB_KEY_Dabovedot, LATIN CAPITAL LETTER D WITH DOT ABOVE */ \
   OP(L'ḋ', RALT(Key_D)) /* U+1e0b, XKB_KEY_dabovedot, LATIN SMALL LETTER D WITH DOT ABOVE */ \
   OP(L'Ḟ', RALT(LSHIFT(Key_F))) /* U+1e1e, XKB_KEY_Fabovedot, LATIN CAPITAL LETTER F WITH DOT ABOVE */ \
   OP(L'ḟ', RALT(Key_F)) /* U+1e1f, XKB_KEY_fabovedot, LATIN SMALL LETTER F WITH DOT ABOVE */ \
   OP(L'Ṁ', RALT(LSHIFT(Key_M))) /* U+1e40, XKB_KEY_Mabovedot, LATIN CAPITAL LETTER M WITH DOT ABOVE */ \
   OP(L'ṁ', RALT(Key_M)) /* U+1e41, XKB_KEY_mabovedot, LATIN SMALL LETTER M WITH DOT ABOVE */ \
   OP(L'Ṗ', RALT(LSHIFT(Key_P))) /* U+1e56, XKB_KEY_Pabovedot, LATIN CAPITAL LETTER P WITH DOT ABOVE */ \
   OP(L'ṗ', RALT(Key_P)) /* U+1e57, XKB_KEY_pabovedot, LATIN SMALL LETTER P WITH DOT ABOVE */ \
   OP(L'Ṡ', RALT(LSHIFT(Key_S))) /* U+1e60, XKB_KEY_Sabovedot, LATIN CAPITAL LETTER S WITH DOT ABOVE */ \
   OP(L'ṡ', RALT(Key_S)) /* U+1e61, XKB_KEY_sabovedot, LATIN SMALL LETTER S WITH DOT ABOVE */ \
   OP(L'Ṫ', RALT(LSHIFT(Key_T))) /* U+1e6a, XKB_KEY_Tabovedot, LATIN CAPITAL LETTER T WITH DOT ABOVE */ \
   OP(L'ṫ', RALT(Key_T)) /* U+1e6b, XKB_KEY_tabovedot, LATIN SMALL LETTER T WITH DOT ABOVE */ \
   OP(L'ẛ', RALT(LSHIFT(Key_Z))) \
   OP(L'–', RALT(Key_Minus)) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(LSHIFT(Key_Minus))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'‘', RALT(Key_RightBracket)) /* U+2018, XKB_KEY_leftsinglequotemark, LEFT SINGLE QUOTATION MARK */ \
   OP(L'’', RALT(LSHIFT(Key_RightBracket))) /* U+2019, XKB_KEY_rightsinglequotemark, RIGHT SINGLE QUOTATION MARK */ \
   OP(L'‚', RALT(LSHIFT(Key_Period))) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   OP(L'“', RALT(Key_LeftBracket)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_LeftBracket))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'„', RALT(LSHIFT(Key_Comma))) /* U+201e, XKB_KEY_doublelowquotemark, DOUBLE LOW-9 QUOTATION MARK */ \
   OP(L'†', RALT(LSHIFT(Key_5))) /* U+2020, XKB_KEY_dagger, DAGGER */ \
   OP(L'‡', RALT(LSHIFT(Key_Semicolon))) /* U+2021, XKB_KEY_doubledagger, DOUBLE DAGGER */ \
   ...
   OP(L'™', RALT(Key_2)) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'∼', RALT(LSHIFT(Key_X))) /* U+223c, XKB_KEY_approximate, TILDE OPERATOR */ \
   OP(L'≠', RALT(Key_Equals)) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
   OP(L'≤', RALT(Key_Comma)) /* U+2264, XKB_KEY_lessthanequal, LESS-THAN OR EQUAL TO */ \
   OP(L'≥', RALT(Key_Period)) /* U+2265, XKB_KEY_greaterthanequal, GREATER-THAN OR EQUAL TO */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cabovedot, RALT(LSHIFT(Key_C))) \
   ...
   OP(XKB_KEY_Dabovedot, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Fabovedot, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_G, LSHIFT(Key_G)) \
   OP(XKB_KEY_Gabovedot, RALT(LSHIFT(Key_G))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_I))) \
   ...
   OP(XKB_KEY_Mabovedot, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_Menu, Key_PcApplication) /* XKB_KEY_Menu */ \
   OP(XKB_KEY_Meta_L, LSHIFT(Key_LeftAlt)) /* XKB_KEY_Meta_L, Left meta  */ \
   OP(XKB_KEY_Multi_key, Key_RightGui) /* XKB_KEY_Multi_key, Multi-key character compose  */ \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_P, LSHIFT(Key_P)) \
   OP(XKB_KEY_Pabovedot, RALT(LSHIFT(Key_P))) \
   ...
   OP(XKB_KEY_Sabovedot, RALT(LSHIFT(Key_S))) \
   ...
   OP(XKB_KEY_Tabovedot, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_acute, RALT(Key_L)) \
   OP(XKB_KEY_ae, RALT(Key_Quote)) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_7)) \
   OP(XKB_KEY_apostrophe, Key_Quote) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_approximate, RALT(LSHIFT(Key_X))) \
   OP(XKB_KEY_asciicircum, LSHIFT(Key_6)) \
   OP(XKB_KEY_asciitilde, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_8)) \
   OP(XKB_KEY_at, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_babovedot, RALT(Key_B)) \
   OP(XKB_KEY_backslash, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_bar, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cabovedot, RALT(Key_C)) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_colon, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_3)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dabovedot, RALT(Key_D)) \
   OP(XKB_KEY_dagger, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_W)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, RALT(Key_K)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_caron, RALT(Key_V)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* XKB_KEY_dead_cedilla */ \
   OP(XKB_KEY_dead_circumflex, RALT(Key_6)) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, RALT(Key_8)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_grave, RALT(Key_NonUsBackslashAndPipe)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_N)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_degree, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_division, RALT(Key_Slash)) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_doubledagger, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_doublelowquotemark, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, RALT(Key_E)) \
   OP(XKB_KEY_ellipsis, RALT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_fabovedot, RALT(Key_F)) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_gabovedot, RALT(Key_G)) \
   OP(XKB_KEY_grave, Key_Backtick) /* XKB_KEY_quoteleft, deprecated  */ \
   OP(XKB_KEY_greater, LSHIFT(Key_Period)) \
   OP(XKB_KEY_greaterthanequal, RALT(Key_Period)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_iacute, RALT(Key_I)) \
   OP(XKB_KEY_idotless, RALT(Key_J)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_leftsinglequotemark, RALT(Key_RightBracket)) \
   OP(XKB_KEY_less, LSHIFT(Key_Comma)) \
   OP(XKB_KEY_lessthanequal, RALT(Key_Comma)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_mabovedot, RALT(Key_M)) \
   OP(XKB_KEY_masculine, RALT(Key_0)) \
   OP(XKB_KEY_minus, Key_Minus) \
   OP(XKB_KEY_mu, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_multiply, RALT(Key_X)) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_notequal, RALT(Key_Equals)) \
   OP(XKB_KEY_notsign, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_numbersign, Key_NonUsPound) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_oacute, RALT(Key_O)) \
   OP(XKB_KEY_oe, RALT(Key_Q)) \
   OP(XKB_KEY_onehalf, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_onequarter, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_onesuperior, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_ordfeminine, RALT(Key_9)) \
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_pabovedot, RALT(Key_P)) \
   OP(XKB_KEY_paragraph, RALT(Key_7)) \
   ...
   OP(XKB_KEY_periodcentered, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_plus, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_plusminus, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_q, Key_Q) \
   OP(XKB_KEY_question, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_questiondown, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_quotedbl, LSHIFT(Key_2)) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_rightdoublequotemark, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_rightsinglequotemark, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_sabovedot, RALT(Key_S)) \
   OP(XKB_KEY_section, RALT(Key_5)) \
   OP(XKB_KEY_semicolon, Key_Semicolon) \
   OP(XKB_KEY_singlelowquotemark, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_slash, Key_Slash) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_ssharp, RALT(LSHIFT(Key_Backtick))) \
   OP(XKB_KEY_sterling, LSHIFT(Key_3)) \
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_tabovedot, RALT(Key_T)) \
   OP(XKB_KEY_threequarters, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_threesuperior, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_trademark, RALT(Key_2)) \
   OP(XKB_KEY_twosuperior, RALT(LSHIFT(Key_2))) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uacute, RALT(Key_U)) \
