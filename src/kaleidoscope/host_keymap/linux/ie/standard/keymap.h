...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¨', RALT(Key_B)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'¯', RALT(Key_M)) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'¸', RALT(LSHIFT(Key_C))) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'‚', RALT(Key_P)) /* U+201a, XKB_KEY_singlelowquotemark, SINGLE LOW-9 QUOTATION MARK */ \
   ...
   OP(L'⟨', RALT(Key_Z)) /* U+27e8, XKB_KEY_leftanglebracket, MATHEMATICAL LEFT ANGLE BRACKET */ \
   OP(L'⟩', RALT(LSHIFT(Key_Z))) /* U+27e9, XKB_KEY_rightanglebracket, MATHEMATICAL RIGHT ANGLE BRACKET */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cedilla, RALT(LSHIFT(Key_C))) \
   ...
   OP(XKB_KEY_dead_acute, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_caron, RALT(Key_V)) /* XKB_KEY_dead_caron */ \
   OP(XKB_KEY_dead_cedilla, RALT(Key_C)) /* XKB_KEY_dead_cedilla */ \
   ...
   OP(XKB_KEY_diaeresis, RALT(Key_B)) \
   ...
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftanglebracket, RALT(Key_Z)) \
   ...
   OP(XKB_KEY_rightanglebracket, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_singlelowquotemark, RALT(Key_P)) \
