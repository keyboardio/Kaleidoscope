...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ј', LSHIFT(Key_Q)) /* U+0408, XKB_KEY_Cyrillic_JE, CYRILLIC CAPITAL LETTER JE */ \
   ...
   OP(L'ј', Key_Q) /* U+0458, XKB_KEY_Cyrillic_je, CYRILLIC SMALL LETTER JE */ \
   OP(L'Ғ', LSHIFT(Key_M)) /* U+0492, XKB_KEY_Cyrillic_GHE_bar, CYRILLIC CAPITAL LETTER GHE WITH STROKE */ \
   OP(L'ғ', Key_M) /* U+0493, XKB_KEY_Cyrillic_ghe_bar, CYRILLIC SMALL LETTER GHE WITH STROKE */ \
   OP(L'Ҝ', LSHIFT(Key_Quote)) /* U+049c, XKB_KEY_Cyrillic_KA_vertstroke, CYRILLIC CAPITAL LETTER KA WITH VERTICAL STROKE */ \
   OP(L'ҝ', Key_Quote) /* U+049d, XKB_KEY_Cyrillic_ka_vertstroke, CYRILLIC SMALL LETTER KA WITH VERTICAL STROKE */ \
   ...
   OP(L'Ҹ', LSHIFT(Key_RightBracket)) /* U+04b8, XKB_KEY_Cyrillic_CHE_vertstroke, CYRILLIC CAPITAL LETTER CHE WITH VERTICAL STROKE */ \
   OP(L'ҹ', Key_RightBracket) /* U+04b9, XKB_KEY_Cyrillic_che_vertstroke, CYRILLIC SMALL LETTER CHE WITH VERTICAL STROKE */ \
   OP(L'Һ', LSHIFT(Key_O)) /* U+04ba, XKB_KEY_Cyrillic_SHHA, CYRILLIC CAPITAL LETTER SHHA */ \
   OP(L'һ', Key_O) /* U+04bb, XKB_KEY_Cyrillic_shha, CYRILLIC SMALL LETTER SHHA */ \
   OP(L'Ә', LSHIFT(Key_Z)) /* U+04d8, XKB_KEY_Cyrillic_SCHWA, CYRILLIC CAPITAL LETTER SCHWA */ \
   OP(L'ә', Key_Z) /* U+04d9, XKB_KEY_Cyrillic_schwa, CYRILLIC SMALL LETTER SCHWA */ \
   OP(L'Ө', LSHIFT(Key_Period)) /* U+04e8, XKB_KEY_Cyrillic_O_bar, CYRILLIC CAPITAL LETTER BARRED O */ \
   OP(L'ө', Key_Period) /* U+04e9, XKB_KEY_Cyrillic_o_bar, CYRILLIC SMALL LETTER BARRED O */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cyrillic_CHE_vertstroke, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Cyrillic_GHE_bar, LSHIFT(Key_M)) \
   OP(XKB_KEY_Cyrillic_HA, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_Cyrillic_I, LSHIFT(Key_B)) \
   OP(XKB_KEY_Cyrillic_IE, LSHIFT(Key_T)) \
   OP(XKB_KEY_Cyrillic_JE, LSHIFT(Key_Q)) /* XKB_KEY_Serbian_JE, deprecated  */ \
   OP(XKB_KEY_Cyrillic_KA, LSHIFT(Key_R)) \
   OP(XKB_KEY_Cyrillic_KA_vertstroke, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Cyrillic_O, LSHIFT(Key_J)) \
   OP(XKB_KEY_Cyrillic_O_bar, LSHIFT(Key_Period)) \
   OP(XKB_KEY_Cyrillic_PE, LSHIFT(Key_G)) \
   OP(XKB_KEY_Cyrillic_SCHWA, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Cyrillic_SHA, LSHIFT(Key_I)) \
   OP(XKB_KEY_Cyrillic_SHHA, LSHIFT(Key_O)) \
   ...
   OP(XKB_KEY_Cyrillic_che_vertstroke, Key_RightBracket) \
   ...
   OP(XKB_KEY_Cyrillic_ghe_bar, Key_M) \
   OP(XKB_KEY_Cyrillic_ha, Key_LeftBracket) \
   OP(XKB_KEY_Cyrillic_i, Key_B) \
   OP(XKB_KEY_Cyrillic_ie, Key_T) \
   OP(XKB_KEY_Cyrillic_je, Key_Q) /* XKB_KEY_Serbian_je, deprecated  */ \
   OP(XKB_KEY_Cyrillic_ka, Key_R) \
   OP(XKB_KEY_Cyrillic_ka_vertstroke, Key_Quote) \
   OP(XKB_KEY_Cyrillic_o, Key_J) \
   OP(XKB_KEY_Cyrillic_o_bar, Key_Period) \
   OP(XKB_KEY_Cyrillic_pe, Key_G) \
   OP(XKB_KEY_Cyrillic_schwa, Key_Z) \
   OP(XKB_KEY_Cyrillic_sha, Key_I) \
   OP(XKB_KEY_Cyrillic_shha, Key_O) \
