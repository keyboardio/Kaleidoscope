...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ç', LSHIFT(Key_Comma)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Ö', LSHIFT(Key_LeftBracket)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ü', LSHIFT(Key_W)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'ç', Key_Comma) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ö', Key_LeftBracket) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_W) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Ğ', LSHIFT(Key_RightBracket)) /* U+011e, XKB_KEY_Gbreve, LATIN CAPITAL LETTER G WITH BREVE */ \
   OP(L'ğ', Key_RightBracket) /* U+011f, XKB_KEY_gbreve, LATIN SMALL LETTER G WITH BREVE */ \
   OP(L'İ', LSHIFT(Key_I)) /* U+0130, XKB_KEY_Iabovedot, LATIN CAPITAL LETTER I WITH DOT ABOVE */ \
   OP(L'ı', Key_Semicolon) /* U+0131, XKB_KEY_idotless, LATIN SMALL LETTER DOTLESS I */ \
   OP(L'Ş', LSHIFT(Key_Period)) /* U+015e, XKB_KEY_Scedilla, LATIN CAPITAL LETTER S WITH CEDILLA */ \
   OP(L'ş', Key_Period) /* U+015f, XKB_KEY_scedilla, LATIN SMALL LETTER S WITH CEDILLA */ \
   OP(L'Ə', LSHIFT(Key_Quote)) /* U+018f, XKB_KEY_SCHWA, LATIN CAPITAL LETTER SCHWA */ \
   OP(L'ə', Key_Quote) /* U+0259, XKB_KEY_schwa, LATIN SMALL LETTER SCHWA */ \
   OP(L'Ⅶ', LSHIFT(Key_3)) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Gbreve, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_SCHWA, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_Scedilla, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_W)) \
