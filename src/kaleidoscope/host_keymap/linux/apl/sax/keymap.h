...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¢', LSHIFT(Key_4)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'¨', Key_1) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   OP(L'¯', Key_2) /* U+00af, XKB_KEY_macron, MACRON */ \
   OP(L'¿', LSHIFT(Key_Q)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_questiondown, LSHIFT(Key_Q)) \
