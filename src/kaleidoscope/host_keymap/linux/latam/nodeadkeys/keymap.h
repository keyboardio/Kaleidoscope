...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('`', Key_LeftBracket) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'`', Key_LeftBracket) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'¡', LSHIFT(Key_Equals)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   ...
   OP(L'¨', LSHIFT(Key_Quote)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'´', Key_Quote) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(Key_R)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(Key_3)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   ...
   OP(L'¿', Key_Equals) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   ...
   OP(L'Ñ', LSHIFT(Key_Semicolon)) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   ...
   OP(L'ñ', Key_Semicolon) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ntilde, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_diaeresis, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_exclamdown, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_fiveeighths, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, Key_LeftBracket) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_ntilde, Key_Semicolon) \
