...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('{', Key_Quote) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', Key_Backtick) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', Key_NonUsPound) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'{', Key_Quote) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', Key_Backtick) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', Key_NonUsPound) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_braceleft, Key_Quote) \
   OP(XKB_KEY_braceright, Key_NonUsPound) \
