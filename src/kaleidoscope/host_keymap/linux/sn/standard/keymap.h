...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¤', RALT(Key_RightBracket)) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   ...
   OP(L'¾', RALT(LSHIFT(Key_Equals))) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   ...
   OP(L'Ñ', LSHIFT(Key_Quote)) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   ...
   OP(L'ê', RALT(LSHIFT(Key_RightBracket))) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ð', RALT(Key_D)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ñ', Key_Quote) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   ...
   OP(L'Ŋ', LSHIFT(Key_LeftBracket)) /* U+014a, XKB_KEY_ENG, LATIN CAPITAL LETTER ENG */ \
   OP(L'ŋ', Key_LeftBracket) /* U+014b, XKB_KEY_eng, LATIN SMALL LETTER ENG */ \
   ...
   OP(L'Ω', RALT(LSHIFT(Key_A))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_ENG, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Greek_OMEGA, RALT(LSHIFT(Key_A))) \
   ...
   OP(XKB_KEY_Ntilde, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_currency, RALT(Key_RightBracket)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(LSHIFT(Key_Slash))) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_acute, RALT(LSHIFT(Key_Quote))) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_ecircumflex, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_egrave, Key_7) \
   OP(XKB_KEY_eng, Key_LeftBracket) \
   ...
   OP(XKB_KEY_threequarters, RALT(LSHIFT(Key_Equals))) \
