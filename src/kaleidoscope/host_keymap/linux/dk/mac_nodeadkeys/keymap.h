...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¬', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'­', RALT(Key_Slash)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'¯', RALT(LSHIFT(Key_Slash))) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'½', Key_Backtick) /* U+00bd, XKB_KEY_onehalf, VULGAR FRACTION ONE HALF */ \
   OP(L'¾', RALT(Key_Backtick)) /* U+00be, XKB_KEY_threequarters, VULGAR FRACTION THREE QUARTERS */ \
   ...
   OP(L'Ø', LSHIFT(Key_Quote)) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   ...
   OP(L'ø', Key_Quote) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Oslash, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(LSHIFT(Key_Slash))) \
   ...
   OP(XKB_KEY_threequarters, RALT(Key_Backtick)) \
