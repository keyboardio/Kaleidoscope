...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('\'', Key_LeftBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP('<', Key_NonUsPound) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', LSHIFT(Key_NonUsPound)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP('~', Key_RightBracket) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'\'', Key_LeftBracket) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   ...
   OP(L'<', Key_NonUsPound) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', LSHIFT(Key_0)) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', LSHIFT(Key_NonUsPound)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   ...
   OP(L'~', Key_RightBracket) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   ...
   OP(L'¢', RALT(LSHIFT(Key_D))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'¨', RALT(LSHIFT(Key_Quote))) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   OP(L'©', RALT(LSHIFT(Key_I))) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_Y)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   ...
   OP(L'´', RALT(LSHIFT(Key_LeftBracket))) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(LSHIFT(Key_Backtick))) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(Key_E)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'¸', RALT(LSHIFT(Key_W))) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'Æ', LSHIFT(Key_Z)) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   ...
   OP(L'Ø', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   ...
   OP(L'æ', Key_Z) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   OP(L'ç', RALT(Key_I)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ð', RALT(Key_H)) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'÷', RALT(LSHIFT(Key_7))) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', Key_NonUsBackslashAndPipe) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Oslash, LSHIFT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_ae, Key_Z) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_6)) \
   OP(XKB_KEY_apostrophe, Key_LeftBracket) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_aring, Key_Q) \
   OP(XKB_KEY_asciicircum, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_asciitilde, Key_RightBracket) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_ccedilla, RALT(Key_I)) \
   OP(XKB_KEY_cedilla, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_dead_diaeresis, RALT(Key_RightBracket)) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_dead_grave, RALT(LSHIFT(Key_Equals))) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_tilde, RALT(LSHIFT(Key_RightBracket))) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_diaeresis, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_k, Key_V) \
   OP(XKB_KEY_l, Key_P) \
   OP(XKB_KEY_less, Key_NonUsPound) \
   OP(XKB_KEY_m, Key_M) \
   ...
   OP(XKB_KEY_ordfeminine, RALT(Key_Y)) \
   OP(XKB_KEY_oslash, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_p, Key_R) \
   ...
   OP(XKB_KEY_periodcentered, RALT(Key_E)) \
