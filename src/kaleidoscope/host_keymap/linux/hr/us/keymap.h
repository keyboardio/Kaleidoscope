...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ć', RALT(LSHIFT(Key_Quote))) /* U+0106, XKB_KEY_Cacute, LATIN CAPITAL LETTER C WITH ACUTE */ \
   OP(L'ć', RALT(Key_Quote)) /* U+0107, XKB_KEY_cacute, LATIN SMALL LETTER C WITH ACUTE */ \
   OP(L'Č', RALT(LSHIFT(Key_Semicolon))) /* U+010c, XKB_KEY_Ccaron, LATIN CAPITAL LETTER C WITH CARON */ \
   OP(L'č', RALT(Key_Semicolon)) /* U+010d, XKB_KEY_ccaron, LATIN SMALL LETTER C WITH CARON */ \
   OP(L'Đ', RALT(LSHIFT(Key_RightBracket))) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', RALT(Key_RightBracket)) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   ...
   OP(L'Š', RALT(LSHIFT(Key_LeftBracket))) /* U+0160, XKB_KEY_Scaron, LATIN CAPITAL LETTER S WITH CARON */ \
   OP(L'š', RALT(Key_LeftBracket)) /* U+0161, XKB_KEY_scaron, LATIN SMALL LETTER S WITH CARON */ \
   OP(L'Ž', RALT(LSHIFT(Key_NonUsPound))) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', RALT(Key_NonUsPound)) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Cacute, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_Caps_Lock, Key_CapsLock) /* XKB_KEY_Caps_Lock, Caps lock  */ \
   OP(XKB_KEY_Ccaron, RALT(LSHIFT(Key_Semicolon))) \
   ...
   OP(XKB_KEY_Dstroke, RALT(LSHIFT(Key_RightBracket))) \
   ...
   OP(XKB_KEY_Scaron, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_Zcaron, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_cacute, RALT(Key_Quote)) \
   OP(XKB_KEY_ccaron, RALT(Key_Semicolon)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dollar, LSHIFT(Key_4)) \
   OP(XKB_KEY_dstroke, RALT(Key_RightBracket)) \
   OP(XKB_KEY_e, Key_E) \
   ...
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_scaron, RALT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_z, Key_Z) \
   OP(XKB_KEY_zcaron, RALT(Key_NonUsPound)) \
