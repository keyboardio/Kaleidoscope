...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_T)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', Key_0) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('#', LSHIFT(Key_NonUsPound)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP('%', LSHIFT(Key_Equals)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP('&', LSHIFT(Key_RightBracket)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP('\'', Key_W) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP('(', Key_7) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   ...
   OP(',', Key_C) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP('-', Key_3) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP('.', Key_T) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(':', Key_Q) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(';', Key_Z) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP('@', LSHIFT(Key_C)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   OP('A', LSHIFT(Key_S)) /* U+0041, XKB_KEY_A, LATIN CAPITAL LETTER A */ \
   OP('B', LSHIFT(Key_G)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP('C', LSHIFT(Key_I)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP('D', LSHIFT(Key_Semicolon)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP('E', LSHIFT(Key_F)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP('F', LSHIFT(Key_H)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP('G', LSHIFT(Key_R)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP('H', LSHIFT(Key_Y)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP('I', LSHIFT(Key_V)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP('J', LSHIFT(Key_Slash)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP('K', LSHIFT(Key_P)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP('L', LSHIFT(Key_Comma)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP('M', LSHIFT(Key_O)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP('N', LSHIFT(Key_L)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP('O', LSHIFT(Key_A)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP('P', LSHIFT(Key_Period)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP('Q', LSHIFT(Key_X)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP('R', LSHIFT(Key_M)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP('S', LSHIFT(Key_J)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP('T', LSHIFT(Key_K)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP('U', LSHIFT(Key_D)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP('V', LSHIFT(Key_U)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP('W', LSHIFT(Key_Quote)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP('X', LSHIFT(Key_N)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP('Y', LSHIFT(Key_B)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP('\\', Key_5) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', Key_Equals) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('_', Key_Backtick) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('a', Key_S) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP('b', Key_G) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP('c', Key_I) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP('d', Key_Semicolon) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP('e', Key_F) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP('f', Key_H) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP('g', Key_R) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP('h', Key_Y) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP('i', Key_V) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP('j', Key_Slash) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP('k', Key_P) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP('l', Key_Comma) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP('m', Key_O) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP('n', Key_L) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP('o', Key_A) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP('p', Key_Period) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP('q', Key_X) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP('r', Key_M) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP('s', Key_J) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP('t', Key_K) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP('u', Key_D) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP('v', Key_U) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP('w', Key_Quote) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP('x', Key_N) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP('y', Key_B) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP('z', Key_LeftBracket) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP('|', LSHIFT(Key_Z)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('~', Key_NonUsPound) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_T)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', Key_0) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'#', LSHIFT(Key_NonUsPound)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP(L'%', LSHIFT(Key_Equals)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   OP(L'&', LSHIFT(Key_RightBracket)) /* U+0026, XKB_KEY_ampersand, AMPERSAND */ \
   OP(L'\'', Key_W) /* U+0027, XKB_KEY_apostrophe, APOSTROPHE */ \
   OP(L'(', Key_7) /* U+0028, XKB_KEY_parenleft, LEFT PARENTHESIS */ \
   ...
   OP(L',', Key_C) /* U+002c, XKB_KEY_comma, COMMA */ \
   OP(L'-', Key_3) /* U+002d, XKB_KEY_minus, HYPHEN-MINUS */ \
   OP(L'.', Key_T) /* U+002e, XKB_KEY_period, FULL STOP */ \
   ...
   OP(L':', Key_Q) /* U+003a, XKB_KEY_colon, COLON */ \
   OP(L';', Key_Z) /* U+003b, XKB_KEY_semicolon, SEMICOLON */ \
   ...
   OP(L'@', LSHIFT(Key_C)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   OP(L'A', LSHIFT(Key_S)) /* U+0041, XKB_KEY_A, LATIN CAPITAL LETTER A */ \
   OP(L'B', LSHIFT(Key_G)) /* U+0042, XKB_KEY_B, LATIN CAPITAL LETTER B */ \
   OP(L'C', LSHIFT(Key_I)) /* U+0043, XKB_KEY_C, LATIN CAPITAL LETTER C */ \
   OP(L'D', LSHIFT(Key_Semicolon)) /* U+0044, XKB_KEY_D, LATIN CAPITAL LETTER D */ \
   OP(L'E', LSHIFT(Key_F)) /* U+0045, XKB_KEY_E, LATIN CAPITAL LETTER E */ \
   OP(L'F', LSHIFT(Key_H)) /* U+0046, XKB_KEY_F, LATIN CAPITAL LETTER F */ \
   OP(L'G', LSHIFT(Key_R)) /* U+0047, XKB_KEY_G, LATIN CAPITAL LETTER G */ \
   OP(L'H', LSHIFT(Key_Y)) /* U+0048, XKB_KEY_H, LATIN CAPITAL LETTER H */ \
   OP(L'I', LSHIFT(Key_V)) /* U+0049, XKB_KEY_I, LATIN CAPITAL LETTER I */ \
   OP(L'J', LSHIFT(Key_Slash)) /* U+004a, XKB_KEY_J, LATIN CAPITAL LETTER J */ \
   OP(L'K', LSHIFT(Key_P)) /* U+004b, XKB_KEY_K, LATIN CAPITAL LETTER K */ \
   OP(L'L', LSHIFT(Key_Comma)) /* U+004c, XKB_KEY_L, LATIN CAPITAL LETTER L */ \
   OP(L'M', LSHIFT(Key_O)) /* U+004d, XKB_KEY_M, LATIN CAPITAL LETTER M */ \
   OP(L'N', LSHIFT(Key_L)) /* U+004e, XKB_KEY_N, LATIN CAPITAL LETTER N */ \
   OP(L'O', LSHIFT(Key_A)) /* U+004f, XKB_KEY_O, LATIN CAPITAL LETTER O */ \
   OP(L'P', LSHIFT(Key_Period)) /* U+0050, XKB_KEY_P, LATIN CAPITAL LETTER P */ \
   OP(L'Q', LSHIFT(Key_X)) /* U+0051, XKB_KEY_Q, LATIN CAPITAL LETTER Q */ \
   OP(L'R', LSHIFT(Key_M)) /* U+0052, XKB_KEY_R, LATIN CAPITAL LETTER R */ \
   OP(L'S', LSHIFT(Key_J)) /* U+0053, XKB_KEY_S, LATIN CAPITAL LETTER S */ \
   OP(L'T', LSHIFT(Key_K)) /* U+0054, XKB_KEY_T, LATIN CAPITAL LETTER T */ \
   OP(L'U', LSHIFT(Key_D)) /* U+0055, XKB_KEY_U, LATIN CAPITAL LETTER U */ \
   OP(L'V', LSHIFT(Key_U)) /* U+0056, XKB_KEY_V, LATIN CAPITAL LETTER V */ \
   OP(L'W', LSHIFT(Key_Quote)) /* U+0057, XKB_KEY_W, LATIN CAPITAL LETTER W */ \
   OP(L'X', LSHIFT(Key_N)) /* U+0058, XKB_KEY_X, LATIN CAPITAL LETTER X */ \
   OP(L'Y', LSHIFT(Key_B)) /* U+0059, XKB_KEY_Y, LATIN CAPITAL LETTER Y */ \
   ...
   OP(L'\\', Key_5) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', Key_Equals) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'_', Key_Backtick) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'a', Key_S) /* U+0061, XKB_KEY_a, LATIN SMALL LETTER A */ \
   OP(L'b', Key_G) /* U+0062, XKB_KEY_b, LATIN SMALL LETTER B */ \
   OP(L'c', Key_I) /* U+0063, XKB_KEY_c, LATIN SMALL LETTER C */ \
   OP(L'd', Key_Semicolon) /* U+0064, XKB_KEY_d, LATIN SMALL LETTER D */ \
   OP(L'e', Key_F) /* U+0065, XKB_KEY_e, LATIN SMALL LETTER E */ \
   OP(L'f', Key_H) /* U+0066, XKB_KEY_f, LATIN SMALL LETTER F */ \
   OP(L'g', Key_R) /* U+0067, XKB_KEY_g, LATIN SMALL LETTER G */ \
   OP(L'h', Key_Y) /* U+0068, XKB_KEY_h, LATIN SMALL LETTER H */ \
   OP(L'i', Key_V) /* U+0069, XKB_KEY_i, LATIN SMALL LETTER I */ \
   OP(L'j', Key_Slash) /* U+006a, XKB_KEY_j, LATIN SMALL LETTER J */ \
   OP(L'k', Key_P) /* U+006b, XKB_KEY_k, LATIN SMALL LETTER K */ \
   OP(L'l', Key_Comma) /* U+006c, XKB_KEY_l, LATIN SMALL LETTER L */ \
   OP(L'm', Key_O) /* U+006d, XKB_KEY_m, LATIN SMALL LETTER M */ \
   OP(L'n', Key_L) /* U+006e, XKB_KEY_n, LATIN SMALL LETTER N */ \
   OP(L'o', Key_A) /* U+006f, XKB_KEY_o, LATIN SMALL LETTER O */ \
   OP(L'p', Key_Period) /* U+0070, XKB_KEY_p, LATIN SMALL LETTER P */ \
   OP(L'q', Key_X) /* U+0071, XKB_KEY_q, LATIN SMALL LETTER Q */ \
   OP(L'r', Key_M) /* U+0072, XKB_KEY_r, LATIN SMALL LETTER R */ \
   OP(L's', Key_J) /* U+0073, XKB_KEY_s, LATIN SMALL LETTER S */ \
   OP(L't', Key_K) /* U+0074, XKB_KEY_t, LATIN SMALL LETTER T */ \
   OP(L'u', Key_D) /* U+0075, XKB_KEY_u, LATIN SMALL LETTER U */ \
   OP(L'v', Key_U) /* U+0076, XKB_KEY_v, LATIN SMALL LETTER V */ \
   OP(L'w', Key_Quote) /* U+0077, XKB_KEY_w, LATIN SMALL LETTER W */ \
   OP(L'x', Key_N) /* U+0078, XKB_KEY_x, LATIN SMALL LETTER X */ \
   OP(L'y', Key_B) /* U+0079, XKB_KEY_y, LATIN SMALL LETTER Y */ \
   OP(L'z', Key_LeftBracket) /* U+007a, XKB_KEY_z, LATIN SMALL LETTER Z */ \
   OP(L'|', LSHIFT(Key_Z)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'~', Key_NonUsPound) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L'à', Key_NonUsBackslashAndPipe) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   OP(L'ç', LSHIFT(Key_NonUsBackslashAndPipe)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', Key_4) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_D, LSHIFT(Key_Semicolon)) \
   ...
   OP(XKB_KEY_G, LSHIFT(Key_R)) \
   OP(XKB_KEY_H, LSHIFT(Key_Y)) \
   OP(XKB_KEY_Home, Key_Home) /* XKB_KEY_Home */ \
   OP(XKB_KEY_I, LSHIFT(Key_V)) \
   OP(XKB_KEY_ISO_Left_Tab, LSHIFT(Key_Tab)) /* XKB_KEY_ISO_Left_Tab */ \
   OP(XKB_KEY_ISO_Level3_Latch, Key_8) /* XKB_KEY_ISO_Level3_Latch */ \
   OP(XKB_KEY_Insert, Key_Insert) /* XKB_KEY_Insert, Insert, insert here  */ \
   OP(XKB_KEY_J, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_K, LSHIFT(Key_P)) \
   ...
   OP(XKB_KEY_O, LSHIFT(Key_A)) \
   OP(XKB_KEY_P, LSHIFT(Key_Period)) \
   ...
   OP(XKB_KEY_U, LSHIFT(Key_D)) \
   OP(XKB_KEY_Up, Key_UpArrow) /* XKB_KEY_Up, Move up, up arrow  */ \
   OP(XKB_KEY_V, LSHIFT(Key_U)) \
   OP(XKB_KEY_W, LSHIFT(Key_Quote)) \
   OP(XKB_KEY_X, LSHIFT(Key_N)) \
   ...
   OP(XKB_KEY_Y, LSHIFT(Key_B)) \
   OP(XKB_KEY_Z, LSHIFT(Key_LeftBracket)) \
   OP(XKB_KEY_a, Key_S) \
   OP(XKB_KEY_agrave, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_ampersand, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_apostrophe, Key_W) /* XKB_KEY_quoteright, deprecated  */ \
   OP(XKB_KEY_asciitilde, Key_NonUsPound) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_at, LSHIFT(Key_C)) \
   OP(XKB_KEY_b, Key_G) \
   OP(XKB_KEY_backslash, Key_5) \
   OP(XKB_KEY_bar, LSHIFT(Key_Z)) \
   OP(XKB_KEY_bracketleft, Key_Minus) \
   OP(XKB_KEY_bracketright, Key_Equals) \
   OP(XKB_KEY_c, Key_I) \
   OP(XKB_KEY_ccedilla, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_colon, Key_Q) \
   OP(XKB_KEY_comma, Key_C) \
   OP(XKB_KEY_d, Key_Semicolon) \
   OP(XKB_KEY_dead_circumflex, Key_6) /* XKB_KEY_dead_circumflex */ \
   OP(XKB_KEY_dead_diaeresis, Key_RightBracket) /* XKB_KEY_dead_diaeresis */ \
   OP(XKB_KEY_e, Key_F) \
   OP(XKB_KEY_eacute, Key_E) \
   OP(XKB_KEY_egrave, Key_4) \
   OP(XKB_KEY_equal, Key_1) \
   OP(XKB_KEY_exclam, LSHIFT(Key_T)) \
   OP(XKB_KEY_f, Key_H) \
   OP(XKB_KEY_g, Key_R) \
   OP(XKB_KEY_greater, LSHIFT(Key_E)) \
   OP(XKB_KEY_h, Key_Y) \
   OP(XKB_KEY_i, Key_V) \
   OP(XKB_KEY_j, Key_Slash) \
   OP(XKB_KEY_k, Key_P) \
   OP(XKB_KEY_l, Key_Comma) \
   OP(XKB_KEY_less, LSHIFT(Key_W)) \
   OP(XKB_KEY_m, Key_O) \
   OP(XKB_KEY_minus, Key_3) \
   OP(XKB_KEY_n, Key_L) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_o, Key_A) \
   OP(XKB_KEY_p, Key_Period) \
   OP(XKB_KEY_parenleft, Key_7) \
   OP(XKB_KEY_parenright, Key_9) \
   OP(XKB_KEY_percent, LSHIFT(Key_Equals)) \
   OP(XKB_KEY_period, Key_T) \
   OP(XKB_KEY_plus, LSHIFT(Key_Minus)) \
   OP(XKB_KEY_q, Key_X) \
   OP(XKB_KEY_question, LSHIFT(Key_Q)) \
   OP(XKB_KEY_quotedbl, Key_0) \
   OP(XKB_KEY_r, Key_M) \
   OP(XKB_KEY_s, Key_J) \
   OP(XKB_KEY_semicolon, Key_Z) \
