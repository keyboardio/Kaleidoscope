...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('^', Key_LeftBracket) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'^', Key_LeftBracket) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   ...
   OP(L'¨', LSHIFT(Key_LeftBracket)) /* U+00a8, XKB_KEY_diaeresis, DIAERESIS */ \
   ...
   OP(L'¯', RALT(LSHIFT(Key_NonUsPound))) /* U+00af, XKB_KEY_macron, MACRON */ \
   ...
   OP(L'¸', RALT(LSHIFT(Key_Backtick))) /* U+00b8, XKB_KEY_cedilla, CEDILLA */ \
   ...
   OP(L'Å', RALT(LSHIFT(Key_LeftBracket))) /* U+00c5, XKB_KEY_Aring, LATIN CAPITAL LETTER A WITH RING ABOVE */ \
   ...
   OP(L'ˇ', RALT(Key_1)) /* U+02c7, XKB_KEY_caron, CARON */ \
   OP(L'˘', RALT(LSHIFT(Key_3))) /* U+02d8, XKB_KEY_breve, BREVE */ \
   OP(L'˛', RALT(LSHIFT(Key_1))) /* U+02db, XKB_KEY_ogonek, OGONEK */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aring, RALT(LSHIFT(Key_LeftBracket))) \
   ...
   OP(XKB_KEY_asciicircum, Key_LeftBracket) \
   ...
   OP(XKB_KEY_breve, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caron, RALT(Key_1)) \
   OP(XKB_KEY_ccedilla, Key_9) \
   OP(XKB_KEY_cedilla, RALT(LSHIFT(Key_Backtick))) \
   ...
   OP(XKB_KEY_diaeresis, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_macron, RALT(LSHIFT(Key_NonUsPound))) \
   ...
   OP(XKB_KEY_ogonek, RALT(LSHIFT(Key_1))) \
