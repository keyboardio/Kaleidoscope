...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'·', RALT(Key_L)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_dead_cedilla, RALT(LSHIFT(Key_1))) /* XKB_KEY_dead_cedilla */ \
   ...
   OP(XKB_KEY_periodcentered, RALT(Key_L)) \
