...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', Key_8) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   ...
   OP('=', Key_Slash) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP('@', Key_Backtick) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('[', RALT(LSHIFT(Key_5))) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP('\\', RALT(LSHIFT(Key_Period))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(LSHIFT(Key_Minus))) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP('{', RALT(Key_5)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(LSHIFT(Key_L))) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_Minus)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP('~', RALT(LSHIFT(Key_N))) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', Key_8) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   ...
   OP(L'=', Key_Slash) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   ...
   OP(L'@', Key_Backtick) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'[', RALT(LSHIFT(Key_5))) /* U+005b, XKB_KEY_bracketleft, LEFT SQUARE BRACKET */ \
   OP(L'\\', RALT(LSHIFT(Key_Period))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(LSHIFT(Key_Minus))) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   ...
   OP(L'{', RALT(Key_5)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(LSHIFT(Key_L))) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_Minus)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'~', RALT(LSHIFT(Key_N))) /* U+007e, XKB_KEY_asciitilde, TILDE */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L' ', RALT(Key_Spacebar)) /* U+00a0, XKB_KEY_nobreakspace, NO-BREAK SPACE */ \
   OP(L'¡', RALT(Key_8)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   OP(L'¢', RALT(LSHIFT(Key_C))) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', LSHIFT(Key_NonUsPound)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¤', RALT(LSHIFT(Key_R))) /* U+00a4, XKB_KEY_currency, CURRENCY SIGN */ \
   OP(L'¥', RALT(LSHIFT(Key_RightBracket))) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'§', Key_6) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(LSHIFT(Key_U))) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_7)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   ...
   OP(L'±', RALT(LSHIFT(Key_Slash))) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'µ', RALT(Key_Semicolon)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(Key_6)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(Key_Backtick)) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'»', RALT(LSHIFT(Key_7))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¿', RALT(LSHIFT(Key_M))) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'À', RALT(LSHIFT(Key_A))) /* U+00c0, XKB_KEY_Agrave, LATIN CAPITAL LETTER A WITH GRAVE */ \
   OP(L'Á', RALT(LSHIFT(Key_9))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Â', RALT(Key_W)) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   ...
   OP(L'Ç', RALT(Key_9)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'È', RALT(Key_K)) /* U+00c8, XKB_KEY_Egrave, LATIN CAPITAL LETTER E WITH GRAVE */ \
   OP(L'É', RALT(LSHIFT(Key_2))) /* U+00c9, XKB_KEY_Eacute, LATIN CAPITAL LETTER E WITH ACUTE */ \
   OP(L'Ê', RALT(LSHIFT(Key_E))) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Ë', RALT(LSHIFT(Key_K))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Ì', RALT(Key_H)) /* U+00cc, XKB_KEY_Igrave, LATIN CAPITAL LETTER I WITH GRAVE */ \
   OP(L'Í', RALT(LSHIFT(Key_J))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Î', RALT(LSHIFT(Key_H))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ï', RALT(Key_J)) /* U+00cf, XKB_KEY_Idiaeresis, LATIN CAPITAL LETTER I WITH DIAERESIS */ \
   OP(L'Ò', RALT(Key_S)) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   OP(L'Ó', RALT(LSHIFT(Key_Semicolon))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ô', RALT(LSHIFT(Key_LeftBracket))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ù', RALT(Key_Quote)) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'Ú', RALT(Key_Y)) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   OP(L'Û', RALT(LSHIFT(Key_8))) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
   ...
   OP(L'â', RALT(Key_A)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'å', RALT(LSHIFT(Key_6))) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   ...
   OP(L'ê', RALT(Key_E)) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ë', RALT(Key_2)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   ...
   OP(L'ô', RALT(Key_LeftBracket)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'÷', RALT(Key_Period)) /* U+00f7, XKB_KEY_division, DIVISION SIGN */ \
   OP(L'ø', RALT(Key_0)) /* U+00f8, XKB_KEY_oslash, LATIN SMALL LETTER O WITH STROKE */ \
   OP(L'ù', Key_Quote) /* U+00f9, XKB_KEY_ugrave, LATIN SMALL LETTER U WITH GRAVE */ \
   OP(L'û', RALT(LSHIFT(Key_Quote))) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
   ...
   OP(L'–', RALT(LSHIFT(Key_Equals))) /* U+2013, XKB_KEY_endash, EN DASH */ \
   OP(L'—', RALT(Key_Equals)) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'€', RALT(Key_RightBracket)) /* U+20ac, XKB_KEY_EuroSign, EURO SIGN */ \
   OP(L'⎷', RALT(LSHIFT(Key_V))) /* U+23b7, XKB_KEY_leftradical, RADICAL SYMBOL BOTTOM */ \
   OP(L'♦', RALT(Key_V)) /* U+2666, XKB_KEY_diamond, BLACK DIAMOND SUIT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_Acircumflex, RALT(Key_W)) \
   ...
   OP(XKB_KEY_Ccedilla, RALT(Key_9)) \
   ...
   OP(XKB_KEY_Ecircumflex, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_Egrave, RALT(Key_K)) \
   OP(XKB_KEY_End, Key_End) /* XKB_KEY_End, EOL  */ \
   OP(XKB_KEY_Escape, Key_Escape) /* XKB_KEY_Escape */ \
   OP(XKB_KEY_EuroSign, RALT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_Icircumflex, RALT(LSHIFT(Key_H))) \
   OP(XKB_KEY_Idiaeresis, RALT(Key_J)) \
   OP(XKB_KEY_Igrave, RALT(Key_H)) \
   ...
   OP(XKB_KEY_Ocircumflex, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_Ograve, RALT(Key_S)) \
   ...
   OP(XKB_KEY_Uacute, RALT(Key_Y)) \
   OP(XKB_KEY_Ucircumflex, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_Ugrave, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_aring, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_asciitilde, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_at, Key_Backtick) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_bar, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_braceleft, RALT(Key_5)) \
   OP(XKB_KEY_braceright, RALT(Key_Minus)) \
   OP(XKB_KEY_bracketleft, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_bracketright, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_ccedilla, Key_9) \
   OP(XKB_KEY_cent, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_colon, Key_Period) \
   OP(XKB_KEY_comma, Key_M) \
   OP(XKB_KEY_copyright, RALT(Key_C)) \
   OP(XKB_KEY_currency, RALT(LSHIFT(Key_R))) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_acute, RALT(LSHIFT(Key_1))) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_ediaeresis, RALT(Key_2)) \
   OP(XKB_KEY_egrave, Key_7) \
   OP(XKB_KEY_emdash, RALT(Key_Equals)) \
   OP(XKB_KEY_endash, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_equal, Key_Slash) \
   OP(XKB_KEY_exclam, Key_8) \
   OP(XKB_KEY_exclamdown, RALT(Key_8)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_greater, LSHIFT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_guillemotleft, RALT(Key_7)) \
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_i, Key_I) \
   ...
   OP(XKB_KEY_periodcentered, RALT(Key_Backtick)) \
   OP(XKB_KEY_plus, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_plusminus, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_q, Key_A) \
   OP(XKB_KEY_question, LSHIFT(Key_M)) \
   OP(XKB_KEY_questiondown, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_quotedbl, Key_3) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(Key_R)) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, Key_6) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_ucircumflex, RALT(LSHIFT(Key_Quote))) \
   ...
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_z, Key_W) \
