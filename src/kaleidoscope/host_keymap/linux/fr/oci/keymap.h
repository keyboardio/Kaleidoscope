...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Á', RALT(LSHIFT(Key_Q))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   OP(L'Â', RALT(LSHIFT(Key_D))) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   OP(L'Ä', RALT(LSHIFT(Key_A))) /* U+00c4, XKB_KEY_Adiaeresis, LATIN CAPITAL LETTER A WITH DIAERESIS */ \
   OP(L'Æ', RALT(LSHIFT(Key_W))) /* U+00c6, XKB_KEY_AE, LATIN CAPITAL LETTER AE */ \
   ...
   OP(L'Ë', RALT(LSHIFT(Key_T))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Í', RALT(LSHIFT(Key_I))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Î', RALT(LSHIFT(Key_J))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   ...
   OP(L'Ò', RALT(LSHIFT(Key_P))) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   OP(L'Ó', RALT(LSHIFT(Key_O))) /* U+00d3, XKB_KEY_Oacute, LATIN CAPITAL LETTER O WITH ACUTE */ \
   OP(L'Ô', RALT(LSHIFT(Key_L))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   ...
   OP(L'Û', RALT(LSHIFT(Key_Y))) /* U+00db, XKB_KEY_Ucircumflex, LATIN CAPITAL LETTER U WITH CIRCUMFLEX */ \
   ...
   OP(L'á', RALT(Key_Q)) /* U+00e1, XKB_KEY_aacute, LATIN SMALL LETTER A WITH ACUTE */ \
   OP(L'â', RALT(Key_D)) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'ä', RALT(Key_A)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'æ', RALT(Key_W)) /* U+00e6, XKB_KEY_ae, LATIN SMALL LETTER AE */ \
   ...
   OP(L'ë', RALT(Key_T)) /* U+00eb, XKB_KEY_ediaeresis, LATIN SMALL LETTER E WITH DIAERESIS */ \
   OP(L'í', RALT(Key_I)) /* U+00ed, XKB_KEY_iacute, LATIN SMALL LETTER I WITH ACUTE */ \
   OP(L'î', RALT(Key_J)) /* U+00ee, XKB_KEY_icircumflex, LATIN SMALL LETTER I WITH CIRCUMFLEX */ \
   ...
   OP(L'ò', RALT(Key_P)) /* U+00f2, XKB_KEY_ograve, LATIN SMALL LETTER O WITH GRAVE */ \
   OP(L'ó', RALT(Key_O)) /* U+00f3, XKB_KEY_oacute, LATIN SMALL LETTER O WITH ACUTE */ \
   OP(L'ô', RALT(Key_L)) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   ...
   OP(L'û', RALT(Key_Y)) /* U+00fb, XKB_KEY_ucircumflex, LATIN SMALL LETTER U WITH CIRCUMFLEX */ \
   OP(L'ü', RALT(Key_H)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'Œ', RALT(LSHIFT(Key_LeftBracket))) /* U+0152, XKB_KEY_OE, LATIN CAPITAL LIGATURE OE */ \
   OP(L'œ', RALT(Key_LeftBracket)) /* U+0153, XKB_KEY_oe, LATIN SMALL LIGATURE OE */ \
   ...
   OP(L'→', RALT(Key_V)) /* U+2192, XKB_KEY_rightarrow, RIGHTWARDS ARROW */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_AE, RALT(LSHIFT(Key_W))) \
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_Acircumflex, RALT(LSHIFT(Key_D))) \
   ...
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_Icircumflex, RALT(LSHIFT(Key_J))) \
   ...
   OP(XKB_KEY_OE, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_Oacute, RALT(LSHIFT(Key_O))) \
   OP(XKB_KEY_Ocircumflex, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_Odiaeresis, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_Ograve, RALT(LSHIFT(Key_P))) \
   ...
   OP(XKB_KEY_Ucircumflex, RALT(LSHIFT(Key_Y))) \
   ...
   OP(XKB_KEY_a, Key_Q) \
   OP(XKB_KEY_aacute, RALT(Key_Q)) \
   OP(XKB_KEY_acircumflex, RALT(Key_D)) \
   OP(XKB_KEY_adiaeresis, RALT(Key_A)) \
   OP(XKB_KEY_ae, RALT(Key_W)) \
   ...
   OP(XKB_KEY_ediaeresis, RALT(Key_T)) \
   ...
   OP(XKB_KEY_icircumflex, RALT(Key_J)) \
   ...
   OP(XKB_KEY_oe, RALT(Key_LeftBracket)) \
   OP(XKB_KEY_ograve, RALT(Key_P)) \
   ...
   OP(XKB_KEY_rightarrow, RALT(Key_V)) \
   ...
   OP(XKB_KEY_ucircumflex, RALT(Key_Y)) \
