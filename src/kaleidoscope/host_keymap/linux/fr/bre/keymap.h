...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_NonUsPound)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   ...
   OP('%', RALT(Key_Slash)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP('/', Key_RightBracket) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP('<', RALT(Key_NonUsBackslashAndPipe)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP('=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP('>', RALT(Key_Z)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP('?', Key_NonUsPound) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_NonUsPound)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   ...
   OP(L'%', RALT(Key_Slash)) /* U+0025, XKB_KEY_percent, PERCENT SIGN */ \
   ...
   OP(L'/', Key_RightBracket) /* U+002f, XKB_KEY_slash, SOLIDUS */ \
   ...
   OP(L'<', RALT(Key_NonUsBackslashAndPipe)) /* U+003c, XKB_KEY_less, LESS-THAN SIGN */ \
   OP(L'=', Key_Equals) /* U+003d, XKB_KEY_equal, EQUALS SIGN */ \
   OP(L'>', RALT(Key_Z)) /* U+003e, XKB_KEY_greater, GREATER-THAN SIGN */ \
   OP(L'?', Key_NonUsPound) /* U+003f, XKB_KEY_question, QUESTION MARK */ \
   ...
   OP(L'¡', RALT(LSHIFT(Key_NonUsPound))) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   OP(L'¢', RALT(Key_C)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', RALT(LSHIFT(Key_RightBracket))) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¥', RALT(LSHIFT(Key_LeftBracket))) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'§', RALT(Key_Period)) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(LSHIFT(Key_Period))) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   ...
   OP(L'®', RALT(LSHIFT(Key_Quote))) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   ...
   OP(L'¿', RALT(Key_NonUsPound)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   ...
   OP(L'Ñ', LSHIFT(Key_Comma)) /* U+00d1, XKB_KEY_Ntilde, LATIN CAPITAL LETTER N WITH TILDE */ \
   OP(L'×', RALT(Key_KeypadMultiply)) \
   OP(L'Ù', LSHIFT(Key_Quote)) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'ß', RALT(LSHIFT(Key_Minus))) /* U+00df, XKB_KEY_ssharp, LATIN SMALL LETTER SHARP S */ \
   ...
   OP(L'ñ', Key_Comma) /* U+00f1, XKB_KEY_ntilde, LATIN SMALL LETTER N WITH TILDE */ \
   ...
   OP(L'ŭ', RALT(Key_Quote)) /* U+016d, XKB_KEY_ubreve, LATIN SMALL LETTER U WITH BREVE */ \
   OP(L'Γ', RALT(LSHIFT(Key_Backtick))) /* U+0393, XKB_KEY_Greek_GAMMA, GREEK CAPITAL LETTER GAMMA */ \
   OP(L'Δ', RALT(LSHIFT(Key_1))) /* U+0394, XKB_KEY_Greek_DELTA, GREEK CAPITAL LETTER DELTA */ \
   OP(L'Θ', RALT(LSHIFT(Key_2))) /* U+0398, XKB_KEY_Greek_THETA, GREEK CAPITAL LETTER THETA */ \
   OP(L'Λ', RALT(LSHIFT(Key_3))) /* U+039b, XKB_KEY_Greek_LAMDA, GREEK CAPITAL LETTER LAMDA */ \
   OP(L'Ξ', RALT(LSHIFT(Key_4))) /* U+039e, XKB_KEY_Greek_XI, GREEK CAPITAL LETTER XI */ \
   OP(L'Π', RALT(LSHIFT(Key_5))) /* U+03a0, XKB_KEY_Greek_PI, GREEK CAPITAL LETTER PI */ \
   OP(L'Σ', RALT(LSHIFT(Key_6))) /* U+03a3, XKB_KEY_Greek_SIGMA, GREEK CAPITAL LETTER SIGMA */ \
   OP(L'Φ', RALT(LSHIFT(Key_7))) /* U+03a6, XKB_KEY_Greek_PHI, GREEK CAPITAL LETTER PHI */ \
   OP(L'Ψ', RALT(LSHIFT(Key_8))) /* U+03a8, XKB_KEY_Greek_PSI, GREEK CAPITAL LETTER PSI */ \
   OP(L'Ω', RALT(LSHIFT(Key_0))) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'α', RALT(LSHIFT(Key_Q))) /* U+03b1, XKB_KEY_Greek_alpha, GREEK SMALL LETTER ALPHA */ \
   OP(L'β', RALT(Key_B)) /* U+03b2, XKB_KEY_Greek_beta, GREEK SMALL LETTER BETA */ \
   OP(L'γ', RALT(Key_G)) /* U+03b3, XKB_KEY_Greek_gamma, GREEK SMALL LETTER GAMMA */ \
   OP(L'δ', RALT(LSHIFT(Key_D))) /* U+03b4, XKB_KEY_Greek_delta, GREEK SMALL LETTER DELTA */ \
   OP(L'ε', RALT(LSHIFT(Key_E))) /* U+03b5, XKB_KEY_Greek_epsilon, GREEK SMALL LETTER EPSILON */ \
   OP(L'ζ', RALT(LSHIFT(Key_Z))) /* U+03b6, XKB_KEY_Greek_zeta, GREEK SMALL LETTER ZETA */ \
   OP(L'η', RALT(Key_H)) /* U+03b7, XKB_KEY_Greek_eta, GREEK SMALL LETTER ETA */ \
   OP(L'θ', RALT(LSHIFT(Key_NonUsBackslashAndPipe))) /* U+03b8, XKB_KEY_Greek_theta, GREEK SMALL LETTER THETA */ \
   OP(L'ι', RALT(LSHIFT(Key_I))) /* U+03b9, XKB_KEY_Greek_iota, GREEK SMALL LETTER IOTA */ \
   OP(L'κ', RALT(Key_K)) /* U+03ba, XKB_KEY_Greek_kappa, GREEK SMALL LETTER KAPPA */ \
   OP(L'λ', RALT(Key_L)) /* U+03bb, XKB_KEY_Greek_lamda, GREEK SMALL LETTER LAMDA */ \
   OP(L'μ', RALT(Key_Semicolon)) /* U+03bc, XKB_KEY_Greek_mu, GREEK SMALL LETTER MU */ \
   OP(L'ν', RALT(Key_N)) /* U+03bd, XKB_KEY_Greek_nu, GREEK SMALL LETTER NU */ \
   OP(L'ξ', RALT(Key_X)) /* U+03be, XKB_KEY_Greek_xi, GREEK SMALL LETTER XI */ \
   OP(L'ο', RALT(LSHIFT(Key_M))) /* U+03bf, XKB_KEY_Greek_omicron, GREEK SMALL LETTER OMICRON */ \
   OP(L'π', RALT(Key_P)) /* U+03c0, XKB_KEY_Greek_pi, GREEK SMALL LETTER PI */ \
   OP(L'ρ', RALT(Key_R)) /* U+03c1, XKB_KEY_Greek_rho, GREEK SMALL LETTER RHO */ \
   OP(L'ς', RALT(Key_J)) /* U+03c2, XKB_KEY_Greek_finalsmallsigma, GREEK SMALL LETTER FINAL SIGMA */ \
   OP(L'σ', RALT(Key_S)) /* U+03c3, XKB_KEY_Greek_sigma, GREEK SMALL LETTER SIGMA */ \
   OP(L'τ', RALT(Key_T)) /* U+03c4, XKB_KEY_Greek_tau, GREEK SMALL LETTER TAU */ \
   OP(L'υ', RALT(Key_U)) /* U+03c5, XKB_KEY_Greek_upsilon, GREEK SMALL LETTER UPSILON */ \
   OP(L'φ', RALT(Key_F)) /* U+03c6, XKB_KEY_Greek_phi, GREEK SMALL LETTER PHI */ \
   OP(L'χ', RALT(LSHIFT(Key_C))) /* U+03c7, XKB_KEY_Greek_chi, GREEK SMALL LETTER CHI */ \
   OP(L'ψ', RALT(Key_Y)) /* U+03c8, XKB_KEY_Greek_psi, GREEK SMALL LETTER PSI */ \
   OP(L'ω', RALT(Key_W)) /* U+03c9, XKB_KEY_Greek_omega, GREEK SMALL LETTER OMEGA */ \
   OP(L' ', RALT(LSHIFT(Key_KeypadDot))) \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Greek_DELTA, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_Greek_GAMMA, RALT(LSHIFT(Key_Backtick))) \
   OP(XKB_KEY_Greek_LAMDA, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_Greek_OMEGA, RALT(LSHIFT(Key_0))) \
   OP(XKB_KEY_Greek_PHI, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_Greek_PI, RALT(LSHIFT(Key_5))) \
   OP(XKB_KEY_Greek_PSI, RALT(LSHIFT(Key_8))) \
   OP(XKB_KEY_Greek_SIGMA, RALT(LSHIFT(Key_6))) \
   OP(XKB_KEY_Greek_THETA, RALT(LSHIFT(Key_2))) \
   OP(XKB_KEY_Greek_XI, RALT(LSHIFT(Key_4))) \
   OP(XKB_KEY_Greek_alpha, RALT(LSHIFT(Key_Q))) \
   OP(XKB_KEY_Greek_beta, RALT(Key_B)) \
   OP(XKB_KEY_Greek_chi, RALT(LSHIFT(Key_C))) \
   OP(XKB_KEY_Greek_delta, RALT(LSHIFT(Key_D))) \
   OP(XKB_KEY_Greek_epsilon, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Greek_eta, RALT(Key_H)) \
   OP(XKB_KEY_Greek_finalsmallsigma, RALT(Key_J)) \
   OP(XKB_KEY_Greek_gamma, RALT(Key_G)) \
   OP(XKB_KEY_Greek_iota, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_Greek_kappa, RALT(Key_K)) \
   OP(XKB_KEY_Greek_lamda, RALT(Key_L)) \
   OP(XKB_KEY_Greek_mu, RALT(Key_Semicolon)) \
   OP(XKB_KEY_Greek_nu, RALT(Key_N)) \
   OP(XKB_KEY_Greek_omega, RALT(Key_W)) \
   OP(XKB_KEY_Greek_omicron, RALT(LSHIFT(Key_M))) \
   OP(XKB_KEY_Greek_phi, RALT(Key_F)) \
   OP(XKB_KEY_Greek_pi, RALT(Key_P)) \
   OP(XKB_KEY_Greek_psi, RALT(Key_Y)) \
   OP(XKB_KEY_Greek_rho, RALT(Key_R)) \
   OP(XKB_KEY_Greek_sigma, RALT(Key_S)) \
   OP(XKB_KEY_Greek_tau, RALT(Key_T)) \
   OP(XKB_KEY_Greek_theta, RALT(LSHIFT(Key_NonUsBackslashAndPipe))) \
   OP(XKB_KEY_Greek_upsilon, RALT(Key_U)) \
   OP(XKB_KEY_Greek_xi, RALT(Key_X)) \
   OP(XKB_KEY_Greek_zeta, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_Ntilde, LSHIFT(Key_Comma)) \
   ...
   OP(XKB_KEY_Ugrave, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_copyright, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_abovedot, RALT(Key_Backtick)) /* XKB_KEY_dead_abovedot */ \
   OP(XKB_KEY_dead_abovering, LSHIFT(Key_Minus)) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_2)) /* XKB_KEY_dead_acute */ \
   ...
   OP(XKB_KEY_dead_macron, RALT(Key_1)) /* XKB_KEY_dead_macron */ \
   ...
   OP(XKB_KEY_exclam, LSHIFT(Key_NonUsPound)) \
   OP(XKB_KEY_exclamdown, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   ...
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_less, RALT(Key_NonUsBackslashAndPipe)) \
   ...
   OP(XKB_KEY_percent, RALT(Key_Slash)) \
   ...
   OP(XKB_KEY_question, Key_NonUsPound) \
   OP(XKB_KEY_questiondown, RALT(Key_NonUsPound)) \
   OP(XKB_KEY_quotedbl, Key_3) \
   OP(XKB_KEY_r, Key_R) \
   OP(XKB_KEY_registered, RALT(LSHIFT(Key_Quote))) \
   OP(XKB_KEY_s, Key_S) \
   OP(XKB_KEY_section, RALT(Key_Period)) \
   OP(XKB_KEY_semicolon, LSHIFT(Key_Slash)) \
   OP(XKB_KEY_slash, Key_RightBracket) \
   OP(XKB_KEY_space, Key_Spacebar) \
   OP(XKB_KEY_ssharp, RALT(LSHIFT(Key_Minus))) \
   OP(XKB_KEY_sterling, RALT(LSHIFT(Key_RightBracket))) \
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_twosuperior, Key_Backtick) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_ubreve, RALT(Key_Quote)) \
   ...
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Y) \
   OP(XKB_KEY_yen, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_z, Key_Z) \
