...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('^', RALT(Key_4)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'^', RALT(Key_4)) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_asciicircum, RALT(Key_4)) \
