...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'à', LSHIFT(Key_Quote)) /* U+00e0, XKB_KEY_agrave, LATIN SMALL LETTER A WITH GRAVE */ \
   ...
   OP(L'è', LSHIFT(Key_LeftBracket)) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'é', LSHIFT(Key_Semicolon)) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_agrave, LSHIFT(Key_Quote)) \
   ...
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_egrave, LSHIFT(Key_LeftBracket)) \
