...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'¢', RALT(Key_8)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   ...
   OP(L'´', RALT(Key_Minus)) /* U+00b4, XKB_KEY_acute, ACUTE ACCENT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_acute, RALT(Key_Minus)) \
