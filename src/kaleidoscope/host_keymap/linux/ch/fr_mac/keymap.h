...
#define _HOST_KEYMAP_ASCII(OP) \
   ...
   OP('!', LSHIFT(Key_RightBracket)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP('"', LSHIFT(Key_2)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP('#', RALT(Key_3)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP('$', Key_NonUsPound) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   ...
   OP('@', RALT(Key_G)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP('\\', RALT(LSHIFT(Key_7))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(']', RALT(Key_6)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP('^', RALT(LSHIFT(Key_Equals))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP('_', LSHIFT(Key_Slash)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP('`', RALT(Key_RightBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP('{', RALT(Key_8)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP('|', RALT(Key_7)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP('}', RALT(Key_9)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'!', LSHIFT(Key_RightBracket)) /* U+0021, XKB_KEY_exclam, EXCLAMATION MARK */ \
   OP(L'"', LSHIFT(Key_2)) /* U+0022, XKB_KEY_quotedbl, QUOTATION MARK */ \
   OP(L'#', RALT(Key_3)) /* U+0023, XKB_KEY_numbersign, NUMBER SIGN */ \
   OP(L'$', Key_NonUsPound) /* U+0024, XKB_KEY_dollar, DOLLAR SIGN */ \
   ...
   OP(L'@', RALT(Key_G)) /* U+0040, XKB_KEY_at, COMMERCIAL AT */ \
   ...
   OP(L'\\', RALT(LSHIFT(Key_7))) /* U+005c, XKB_KEY_backslash, REVERSE SOLIDUS */ \
   OP(L']', RALT(Key_6)) /* U+005d, XKB_KEY_bracketright, RIGHT SQUARE BRACKET */ \
   OP(L'^', RALT(LSHIFT(Key_Equals))) /* U+005e, XKB_KEY_asciicircum, CIRCUMFLEX ACCENT */ \
   OP(L'_', LSHIFT(Key_Slash)) /* U+005f, XKB_KEY_underscore, LOW LINE */ \
   OP(L'`', RALT(Key_RightBracket)) /* U+0060, XKB_KEY_grave, GRAVE ACCENT */ \
   ...
   OP(L'{', RALT(Key_8)) /* U+007b, XKB_KEY_braceleft, LEFT CURLY BRACKET */ \
   OP(L'|', RALT(Key_7)) /* U+007c, XKB_KEY_bar, VERTICAL LINE */ \
   OP(L'}', RALT(Key_9)) /* U+007d, XKB_KEY_braceright, RIGHT CURLY BRACKET */ \
   OP(L'', Key_Delete) /* XKB_KEY_Delete, Delete, rubout  */ \
   OP(L' ', RALT(Key_Spacebar)) /* U+00a0, XKB_KEY_nobreakspace, NO-BREAK SPACE */ \
   OP(L'¡', RALT(Key_I)) /* U+00a1, XKB_KEY_exclamdown, INVERTED EXCLAMATION MARK */ \
   OP(L'¢', RALT(Key_Semicolon)) /* U+00a2, XKB_KEY_cent, CENT SIGN */ \
   OP(L'£', LSHIFT(Key_NonUsPound)) /* U+00a3, XKB_KEY_sterling, POUND SIGN */ \
   OP(L'¥', RALT(Key_Z)) /* U+00a5, XKB_KEY_yen, YEN SIGN */ \
   OP(L'§', Key_Backtick) /* U+00a7, XKB_KEY_section, SECTION SIGN */ \
   OP(L'©', RALT(Key_C)) /* U+00a9, XKB_KEY_copyright, COPYRIGHT SIGN */ \
   OP(L'ª', RALT(Key_H)) /* U+00aa, XKB_KEY_ordfeminine, FEMININE ORDINAL INDICATOR */ \
   OP(L'«', RALT(Key_Comma)) /* U+00ab, XKB_KEY_guillemotleft, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¬', RALT(Key_L)) /* U+00ac, XKB_KEY_notsign, NOT SIGN */ \
   OP(L'­', RALT(Key_Slash)) /* U+00ad, XKB_KEY_hyphen, SOFT HYPHEN */ \
   OP(L'®', RALT(Key_R)) /* U+00ae, XKB_KEY_registered, REGISTERED SIGN */ \
   OP(L'¯', RALT(LSHIFT(Key_K))) /* U+00af, XKB_KEY_macron, MACRON */ \
   OP(L'°', RALT(Key_U)) /* U+00b0, XKB_KEY_degree, DEGREE SIGN */ \
   OP(L'±', RALT(Key_1)) /* U+00b1, XKB_KEY_plusminus, PLUS-MINUS SIGN */ \
   OP(L'µ', RALT(Key_M)) /* U+00b5, XKB_KEY_mu, MICRO SIGN */ \
   OP(L'¶', RALT(Key_NonUsPound)) /* U+00b6, XKB_KEY_paragraph, PILCROW SIGN */ \
   OP(L'·', RALT(LSHIFT(Key_H))) /* U+00b7, XKB_KEY_periodcentered, MIDDLE DOT */ \
   OP(L'º', RALT(Key_J)) /* U+00ba, XKB_KEY_masculine, MASCULINE ORDINAL INDICATOR */ \
   OP(L'»', RALT(LSHIFT(Key_Comma))) /* U+00bb, XKB_KEY_guillemotright, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK */ \
   OP(L'¿', RALT(Key_Minus)) /* U+00bf, XKB_KEY_questiondown, INVERTED QUESTION MARK */ \
   OP(L'Á', RALT(LSHIFT(Key_W))) /* U+00c1, XKB_KEY_Aacute, LATIN CAPITAL LETTER A WITH ACUTE */ \
   ...
   OP(L'Ç', RALT(Key_4)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'È', RALT(LSHIFT(Key_R))) /* U+00c8, XKB_KEY_Egrave, LATIN CAPITAL LETTER E WITH GRAVE */ \
   OP(L'Ë', RALT(LSHIFT(Key_E))) /* U+00cb, XKB_KEY_Ediaeresis, LATIN CAPITAL LETTER E WITH DIAERESIS */ \
   OP(L'Í', RALT(LSHIFT(Key_Y))) /* U+00cd, XKB_KEY_Iacute, LATIN CAPITAL LETTER I WITH ACUTE */ \
   OP(L'Î', RALT(LSHIFT(Key_T))) /* U+00ce, XKB_KEY_Icircumflex, LATIN CAPITAL LETTER I WITH CIRCUMFLEX */ \
   OP(L'Ò', RALT(LSHIFT(Key_8))) /* U+00d2, XKB_KEY_Ograve, LATIN CAPITAL LETTER O WITH GRAVE */ \
   OP(L'Ô', RALT(LSHIFT(Key_9))) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ø', RALT(LSHIFT(Key_O))) /* U+00d8, XKB_KEY_Oslash, LATIN CAPITAL LETTER O WITH STROKE */ \
   OP(L'Ù', RALT(LSHIFT(Key_U))) /* U+00d9, XKB_KEY_Ugrave, LATIN CAPITAL LETTER U WITH GRAVE */ \
   OP(L'Ú', RALT(LSHIFT(Key_0))) /* U+00da, XKB_KEY_Uacute, LATIN CAPITAL LETTER U WITH ACUTE */ \
   ...
   OP(L'ä', LSHIFT(Key_Quote)) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'å', RALT(Key_A)) /* U+00e5, XKB_KEY_aring, LATIN SMALL LETTER A WITH RING ABOVE */ \
   OP(L'ç', LSHIFT(Key_4)) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'è', Key_LeftBracket) /* U+00e8, XKB_KEY_egrave, LATIN SMALL LETTER E WITH GRAVE */ \
   OP(L'é', Key_Semicolon) /* U+00e9, XKB_KEY_eacute, LATIN SMALL LETTER E WITH ACUTE */ \
   OP(L'ð', RALT(LSHIFT(Key_J))) /* U+00f0, XKB_KEY_eth, LATIN SMALL LETTER ETH */ \
   OP(L'ö', LSHIFT(Key_Semicolon)) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   ...
   OP(L'ü', LSHIFT(Key_LeftBracket)) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ÿ', RALT(LSHIFT(Key_LeftBracket))) /* U+00ff, XKB_KEY_ydiaeresis, LATIN SMALL LETTER Y WITH DIAERESIS */ \
   ...
   OP(L'Ÿ', RALT(LSHIFT(Key_Z))) /* U+0178, XKB_KEY_Ydiaeresis, LATIN CAPITAL LETTER Y WITH DIAERESIS */ \
   OP(L'ƒ', RALT(Key_F)) /* U+0192, XKB_KEY_function, LATIN SMALL LETTER F WITH HOOK */ \
   OP(L'˘', RALT(LSHIFT(Key_Semicolon))) /* U+02d8, XKB_KEY_breve, BREVE */ \
   OP(L'Δ', RALT(Key_K)) /* U+0394, XKB_KEY_Greek_DELTA, GREEK CAPITAL LETTER DELTA */ \
   ...
   OP(L'Ω', RALT(Key_Y)) /* U+03a9, XKB_KEY_Greek_OMEGA, GREEK CAPITAL LETTER OMEGA */ \
   OP(L'π', RALT(Key_P)) /* U+03c0, XKB_KEY_Greek_pi, GREEK SMALL LETTER PI */ \
   OP(L'σ', RALT(Key_D)) /* U+03c3, XKB_KEY_Greek_sigma, GREEK SMALL LETTER SIGMA */ \
   OP(L'—', RALT(LSHIFT(Key_Slash))) /* U+2014, XKB_KEY_emdash, EM DASH */ \
   OP(L'“', RALT(Key_2)) /* U+201c, XKB_KEY_leftdoublequotemark, LEFT DOUBLE QUOTATION MARK */ \
   OP(L'”', RALT(LSHIFT(Key_2))) /* U+201d, XKB_KEY_rightdoublequotemark, RIGHT DOUBLE QUOTATION MARK */ \
   OP(L'†', RALT(Key_T)) /* U+2020, XKB_KEY_dagger, DAGGER */ \
   OP(L'‡', RALT(LSHIFT(Key_F))) /* U+2021, XKB_KEY_doubledagger, DOUBLE DAGGER */ \
   OP(L'•', RALT(LSHIFT(Key_NonUsPound))) /* U+2022, XKB_KEY_enfilledcircbullet, BULLET */ \
   ...
   OP(L'™', RALT(LSHIFT(Key_X))) /* U+2122, XKB_KEY_trademark, TRADE MARK SIGN */ \
   OP(L'√', RALT(Key_V)) /* U+221a, XKB_KEY_radical, SQUARE ROOT */ \
   OP(L'∞', RALT(LSHIFT(Key_1))) /* U+221e, XKB_KEY_infinity, INFINITY */ \
   OP(L'∫', RALT(Key_B)) /* U+222b, XKB_KEY_integral, INTEGRAL */ \
   OP(L'≃', RALT(Key_X)) /* U+2243, XKB_KEY_similarequal, ASYMPTOTICALLY EQUAL TO */ \
   OP(L'≠', RALT(Key_0)) /* U+2260, XKB_KEY_notequal, NOT EQUAL TO */ \
   ...
   OP(L'◦', RALT(LSHIFT(Key_N))) /* U+25e6, XKB_KEY_enopencircbullet, WHITE BULLET */ \
   OP(L'♦', RALT(LSHIFT(Key_V))) /* U+2666, XKB_KEY_diamond, BLACK DIAMOND SUIT */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Aacute, RALT(LSHIFT(Key_W))) \
   ...
   OP(XKB_KEY_Ccedilla, RALT(Key_4)) \
   ...
   OP(XKB_KEY_Ediaeresis, RALT(LSHIFT(Key_E))) \
   OP(XKB_KEY_Egrave, RALT(LSHIFT(Key_R))) \
   ...
   OP(XKB_KEY_Iacute, RALT(LSHIFT(Key_Y))) \
   OP(XKB_KEY_Icircumflex, RALT(LSHIFT(Key_T))) \
   ...
   OP(XKB_KEY_Ocircumflex, RALT(LSHIFT(Key_9))) \
   OP(XKB_KEY_Ograve, RALT(LSHIFT(Key_8))) \
   ...
   OP(XKB_KEY_Uacute, RALT(LSHIFT(Key_0))) \
   ...
   OP(XKB_KEY_Ydiaeresis, RALT(LSHIFT(Key_Z))) \
   ...
   OP(XKB_KEY_asciicircum, RALT(LSHIFT(Key_Equals))) \
   OP(XKB_KEY_asterisk, LSHIFT(Key_3)) \
   OP(XKB_KEY_at, RALT(Key_G)) \
   OP(XKB_KEY_b, Key_B) \
   OP(XKB_KEY_backslash, RALT(LSHIFT(Key_7))) \
   OP(XKB_KEY_bar, RALT(Key_7)) \
   OP(XKB_KEY_braceleft, RALT(Key_8)) \
   OP(XKB_KEY_braceright, RALT(Key_9)) \
   OP(XKB_KEY_bracketleft, RALT(Key_5)) \
   OP(XKB_KEY_bracketright, RALT(Key_6)) \
   OP(XKB_KEY_breve, RALT(LSHIFT(Key_Semicolon))) \
   OP(XKB_KEY_c, Key_C) \
   OP(XKB_KEY_caret, RALT(LSHIFT(Key_L))) \
   OP(XKB_KEY_ccedilla, LSHIFT(Key_4)) \
   OP(XKB_KEY_cent, RALT(Key_Semicolon)) \
   OP(XKB_KEY_colon, LSHIFT(Key_Period)) \
   OP(XKB_KEY_comma, Key_Comma) \
   OP(XKB_KEY_copyright, RALT(Key_C)) \
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dagger, RALT(Key_T)) \
   OP(XKB_KEY_dead_abovering, RALT(LSHIFT(Key_M))) /* XKB_KEY_dead_abovering */ \
   OP(XKB_KEY_dead_acute, RALT(Key_Equals)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_circumflex, Key_Equals) /* XKB_KEY_dead_circumflex */ \
   ...
   OP(XKB_KEY_degree, RALT(Key_U)) \
   OP(XKB_KEY_diamond, RALT(LSHIFT(Key_V))) \
   OP(XKB_KEY_division, RALT(LSHIFT(Key_Period))) \
   OP(XKB_KEY_dollar, Key_NonUsPound) \
   OP(XKB_KEY_doubledagger, RALT(LSHIFT(Key_F))) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_eacute, Key_Semicolon) \
   OP(XKB_KEY_egrave, Key_LeftBracket) \
   OP(XKB_KEY_ellipsis, RALT(Key_Period)) \
   OP(XKB_KEY_emdash, RALT(LSHIFT(Key_Slash))) \
   OP(XKB_KEY_enfilledcircbullet, RALT(LSHIFT(Key_NonUsPound))) \
   OP(XKB_KEY_enopencircbullet, RALT(LSHIFT(Key_N))) \
   OP(XKB_KEY_equal, LSHIFT(Key_0)) \
   OP(XKB_KEY_eth, RALT(LSHIFT(Key_J))) \
   OP(XKB_KEY_exclam, LSHIFT(Key_RightBracket)) \
   OP(XKB_KEY_exclamdown, RALT(Key_I)) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_function, RALT(Key_F)) \
   OP(XKB_KEY_g, Key_G) \
   OP(XKB_KEY_grave, RALT(Key_RightBracket)) /* XKB_KEY_quoteleft, deprecated  */ \
   ...
   OP(XKB_KEY_guillemotright, RALT(LSHIFT(Key_Comma))) \
   OP(XKB_KEY_h, Key_H) \
   OP(XKB_KEY_hyphen, RALT(Key_Slash)) \
   OP(XKB_KEY_i, Key_I) \
   OP(XKB_KEY_idotless, RALT(LSHIFT(Key_I))) \
   OP(XKB_KEY_infinity, RALT(LSHIFT(Key_1))) \
   OP(XKB_KEY_integral, RALT(Key_B)) \
   OP(XKB_KEY_j, Key_J) \
   OP(XKB_KEY_k, Key_K) \
   OP(XKB_KEY_l, Key_L) \
   OP(XKB_KEY_leftcaret, RALT(LSHIFT(Key_3))) \
   OP(XKB_KEY_leftdoublequotemark, RALT(Key_2)) \
   OP(XKB_KEY_less, Key_NonUsBackslashAndPipe) \
   OP(XKB_KEY_lessthanequal, RALT(Key_NonUsBackslashAndPipe)) \
   OP(XKB_KEY_m, Key_M) \
   OP(XKB_KEY_macron, RALT(LSHIFT(Key_K))) \
   OP(XKB_KEY_masculine, RALT(Key_J)) \
   OP(XKB_KEY_minus, Key_Slash) \
   OP(XKB_KEY_mu, RALT(Key_M)) \
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_nobreakspace, RALT(Key_Spacebar)) \
   OP(XKB_KEY_notequal, RALT(Key_0)) \
   OP(XKB_KEY_notsign, RALT(Key_L)) \
   OP(XKB_KEY_numbersign, RALT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_odiaeresis, LSHIFT(Key_Semicolon)) \
   OP(XKB_KEY_oe, RALT(Key_Q)) \
   OP(XKB_KEY_ordfeminine, RALT(Key_H)) \
   OP(XKB_KEY_oslash, RALT(Key_O)) \
   OP(XKB_KEY_p, Key_P) \
   OP(XKB_KEY_paragraph, RALT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_x, Key_X) \
   OP(XKB_KEY_y, Key_Z) \
   OP(XKB_KEY_ydiaeresis, RALT(LSHIFT(Key_LeftBracket))) \
   OP(XKB_KEY_yen, RALT(Key_Z)) \
   OP(XKB_KEY_z, Key_Y) \
