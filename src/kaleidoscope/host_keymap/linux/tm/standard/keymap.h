...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Ç', LSHIFT(Key_C)) /* U+00c7, XKB_KEY_Ccedilla, LATIN CAPITAL LETTER C WITH CEDILLA */ \
   OP(L'Ö', LSHIFT(Key_RightBracket)) /* U+00d6, XKB_KEY_Odiaeresis, LATIN CAPITAL LETTER O WITH DIAERESIS */ \
   OP(L'Ü', LSHIFT(Key_X)) /* U+00dc, XKB_KEY_Udiaeresis, LATIN CAPITAL LETTER U WITH DIAERESIS */ \
   OP(L'Ý', LSHIFT(Key_V)) /* U+00dd, XKB_KEY_Yacute, LATIN CAPITAL LETTER Y WITH ACUTE */ \
   OP(L'ä', Key_Q) /* U+00e4, XKB_KEY_adiaeresis, LATIN SMALL LETTER A WITH DIAERESIS */ \
   OP(L'ç', Key_C) /* U+00e7, XKB_KEY_ccedilla, LATIN SMALL LETTER C WITH CEDILLA */ \
   OP(L'ö', Key_RightBracket) /* U+00f6, XKB_KEY_odiaeresis, LATIN SMALL LETTER O WITH DIAERESIS */ \
   OP(L'ü', Key_X) /* U+00fc, XKB_KEY_udiaeresis, LATIN SMALL LETTER U WITH DIAERESIS */ \
   OP(L'ý', Key_V) /* U+00fd, XKB_KEY_yacute, LATIN SMALL LETTER Y WITH ACUTE */ \
   OP(L'Ň', LSHIFT(Key_LeftBracket)) /* U+0147, XKB_KEY_Ncaron, LATIN CAPITAL LETTER N WITH CARON */ \
   OP(L'ň', Key_LeftBracket) /* U+0148, XKB_KEY_ncaron, LATIN SMALL LETTER N WITH CARON */ \
   OP(L'Ş', LSHIFT(Key_NonUsPound)) /* U+015e, XKB_KEY_Scedilla, LATIN CAPITAL LETTER S WITH CEDILLA */ \
   OP(L'ş', Key_NonUsPound) /* U+015f, XKB_KEY_scedilla, LATIN SMALL LETTER S WITH CEDILLA */ \
   OP(L'Ž', LSHIFT(Key_Backtick)) /* U+017d, XKB_KEY_Zcaron, LATIN CAPITAL LETTER Z WITH CARON */ \
   OP(L'ž', Key_Backtick) /* U+017e, XKB_KEY_zcaron, LATIN SMALL LETTER Z WITH CARON */ \
...
#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   ...
   OP(XKB_KEY_Ccedilla, LSHIFT(Key_C)) \
   ...
   OP(XKB_KEY_Ncaron, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_Odiaeresis, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Scedilla, LSHIFT(Key_NonUsPound)) \
   ...
   OP(XKB_KEY_Udiaeresis, LSHIFT(Key_X)) \
   ...
   OP(XKB_KEY_Yacute, LSHIFT(Key_V)) \
   OP(XKB_KEY_Z, LSHIFT(Key_Z)) \
   OP(XKB_KEY_Zcaron, LSHIFT(Key_Backtick)) \
   OP(XKB_KEY_a, Key_A) \
   ...
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_ncaron, Key_LeftBracket) \
   OP(XKB_KEY_numbersign, LSHIFT(Key_3)) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_odiaeresis, Key_RightBracket) \
   OP(XKB_KEY_p, Key_P) \
