...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'Â', LSHIFT(Key_2)) /* U+00c2, XKB_KEY_Acircumflex, LATIN CAPITAL LETTER A WITH CIRCUMFLEX */ \
   OP(L'Ê', LSHIFT(Key_3)) /* U+00ca, XKB_KEY_Ecircumflex, LATIN CAPITAL LETTER E WITH CIRCUMFLEX */ \
   OP(L'Ô', LSHIFT(Key_4)) /* U+00d4, XKB_KEY_Ocircumflex, LATIN CAPITAL LETTER O WITH CIRCUMFLEX */ \
   OP(L'â', Key_2) /* U+00e2, XKB_KEY_acircumflex, LATIN SMALL LETTER A WITH CIRCUMFLEX */ \
   OP(L'ê', Key_3) /* U+00ea, XKB_KEY_ecircumflex, LATIN SMALL LETTER E WITH CIRCUMFLEX */ \
   OP(L'ô', Key_4) /* U+00f4, XKB_KEY_ocircumflex, LATIN SMALL LETTER O WITH CIRCUMFLEX */ \
   OP(L'Ă', LSHIFT(Key_1)) /* U+0102, XKB_KEY_Abreve, LATIN CAPITAL LETTER A WITH BREVE */ \
   OP(L'ă', Key_1) /* U+0103, XKB_KEY_abreve, LATIN SMALL LETTER A WITH BREVE */ \
   OP(L'Đ', LSHIFT(Key_0)) /* U+0110, XKB_KEY_Dstroke, LATIN CAPITAL LETTER D WITH STROKE */ \
   OP(L'đ', Key_0) /* U+0111, XKB_KEY_dstroke, LATIN SMALL LETTER D WITH STROKE */ \
   OP(L'Ơ', LSHIFT(Key_RightBracket)) /* U+01a0, XKB_KEY_Ohorn, LATIN CAPITAL LETTER O WITH HORN */ \
   OP(L'ơ', Key_RightBracket) /* U+01a1, XKB_KEY_ohorn, LATIN SMALL LETTER O WITH HORN */ \
   OP(L'Ư', LSHIFT(Key_LeftBracket)) /* U+01af, XKB_KEY_Uhorn, LATIN CAPITAL LETTER U WITH HORN */ \
   OP(L'ư', Key_LeftBracket) /* U+01b0, XKB_KEY_uhorn, LATIN SMALL LETTER U WITH HORN */ \
   OP(L'̀', Key_5) \
   OP(L'́', Key_8) \
   OP(L'̃', Key_7) \
   OP(L'̉', Key_6) \
   OP(L'̣', Key_9) \
   OP(L'₫', Key_Equals) /* U+20ab, XKB_KEY_DongSign, DONG SIGN */ \

#define _HOST_KEYMAP_NON_PRINTABLE(OP) \
   OP(XKB_KEY_A, LSHIFT(Key_A)) \
   OP(XKB_KEY_Abreve, LSHIFT(Key_1)) \
   OP(XKB_KEY_Acircumflex, LSHIFT(Key_2)) \
   ...
   OP(XKB_KEY_DongSign, Key_Equals) \
   OP(XKB_KEY_Down, Key_DownArrow) /* XKB_KEY_Down, Move down, down arrow  */ \
   OP(XKB_KEY_Dstroke, LSHIFT(Key_0)) \
   OP(XKB_KEY_E, LSHIFT(Key_E)) \
   OP(XKB_KEY_Ecircumflex, LSHIFT(Key_3)) \
   ...
   OP(XKB_KEY_Ocircumflex, LSHIFT(Key_4)) \
   OP(XKB_KEY_Ohorn, LSHIFT(Key_RightBracket)) \
   ...
   OP(XKB_KEY_Uhorn, LSHIFT(Key_LeftBracket)) \
   ...
   OP(XKB_KEY_a, Key_A) \
   OP(XKB_KEY_abreve, Key_1) \
   OP(XKB_KEY_acircumflex, Key_2) \
   ...
   OP(XKB_KEY_d, Key_D) \
   OP(XKB_KEY_dead_acute, RALT(Key_8)) /* XKB_KEY_dead_acute */ \
   OP(XKB_KEY_dead_belowdot, RALT(Key_9)) /* XKB_KEY_dead_belowdot */ \
   OP(XKB_KEY_dead_grave, RALT(Key_5)) /* XKB_KEY_dead_grave */ \
   OP(XKB_KEY_dead_hook, RALT(Key_6)) /* XKB_KEY_dead_hook */ \
   OP(XKB_KEY_dead_tilde, RALT(Key_7)) /* XKB_KEY_dead_tilde */ \
   OP(XKB_KEY_dstroke, Key_0) \
   OP(XKB_KEY_e, Key_E) \
   OP(XKB_KEY_ecircumflex, Key_3) \
   OP(XKB_KEY_f, Key_F) \
   OP(XKB_KEY_g, Key_G) \
   ...
   OP(XKB_KEY_n, Key_N) \
   OP(XKB_KEY_o, Key_O) \
   OP(XKB_KEY_ocircumflex, Key_4) \
   OP(XKB_KEY_ohorn, Key_RightBracket) \
   OP(XKB_KEY_p, Key_P) \
   ...
   OP(XKB_KEY_t, Key_T) \
   OP(XKB_KEY_u, Key_U) \
   OP(XKB_KEY_uhorn, Key_LeftBracket) \
