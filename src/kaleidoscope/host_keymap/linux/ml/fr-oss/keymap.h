...
#define _HOST_KEYMAP_UNICODE(OP) \
   ...
   OP(L'ŀ', RALT(Key_L)) \
   OP(L'Ŋ', RALT(LSHIFT(Key_Semicolon))) \
   OP(L'ŋ', RALT(Key_Semicolon)) \
   ...
   OP(L'Š', RALT(LSHIFT(Key_D))) \
   OP(L'š', RALT(Key_D)) \
   OP(L'Ÿ', RALT(LSHIFT(Key_Y))) /* U+0178, XKB_KEY_Ydiaeresis, LATIN CAPITAL LETTER Y WITH DIAERESIS */ \
   OP(L'Ž', RALT(LSHIFT(Key_W))) \
   OP(L'ž', RALT(Key_W)) \
   OP(L'Ɔ', RALT(LSHIFT(Key_P))) \
   OP(L'Ɛ', RALT(LSHIFT(Key_R))) \
