...
#define Consumer_MicrophoneCa CONSUMER_KEY(HID_CONSUMER_MICROPHONE_CA, KEY_FLAGS |  HID_TYPE_CA )
#define Consumer_HeadphoneCa CONSUMER_KEY(HID_CONSUMER_HEADPHONE_CA, KEY_FLAGS |  HID_TYPE_CA )
#define Consumer_GraphicEqualizerCa CONSUMER_KEY(HID_CONSUMER_GRAPHIC_EQUALIZER_CA, KEY_FLAGS |  HID_TYPE_CA )
...
#define Consumer_EnterDiscMc CONSUMER_KEY(HID_CONSUMER_ENTER_DISC_MC, KEY_FLAGS |  HID_TYPE_MC )
