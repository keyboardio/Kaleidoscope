...
#define ATMEGA32U4_DEVICE_PROPS_WITH_PROG_KEY(BOARD_, BOOTLOADER_, NAME_, ROW_PINS_, COL_PINS_, PROG_KEY_) \
...
#define ATMEGA32U4_DEVICE_PROPS(BOARD_, BOOTLOADER_, NAME_, ROW_PINS_, COL_PINS_) \
  ATMEGA32U4_DEVICE_PROPS_WITH_PROG_KEY(BOARD_, BOOTLOADER_, NAME_,               \
...
#define ATMEGA32U4_KEYBOARD_WITH_PROG_KEY(BOARD_, BOOTLOADER_, NAME_, ROW_PINS_, COL_PINS_, PROG_KEY_)  \
  ATMEGA32U4_DEVICE_PROPS_WITH_PROG_KEY(BOARD_, BOOTLOADER_, NAME_,                                     \
...
#define ATMEGA32U4_KEYBOARD(BOARD_, BOOTLOADER_, NAME_, ROW_PINS_, COL_PINS_)  \
  ATMEGA32U4_KEYBOARD_WITH_PROG_KEY(BOARD_, BOOTLOADER_, NAME_,                \
                                    FORWARD(ROW_PINS_), FORWARD(COL_PINS_),    \
                                    NO_PROG_KEY)
