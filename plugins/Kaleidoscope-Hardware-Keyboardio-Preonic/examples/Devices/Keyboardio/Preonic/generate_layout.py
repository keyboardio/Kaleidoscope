...
def clean_key_name(key):
    ...
    mappings = {
        ...
        'Key_BLEOff': get_usb_icon(),
        'Key_BLESelectDevice1': get_bluetooth_icon() + ' + 1',
        'Key_BLESelectDevice2': get_bluetooth_icon() + ' + 2',
        'Key_BLESelectDevice3': get_bluetooth_icon() + ' + 3',
        'Key_BLESelectDevice4': get_bluetooth_icon() + ' + 4',
        'Key_BLEStartPairing': get_bluetooth_pair_icon(),
        'M(MACRO_FLASH_ERASE)': '⚡',
        'M(MACRO_ANY)': 'Any',
        'Key_Hyper': 'Hyper',
