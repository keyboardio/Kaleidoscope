 ...
 // Other Peripherals (Disable just in case)
  ...
  // Restore USB Shutdown Logic
   ...
   // PWM
    ...
    // Timers
    NRF_TIMER0->TASKS_STOP = 1; NRF_TIMER0->INTENCLR = 0xFFFFFFFF;
    NRF_TIMER1->TASKS_STOP = 1; NRF_TIMER1->INTENCLR = 0xFFFFFFFF;
    NRF_TIMER2->TASKS_STOP = 1; NRF_TIMER2->INTENCLR = 0xFFFFFFFF;
    NRF_TIMER3->TASKS_STOP = 1; NRF_TIMER3->INTENCLR = 0xFFFFFFFF;
    NRF_TIMER4->TASKS_STOP = 1; NRF_TIMER4->INTENCLR = 0xFFFFFFFF;

    // RTCs
    NRF_RTC0->TASKS_STOP = 1; NRF_RTC0->EVTENCLR = 0xFFFFFFFF; NRF_RTC0->INTENCLR = 0xFFFFFFFF;
    NRF_RTC1->TASKS_STOP = 1; NRF_RTC1->EVTENCLR = 0xFFFFFFFF; NRF_RTC1->INTENCLR = 0xFFFFFFFF;
